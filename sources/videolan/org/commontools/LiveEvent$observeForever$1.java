...
final class LiveEvent$observeForever$1 extends Lambda implements Function1<T, Unit> {
    final /* synthetic */ Observer<? super T> $observer;
    final /* synthetic */ LiveEvent<T> this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    LiveEvent$observeForever$1(LiveEvent<T> liveEvent, Observer<? super T> observer) {
        super(1);
