...
public final class HttpHeaderValues {
    ...
    public static final AsciiString FILENAME = AsciiString.cached(ContentDisposition.Parameters.FileName);
    ...
    public static final AsciiString NAME = AsciiString.cached(ContentDisposition.Parameters.Name);
    ...
    public static final AsciiString ZERO = AsciiString.cached(Constants.GROUP_VIDEOS_FOLDER);
