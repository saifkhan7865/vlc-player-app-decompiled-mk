...
public class WebSocketClientHandshaker08 extends WebSocketClientHandshaker {
    ...
    public WebSocketClientHandshaker08(URI uri, WebSocketVersion webSocketVersion, String str, boolean z, HttpHeaders httpHeaders, int i) {
        this(uri, webSocketVersion, str, z, httpHeaders, i, true, false, 10000);
    }
    ...
    public WebSocketClientHandshaker08(URI uri, WebSocketVersion webSocketVersion, String str, boolean z, HttpHeaders httpHeaders, int i, boolean z2, boolean z3, long j) {
        this(uri, webSocketVersion, str, z, httpHeaders, i, z2, z3, j, false, true);
    }

    WebSocketClientHandshaker08(URI uri, WebSocketVersion webSocketVersion, String str, boolean z, HttpHeaders httpHeaders, int i, boolean z2, boolean z3, long j, boolean z4) {
        this(uri, webSocketVersion, str, z, httpHeaders, i, z2, z3, j, z4, true);
    }

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    WebSocketClientHandshaker08(URI uri, WebSocketVersion webSocketVersion, String str, boolean z, HttpHeaders httpHeaders, int i, boolean z2, boolean z3, long j, boolean z4, boolean z5) {
    ...
    public FullHttpRequest newHandshakeRequest() {
        ...
        if (this.generateOriginHeader && !headers.contains((CharSequence) HttpHeaderNames.SEC_WEBSOCKET_ORIGIN)) {
            headers.set((CharSequence) HttpHeaderNames.SEC_WEBSOCKET_ORIGIN, (Object) websocketOriginValue(uri));
        }
