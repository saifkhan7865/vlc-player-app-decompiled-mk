...
final class HpackUtil {
    ...
    static int equalsConstantTime(CharSequence charSequence, CharSequence charSequence2) {
    ...
    static boolean equalsVariableTime(CharSequence charSequence, CharSequence charSequence2) {
