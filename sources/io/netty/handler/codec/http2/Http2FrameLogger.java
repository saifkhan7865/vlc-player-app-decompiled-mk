...
public class Http2FrameLogger extends ChannelHandlerAdapter {
    ...
    public Http2FrameLogger(LogLevel logLevel, String str) {
        this(checkAndConvertLevel(logLevel), InternalLoggerFactory.getInstance((String) ObjectUtil.checkNotNull(str, ContentDisposition.Parameters.Name)));
    }

    public Http2FrameLogger(LogLevel logLevel, Class<?> cls) {
        this(checkAndConvertLevel(logLevel), InternalLoggerFactory.getInstance((Class<?>) (Class) ObjectUtil.checkNotNull(cls, "clazz")));
    }
