...
public final class SslContextBuilder {
    ...
    public SslContextBuilder keyManager(PrivateKey privateKey, String str, X509Certificate... x509CertificateArr) {
        if (this.forServer) {
            ObjectUtil.checkNonEmpty((T[]) x509CertificateArr, "keyCertChain");
            ObjectUtil.checkNotNull(privateKey, "key required for servers");
        }
        if (x509CertificateArr == null || x509CertificateArr.length == 0) {
            this.keyCertChain = null;
        } else {
            for (X509Certificate checkNotNullWithIAE : x509CertificateArr) {
                ObjectUtil.checkNotNullWithIAE(checkNotNullWithIAE, "cert");
            }
