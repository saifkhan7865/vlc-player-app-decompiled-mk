...
public final class NettyApplicationCallHandler$handleRequest$1$invokeSuspend$$inlined$execute$1 extends SuspendLambda implements Function1<Continuation<? super Unit>, Object> {
    final /* synthetic */ Object $context;
    final /* synthetic */ Pipeline $this_execute;
    int label;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public NettyApplicationCallHandler$handleRequest$1$invokeSuspend$$inlined$execute$1(Pipeline pipeline, Object obj, Continuation continuation) {
    ...
    public final Object invoke(Continuation<? super Unit> continuation) {
        return ((NettyApplicationCallHandler$handleRequest$1$invokeSuspend$$inlined$execute$1) create(continuation)).invokeSuspend(Unit.INSTANCE);
    }
