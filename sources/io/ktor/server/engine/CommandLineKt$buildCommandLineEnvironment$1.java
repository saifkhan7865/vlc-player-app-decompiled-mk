...
final class CommandLineKt$buildCommandLineEnvironment$1 extends Lambda implements Function1<ApplicationEngineEnvironmentBuilder, Unit> {
    public static final CommandLineKt$buildCommandLineEnvironment$1 INSTANCE = new CommandLineKt$buildCommandLineEnvironment$1();

    CommandLineKt$buildCommandLineEnvironment$1() {
        super(1);
    }
