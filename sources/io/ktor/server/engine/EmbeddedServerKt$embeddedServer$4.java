...
final class EmbeddedServerKt$embeddedServer$4 extends Lambda implements Function1<TConfiguration, Unit> {
    public static final EmbeddedServerKt$embeddedServer$4 INSTANCE = new EmbeddedServerKt$embeddedServer$4();

    EmbeddedServerKt$embeddedServer$4() {
        super(1);
    }
