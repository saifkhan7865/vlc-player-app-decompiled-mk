...
final class CommandLineJvmKt$commandLineEnvironment$1 extends Lambda implements Function1<ApplicationEngineEnvironmentBuilder, Unit> {
    public static final CommandLineJvmKt$commandLineEnvironment$1 INSTANCE = new CommandLineJvmKt$commandLineEnvironment$1();

    CommandLineJvmKt$commandLineEnvironment$1() {
        super(1);
    }
