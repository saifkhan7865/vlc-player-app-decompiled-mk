...
final class EmbeddedServerKt$embeddedServer$2 extends Lambda implements Function1<TConfiguration, Unit> {
    public static final EmbeddedServerKt$embeddedServer$2 INSTANCE = new EmbeddedServerKt$embeddedServer$2();

    EmbeddedServerKt$embeddedServer$2() {
        super(1);
    }
