...
@DebugMetadata(c = "io.ktor.server.routing.RegexRoutingKt$put$2", f = "RegexRouting.kt", i = {}, l = {287, 159}, m = "invokeSuspend", n = {}, s = {})
/* compiled from: RegexRouting.kt */
public final class RegexRoutingKt$put$2 extends SuspendLambda implements Function3<PipelineContext<Unit, ApplicationCall>, Unit, Continuation<? super Unit>, Object> {
    ...
    public RegexRoutingKt$put$2(Function3<? super PipelineContext<Unit, ApplicationCall>, ? super R, ? super Continuation<? super Unit>, ? extends Object> function3, Continuation<? super RegexRoutingKt$put$2> continuation) {
        super(3, continuation);
        this.$body = function3;
    }

    public final Object invoke(PipelineContext<Unit, ApplicationCall> pipelineContext, Unit unit, Continuation<? super Unit> continuation) {
        RegexRoutingKt$put$2 regexRoutingKt$put$2 = new RegexRoutingKt$put$2(this.$body, continuation);
        regexRoutingKt$put$2.L$0 = pipelineContext;
        return regexRoutingKt$put$2.invokeSuspend(Unit.INSTANCE);
    }
