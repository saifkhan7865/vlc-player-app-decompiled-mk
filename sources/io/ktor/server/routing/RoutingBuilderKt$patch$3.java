...
@DebugMetadata(c = "io.ktor.server.routing.RoutingBuilderKt$patch$3", f = "RoutingBuilder.kt", i = {}, l = {409, 262}, m = "invokeSuspend", n = {}, s = {})
/* compiled from: RoutingBuilder.kt */
public final class RoutingBuilderKt$patch$3 extends SuspendLambda implements Function3<PipelineContext<Unit, ApplicationCall>, Unit, Continuation<? super Unit>, Object> {
    ...
    public RoutingBuilderKt$patch$3(Function3<? super PipelineContext<Unit, ApplicationCall>, ? super R, ? super Continuation<? super Unit>, ? extends Object> function3, Continuation<? super RoutingBuilderKt$patch$3> continuation) {
        super(3, continuation);
        this.$body = function3;
    }

    public final Object invoke(PipelineContext<Unit, ApplicationCall> pipelineContext, Unit unit, Continuation<? super Unit> continuation) {
        RoutingBuilderKt$patch$3 routingBuilderKt$patch$3 = new RoutingBuilderKt$patch$3(this.$body, continuation);
        routingBuilderKt$patch$3.L$0 = pipelineContext;
        return routingBuilderKt$patch$3.invokeSuspend(Unit.INSTANCE);
    }
