...
public final class HttpAcceptRouteSelector extends RouteSelector {
    ...
    public static /* synthetic */ HttpAcceptRouteSelector copy$default(HttpAcceptRouteSelector httpAcceptRouteSelector, ContentType contentType2, int i, Object obj) {
        if ((i & 1) != 0) {
    ...
    public final HttpAcceptRouteSelector copy(ContentType contentType2) {
    ...
    public boolean equals(Object obj) {
        ...
        return (obj instanceof HttpAcceptRouteSelector) && Intrinsics.areEqual((Object) this.contentType, (Object) ((HttpAcceptRouteSelector) obj).contentType);
    }
    ...
    public HttpAcceptRouteSelector(ContentType contentType2) {
        Intrinsics.checkNotNullParameter(contentType2, CMSAttributeTableGenerator.CONTENT_TYPE);
        this.contentType = contentType2;
        this.delegate = new HttpMultiAcceptRouteSelector(CollectionsKt.listOf(contentType2));
    }
    ...
    public RouteSelectorEvaluation evaluate(RoutingResolveContext routingResolveContext, int i) {
        ...
        return this.delegate.evaluate(routingResolveContext, i);
    }
