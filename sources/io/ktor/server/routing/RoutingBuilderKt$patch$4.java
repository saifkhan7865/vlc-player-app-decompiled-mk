...
@DebugMetadata(c = "io.ktor.server.routing.RoutingBuilderKt$patch$4", f = "RoutingBuilder.kt", i = {}, l = {409, 275}, m = "invokeSuspend", n = {}, s = {})
/* compiled from: RoutingBuilder.kt */
public final class RoutingBuilderKt$patch$4 extends SuspendLambda implements Function3<PipelineContext<Unit, ApplicationCall>, Unit, Continuation<? super Unit>, Object> {
    ...
    public RoutingBuilderKt$patch$4(Function3<? super PipelineContext<Unit, ApplicationCall>, ? super R, ? super Continuation<? super Unit>, ? extends Object> function3, Continuation<? super RoutingBuilderKt$patch$4> continuation) {
        super(3, continuation);
        this.$body = function3;
    }

    public final Object invoke(PipelineContext<Unit, ApplicationCall> pipelineContext, Unit unit, Continuation<? super Unit> continuation) {
        RoutingBuilderKt$patch$4 routingBuilderKt$patch$4 = new RoutingBuilderKt$patch$4(this.$body, continuation);
        routingBuilderKt$patch$4.L$0 = pipelineContext;
        return routingBuilderKt$patch$4.invokeSuspend(Unit.INSTANCE);
    }
