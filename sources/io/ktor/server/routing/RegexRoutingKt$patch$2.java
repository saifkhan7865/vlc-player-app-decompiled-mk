...
@DebugMetadata(c = "io.ktor.server.routing.RegexRoutingKt$patch$2", f = "RegexRouting.kt", i = {}, l = {287, 197}, m = "invokeSuspend", n = {}, s = {})
/* compiled from: RegexRouting.kt */
public final class RegexRoutingKt$patch$2 extends SuspendLambda implements Function3<PipelineContext<Unit, ApplicationCall>, Unit, Continuation<? super Unit>, Object> {
    ...
    public RegexRoutingKt$patch$2(Function3<? super PipelineContext<Unit, ApplicationCall>, ? super R, ? super Continuation<? super Unit>, ? extends Object> function3, Continuation<? super RegexRoutingKt$patch$2> continuation) {
        super(3, continuation);
        this.$body = function3;
    }

    public final Object invoke(PipelineContext<Unit, ApplicationCall> pipelineContext, Unit unit, Continuation<? super Unit> continuation) {
        RegexRoutingKt$patch$2 regexRoutingKt$patch$2 = new RegexRoutingKt$patch$2(this.$body, continuation);
        regexRoutingKt$patch$2.L$0 = pipelineContext;
        return regexRoutingKt$patch$2.invokeSuspend(Unit.INSTANCE);
    }
