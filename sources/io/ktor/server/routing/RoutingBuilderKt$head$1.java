...
final class RoutingBuilderKt$head$1 extends Lambda implements Function1<Route, Unit> {
    final /* synthetic */ Function3<PipelineContext<Unit, ApplicationCall>, Unit, Continuation<? super Unit>, Object> $body;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    RoutingBuilderKt$head$1(Function3<? super PipelineContext<Unit, ApplicationCall>, ? super Unit, ? super Continuation<? super Unit>, ? extends Object> function3) {
        super(1);
        this.$body = function3;
    }
