...
final class PartialOutgoingContent$Single$headers$2$1$1 extends Lambda implements Function2<String, String, Boolean> {
    public static final PartialOutgoingContent$Single$headers$2$1$1 INSTANCE = new PartialOutgoingContent$Single$headers$2$1$1();

    PartialOutgoingContent$Single$headers$2$1$1() {
        super(2);
    }
