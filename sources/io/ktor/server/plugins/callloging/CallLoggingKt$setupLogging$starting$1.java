...
final class CallLoggingKt$setupLogging$starting$1 extends Lambda implements Function1<Application, Unit> {
    final /* synthetic */ Function1<String, Unit> $log;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    CallLoggingKt$setupLogging$starting$1(Function1<? super String, Unit> function1) {
        super(1);
        this.$log = function1;
    }
