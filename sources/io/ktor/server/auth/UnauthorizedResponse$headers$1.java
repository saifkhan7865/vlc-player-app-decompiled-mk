...
final class UnauthorizedResponse$headers$1 extends Lambda implements Function1<HttpAuthHeader, CharSequence> {
    public static final UnauthorizedResponse$headers$1 INSTANCE = new UnauthorizedResponse$headers$1();

    UnauthorizedResponse$headers$1() {
        super(1);
    }
