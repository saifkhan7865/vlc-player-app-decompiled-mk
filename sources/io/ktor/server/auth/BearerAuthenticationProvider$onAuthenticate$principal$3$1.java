...
@DebugMetadata(c = "io.ktor.server.auth.BearerAuthenticationProvider$onAuthenticate$principal$3$1", f = "BearerAuth.kt", i = {0}, l = {119}, m = "invokeSuspend", n = {"challenge"}, s = {"L$0"})
/* compiled from: BearerAuth.kt */
final class BearerAuthenticationProvider$onAuthenticate$principal$3$1 extends SuspendLambda implements Function3<AuthenticationProcedureChallenge, ApplicationCall, Continuation<? super Unit>, Object> {
    ...
    BearerAuthenticationProvider$onAuthenticate$principal$3$1(BearerAuthenticationProvider bearerAuthenticationProvider, Continuation<? super BearerAuthenticationProvider$onAuthenticate$principal$3$1> continuation) {
    ...
    public final Object invoke(AuthenticationProcedureChallenge authenticationProcedureChallenge, ApplicationCall applicationCall, Continuation<? super Unit> continuation) {
        BearerAuthenticationProvider$onAuthenticate$principal$3$1 bearerAuthenticationProvider$onAuthenticate$principal$3$1 = new BearerAuthenticationProvider$onAuthenticate$principal$3$1(this.this$0, continuation);
        bearerAuthenticationProvider$onAuthenticate$principal$3$1.L$0 = authenticationProcedureChallenge;
        bearerAuthenticationProvider$onAuthenticate$principal$3$1.L$1 = applicationCall;
        return bearerAuthenticationProvider$onAuthenticate$principal$3$1.invokeSuspend(Unit.INSTANCE);
    }
