...
public final class LocalFileContent extends OutgoingContent.ReadChannelContent {
    ...
    public LocalFileContent(File file2, ContentType contentType2) {
        ...
        if (file2.exists()) {
            ...
            VersionsKt.setVersions(outgoingContent, CollectionsKt.plus(VersionsKt.getVersions(outgoingContent), LastModifiedJavaTimeKt.LastModifiedVersion(file2.lastModified())));
            return;
        }
        throw new IOException("No such file " + file2.getAbsolutePath());
    }
