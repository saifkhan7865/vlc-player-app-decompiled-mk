...
final class SinglePageApplicationKt$singlePageApplication$3 extends Lambda implements Function1<StaticContentConfig<File>, Unit> {
    final /* synthetic */ SPAConfig $config;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    SinglePageApplicationKt$singlePageApplication$3(SPAConfig sPAConfig) {
        super(1);
    ...
    public final void invoke(StaticContentConfig<File> staticContentConfig) {
        ...
        for (Function1 singlePageApplicationKt$singlePageApplication$3$1$1 : this.$config.getIgnoredFiles$ktor_server_core()) {
            staticContentConfig.exclude(new SinglePageApplicationKt$singlePageApplication$3$1$1(singlePageApplicationKt$singlePageApplication$3$1$1));
        }
    }
}
