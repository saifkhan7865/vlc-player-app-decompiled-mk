...
@DebugMetadata(c = "io.ktor.server.http.content.StaticContentKt$file$1", f = "StaticContent.kt", i = {}, l = {317}, m = "invokeSuspend", n = {}, s = {})
...
final class StaticContentKt$file$1 extends SuspendLambda implements Function3<PipelineContext<Unit, ApplicationCall>, Unit, Continuation<? super Unit>, Object> {
    ...
    StaticContentKt$file$1(File file, List<? extends CompressedFileType> list, Continuation<? super StaticContentKt$file$1> continuation) {
    ...
    public final Object invoke(PipelineContext<Unit, ApplicationCall> pipelineContext, Unit unit, Continuation<? super Unit> continuation) {
        StaticContentKt$file$1 staticContentKt$file$1 = new StaticContentKt$file$1(this.$file, this.$compressedTypes, continuation);
        staticContentKt$file$1.L$0 = pipelineContext;
        return staticContentKt$file$1.invokeSuspend(Unit.INSTANCE);
    }
