...
final class UtilsKt$ijDebugReportHandlerFinished$2 extends Lambda implements Function1<PluginsTrace, Unit> {
    final /* synthetic */ String $handler;
    final /* synthetic */ String $pluginName;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    UtilsKt$ijDebugReportHandlerFinished$2(String str, String str2) {
        super(1);
        this.$pluginName = str;
        this.$handler = str2;
    }
