...
final class CIOMultipartDataBase$withoutTempFile$1 extends Lambda implements Function0<Input> {
    final /* synthetic */ Lazy<MultipartInput> $lazyInput;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    CIOMultipartDataBase$withoutTempFile$1(Lazy<MultipartInput> lazy) {
        super(0);
        this.$lazyInput = lazy;
    }
