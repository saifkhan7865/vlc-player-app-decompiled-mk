...
public final class HttpMethod {
    ...
    public boolean equals(Object obj) {
        ...
        return (obj instanceof HttpMethod) && Intrinsics.areEqual((Object) this.value, (Object) ((HttpMethod) obj).value);
    }
    ...
    public static final class Companion {
        ...
        public final HttpMethod parse(String str) {
            ...
            if (Intrinsics.areEqual((Object) str, (Object) getGet().getValue())) {
                return getGet();
            }
            if (Intrinsics.areEqual((Object) str, (Object) getPost().getValue())) {
                return getPost();
            }
            if (Intrinsics.areEqual((Object) str, (Object) getPut().getValue())) {
                return getPut();
            }
            if (Intrinsics.areEqual((Object) str, (Object) getPatch().getValue())) {
                return getPatch();
            }
            if (Intrinsics.areEqual((Object) str, (Object) getDelete().getValue())) {
                return getDelete();
            }
            if (Intrinsics.areEqual((Object) str, (Object) getHead().getValue())) {
                return getHead();
            }
            if (Intrinsics.areEqual((Object) str, (Object) getOptions().getValue())) {
                return getOptions();
            }
            return new HttpMethod(str);
        }
    ...
    static {
        ...
        Options = httpMethod7;
        DefaultMethods = CollectionsKt.listOf(httpMethod, httpMethod2, httpMethod3, httpMethod4, httpMethod5, httpMethod6, httpMethod7);
    }
}
