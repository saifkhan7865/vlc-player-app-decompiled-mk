...
public final class HttpHeaderValueParserKt$parseAndSortContentTypeHeader$$inlined$thenBy$1<T> implements Comparator {
    ...
    public final int compare(T t, T t2) {
        ...
        int i = 2;
        int i2 = Intrinsics.areEqual((Object) parse.getContentType(), (Object) "*") ? 2 : 0;
        if (Intrinsics.areEqual((Object) parse.getContentSubtype(), (Object) "*")) {
            i2++;
        }
        Comparable valueOf = Integer.valueOf(i2);
        ContentType parse2 = ContentType.Companion.parse(((HeaderValue) t2).getValue());
        if (!Intrinsics.areEqual((Object) parse2.getContentType(), (Object) "*")) {
            i = 0;
        }
        if (Intrinsics.areEqual((Object) parse2.getContentSubtype(), (Object) "*")) {
            i++;
        }
