...
final class URLBuilderKt$set$1 extends Lambda implements Function1<URLBuilder, Unit> {
    public static final URLBuilderKt$set$1 INSTANCE = new URLBuilderKt$set$1();
