...
public final class HttpProtocolVersion {
    ...
    public boolean equals(Object obj) {
        ...
        return Intrinsics.areEqual((Object) this.name, (Object) httpProtocolVersion.name) && this.major == httpProtocolVersion.major && this.minor == httpProtocolVersion.minor;
    }
    ...
    public static final class Companion {
        ...
        public final HttpProtocolVersion fromValue(String str, int i, int i2) {
            Intrinsics.checkNotNullParameter(str, ContentDisposition.Parameters.Name);
            if (Intrinsics.areEqual((Object) str, (Object) "HTTP") && i == 1 && i2 == 0) {
                return getHTTP_1_0();
            }
            if (Intrinsics.areEqual((Object) str, (Object) "HTTP") && i == 1 && i2 == 1) {
                return getHTTP_1_1();
            }
            if (Intrinsics.areEqual((Object) str, (Object) "HTTP") && i == 2 && i2 == 0) {
                return getHTTP_2_0();
            }
            return new HttpProtocolVersion(str, i, i2);
        }
