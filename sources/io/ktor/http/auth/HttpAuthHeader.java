...
public abstract class HttpAuthHeader {
    ...
    public static final class Single extends HttpAuthHeader {
        ...
        public Single(String str, String str2) {
            ...
            if (!HttpAuthHeaderKt.token68Pattern.matches(str2)) {
                throw new ParseException("Invalid blob value: it should be token68", (Throwable) null, 2, (DefaultConstructorMarker) null);
            }
        }
    ...
    public static final class Parameterized extends HttpAuthHeader {
        ...
        public Parameterized(String str, List<HeaderValueParam> list, HeaderValueEncoding headerValueEncoding) {
            ...
            for (HeaderValueParam name : list) {
                if (!HttpAuthHeaderKt.token68Pattern.matches(name.getName())) {
                    throw new ParseException("Parameter name should be a token", (Throwable) null, 2, (DefaultConstructorMarker) null);
                }
            }
        }
        ...
        public final Parameterized withReplacedParameter(String str, String str2) {
            ...
            while (true) {
                if (!it.hasNext()) {
                    break;
                } else if (!Intrinsics.areEqual((Object) it.next().getName(), (Object) str)) {
                    i++;
                } else if (i != -1) {
                    Collection arrayList = new ArrayList();
                    for (HeaderValueParam headerValueParam : this.parameters) {
                        if (Intrinsics.areEqual((Object) headerValueParam.getName(), (Object) str)) {
                            if (!z) {
        ...
        public final String parameter(String str) {
            ...
            while (true) {
                ...
                obj = it.next();
                if (Intrinsics.areEqual((Object) ((HeaderValueParam) obj).getName(), (Object) str)) {
                    break;
                }
            }
        ...
        public boolean equals(Object obj) {
            ...
            if (!StringsKt.equals(parameterized.getAuthScheme(), getAuthScheme(), true) || !Intrinsics.areEqual((Object) parameterized.parameters, (Object) this.parameters)) {
                return false;
            }
            return true;
        }
    ...
    public static final class Companion {
        ...
        public final HttpAuthHeader bearerAuthChallenge(String str, String str2) {
            Intrinsics.checkNotNullParameter(str, "scheme");
            return new Parameterized(str, str2 == null ? MapsKt.emptyMap() : MapsKt.mapOf(TuplesKt.to(Parameters.Realm, str2)), (HeaderValueEncoding) null, 4, (DefaultConstructorMarker) null);
        }
        ...
        public final Parameterized digestAuthChallenge(String str, String str2, List<String> list, String str3, Boolean bool, String str4) {
            ...
            if (!list2.isEmpty()) {
                linkedHashMap.put("domain", CollectionsKt.joinToString$default(list2, AnsiRenderer.CODE_TEXT_SEPARATOR, (CharSequence) null, (CharSequence) null, 0, (CharSequence) null, (Function1) null, 62, (Object) null));
            }
            if (str7 != null) {
