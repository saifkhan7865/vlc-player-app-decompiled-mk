...
public final class DebugKt {
    ...
    public static final void printDebug(Grammar grammar, int i) {
        ...
        if (grammar instanceof StringGrammar) {
            printlnWithOffset(i, "STRING[" + Regex.Companion.escape(((StringGrammar) grammar).getValue()) + AbstractJsonLexerKt.END_LIST);
            ...
            printlnWithOffset(i, "ANY_OF[" + Regex.Companion.escape(((AnyOfGrammar) grammar).getValue()) + AbstractJsonLexerKt.END_LIST);
    ...
    private static final void printlnWithOffset(int i, Object obj) {
        System.out.println(StringsKt.repeat(AnsiRenderer.CODE_TEXT_SEPARATOR, i) + (i / 2) + ": " + obj);
    }
}
