...
public abstract class CacheControl {
    ...
    public CacheControl(Visibility visibility2) {
    ...
    public static final class MaxAge extends CacheControl {
        ...
        public boolean equals(Object obj) {
            if (obj != this) {
                if (obj instanceof MaxAge) {
                    ...
                    if (!(maxAge.maxAgeSeconds == this.maxAgeSeconds && Intrinsics.areEqual((Object) maxAge.proxyMaxAgeSeconds, (Object) this.proxyMaxAgeSeconds) && maxAge.mustRevalidate == this.mustRevalidate && maxAge.proxyRevalidate == this.proxyRevalidate && maxAge.getVisibility() == getVisibility())) {
                        return false;
                    }
                }
                return false;
        ...
        public int hashCode() {
            ...
            int i2 = 0;
            int intValue = (((((i + (num != null ? num.intValue() : 0)) * 31) + UInt$$ExternalSyntheticBackport0.m(this.mustRevalidate)) * 31) + UInt$$ExternalSyntheticBackport0.m(this.proxyRevalidate)) * 31;
            Visibility visibility = getVisibility();
            if (visibility != null) {
