...
public final class URLProtocol {
    ...
    public boolean equals(Object obj) {
        ...
        return Intrinsics.areEqual((Object) this.name, (Object) uRLProtocol.name) && this.defaultPort == uRLProtocol.defaultPort;
    }
    ...
    public URLProtocol(String str, int i) {
        ...
        while (i2 < charSequence.length()) {
            if (CharsetKt.isLowerCase(charSequence.charAt(i2))) {
                i2++;
            } else {
    ...
    static {
        ...
        SOCKS = uRLProtocol5;
        Iterable listOf = CollectionsKt.listOf(uRLProtocol, uRLProtocol2, uRLProtocol3, uRLProtocol4, uRLProtocol5);
