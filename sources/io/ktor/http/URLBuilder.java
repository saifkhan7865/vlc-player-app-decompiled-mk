...
public final class URLBuilder {
    ...
    public URLBuilder() {
        this((URLProtocol) null, (String) null, 0, (String) null, (String) null, (List) null, (Parameters) null, (String) null, false, FrameMetricsAggregator.EVERY_DURATION, (DefaultConstructorMarker) null);
    }
    ...
    public URLBuilder(URLProtocol uRLProtocol, String str, int i, String str2, String str3, List<String> list, Parameters parameters2, String str4, boolean z) {
        ...
        Intrinsics.checkNotNullParameter(str4, SecondaryActivity.KEY_FRAGMENT);
        ...
        for (String encodeURLPathPart : iterable) {
            arrayList.add(CodecsKt.encodeURLPathPart(encodeURLPathPart));
        }
    ...
    private final void applyOrigin() {
        if (this.host.length() <= 0 && !Intrinsics.areEqual((Object) this.protocol.getName(), (Object) "file")) {
            Url url = originUrl;
            this.host = url.getHost();
            if (Intrinsics.areEqual((Object) this.protocol, (Object) URLProtocol.Companion.getHTTP())) {
