...
final class OutgoingContent$ReadChannelContent$readFrom$1 extends SuspendLambda implements Function2<WriterScope, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            this.label = 1;
            if (byteReadChannel.discard(this.$range.getStart().longValue(), this) == coroutine_suspended) {
        ...
        this.L$1 = null;
        this.label = 2;
        if (ByteReadChannelJVMKt.copyTo(byteReadChannel, channel, (this.$range.getEndInclusive().longValue() - this.$range.getStart().longValue()) + 1, this) == coroutine_suspended) {
            return coroutine_suspended;
        }
        return Unit.INSTANCE;
    }
