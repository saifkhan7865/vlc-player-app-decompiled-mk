...
public final class EntityTagVersion implements Version {
    ...
    public boolean equals(Object obj) {
        ...
        return Intrinsics.areEqual((Object) this.etag, (Object) entityTagVersion.etag) && this.weak == entityTagVersion.weak;
    }
    ...
    public EntityTagVersion(String str, boolean z) {
        ...
        this.weak = z;
        int i = 0;
        if (!Intrinsics.areEqual((Object) str, (Object) "*") && !StringsKt.startsWith$default(str, "\"", false, 2, (Object) null)) {
    ...
    public final boolean match(EntityTagVersion entityTagVersion) {
        ...
        if (Intrinsics.areEqual((Object) this, (Object) entityTagVersion2) || Intrinsics.areEqual((Object) entityTagVersion, (Object) entityTagVersion2)) {
            return true;
        }
        return Intrinsics.areEqual((Object) this.normalized, (Object) entityTagVersion.normalized);
    }
    ...
    public final VersionCheckResult noneMatch(List<EntityTagVersion> list) {
        ...
        Iterable<EntityTagVersion> iterable = list;
        if (!(iterable instanceof Collection) || !((Collection) iterable).isEmpty()) {
            for (EntityTagVersion match : iterable) {
                if (match(match)) {
