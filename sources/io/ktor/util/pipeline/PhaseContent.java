...
public final class PhaseContent<TSubject, Call> {
    ...
    public final void addTo(PhaseContent<TSubject, Call> phaseContent) {
        Intrinsics.checkNotNullParameter(phaseContent, RtspHeaders.Values.DESTINATION);
        if (!isEmpty()) {
