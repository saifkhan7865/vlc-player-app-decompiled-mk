...
public final class SuspendFunctionGun<TSubject, TContext> extends PipelineContext<TSubject, TContext> {
    ...
    private final Continuation<Unit> continuation = new SuspendFunctionGun$continuation$1(this);
    private int index;
    ...
    public Object proceed(Continuation<? super TSubject> continuation2) {
        ...
        if (this.index == this.blocks.size()) {
            ...
            addContinuation(IntrinsicsKt.intercepted(continuation2));
            if (loop(true)) {
        ...
        do {
            ...
            if (i != this.blocks.size()) {
                ...
                try {
                    ...
                    resumeRootWith(Result.m1774constructorimpl(ResultKt.createFailure(th)));
                    return false;
                }
            } else if (z) {
                return true;
                ...
                resumeRootWith(Result.m1774constructorimpl(getSubject()));
                return false;
            }
    ...
    public final void resumeRootWith(Object obj) {
        ...
        if (i >= 0) {
            ...
            Throwable r5 = Result.m1777exceptionOrNullimpl(obj);
            Intrinsics.checkNotNull(r5);
            Throwable recoverStackTraceBridge = StackTraceRecoverKt.recoverStackTraceBridge(r5, continuation2);
            Result.Companion companion = Result.Companion;
            continuation2.resumeWith(Result.m1774constructorimpl(ResultKt.createFailure(recoverStackTraceBridge)));
            return;
        }
