...
final class StringValuesBuilderImpl$appendAll$1 extends Lambda implements Function2<String, List<? extends String>, Unit> {
    final /* synthetic */ StringValuesBuilderImpl this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    StringValuesBuilderImpl$appendAll$1(StringValuesBuilderImpl stringValuesBuilderImpl) {
        super(2);
