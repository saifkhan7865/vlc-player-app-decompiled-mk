...
final /* synthetic */ class CryptoKt__CryptoJvmKt {
    public static final Function1<String, byte[]> getDigestFunction(String str, Function1<? super String, String> function1) {
        ...
        return new CryptoKt__CryptoJvmKt$getDigestFunction$1(str, function1);
    }
    ...
    public static final Digest Digest(String str) {
        ...
        return DigestImpl.m1484boximpl(DigestImpl.m1486constructorimpl(instance));
    }

    public static final String generateNonce() {
        String str = (String) ChannelResult.m2341getOrNullimpl(NonceKt.getSeedChannel().m1138tryReceivePtdJZtk());
        if (str != null) {
            return str;
        }
