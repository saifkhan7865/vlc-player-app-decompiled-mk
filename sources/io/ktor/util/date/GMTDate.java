...
public final class GMTDate implements Comparable<GMTDate> {
    ...
    public static /* synthetic */ GMTDate copy$default(GMTDate gMTDate, int i, int i2, int i3, WeekDay weekDay, int i4, int i5, Month month2, int i6, long j, int i7, Object obj) {
        ...
        int i8 = i7;
        return gMTDate.copy((i8 & 1) != 0 ? gMTDate2.seconds : i, (i8 & 2) != 0 ? gMTDate2.minutes : i2, (i8 & 4) != 0 ? gMTDate2.hours : i3, (i8 & 8) != 0 ? gMTDate2.dayOfWeek : weekDay, (i8 & 16) != 0 ? gMTDate2.dayOfMonth : i4, (i8 & 32) != 0 ? gMTDate2.dayOfYear : i5, (i8 & 64) != 0 ? gMTDate2.month : month2, (i8 & 128) != 0 ? gMTDate2.year : i6, (i8 & 256) != 0 ? gMTDate2.timestamp : j);
    }
    ...
    public int hashCode() {
        return (((((((((((((((this.seconds * 31) + this.minutes) * 31) + this.hours) * 31) + this.dayOfWeek.hashCode()) * 31) + this.dayOfMonth) * 31) + this.dayOfYear) * 31) + this.month.hashCode()) * 31) + this.year) * 31) + UInt$$ExternalSyntheticBackport0.m(this.timestamp);
    }
