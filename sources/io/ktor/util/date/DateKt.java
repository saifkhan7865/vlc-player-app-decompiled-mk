...
public final class DateKt {
    ...
    public static final GMTDate m1497plusHG0u8IE(GMTDate gMTDate, long j) {
        Intrinsics.checkNotNullParameter(gMTDate, "$this$plus");
        return DateJvmKt.GMTDate(Long.valueOf(gMTDate.getTimestamp() + Duration.m1010getInWholeMillisecondsimpl(j)));
    }

    /* renamed from: minus-HG0u8IE  reason: not valid java name */
    public static final GMTDate m1496minusHG0u8IE(GMTDate gMTDate, long j) {
