...
public final class DeflaterKt {
    ...
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r3v11, resolved type: io.ktor.utils.io.pool.ObjectPool<java.nio.ByteBuffer>} */
    /* access modifiers changed from: private */
    /* JADX WARNING: Multi-variable type inference failed */
    /* JADX WARNING: Removed duplicated region for block: B:37:0x00fe  */
    /* JADX WARNING: Removed duplicated region for block: B:56:0x014f A[Catch:{ all -> 0x0214 }] */
    /* JADX WARNING: Removed duplicated region for block: B:63:0x017e A[Catch:{ all -> 0x01b2 }] */
    /* JADX WARNING: Removed duplicated region for block: B:73:0x01be A[Catch:{ all -> 0x0214 }] */
    /* JADX WARNING: Removed duplicated region for block: B:78:0x01ea A[SYNTHETIC, Splitter:B:78:0x01ea] */
    /* JADX WARNING: Removed duplicated region for block: B:86:0x0213 A[SYNTHETIC, Splitter:B:86:0x0213] */
    ...
    public static final java.lang.Object deflateTo(io.ktor.utils.io.ByteReadChannel r17, io.ktor.utils.io.ByteWriteChannel r18, boolean r19, io.ktor.utils.io.pool.ObjectPool<java.nio.ByteBuffer> r20, kotlin.coroutines.Continuation<? super kotlin.Unit> r21) {
        ...
        L_0x00a5:
            ...
            java.lang.Object r15 = r3.L$0
            io.ktor.utils.io.ByteReadChannel r15 = (io.ktor.utils.io.ByteReadChannel) r15
            kotlin.ResultKt.throwOnFailure(r2)     // Catch:{ all -> 0x00f9 }
            r16 = r1
            r1 = r0
            r0 = r14
            r14 = r13
        ...
        L_0x00fe:
            ...
            r14 = r17
            r3.L$0 = r14     // Catch:{ all -> 0x0139 }
            r3.L$1 = r0     // Catch:{ all -> 0x0139 }
            r15 = r20
            ...
            java.lang.Object r11 = putGzipHeader(r0, r3)     // Catch:{ all -> 0x0137 }
        ...
        L_0x0145:
            ...
            r13 = r15
        L_0x0149:
            boolean r15 = r14.isClosedForRead()     // Catch:{ all -> 0x0214 }
            if (r15 != 0) goto L_0x01b8
            r5.clear()     // Catch:{ all -> 0x0214 }
            r3.L$0 = r14     // Catch:{ all -> 0x0214 }
            r3.L$1 = r0     // Catch:{ all -> 0x0214 }
            r3.L$2 = r13     // Catch:{ all -> 0x0214 }
            r3.L$3 = r12     // Catch:{ all -> 0x0214 }
            r3.L$4 = r11     // Catch:{ all -> 0x0214 }
            r3.L$5 = r5     // Catch:{ all -> 0x0214 }
            r3.L$6 = r2     // Catch:{ all -> 0x0214 }
            r3.Z$0 = r1     // Catch:{ all -> 0x0214 }
            r3.label = r9     // Catch:{ all -> 0x0214 }
            java.lang.Object r15 = r14.readAvailable((java.nio.ByteBuffer) r5, (kotlin.coroutines.Continuation<? super java.lang.Integer>) r3)     // Catch:{ all -> 0x0214 }
        ...
        L_0x016b:
            ...
            r5 = r16
        L_0x0176:
            java.lang.Number r2 = (java.lang.Number) r2     // Catch:{ all -> 0x01b2 }
            int r2 = r2.intValue()     // Catch:{ all -> 0x01b2 }
            if (r2 <= 0) goto L_0x01aa
            r11.flip()     // Catch:{ all -> 0x01b2 }
            r2 = r13
            java.util.zip.Checksum r2 = (java.util.zip.Checksum) r2     // Catch:{ all -> 0x01b2 }
            updateKeepPosition(r2, r11)     // Catch:{ all -> 0x01b2 }
            setInputBuffer(r12, r11)     // Catch:{ all -> 0x01b2 }
            io.ktor.util.DeflaterKt$deflateTo$2 r2 = new io.ktor.util.DeflaterKt$deflateTo$2     // Catch:{ all -> 0x01b2 }
            r2.<init>(r12)     // Catch:{ all -> 0x01b2 }
            kotlin.jvm.functions.Function0 r2 = (kotlin.jvm.functions.Function0) r2     // Catch:{ all -> 0x01b2 }
            r5.L$0 = r15     // Catch:{ all -> 0x01b2 }
            r5.L$1 = r0     // Catch:{ all -> 0x01b2 }
            r5.L$2 = r14     // Catch:{ all -> 0x01b2 }
            r5.L$3 = r13     // Catch:{ all -> 0x01b2 }
            r5.L$4 = r12     // Catch:{ all -> 0x01b2 }
            r5.L$5 = r11     // Catch:{ all -> 0x01b2 }
            r5.L$6 = r3     // Catch:{ all -> 0x01b2 }
            r5.Z$0 = r1     // Catch:{ all -> 0x01b2 }
            r5.label = r8     // Catch:{ all -> 0x01b2 }
            java.lang.Object r2 = deflateWhile(r0, r12, r3, r2, r5)     // Catch:{ all -> 0x01b2 }
        ...
        L_0x01b2:
            ...
            goto L_0x0218
        L_0x01b8:
            java.lang.Throwable r8 = r14.getClosedCause()     // Catch:{ all -> 0x0214 }
            if (r8 != 0) goto L_0x0213
            r11.finish()     // Catch:{ all -> 0x0214 }
            io.ktor.util.DeflaterKt$deflateTo$4 r8 = new io.ktor.util.DeflaterKt$deflateTo$4     // Catch:{ all -> 0x0214 }
            r8.<init>(r11)     // Catch:{ all -> 0x0214 }
            kotlin.jvm.functions.Function0 r8 = (kotlin.jvm.functions.Function0) r8     // Catch:{ all -> 0x0214 }
            r3.L$0 = r0     // Catch:{ all -> 0x0214 }
            r3.L$1 = r13     // Catch:{ all -> 0x0214 }
            r3.L$2 = r12     // Catch:{ all -> 0x0214 }
            r3.L$3 = r11     // Catch:{ all -> 0x0214 }
            r3.L$4 = r5     // Catch:{ all -> 0x0214 }
            r3.L$5 = r2     // Catch:{ all -> 0x0214 }
            r3.L$6 = r10     // Catch:{ all -> 0x0214 }
            r3.Z$0 = r1     // Catch:{ all -> 0x0214 }
            r3.label = r7     // Catch:{ all -> 0x0214 }
            java.lang.Object r7 = deflateWhile(r0, r11, r2, r8, r3)     // Catch:{ all -> 0x0214 }
        ...
        L_0x01e8:
            ...
            java.util.zip.Checksum r8 = (java.util.zip.Checksum) r8     // Catch:{ all -> 0x00f9 }
            r3.L$0 = r13     // Catch:{ all -> 0x00f9 }
            r3.L$1 = r11     // Catch:{ all -> 0x00f9 }
            r3.L$2 = r5     // Catch:{ all -> 0x00f9 }
            r3.L$3 = r1     // Catch:{ all -> 0x00f9 }
            r3.L$4 = r10     // Catch:{ all -> 0x00f9 }
            r3.L$5 = r10     // Catch:{ all -> 0x00f9 }
            r3.label = r6     // Catch:{ all -> 0x00f9 }
            java.lang.Object r0 = putGzipTrailer(r2, r8, r11, r3)     // Catch:{ all -> 0x00f9 }
