...
public class LockFreeLinkedListNode {
    ...
    public static class AddLastDesc<T extends LockFreeLinkedListNode> extends AbstractAtomicDesc {
        ...
        public Object onPrepare(LockFreeLinkedListNode lockFreeLinkedListNode, LockFreeLinkedListNode lockFreeLinkedListNode2) {
            Intrinsics.checkNotNullParameter(lockFreeLinkedListNode, "affected");
            Intrinsics.checkNotNullParameter(lockFreeLinkedListNode2, LinkHeader.Rel.Next);
            AbstractResolvableFuture$SafeAtomicHelper$$ExternalSyntheticBackportWithForwarding0.m(_affectedNode$FU, this, (Object) null, lockFreeLinkedListNode);
            return null;
        }
    ...
    public static class RemoveFirstDesc<T> extends AbstractAtomicDesc {
        ...
        public final Object onPrepare(LockFreeLinkedListNode lockFreeLinkedListNode, LockFreeLinkedListNode lockFreeLinkedListNode2) {
            ...
            if (!(!(lockFreeLinkedListNode instanceof LockFreeLinkedListHead))) {
                ...
                AbstractResolvableFuture$SafeAtomicHelper$$ExternalSyntheticBackportWithForwarding0.m(_affectedNode$FU, this, (Object) null, lockFreeLinkedListNode);
                AbstractResolvableFuture$SafeAtomicHelper$$ExternalSyntheticBackportWithForwarding0.m(_originalNext$FU, this, (Object) null, lockFreeLinkedListNode2);
                return null;
            }
        }
            ...
            while (true) {
                ...
                if (obj instanceof OpDescriptor) {
                    ...
                    if (!retry(takeAffectedNode, obj)) {
                        ...
                        if (AbstractResolvableFuture$SafeAtomicHelper$$ExternalSyntheticBackportWithForwarding0.m(LockFreeLinkedListNode._next$FU, takeAffectedNode, obj, prepareOp) && (perform = prepareOp.perform(takeAffectedNode)) != LockFreeLinkedListKt.REMOVE_PREPARED) {
                            return perform;
                        }
                    } else {
                        continue;
    ...
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r3v4, resolved type: io.ktor.util.internal.LockFreeLinkedListNode} */
    ...
    public final void helpDelete() {
        ...
        L_0x0021:
            ...
            androidx.concurrent.futures.AbstractResolvableFuture$SafeAtomicHelper$$ExternalSyntheticBackportWithForwarding0.m(r5, r3, r0, r4)
            r0 = r3
            goto L_0x0010
        L_0x0039:
        ...
        L_0x0051:
            ...
            boolean r4 = androidx.concurrent.futures.AbstractResolvableFuture$SafeAtomicHelper$$ExternalSyntheticBackportWithForwarding0.m(r4, r0, r7, r1)
    ...
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r1v4, resolved type: io.ktor.util.internal.LockFreeLinkedListNode} */
    /* access modifiers changed from: private */
    /* JADX WARNING: Multi-variable type inference failed */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public final io.ktor.util.internal.LockFreeLinkedListNode correctPrev(io.ktor.util.internal.LockFreeLinkedListNode r7, io.ktor.util.internal.OpDescriptor r8) {
        ...
        L_0x0011:
            ...
            androidx.concurrent.futures.AbstractResolvableFuture$SafeAtomicHelper$$ExternalSyntheticBackportWithForwarding0.m(r3, r1, r7, r2)
            r7 = r1
            goto L_0x0001
        L_0x0025:
        ...
        L_0x0044:
            ...
            boolean r2 = androidx.concurrent.futures.AbstractResolvableFuture$SafeAtomicHelper$$ExternalSyntheticBackportWithForwarding0.m(r2, r6, r3, r7)
    ...
    public final void validateNode$ktor_utils(LockFreeLinkedListNode lockFreeLinkedListNode, LockFreeLinkedListNode lockFreeLinkedListNode2) {
        ...
        if (lockFreeLinkedListNode != this._prev) {
            throw new IllegalStateException("Check failed.".toString());
        } else if (lockFreeLinkedListNode2 != this._next) {
            throw new IllegalStateException("Check failed.".toString());
        }
    }
    ...
    public final void finishAdd(LockFreeLinkedListNode lockFreeLinkedListNode) {
        ...
        } while (!AbstractResolvableFuture$SafeAtomicHelper$$ExternalSyntheticBackportWithForwarding0.m(_prev$FU, lockFreeLinkedListNode, obj, this));
