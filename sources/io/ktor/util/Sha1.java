...
@Metadata(d1 = {"\u00002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\b\n\u0002\b\u0005\n\u0002\u0010\t\n\u0000\n\u0002\u0010\u0012\n\u0002\b\u0002\n\u0002\u0010\u0015\n\u0002\b\u0002\n\u0002\u0010\u0002\n\u0002\b\u0007\b\u0000\u0018\u00002\u00020\u0001B\u0005¢\u0006\u0002\u0010\u0002J\b\u0010\u0010\u001a\u00020\fH\u0016J\u0018\u0010\u0011\u001a\u00020\u00122\u0006\u0010\u0013\u001a\u00020\f2\u0006\u0010\u0014\u001a\u00020\u0004H\u0002J\b\u0010\u0015\u001a\u00020\u0012H\u0002J \u0010\u0016\u001a\u00020\u00122\u0006\u0010\u0013\u001a\u00020\f2\u0006\u0010\u0017\u001a\u00020\u00042\u0006\u0010\u0018\u001a\u00020\u0004H\u0016R\u000e\u0010\u0003\u001a\u00020\u0004X\u000e¢\u0006\u0002\n\u0000R\u000e\u0010\u0005\u001a\u00020\u0004X\u000e¢\u0006\u0002\n\u0000R\u000e\u0010\u0006\u001a\u00020\u0004X\u000e¢\u0006\u0002\n\u0000R\u000e\u0010\u0007\u001a\u00020\u0004X\u000e¢\u0006\u0002\n\u0000R\u000e\u0010\b\u001a\u00020\u0004X\u000e¢\u0006\u0002\n\u0000R\u000e\u0010\t\u001a\u00020\nX\u000e¢\u0006\u0002\n\u0000R\u000e\u0010\u000b\u001a\u00020\fX\u0004¢\u0006\u0002\n\u0000R\u000e\u0010\r\u001a\u00020\u0004X\u000e¢\u0006\u0002\n\u0000R\u000e\u0010\u000e\u001a\u00020\u000fX\u0004¢\u0006\u0002\n\u0000¨\u0006\u0019"}, d2 = {"Lio/ktor/util/Sha1;", "Lio/ktor/util/HashFunction;", "()V", "h0", "", "h1", "h2", "h3", "h4", "messageLength", "", "unprocessed", "", "unprocessedLimit", "words", "", "digest", "processChunk", "", "input", "pos", "reset", "update", "offset", "length", "ktor-utils"}, k = 1, mv = {1, 8, 0}, xi = 48)
...
public final class Sha1 implements HashFunction {
    ...
    public void update(byte[] r6, int r7, int r8) {
        /*
            ...
            kotlin.collections.ArraysKt.copyInto((byte[]) r6, (byte[]) r1, (int) r2, (int) r7, (int) r0)
            r5.unprocessedLimit = r8
            return
        L_0x001f:
            int r8 = 64 - r2
            int r8 = r8 + r7
            kotlin.collections.ArraysKt.copyInto((byte[]) r6, (byte[]) r1, (int) r2, (int) r7, (int) r8)
        ...
        L_0x002b:
            ...
            kotlin.collections.ArraysKt.copyInto((byte[]) r6, (byte[]) r1, (int) r3, (int) r7, (int) r0)
            int r0 = r0 - r7
    ...
    private final void processChunk(byte[] bArr, int i) {
        ...
        while (true) {
            ...
            int i6 = (bArr[i] & 255) << Ascii.CAN;
            int i7 = i + 3;
            i += 4;
            iArr[i5] = ((bArr[i + 1] & 255) << Ascii.DLE) | i6 | ((bArr[i + 2] & 255) << 8) | (bArr[i7] & 255);
            i5++;
        }
        for (i2 = 16; i2 < 80; i2++) {
        ...
        while (i4 < 80) {
            if (i4 < 20) {
                access$leftRotate = HashFunctionKt.leftRotate(i8, 5) + (((i10 ^ i11) & i9) ^ i11) + i12 + 1518500249;
                i3 = iArr[i4];
            } else if (i4 < 40) {
                access$leftRotate = HashFunctionKt.leftRotate(i8, 5) + ((i9 ^ i10) ^ i11) + i12 + 1859775393;
                i3 = iArr[i4];
            } else if (i4 < 60) {
                access$leftRotate = ((HashFunctionKt.leftRotate(i8, 5) + (((i9 & i10) | (i9 & i11)) | (i10 & i11))) + i12) - 1894007588;
                i3 = iArr[i4];
            } else {
                access$leftRotate = ((HashFunctionKt.leftRotate(i8, 5) + ((i9 ^ i10) ^ i11)) + i12) - 899497514;
                i3 = iArr[i4];
            }
            int i13 = access$leftRotate + i3;
            i4++;
            i12 = i11;
            i11 = i10;
            i10 = HashFunctionKt.leftRotate(i9, 30);
            i9 = i8;
            i8 = i13;
        }
        this.h0 += i8;
