...
final class TCPSocketBuilderJvmKt$connect$2 extends Lambda implements Function1<SocketOptions.TCPClientSocketOptions, Unit> {
    public static final TCPSocketBuilderJvmKt$connect$2 INSTANCE = new TCPSocketBuilderJvmKt$connect$2();

    TCPSocketBuilderJvmKt$connect$2() {
        super(1);
    }
