...
final class CertificatesKt$writeAlgorithmIdentifier$1 extends Lambda implements Function1<BytePacketBuilder, Unit> {
    final /* synthetic */ String $algorithm;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    CertificatesKt$writeAlgorithmIdentifier$1(String str) {
        super(1);
        this.$algorithm = str;
    }
    ...
    public final void invoke(BytePacketBuilder bytePacketBuilder) {
        ...
        CertificatesKt.writeDerObjectIdentifier(bytePacketBuilder, OID.Companion.fromAlgorithm(this.$algorithm));
