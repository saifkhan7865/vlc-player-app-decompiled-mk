...
final class CertificatesKt$generateCertificate$keyStore$1 extends Lambda implements Function1<KeyStoreBuilder, Unit> {
    ...
    CertificatesKt$generateCertificate$keyStore$1(String str, String str2, String str3, int i, KeyType keyType) {
        super(1);
        this.$keyAlias = str;
        this.$algorithm = str2;
    ...
    public final void invoke(KeyStoreBuilder keyStoreBuilder) {
        ...
        keyStoreBuilder.certificate(str, new Function1<CertificateBuilder, Unit>() {
            ...
            public final void invoke(CertificateBuilder certificateBuilder) {
                ...
                certificateBuilder.setSubject(keyType == KeyType.CA ? CertificatesKt.DEFAULT_CA_PRINCIPAL : CertificatesKt.getDEFAULT_PRINCIPAL());
