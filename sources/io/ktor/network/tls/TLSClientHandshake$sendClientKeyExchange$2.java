...
final class TLSClientHandshake$sendClientKeyExchange$2 extends Lambda implements Function1<BytePacketBuilder, Unit> {
    final /* synthetic */ ByteReadPacket $packet;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    TLSClientHandshake$sendClientKeyExchange$2(ByteReadPacket byteReadPacket) {
        super(1);
