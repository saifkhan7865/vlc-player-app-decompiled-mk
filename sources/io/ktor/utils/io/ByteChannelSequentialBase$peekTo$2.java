...
final class ByteChannelSequentialBase$peekTo$2 extends SuspendLambda implements Function2<SuspendableReadSession, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            this.label = 1;
            if (suspendableReadSession2.await((int) RangesKt.coerceAtMost(this.$min + this.$offset, 4088), this) == coroutine_suspended) {
        ...
        if (((long) (buffer.getWritePosition() - buffer.getReadPosition())) > this.$offset) {
            ...
            Memory.m1511copyToJT6ljtQ(request.m155getMemorySK3TCg8(), this.$destination, this.$offset, this.$bytesCopied.element, this.$destinationOffset);
        }
