...
public final class StreamsKt {
    ...
    public static final void writePacket(OutputStream outputStream, ByteReadPacket byteReadPacket) {
        ...
        if (remaining != 0) {
            byte[] bArr = new byte[((int) RangesKt.coerceAtMost(remaining, (long) PlaybackStateCompat.ACTION_SKIP_TO_QUEUE_ITEM))];
    ...
    private static final ByteReadPacket readPacketImpl(InputStream inputStream, long j, long j2) {
        if (j < 0) {
            ...
            int coerceAtMost = (int) RangesKt.coerceAtMost(j2, (long) PlaybackStateCompat.ACTION_SKIP_TO_QUEUE_ITEM);
