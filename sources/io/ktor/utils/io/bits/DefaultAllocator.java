...
public final class DefaultAllocator implements Allocator {
    ...
    public void m1507free3GNKZMM(ByteBuffer byteBuffer) {
    ...
    public ByteBuffer m1505allocgFvZug(int i) {
        ByteBuffer allocate = ByteBuffer.allocate(i);
        Intrinsics.checkNotNullExpressionValue(allocate, "allocate(size)");
        return Memory.m1509constructorimpl(allocate);
    }

    /* renamed from: alloc-gFv-Zug  reason: not valid java name */
    public ByteBuffer m1506allocgFvZug(long j) {
        if (j < 2147483647L) {
            return m1505allocgFvZug((int) j);
        }
