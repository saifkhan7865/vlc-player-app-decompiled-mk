...
public final class MemoryKt {
    ...
    public static final void m1533copyToJT6ljtQ(ByteBuffer byteBuffer, byte[] bArr, int i, int i2) {
        ...
        MemoryJvmKt.m1528copyTo9zorpBc(byteBuffer, bArr, i, i2, 0);
    }

    /* renamed from: copyTo-JT6ljtQ  reason: not valid java name */
    public static final void m1534copyToJT6ljtQ(ByteBuffer byteBuffer, byte[] bArr, long j, int i) {
        Intrinsics.checkNotNullParameter(byteBuffer, "$this$copyTo");
        Intrinsics.checkNotNullParameter(bArr, RtspHeaders.Values.DESTINATION);
        MemoryJvmKt.m1529copyTo9zorpBc(byteBuffer, bArr, j, i, 0);
    }

    /* renamed from: get-eY85DW0  reason: not valid java name */
    public static final byte m1535geteY85DW0(ByteBuffer byteBuffer, int i) {
        Intrinsics.checkNotNullParameter(byteBuffer, "$this$get");
        return byteBuffer.get(i);
    }

    /* renamed from: get-eY85DW0  reason: not valid java name */
    public static final byte m1536geteY85DW0(ByteBuffer byteBuffer, long j) {
        Intrinsics.checkNotNullParameter(byteBuffer, "$this$get");
        if (j < 2147483647L) {
    ...
    public static final void m1538set62zg_DM(ByteBuffer byteBuffer, long j, byte b) {
    ...
    /* renamed from: set-62zg_DM  reason: not valid java name */
    public static final void m1537set62zg_DM(ByteBuffer byteBuffer, int i, byte b) {
        Intrinsics.checkNotNullParameter(byteBuffer, "$this$set");
        byteBuffer.put(i, b);
    }

    /* renamed from: storeAt-OEmREl0  reason: not valid java name */
    public static final void m1540storeAtOEmREl0(ByteBuffer byteBuffer, long j, byte b) {
    ...
    /* renamed from: storeAt-OEmREl0  reason: not valid java name */
    public static final void m1539storeAtOEmREl0(ByteBuffer byteBuffer, int i, byte b) {
        Intrinsics.checkNotNullParameter(byteBuffer, "$this$storeAt");
        byteBuffer.put(i, b);
    }
}
