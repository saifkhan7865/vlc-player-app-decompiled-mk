...
public final class Memory {
    ...
    public static final /* synthetic */ Memory m1508boximpl(ByteBuffer byteBuffer) {
        return new Memory(byteBuffer);
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    public static ByteBuffer m1509constructorimpl(ByteBuffer byteBuffer) {
        Intrinsics.checkNotNullParameter(byteBuffer, "buffer");
        return byteBuffer;
    }

    /* renamed from: equals-impl  reason: not valid java name */
    public static boolean m1512equalsimpl(ByteBuffer byteBuffer, Object obj) {
        return (obj instanceof Memory) && Intrinsics.areEqual((Object) byteBuffer, (Object) ((Memory) obj).m1524unboximpl());
    }

    /* renamed from: equals-impl0  reason: not valid java name */
    public static final boolean m1513equalsimpl0(ByteBuffer byteBuffer, ByteBuffer byteBuffer2) {
        return Intrinsics.areEqual((Object) byteBuffer, (Object) byteBuffer2);
    }

    /* renamed from: hashCode-impl  reason: not valid java name */
    public static int m1516hashCodeimpl(ByteBuffer byteBuffer) {
        return byteBuffer.hashCode();
    }

    /* renamed from: toString-impl  reason: not valid java name */
    public static String m1523toStringimpl(ByteBuffer byteBuffer) {
        return "Memory(buffer=" + byteBuffer + ')';
    }

    public boolean equals(Object obj) {
        return m1512equalsimpl(this.buffer, obj);
    }

    public int hashCode() {
        return m1516hashCodeimpl(this.buffer);
    }

    public String toString() {
        return m1523toStringimpl(this.buffer);
    }

    /* renamed from: unbox-impl  reason: not valid java name */
    public final /* synthetic */ ByteBuffer m1524unboximpl() {
        return this.buffer;
    }
    ...
    public static final long m1514getSizeimpl(ByteBuffer byteBuffer) {
        return (long) byteBuffer.limit();
    }

    /* renamed from: getSize32-impl  reason: not valid java name */
    public static final int m1515getSize32impl(ByteBuffer byteBuffer) {
        return byteBuffer.limit();
    }

    /* renamed from: loadAt-impl  reason: not valid java name */
    public static final byte m1517loadAtimpl(ByteBuffer byteBuffer, int i) {
        return byteBuffer.get(i);
    }

    /* renamed from: loadAt-impl  reason: not valid java name */
    public static final byte m1518loadAtimpl(ByteBuffer byteBuffer, long j) {
        if (j < 2147483647L) {
    ...
    public static final void m1521storeAtimpl(ByteBuffer byteBuffer, int i, byte b) {
        byteBuffer.put(i, b);
    }

    /* renamed from: storeAt-impl  reason: not valid java name */
    public static final void m1522storeAtimpl(ByteBuffer byteBuffer, long j, byte b) {
        if (j < 2147483647L) {
    ...
    public static final ByteBuffer m1519slice87lwejk(ByteBuffer byteBuffer, int i, int i2) {
        return m1509constructorimpl(MemoryJvmKt.sliceSafe(byteBuffer, i, i2));
    }

    /* renamed from: slice-87lwejk  reason: not valid java name */
    public static final ByteBuffer m1520slice87lwejk(ByteBuffer byteBuffer, long j, long j2) {
        if (j < 2147483647L) {
            int i = (int) j;
            if (j2 < 2147483647L) {
                return m1519slice87lwejk(byteBuffer, i, (int) j2);
            }
    ...
    public static final void m1510copyToJT6ljtQ(ByteBuffer byteBuffer, ByteBuffer byteBuffer2, int i, int i2, int i3) {
    ...
    /* renamed from: copyTo-JT6ljtQ  reason: not valid java name */
    public static final void m1511copyToJT6ljtQ(ByteBuffer byteBuffer, ByteBuffer byteBuffer2, long j, long j2, long j3) {
        Intrinsics.checkNotNullParameter(byteBuffer2, RtspHeaders.Values.DESTINATION);
        if (j < 2147483647L) {
            int i = (int) j;
            if (j2 < 2147483647L) {
                int i2 = (int) j2;
                if (j3 < 2147483647L) {
                    m1510copyToJT6ljtQ(byteBuffer, byteBuffer2, i, i2, (int) j3);
                } else {
    ...
    public static final class Companion {
        ...
        public final ByteBuffer m1525getEmptySK3TCg8() {
            return Memory.Empty;
        }
    }
    ...
    static {
        ...
        Empty = m1509constructorimpl(order);
    }
}
