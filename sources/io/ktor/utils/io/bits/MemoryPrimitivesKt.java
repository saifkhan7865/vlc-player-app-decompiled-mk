...
public final class MemoryPrimitivesKt {
    ...
    public static final short m1565loadUShortAteY85DW0(ByteBuffer byteBuffer, int i) {
        Intrinsics.checkNotNullParameter(byteBuffer, "$this$loadUShortAt");
        return UShort.m2055constructorimpl(byteBuffer.getShort(i));
    }

    /* renamed from: loadUShortAt-eY85DW0  reason: not valid java name */
    public static final short m1566loadUShortAteY85DW0(ByteBuffer byteBuffer, long j) {
        Intrinsics.checkNotNullParameter(byteBuffer, "$this$loadUShortAt");
        if (j < 2147483647L) {
            return UShort.m2055constructorimpl(byteBuffer.getShort((int) j));
        }
    ...
    public static final void m1571storeUShortAt4ET0KQI(ByteBuffer byteBuffer, int i, short s) {
        Intrinsics.checkNotNullParameter(byteBuffer, "$this$storeUShortAt");
        byteBuffer.putShort(i, s);
    }

    /* renamed from: storeUShortAt-4ET0KQI  reason: not valid java name */
    public static final void m1572storeUShortAt4ET0KQI(ByteBuffer byteBuffer, long j, short s) {
        Intrinsics.checkNotNullParameter(byteBuffer, "$this$storeUShortAt");
        if (j < 2147483647L) {
    ...
    public static final int m1561loadUIntAteY85DW0(ByteBuffer byteBuffer, int i) {
        Intrinsics.checkNotNullParameter(byteBuffer, "$this$loadUIntAt");
        return UInt.m1869constructorimpl(byteBuffer.getInt(i));
    }

    /* renamed from: loadUIntAt-eY85DW0  reason: not valid java name */
    public static final int m1562loadUIntAteY85DW0(ByteBuffer byteBuffer, long j) {
        Intrinsics.checkNotNullParameter(byteBuffer, "$this$loadUIntAt");
        if (j < 2147483647L) {
            return UInt.m1869constructorimpl(byteBuffer.getInt((int) j));
        }
        NumbersKt.failLongToIntConversion(j, TypedValues.CycleType.S_WAVE_OFFSET);
        throw new KotlinNothingValueException();
    }
    ...
    public static final void m1567storeUIntAtc9EmHqw(ByteBuffer byteBuffer, int i, int i2) {
        Intrinsics.checkNotNullParameter(byteBuffer, "$this$storeUIntAt");
        byteBuffer.putInt(i, i2);
    }

    /* renamed from: storeUIntAt-c9EmHqw  reason: not valid java name */
    public static final void m1568storeUIntAtc9EmHqw(ByteBuffer byteBuffer, long j, int i) {
        Intrinsics.checkNotNullParameter(byteBuffer, "$this$storeUIntAt");
        if (j < 2147483647L) {
    ...
    public static final long m1563loadULongAteY85DW0(ByteBuffer byteBuffer, int i) {
        Intrinsics.checkNotNullParameter(byteBuffer, "$this$loadULongAt");
        return ULong.m1948constructorimpl(byteBuffer.getLong(i));
    }

    /* renamed from: loadULongAt-eY85DW0  reason: not valid java name */
    public static final long m1564loadULongAteY85DW0(ByteBuffer byteBuffer, long j) {
        Intrinsics.checkNotNullParameter(byteBuffer, "$this$loadULongAt");
        if (j < 2147483647L) {
            return ULong.m1948constructorimpl(byteBuffer.getLong((int) j));
        }
        NumbersKt.failLongToIntConversion(j, TypedValues.CycleType.S_WAVE_OFFSET);
        throw new KotlinNothingValueException();
    }
    ...
    public static final void m1569storeULongAtzwzI6Wg(ByteBuffer byteBuffer, int i, long j) {
        Intrinsics.checkNotNullParameter(byteBuffer, "$this$storeULongAt");
        byteBuffer.putLong(i, j);
    }

    /* renamed from: storeULongAt-zwzI6Wg  reason: not valid java name */
    public static final void m1570storeULongAtzwzI6Wg(ByteBuffer byteBuffer, long j, long j2) {
        Intrinsics.checkNotNullParameter(byteBuffer, "$this$storeULongAt");
        if (j < 2147483647L) {
