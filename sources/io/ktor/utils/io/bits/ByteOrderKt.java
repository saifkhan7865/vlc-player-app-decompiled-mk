...
public final class ByteOrderKt {
    ...
    public static final short m1504reverseByteOrderxj2QHRw(short s) {
        return UShort.m2055constructorimpl(Short.reverseBytes(s));
    }

    /* renamed from: reverseByteOrder-WZ4Q5Ns  reason: not valid java name */
    public static final int m1503reverseByteOrderWZ4Q5Ns(int i) {
        return UInt.m1869constructorimpl(Integer.reverseBytes(i));
    }

    /* renamed from: reverseByteOrder-VKZWuLQ  reason: not valid java name */
    public static final long m1502reverseByteOrderVKZWuLQ(long j) {
        return ULong.m1948constructorimpl(Long.reverseBytes(j));
    }
}
