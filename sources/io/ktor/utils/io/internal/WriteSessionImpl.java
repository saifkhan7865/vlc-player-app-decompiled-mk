...
public final class WriteSessionImpl implements WriterSuspendSession {
    private ByteBuffer byteBuffer = ChunkBuffer.Companion.getEmpty().m155getMemorySK3TCg8();
    ...
    public WriteSessionImpl(ByteBufferChannel byteBufferChannel) {
        Intrinsics.checkNotNullParameter(byteBufferChannel, TvContractCompat.PARAM_CHANNEL);
