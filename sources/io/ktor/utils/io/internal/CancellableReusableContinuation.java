...
public final class CancellableReusableContinuation<T> implements Continuation<T> {
    ...
    static {
        ...
        state$FU = AtomicReferenceFieldUpdater.newUpdater(cls, Object.class, OAuth2RequestParameters.State);
    ...
    public final void close(T t) {
        ...
        resumeWith(Result.m1774constructorimpl(t));
    ...
    public final void close(Throwable th) {
        ...
        Result.Companion companion = Result.Companion;
        resumeWith(Result.m1774constructorimpl(ResultKt.createFailure(th)));
        JobRelation jobRelation = (JobRelation) jobCancellationHandler$FU.getAndSet(this, (Object) null);
        if (jobRelation != null) {
            jobRelation.dispose();
        }
    ...
    public final Object completeSuspendBlock(Continuation<? super T> continuation) {
        ...
        while (true) {
            ...
            if (obj == null) {
                if (AbstractResolvableFuture$SafeAtomicHelper$$ExternalSyntheticBackportWithForwarding0.m(state$FU, this, (Object) null, continuation)) {
                    parent(continuation.getContext());
                    return IntrinsicsKt.getCOROUTINE_SUSPENDED();
                }
            } else if (AbstractResolvableFuture$SafeAtomicHelper$$ExternalSyntheticBackportWithForwarding0.m(state$FU, this, obj, (Object) null)) {
    ...
    public final void notParent(CancellableReusableContinuation<T>.JobRelation jobRelation) {
        AbstractResolvableFuture$SafeAtomicHelper$$ExternalSyntheticBackportWithForwarding0.m(jobCancellationHandler$FU, this, jobRelation, (Object) null);
    }
    ...
    private final class JobRelation implements Function1<Throwable, Unit> {
        ...
        public JobRelation(CancellableReusableContinuation cancellableReusableContinuation, Job job2) {
            ...
            this.job = job2;
            DisposableHandle invokeOnCompletion$default = Job.DefaultImpls.invokeOnCompletion$default(job2, true, false, this, 2, (Object) null);
            if (job2.isActive()) {
    ...
    public void resumeWith(Object obj) {
        ...
        do {
            obj2 = this.state;
            if (obj2 == null) {
                obj3 = Result.m1777exceptionOrNullimpl(obj);
                if (obj3 == null) {
    ...
    public final void resumeWithExceptionContinuationOnly(Job job, Throwable th) {
        ...
        } while (!AbstractResolvableFuture$SafeAtomicHelper$$ExternalSyntheticBackportWithForwarding0.m(state$FU, this, obj, (Object) null));
