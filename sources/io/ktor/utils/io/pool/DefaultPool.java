...
public abstract class DefaultPool<T> implements ObjectPool<T> {
    ...
    private final boolean tryPush(T t) {
        ...
        for (int i = 0; i < 8; i++) {
            if (Striped$SmallLazyStriped$$ExternalSyntheticBackportWithForwarding0.m(this.instances, identityHashCode, (Object) null, t)) {
    ...
    private final void pushTop(int i) {
        ...
        if (i > 0) {
            ...
            } while (!Top.compareAndSet(this, j, ((((j >> 32) & 4294967295L) + 1) << 32) | ((long) i)));
            return;
        }
