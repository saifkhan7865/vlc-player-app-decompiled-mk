...
public final class DefaultBufferPool extends DefaultPool<ChunkBuffer> {
    ...
    public ChunkBuffer produceInstance() {
        return new ChunkBuffer(this.allocator.m1499allocgFvZug(this.bufferSize), (ChunkBuffer) null, this, (DefaultConstructorMarker) null);
    }

    /* access modifiers changed from: protected */
    public void disposeInstance(ChunkBuffer chunkBuffer) {
        Intrinsics.checkNotNullParameter(chunkBuffer, "instance");
        this.allocator.m1501free3GNKZMM(chunkBuffer.m155getMemorySK3TCg8());
    ...
    public void validateInstance(ChunkBuffer chunkBuffer) {
        ...
        if (((long) chunkBuffer.m155getMemorySK3TCg8().limit()) != ((long) this.bufferSize)) {
            throw new IllegalStateException(("Buffer size mismatch. Expected: " + this.bufferSize + ", actual: " + ((long) chunkBuffer.m155getMemorySK3TCg8().limit())).toString());
        } else if (chunkBuffer == ChunkBuffer.Companion.getEmpty()) {
            throw new IllegalStateException("ChunkBuffer.Empty couldn't be recycled".toString());
        } else if (chunkBuffer == Buffer.Companion.getEmpty()) {
            throw new IllegalStateException("Empty instance couldn't be recycled".toString());
        } else if (chunkBuffer.getReferenceCount() != 0) {
            throw new IllegalStateException("Unable to clear buffer: it is still in use.".toString());
        } else if (chunkBuffer.getNext() != null) {
            throw new IllegalStateException("Recycled instance shouldn't be a part of a chain.".toString());
        } else if (chunkBuffer.getOrigin() != null) {
