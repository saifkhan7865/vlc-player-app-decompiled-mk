...
public final class UnsignedTypesKt {
    ...
    public static final void m1732readFullyo1GoV1E(Input input, byte[] bArr, int i, int i2) {
        Intrinsics.checkNotNullParameter(input, "$this$readFully");
        Intrinsics.checkNotNullParameter(bArr, "dst");
        InputArraysKt.readFully(input, bArr, i, i2);
    }
    ...
    public static /* synthetic */ void m1731readFullyWt3Bwxc$default(Input input, short[] sArr, int i, int i2, int i3, Object obj) {
        if ((i3 & 2) != 0) {
            i = 0;
        }
        if ((i3 & 4) != 0) {
    ...
    public static final void m1730readFullyWt3Bwxc(Input input, short[] sArr, int i, int i2) {
        Intrinsics.checkNotNullParameter(input, "$this$readFully");
        Intrinsics.checkNotNullParameter(sArr, "dst");
        InputArraysKt.readFully(input, sArr, i, i2);
    }
    ...
    public static /* synthetic */ void m1735readFullyo2ZM2JE$default(Input input, int[] iArr, int i, int i2, int i3, Object obj) {
        if ((i3 & 2) != 0) {
            i = 0;
        }
        if ((i3 & 4) != 0) {
    ...
    public static final void m1734readFullyo2ZM2JE(Input input, int[] iArr, int i, int i2) {
        Intrinsics.checkNotNullParameter(input, "$this$readFully");
        Intrinsics.checkNotNullParameter(iArr, "dst");
        InputArraysKt.readFully(input, iArr, i, i2);
    }
    ...
    public static /* synthetic */ void m1737readFullypqYNikA$default(Input input, long[] jArr, int i, int i2, int i3, Object obj) {
        if ((i3 & 2) != 0) {
            i = 0;
        }
        if ((i3 & 4) != 0) {
    ...
    public static final void m1736readFullypqYNikA(Input input, long[] jArr, int i, int i2) {
        Intrinsics.checkNotNullParameter(input, "$this$readFully");
        Intrinsics.checkNotNullParameter(jArr, "dst");
        InputArraysKt.readFully(input, jArr, i, i2);
    }
    ...
    public static final void m1746writeUByteEK6454(Output output, byte b) {
        Intrinsics.checkNotNullParameter(output, "$this$writeUByte");
        output.writeByte(b);
    }

    /* renamed from: writeUShort-i8woANY  reason: not valid java name */
    public static final void m1749writeUShorti8woANY(Output output, short s) {
    ...
    public static final void m1747writeUIntQn1smSk(Output output, int i) {
    ...
    public static final void m1748writeULong2TYgG_w(Output output, long j) {
    ...
    public static /* synthetic */ void m1741writeFullyo1GoV1E$default(Output output, byte[] bArr, int i, int i2, int i3, Object obj) {
        if ((i3 & 2) != 0) {
            i = 0;
        }
        if ((i3 & 4) != 0) {
    ...
    public static final void m1740writeFullyo1GoV1E(Output output, byte[] bArr, int i, int i2) {
        Intrinsics.checkNotNullParameter(output, "$this$writeFully");
        Intrinsics.checkNotNullParameter(bArr, "array");
        OutputKt.writeFully(output, bArr, i, i2);
    }
    ...
    public static /* synthetic */ void m1739writeFullyWt3Bwxc$default(Output output, short[] sArr, int i, int i2, int i3, Object obj) {
        if ((i3 & 2) != 0) {
            i = 0;
        }
        if ((i3 & 4) != 0) {
    ...
    public static final void m1738writeFullyWt3Bwxc(Output output, short[] sArr, int i, int i2) {
        Intrinsics.checkNotNullParameter(output, "$this$writeFully");
        Intrinsics.checkNotNullParameter(sArr, "array");
        OutputKt.writeFully(output, sArr, i, i2);
    }
    ...
    public static /* synthetic */ void m1743writeFullyo2ZM2JE$default(Output output, int[] iArr, int i, int i2, int i3, Object obj) {
        if ((i3 & 2) != 0) {
            i = 0;
        }
        if ((i3 & 4) != 0) {
    ...
    public static final void m1742writeFullyo2ZM2JE(Output output, int[] iArr, int i, int i2) {
        Intrinsics.checkNotNullParameter(output, "$this$writeFully");
        Intrinsics.checkNotNullParameter(iArr, "array");
        OutputKt.writeFully(output, iArr, i, i2);
    }
    ...
    public static /* synthetic */ void m1745writeFullypqYNikA$default(Output output, long[] jArr, int i, int i2, int i3, Object obj) {
        if ((i3 & 2) != 0) {
            i = 0;
        }
        if ((i3 & 4) != 0) {
    ...
    public static final void m1744writeFullypqYNikA(Output output, long[] jArr, int i, int i2) {
        Intrinsics.checkNotNullParameter(output, "$this$writeFully");
        Intrinsics.checkNotNullParameter(jArr, "array");
        OutputKt.writeFully(output, jArr, i, i2);
    }
