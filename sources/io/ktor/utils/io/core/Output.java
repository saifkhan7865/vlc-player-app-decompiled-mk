...
public abstract class Output implements Appendable, Closeable {
    ...
    public abstract void m163flush62zg_DM(ByteBuffer byteBuffer, int i, int i2);

    public Output(ObjectPool<ChunkBuffer> objectPool) {
        Intrinsics.checkNotNullParameter(objectPool, "pool");
        this.pool = objectPool;
        this.tailMemory = Memory.Companion.m1525getEmptySK3TCg8();
    }
    ...
    public final ByteBuffer m164getTailMemorySK3TCg8$ktor_io() {
        return this.tailMemory;
    }

    /* renamed from: setTailMemory-3GNKZMM$ktor_io  reason: not valid java name */
    public final void m165setTailMemory3GNKZMM$ktor_io(ByteBuffer byteBuffer) {
        ...
        if (stealAll$ktor_io != null) {
            ...
            do {
                try {
                    ...
                    m163flush62zg_DM(chunkBuffer.m155getMemorySK3TCg8(), chunkBuffer.getReadPosition(), buffer.getWritePosition() - buffer.getReadPosition());
    ...
    private final void appendChainImpl(ChunkBuffer chunkBuffer, ChunkBuffer chunkBuffer2, int i) {
        ...
        this.chainedSize += i;
        this.tailMemory = chunkBuffer2.m155getMemorySK3TCg8();
    ...
    public Output append(char c) {
        ...
        if (this.tailEndExclusive - i >= 3) {
            ...
            if (c >= 0 && c < 128) {
                ...
                byteBuffer.put(i, (byte) (((c >> 12) & 15) | BERTags.FLAGS));
                ...
                byteBuffer.put(i + 1, (byte) (((c >> 12) & 63) | 128));
    ...
    public Output append(CharSequence charSequence) {
        if (charSequence == null) {
            append((CharSequence) AbstractJsonLexerKt.NULL, 0, 4);
        } else {
    ...
    public Output append(CharSequence charSequence, int i, int i2) {
        if (charSequence == null) {
            return append((CharSequence) AbstractJsonLexerKt.NULL, i, i2);
        }
    ...
    public final int write(int i, Function1<? super Buffer, Integer> function1) {
        ...
        try {
            int intValue = function1.invoke(prepareWriteHead(i)).intValue();
            if (intValue >= 0) {
                return intValue;
            }
    ...
    private final void appendCharFallback(char c) {
        ...
        try {
            ...
            ByteBuffer r2 = prepareWriteHead.m155getMemorySK3TCg8();
            ...
            if (c >= 0 && c < 128) {
                ...
                r2.put(writePosition, (byte) (((c >> 12) & 15) | BERTags.FLAGS));
                r2.put(writePosition + 1, (byte) (((c >> 6) & 63) | 128));
                r2.put(writePosition + 2, (byte) ((c & '?') | 128));
            } else if (0 > c || c >= 0) {
                UTF8Kt.malformedCodePoint(c);
                throw new KotlinNothingValueException();
            } else {
                r2.put(writePosition, (byte) (((c >> 18) & 7) | 240));
                r2.put(writePosition + 1, (byte) (((c >> 12) & 63) | 128));
                r2.put(writePosition + 2, (byte) (((c >> 6) & 63) | 128));
