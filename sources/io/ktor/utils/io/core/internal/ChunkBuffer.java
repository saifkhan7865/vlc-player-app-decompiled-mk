...
public class ChunkBuffer extends Buffer {
    ...
    private final void appendNext(ChunkBuffer chunkBuffer) {
        if (!AbstractResolvableFuture$SafeAtomicHelper$$ExternalSyntheticBackportWithForwarding0.m(nextRef$FU, this, (Object) null, chunkBuffer)) {
    ...
    public ChunkBuffer duplicate() {
        ...
        ChunkBuffer chunkBuffer3 = new ChunkBuffer(m155getMemorySK3TCg8(), chunkBuffer, this.parentPool, (DefaultConstructorMarker) null);
    ...
    static {
        ...
        Empty = new ChunkBuffer(Memory.Companion.m1525getEmptySK3TCg8(), (ChunkBuffer) null, chunkBuffer$Companion$EmptyPool$1, (DefaultConstructorMarker) null);
