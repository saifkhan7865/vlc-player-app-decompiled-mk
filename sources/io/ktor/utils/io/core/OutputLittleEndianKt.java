...
public final class OutputLittleEndianKt {
    ...
    public static /* synthetic */ void m1721writeFullyLittleEndianWt3Bwxc$default(Output output, short[] sArr, int i, int i2, int i3, Object obj) {
        if ((i3 & 2) != 0) {
            i = 0;
        }
        if ((i3 & 4) != 0) {
        ...
        m1719writeFullyLittleEndianWt3Bwxc(output, sArr, i, i2);
    }

    /* renamed from: writeFullyLittleEndian-Wt3Bwxc  reason: not valid java name */
    public static final void m1719writeFullyLittleEndianWt3Bwxc(Output output, short[] sArr, int i, int i2) {
    ...
    /* renamed from: writeFullyLittleEndian-Wt3Bwxc$default  reason: not valid java name */
    public static /* synthetic */ void m1720writeFullyLittleEndianWt3Bwxc$default(Buffer buffer, short[] sArr, int i, int i2, int i3, Object obj) {
        if ((i3 & 2) != 0) {
            i = 0;
        }
        if ((i3 & 4) != 0) {
        ...
        m1718writeFullyLittleEndianWt3Bwxc(buffer, sArr, i, i2);
    }

    /* renamed from: writeFullyLittleEndian-Wt3Bwxc  reason: not valid java name */
    public static final void m1718writeFullyLittleEndianWt3Bwxc(Buffer buffer, short[] sArr, int i, int i2) {
    ...
    public static /* synthetic */ void m1725writeFullyLittleEndiano2ZM2JE$default(Output output, int[] iArr, int i, int i2, int i3, Object obj) {
        if ((i3 & 2) != 0) {
            i = 0;
        }
        if ((i3 & 4) != 0) {
        ...
        m1723writeFullyLittleEndiano2ZM2JE(output, iArr, i, i2);
    }

    /* renamed from: writeFullyLittleEndian-o2ZM2JE  reason: not valid java name */
    public static final void m1723writeFullyLittleEndiano2ZM2JE(Output output, int[] iArr, int i, int i2) {
        Intrinsics.checkNotNullParameter(output, "$this$writeFullyLittleEndian");
    ...
    public static /* synthetic */ void m1729writeFullyLittleEndianpqYNikA$default(Output output, long[] jArr, int i, int i2, int i3, Object obj) {
        if ((i3 & 2) != 0) {
            i = 0;
        }
        if ((i3 & 4) != 0) {
        ...
        m1727writeFullyLittleEndianpqYNikA(output, jArr, i, i2);
    }

    /* renamed from: writeFullyLittleEndian-pqYNikA  reason: not valid java name */
    public static final void m1727writeFullyLittleEndianpqYNikA(Output output, long[] jArr, int i, int i2) {
        Intrinsics.checkNotNullParameter(output, "$this$writeFullyLittleEndian");
    ...
    /* renamed from: writeFullyLittleEndian-o2ZM2JE$default  reason: not valid java name */
    public static /* synthetic */ void m1724writeFullyLittleEndiano2ZM2JE$default(Buffer buffer, int[] iArr, int i, int i2, int i3, Object obj) {
        if ((i3 & 2) != 0) {
            i = 0;
        }
        if ((i3 & 4) != 0) {
        ...
        m1722writeFullyLittleEndiano2ZM2JE(buffer, iArr, i, i2);
    }

    /* renamed from: writeFullyLittleEndian-o2ZM2JE  reason: not valid java name */
    public static final void m1722writeFullyLittleEndiano2ZM2JE(Buffer buffer, int[] iArr, int i, int i2) {
        Intrinsics.checkNotNullParameter(buffer, "$this$writeFullyLittleEndian");
        Intrinsics.checkNotNullParameter(iArr, "source");
    ...
    /* renamed from: writeFullyLittleEndian-pqYNikA$default  reason: not valid java name */
    public static /* synthetic */ void m1728writeFullyLittleEndianpqYNikA$default(Buffer buffer, long[] jArr, int i, int i2, int i3, Object obj) {
        if ((i3 & 2) != 0) {
            i = 0;
        }
        if ((i3 & 4) != 0) {
        ...
        m1726writeFullyLittleEndianpqYNikA(buffer, jArr, i, i2);
    }

    /* renamed from: writeFullyLittleEndian-pqYNikA  reason: not valid java name */
    public static final void m1726writeFullyLittleEndianpqYNikA(Buffer buffer, long[] jArr, int i, int i2) {
        Intrinsics.checkNotNullParameter(buffer, "$this$writeFullyLittleEndian");
        Intrinsics.checkNotNullParameter(jArr, "source");
    ...
    /* JADX WARNING: type inference failed for: r4v0, types: [kotlin.jvm.functions.Function1<? super T, ? extends T>, kotlin.jvm.functions.Function1] */
    /* JADX WARNING: Unknown variable types count: 1 */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private static final <T> void writePrimitiveTemplate(T r1, io.ktor.utils.io.core.ByteOrder r2, kotlin.jvm.functions.Function1<? super T, kotlin.Unit> r3, kotlin.jvm.functions.Function1<? super T, ? extends T> r4) {
        /*
            int[] r0 = io.ktor.utils.io.core.OutputLittleEndianKt.WhenMappings.$EnumSwitchMapping$0
            int r2 = r2.ordinal()
            r2 = r0[r2]
            r0 = 1
        ...
        L_0x0010:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: io.ktor.utils.io.core.OutputLittleEndianKt.writePrimitiveTemplate(java.lang.Object, io.ktor.utils.io.core.ByteOrder, kotlin.jvm.functions.Function1, kotlin.jvm.functions.Function1):void");
    }
