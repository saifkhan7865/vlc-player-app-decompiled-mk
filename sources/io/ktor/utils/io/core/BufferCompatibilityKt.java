...
public final class BufferCompatibilityKt {
    ...
    public static final void m156fillsEu17AQ(Buffer buffer, int i, byte b) {
    ...
    public static final void fill(Buffer buffer, int i, byte b) {
        ...
        if (i < 0) {
            ...
            MemoryJvmKt.m1531fillJT6ljtQ(buffer.m155getMemorySK3TCg8(), buffer.getWritePosition(), i, b);
    ...
    public static final int appendChars(Buffer buffer, CharSequence charSequence, int i, int i2) {
        ...
        int r8 = UTF8Kt.m1762encodeUTF8lBXzO7A(buffer.m155getMemorySK3TCg8(), charSequence, i, i2, buffer.getWritePosition(), buffer.getLimit());
        buffer.commitWritten(EncodeResult.m1757getBytesMh2AYeg(r8) & 65535);
        return i + (EncodeResult.m1758getCharactersMh2AYeg(r8) & 65535);
    }
    ...
    public static final Buffer append(Buffer buffer, char c) {
        ...
        if (c >= 0 && c < 128) {
            ...
            r0.put(writePosition, (byte) (((c >> 12) & 15) | BERTags.FLAGS));
            r0.put(writePosition + 1, (byte) (((c >> 6) & 63) | 128));
            ...
            r0.put(writePosition, (byte) (((c >> 18) & 7) | 240));
            r0.put(writePosition + 1, (byte) (((c >> 12) & 63) | 128));
            r0.put(writePosition + 2, (byte) (((c >> 6) & 63) | 128));
