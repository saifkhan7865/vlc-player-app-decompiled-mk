...
public final class OutputKt {
    ...
    public static final void m1716writeFullyUAd2zVI(Output output, ByteBuffer byteBuffer, int i, int i2) {
        Intrinsics.checkNotNullParameter(output, "$this$writeFully");
        Intrinsics.checkNotNullParameter(byteBuffer, "src");
        m1717writeFullyUAd2zVI(output, byteBuffer, (long) i, (long) i2);
    }
    ...
    /* renamed from: writeFully-UAd2zVI  reason: not valid java name */
    public static final void m1717writeFullyUAd2zVI(Output output, ByteBuffer byteBuffer, long j, long j2) {
        ...
        while (true) {
            try {
                ...
                Memory.m1511copyToJT6ljtQ(byteBuffer, buffer.m155getMemorySK3TCg8(), j3, min, (long) buffer.getWritePosition());
                long j5 = min;
    ...
    private static final void writeFullyBytesTemplate(Output output, long j, long j2, Function4<? super Memory, ? super Long, ? super Long, ? super Long, Unit> function4) {
        ...
        while (true) {
            try {
                ...
                function4.invoke(Memory.m1508boximpl(buffer.m155getMemorySK3TCg8()), Long.valueOf((long) buffer.getWritePosition()), Long.valueOf(j), Long.valueOf(min));
