...
public final class BufferKt {
    ...
    public static final int read(Buffer buffer, Function3<? super Memory, ? super Integer, ? super Integer, Integer> function3) {
        ...
        int intValue = function3.invoke(Memory.m1508boximpl(buffer.m155getMemorySK3TCg8()), Integer.valueOf(buffer.getReadPosition()), Integer.valueOf(buffer.getWritePosition())).intValue();
    ...
    public static final int write(Buffer buffer, Function3<? super Memory, ? super Integer, ? super Integer, Integer> function3) {
        Intrinsics.checkNotNullParameter(buffer, "<this>");
        Intrinsics.checkNotNullParameter(function3, "block");
        int intValue = function3.invoke(Memory.m1508boximpl(buffer.m155getMemorySK3TCg8()), Integer.valueOf(buffer.getWritePosition()), Integer.valueOf(buffer.getLimit())).intValue();
