...
abstract class BlockingAdapter {
    static final /* synthetic */ AtomicReferenceFieldUpdater state$FU = AtomicReferenceFieldUpdater.newUpdater(BlockingAdapter.class, Object.class, OAuth2RequestParameters.State);
    ...
    public BlockingAdapter(Job job) {
        this.parent = job;
        Continuation<Unit> blockingAdapter$end$1 = new BlockingAdapter$end$1(this);
    ...
    public final void shutdown() {
        ...
        continuation.resumeWith(Result.m1774constructorimpl(ResultKt.createFailure(new CancellationException("Stream closed"))));
    }
    ...
    public final int submitAndAwait(java.lang.Object r6) {
        ...
        L_0x0034:
            ...
            boolean r2 = androidx.concurrent.futures.AbstractResolvableFuture$SafeAtomicHelper$$ExternalSyntheticBackportWithForwarding0.m(r4, r5, r2, r3)
