...
public final class RawWebSocketCommon implements WebSocketSession {
    ...
    public RawWebSocketCommon(ByteReadChannel byteReadChannel, ByteWriteChannel byteWriteChannel, long j, boolean z, CoroutineContext coroutineContext2) {
        ...
        this.maxFrameSize = j;
        this.masking = z;
        CompletableJob Job = JobKt.Job((Job) coroutineContext2.get(Job.Key));
        this.socketJob = Job;
    ...
    /* JADX WARNING: Removed duplicated region for block: B:24:0x007b A[ExcHandler: all (r9v6 'th' java.lang.Throwable A[CUSTOM_DECLARE]), PHI: r2 
      PHI: (r2v4 io.ktor.websocket.RawWebSocketCommon$FlushRequest) = (r2v5 io.ktor.websocket.RawWebSocketCommon$FlushRequest), (r2v7 io.ktor.websocket.RawWebSocketCommon$FlushRequest), (r2v7 io.ktor.websocket.RawWebSocketCommon$FlushRequest) binds: [B:20:0x006a, B:16:0x004e, B:17:?] A[DONT_GENERATE, DONT_INLINE], Splitter:B:16:0x004e] */
    ...
    public java.lang.Object flush(kotlin.coroutines.Continuation<? super kotlin.Unit> r9) {
        ...
        L_0x0054:
            ...
            r2.<init>(r9)
            kotlinx.coroutines.channels.Channel<java.lang.Object> r9 = r8._outgoing     // Catch:{ ClosedSendChannelException -> 0x0080, all -> 0x007b }
