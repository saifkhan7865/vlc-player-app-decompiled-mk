...
public final class WebSocketWriter implements CoroutineScope {
    ...
    /* JADX WARNING: Removed duplicated region for block: B:30:0x007e A[Catch:{ ChannelWriteException -> 0x0060, all -> 0x005d }, RETURN] */
    /* JADX WARNING: Removed duplicated region for block: B:31:0x007f A[Catch:{ ChannelWriteException -> 0x0060, all -> 0x005d }] */
    /* JADX WARNING: Removed duplicated region for block: B:34:0x008b A[Catch:{ ChannelWriteException -> 0x0060, all -> 0x005d }] */
    /* JADX WARNING: Removed duplicated region for block: B:41:0x00ac A[Catch:{ ChannelWriteException -> 0x0060, all -> 0x005d }] */
    /* JADX WARNING: Removed duplicated region for block: B:8:0x0028  */
    /* JADX WARNING: Unknown top exception splitter block from list: {B:50:0x00d4=Splitter:B:50:0x00d4, B:55:0x00ec=Splitter:B:55:0x00ec} */
    ...
    public final java.lang.Object writeLoop(java.nio.ByteBuffer r11, kotlin.coroutines.Continuation<? super kotlin.Unit> r12) {
        ...
        L_0x0019:
            ...
            kotlin.ResultKt.throwOnFailure(r12)     // Catch:{ ChannelWriteException -> 0x0060, all -> 0x005d }
            r9 = r0
            r0 = r11
            r11 = r2
            r2 = r9
        ...
        L_0x0063:
            ...
            r11.clear()
            kotlinx.coroutines.channels.Channel<java.lang.Object> r12 = r10.queue     // Catch:{ ChannelWriteException -> 0x00ea, all -> 0x00d2 }
            kotlinx.coroutines.channels.ChannelIterator r12 = r12.iterator()     // Catch:{ ChannelWriteException -> 0x00ea, all -> 0x00d2 }
            r7 = r10
        L_0x0070:
            r0.L$0 = r7     // Catch:{ ChannelWriteException -> 0x0060, all -> 0x005d }
            r0.L$1 = r11     // Catch:{ ChannelWriteException -> 0x0060, all -> 0x005d }
            r0.L$2 = r12     // Catch:{ ChannelWriteException -> 0x0060, all -> 0x005d }
            r0.label = r4     // Catch:{ ChannelWriteException -> 0x0060, all -> 0x005d }
            java.lang.Object r2 = r12.hasNext(r0)     // Catch:{ ChannelWriteException -> 0x0060, all -> 0x005d }
        ...
        L_0x007f:
            ...
            goto L_0x005b
        L_0x0083:
            java.lang.Boolean r12 = (java.lang.Boolean) r12     // Catch:{ ChannelWriteException -> 0x0060, all -> 0x005d }
            boolean r12 = r12.booleanValue()     // Catch:{ ChannelWriteException -> 0x0060, all -> 0x005d }
            if (r12 == 0) goto L_0x00d9
            java.lang.Object r12 = r0.next()     // Catch:{ ChannelWriteException -> 0x0060, all -> 0x005d }
            boolean r8 = r12 instanceof io.ktor.websocket.Frame     // Catch:{ ChannelWriteException -> 0x0060, all -> 0x005d }
            if (r8 == 0) goto L_0x00b0
            io.ktor.websocket.Frame r12 = (io.ktor.websocket.Frame) r12     // Catch:{ ChannelWriteException -> 0x0060, all -> 0x005d }
            r2.L$0 = r7     // Catch:{ ChannelWriteException -> 0x0060, all -> 0x005d }
            r2.L$1 = r11     // Catch:{ ChannelWriteException -> 0x0060, all -> 0x005d }
            r2.L$2 = r0     // Catch:{ ChannelWriteException -> 0x0060, all -> 0x005d }
            r2.label = r3     // Catch:{ ChannelWriteException -> 0x0060, all -> 0x005d }
            java.lang.Object r12 = r7.drainQueueAndSerialize(r12, r11, r2)     // Catch:{ ChannelWriteException -> 0x0060, all -> 0x005d }
        ...
        L_0x00ad:
            ...
            goto L_0x0070
        L_0x00b0:
            boolean r8 = r12 instanceof io.ktor.websocket.WebSocketWriter.FlushRequest     // Catch:{ ChannelWriteException -> 0x0060, all -> 0x005d }
            if (r8 == 0) goto L_0x00ba
            io.ktor.websocket.WebSocketWriter$FlushRequest r12 = (io.ktor.websocket.WebSocketWriter.FlushRequest) r12     // Catch:{ ChannelWriteException -> 0x0060, all -> 0x005d }
            r12.complete()     // Catch:{ ChannelWriteException -> 0x0060, all -> 0x005d }
            goto L_0x00ad
        L_0x00ba:
            java.lang.IllegalArgumentException r11 = new java.lang.IllegalArgumentException     // Catch:{ ChannelWriteException -> 0x0060, all -> 0x005d }
            java.lang.StringBuilder r0 = new java.lang.StringBuilder     // Catch:{ ChannelWriteException -> 0x0060, all -> 0x005d }
            r0.<init>()     // Catch:{ ChannelWriteException -> 0x0060, all -> 0x005d }
            java.lang.String r1 = "unknown message "
            r0.append(r1)     // Catch:{ ChannelWriteException -> 0x0060, all -> 0x005d }
            r0.append(r12)     // Catch:{ ChannelWriteException -> 0x0060, all -> 0x005d }
            java.lang.String r12 = r0.toString()     // Catch:{ ChannelWriteException -> 0x0060, all -> 0x005d }
            r11.<init>(r12)     // Catch:{ ChannelWriteException -> 0x0060, all -> 0x005d }
            throw r11     // Catch:{ ChannelWriteException -> 0x0060, all -> 0x005d }
        L_0x00d2:
            r11 = move-exception
            r7 = r10
        L_0x00d4:
            kotlinx.coroutines.channels.Channel<java.lang.Object> r12 = r7.queue     // Catch:{ all -> 0x0102 }
            r12.close(r11)     // Catch:{ all -> 0x0102 }
        L_0x00d9:
        ...
        L_0x00ec:
            ...
            java.lang.Throwable r11 = (java.lang.Throwable) r11     // Catch:{ all -> 0x0102 }
            java.util.concurrent.CancellationException r11 = kotlinx.coroutines.ExceptionsKt.CancellationException(r0, r11)     // Catch:{ all -> 0x0102 }
            java.lang.Throwable r11 = (java.lang.Throwable) r11     // Catch:{ all -> 0x0102 }
            r12.close(r11)     // Catch:{ all -> 0x0102 }
            goto L_0x00d9
        L_0x00fc:
    ...
    private final void drainQueueAndDiscard() {
        ...
        while (true) {
            try {
                Object r0 = ChannelResult.m2341getOrNullimpl(this.queue.m1138tryReceivePtdJZtk());
                if (r0 != null) {
                    if (!(r0 instanceof Frame.Close)) {
                        if (!(r0 instanceof Frame.Ping)) {
                            if (r0 instanceof Frame.Pong) {
                                continue;
                            } else if (r0 instanceof FlushRequest) {
                                ((FlushRequest) r0).complete();
                            } else if (!(r0 instanceof Frame.Text)) {
                                if (!(r0 instanceof Frame.Binary)) {
    ...
    /* JADX WARNING: Removed duplicated region for block: B:65:0x00a4 A[ADDED_TO_REGION, EDGE_INSN: B:65:0x00a4->B:31:0x00a4 ?: BREAK  , SYNTHETIC] */
    public final java.lang.Object drainQueueAndSerialize(io.ktor.websocket.Frame r8, java.nio.ByteBuffer r9, kotlin.coroutines.Continuation<? super java.lang.Boolean> r10) {
        ...
        L_0x0054:
            ...
            java.lang.Object r5 = r5.m1138tryReceivePtdJZtk()
            java.lang.Object r5 = kotlinx.coroutines.channels.ChannelResult.m2341getOrNullimpl(r5)
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:27:0x0080, code lost:
        ...
        r5 = r2;
     */
    /* JADX WARNING: Exception block dominator not found, dom blocks: [B:16:0x004e, B:20:0x006a] */
    /* JADX WARNING: Removed duplicated region for block: B:19:0x0054  */
    /* JADX WARNING: Removed duplicated region for block: B:24:0x007b A[ExcHandler: all (r9v6 'th' java.lang.Throwable A[CUSTOM_DECLARE]), PHI: r2 
      PHI: (r2v4 io.ktor.websocket.WebSocketWriter$FlushRequest) = (r2v5 io.ktor.websocket.WebSocketWriter$FlushRequest), (r2v7 io.ktor.websocket.WebSocketWriter$FlushRequest), (r2v7 io.ktor.websocket.WebSocketWriter$FlushRequest) binds: [B:20:0x006a, B:16:0x004e, B:17:?] A[DONT_GENERATE, DONT_INLINE], Splitter:B:16:0x004e] */
    /* JADX WARNING: Removed duplicated region for block: B:36:0x00a7 A[RETURN] */
    ...
    public final java.lang.Object flush(kotlin.coroutines.Continuation<? super kotlin.Unit> r9) {
        ...
        L_0x0042:
            ...
            java.lang.Object r7 = r0.L$0
            io.ktor.websocket.WebSocketWriter r7 = (io.ktor.websocket.WebSocketWriter) r7
            kotlin.ResultKt.throwOnFailure(r9)     // Catch:{ ClosedSendChannelException -> 0x0052, all -> 0x007b }
            goto L_0x0099
        L_0x0052:
            goto L_0x0083
        L_0x0054:
            ...
            r2.<init>(r9)
            kotlinx.coroutines.channels.Channel<java.lang.Object> r9 = r8.queue     // Catch:{ ClosedSendChannelException -> 0x0080, all -> 0x007b }
            r0.L$0 = r8     // Catch:{ ClosedSendChannelException -> 0x0080, all -> 0x007b }
            r0.L$1 = r2     // Catch:{ ClosedSendChannelException -> 0x0080, all -> 0x007b }
            r0.L$2 = r2     // Catch:{ ClosedSendChannelException -> 0x0080, all -> 0x007b }
            r0.label = r5     // Catch:{ ClosedSendChannelException -> 0x0080, all -> 0x007b }
            java.lang.Object r9 = r9.send(r2, r0)     // Catch:{ ClosedSendChannelException -> 0x0080, all -> 0x007b }
