    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            if (!(HttpResponseKt.getRequest(response).getContent() instanceof WebSocketContent)) {
                ...
                logger.trace("Skipping non-websocket response from " + ((HttpClientCall) pipelineContext.getContext()).getRequest().getUrl() + ": " + component2);
                return Unit.INSTANCE;
            } else if (!Intrinsics.areEqual((Object) status, (Object) HttpStatusCode.Companion.getSwitchingProtocols())) {
            ...
            } else if (component2 instanceof WebSocketSession) {
                Logger logger2 = WebSocketsKt.getLOGGER();
                logger2.trace("Receive websocket session from " + ((HttpClientCall) pipelineContext.getContext()).getRequest().getUrl() + ": " + component2);
                if (Intrinsics.areEqual((Object) component1.getType(), (Object) Reflection.getOrCreateKotlinClass(DefaultClientWebSocketSession.class))) {
                ...
                this.L$0 = null;
                this.label = 1;
                if (pipelineContext.proceedWith(new HttpResponseContainer(component1, clientWebSocketSession), this) == coroutine_suspended) {
