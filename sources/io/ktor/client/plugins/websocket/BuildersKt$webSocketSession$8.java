...
final class BuildersKt$webSocketSession$8 extends Lambda implements Function1<HttpRequestBuilder, Unit> {
    final /* synthetic */ Function1<HttpRequestBuilder, Unit> $block;
    final /* synthetic */ String $urlString;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    BuildersKt$webSocketSession$8(String str, Function1<? super HttpRequestBuilder, Unit> function1) {
        super(1);
        this.$urlString = str;
