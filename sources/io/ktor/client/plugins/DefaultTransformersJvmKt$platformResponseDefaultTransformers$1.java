...
final class DefaultTransformersJvmKt$platformResponseDefaultTransformers$1 extends SuspendLambda implements Function3<PipelineContext<HttpResponseContainer, HttpClientCall>, HttpResponseContainer, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            if (Intrinsics.areEqual((Object) component1.getType(), (Object) Reflection.getOrCreateKotlinClass(InputStream.class))) {
                this.L$0 = null;
                this.label = 1;
                if (pipelineContext.proceedWith(new HttpResponseContainer(component1, new DefaultTransformersJvmKt$platformResponseDefaultTransformers$1$response$1(BlockingKt.toInputStream((ByteReadChannel) component2, (Job) ((HttpClientCall) pipelineContext.getContext()).getCoroutineContext().get(Job.Key)), pipelineContext)), this) == coroutine_suspended) {
