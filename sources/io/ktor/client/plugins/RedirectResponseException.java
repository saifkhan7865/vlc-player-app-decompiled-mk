...
public final class RedirectResponseException extends ResponseException {
    ...
    public RedirectResponseException(HttpResponse httpResponse, String str) {
        ...
        this.message = "Unhandled redirect: " + httpResponse.getCall().getRequest().getMethod().getValue() + ' ' + httpResponse.getCall().getRequest().getUrl() + ". Status: " + httpResponse.getStatus() + ". Text: \"" + str + '\"';
    }
