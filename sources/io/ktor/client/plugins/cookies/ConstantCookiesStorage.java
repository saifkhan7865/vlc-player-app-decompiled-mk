...
public final class ConstantCookiesStorage implements CookiesStorage {
    ...
    public ConstantCookiesStorage(Cookie... cookieArr) {
        ...
        for (Cookie fillDefaults : cookieArr2) {
            arrayList.add(CookiesStorageKt.fillDefaults(fillDefaults, new URLBuilder((URLProtocol) null, (String) null, 0, (String) null, (String) null, (List) null, (Parameters) null, (String) null, false, FrameMetricsAggregator.EVERY_DURATION, (DefaultConstructorMarker) null).build()));
        }
