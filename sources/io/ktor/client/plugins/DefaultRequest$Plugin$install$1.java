...
final class DefaultRequest$Plugin$install$1 extends SuspendLambda implements Function3<PipelineContext<Object, HttpRequestBuilder>, Object, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (this.label == 0) {
            ...
            Logger access$getLOGGER$p = DefaultRequestKt.LOGGER;
            access$getLOGGER$p.trace("Applied DefaultRequest to " + uRLBuilder + ". New url: " + ((HttpRequestBuilder) pipelineContext.getContext()).getUrl());
