...
public final class HttpRequestRetry {
    ...
    public static final class Configuration {
        private Function2<? super Long, ? super Continuation<? super Unit>, ? extends Object> delay = new HttpRequestRetry$Configuration$delay$1((Continuation<? super HttpRequestRetry$Configuration$delay$1>) null);
        public Function2<? super DelayContext, ? super Integer, Long> delayMillis;
        private int maxRetries;
        private Function2<? super ModifyRequestContext, ? super HttpRequestBuilder, Unit> modifyRequest = HttpRequestRetry$Configuration$modifyRequest$1.INSTANCE;
        ...
        public final void retryOnExceptionOrServerErrors(int i) {
            ...
            retryOnException$default(this, i, false, 2, (Object) null);
        }
    ...
    public final boolean shouldRetry(int i, int i2, Function3<? super ShouldRetryContext, ? super HttpRequest, ? super HttpResponse, Boolean> function3, HttpClientCall httpClientCall) {
        return i < i2 && function3.invoke(new ShouldRetryContext(i + 1), httpClientCall.getRequest(), httpClientCall.getResponse()).booleanValue();
    }
