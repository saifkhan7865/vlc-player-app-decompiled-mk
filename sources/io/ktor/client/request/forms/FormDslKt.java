    ...
    public static final List<PartData> formData(FormPart<?>... formPartArr) {
        ...
        for (FormPart<?> formPart : formPartArr) {
            ...
            if (component2 instanceof String) {
                ...
                partData = new PartData.FormItem(component2.toString(), FormDslKt$formData$1$part$3.INSTANCE, headersBuilder.build());
            } else if (component2 instanceof byte[]) {
                headersBuilder.append(HttpHeaders.INSTANCE.getContentLength(), String.valueOf(((byte[]) component2).length));
                partData = new PartData.BinaryItem(new FormDslKt$formData$1$part$4(component2), FormDslKt$formData$1$part$5.INSTANCE, headersBuilder.build());
                ...
                partData = new PartData.BinaryItem(new FormDslKt$formData$1$part$6(component2), new FormDslKt$formData$1$part$7(component2), headersBuilder.build());
                ...
                partData = new PartData.BinaryItem(inputProvider.getBlock(), FormDslKt$formData$1$part$8.INSTANCE, headersBuilder.build());
