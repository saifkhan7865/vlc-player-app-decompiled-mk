...
public final class MultiPartFormDataContent extends OutgoingContent.WriteChannelContent {
    ...
    public MultiPartFormDataContent(List<? extends PartData> list, String str, ContentType contentType2) {
        ...
        Intrinsics.checkNotNullParameter(str2, HttpHeaders.Values.BOUNDARY);
        Intrinsics.checkNotNullParameter(contentType3, CMSAttributeTableGenerator.CONTENT_TYPE);
        this.boundary = str2;
        ...
        while (true) {
            ...
            if (it.hasNext()) {
                ...
                String str5 = partData.getHeaders().get(io.ktor.http.HttpHeaders.INSTANCE.getContentLength());
                ...
                if (partData instanceof PartData.FileItem) {
                    ...
                    try {
                        ...
                        if (valueOf == null) {
                            ...
                            io.ktor.utils.io.core.StringsKt.writeText$default(output2, (CharSequence) io.ktor.http.HttpHeaders.INSTANCE.getContentLength() + ": " + readBytes$default3.length, 0, 0, (Charset) null, 14, (Object) null);
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:59:0x011f, code lost:
        r9 = ((io.ktor.client.request.forms.PreparedPart.InputPart) r9).getProvider().invoke();
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:80:0x0173, code lost:
        if (io.ktor.utils.io.ByteReadChannelKt.copyTo(((io.ktor.client.request.forms.PreparedPart.ChannelPart) r9).getProvider().invoke(), r4, r0) != r1) goto L_0x0176;
     */
    ...
    public java.lang.Object writeTo(io.ktor.utils.io.ByteWriteChannel r9, kotlin.coroutines.Continuation<? super kotlin.Unit> r10) {
        ...
        L_0x011b:
            ...
            r10 = r9
            io.ktor.utils.io.core.Input r10 = (io.ktor.utils.io.core.Input) r10     // Catch:{ all -> 0x0076 }
            r0.L$0 = r5     // Catch:{ all -> 0x0076 }
            r0.L$1 = r4     // Catch:{ all -> 0x0076 }
            r0.L$2 = r2     // Catch:{ all -> 0x0076 }
            r0.L$3 = r9     // Catch:{ all -> 0x0076 }
            r6 = 0
            r0.I$0 = r6     // Catch:{ all -> 0x0076 }
            r6 = 4
            r0.label = r6     // Catch:{ all -> 0x0076 }
            java.lang.Object r10 = io.ktor.client.request.forms.FormDataContentKt.copyTo(r10, r4, r0)     // Catch:{ all -> 0x0076 }
