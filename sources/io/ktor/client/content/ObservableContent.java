...
public final class ObservableContent extends OutgoingContent.ReadChannelContent {
    ...
    public ObservableContent(OutgoingContent outgoingContent, CoroutineContext coroutineContext, Function3<? super Long, ? super Long, ? super Continuation<? super Unit>, ? extends Object> function3) {
        ...
        if (outgoingContent instanceof OutgoingContent.ByteArrayContent) {
            ...
            byteReadChannel = CoroutinesKt.writer((CoroutineScope) GlobalScope.INSTANCE, coroutineContext, true, (Function2<? super WriterScope, ? super Continuation<? super Unit>, ? extends Object>) new ObservableContent$content$1(this, (Continuation<? super ObservableContent$content$1>) null)).getChannel();
        } else {
