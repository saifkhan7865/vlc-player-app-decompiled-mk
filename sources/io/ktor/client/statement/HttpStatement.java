...
public final class HttpStatement {
    ...
    public final /* synthetic */ <T> Object body(Continuation<? super T> continuation) {
        ...
        try {
            ...
            InlineMarker.mark(0);
            Object bodyNullable = call.bodyNullable(typeInfoImpl, (Continuation<Object>) null);
            InlineMarker.mark(1);
    ...
    public final java.lang.Object cleanup(io.ktor.client.statement.HttpResponse r5, kotlin.coroutines.Continuation<? super kotlin.Unit> r6) {
        ...
        L_0x0036:
            ...
            r6.complete()
            io.ktor.utils.io.ByteReadChannel r5 = r5.getContent()     // Catch:{ all -> 0x0055 }
            io.ktor.utils.io.ByteReadChannelKt.cancel(r5)     // Catch:{ all -> 0x0055 }
            goto L_0x0056
        L_0x0055:
        L_0x0056:
            r0.L$0 = r6
