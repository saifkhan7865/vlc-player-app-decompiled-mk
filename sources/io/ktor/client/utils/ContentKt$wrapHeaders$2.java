...
public final class ContentKt$wrapHeaders$2 extends OutgoingContent.ReadChannelContent {
    ...
    ContentKt$wrapHeaders$2(Function1<? super Headers, ? extends Headers> function1, OutgoingContent outgoingContent) {
    ...
    public ByteReadChannel readFrom(LongRange longRange) {
        ...
        return ((OutgoingContent.ReadChannelContent) this.$this_wrapHeaders).readFrom(longRange);
    }
}
