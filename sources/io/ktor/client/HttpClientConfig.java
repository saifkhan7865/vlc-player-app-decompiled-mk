...
public final class HttpClientConfig<T extends HttpClientEngineConfig> {
    ...
    public final void engine(Function1<? super T, Unit> function1) {
        ...
        this.engineConfig = new HttpClientConfig$engine$1(this.engineConfig, function1);
    }
    ...
    public final <TBuilder, TPlugin> void install(HttpClientPlugin<? extends TBuilder, TPlugin> httpClientPlugin, Function1<? super TBuilder, Unit> function1) {
        ...
        this.pluginConfigurations.put(httpClientPlugin.getKey(), new HttpClientConfig$install$2(this.pluginConfigurations.get(httpClientPlugin.getKey()), function1));
    ...
    public final void install(HttpClient httpClient) {
        ...
        for (Function1 invoke : this.plugins.values()) {
            invoke.invoke(httpClient);
        }
        for (Function1 invoke2 : this.customInterceptors.values()) {
            invoke2.invoke(httpClient);
        }
    }
