...
public final class MediaMetadataCompat implements Parcelable {
    ...
    public static MediaMetadataCompat fromMediaMetadata(Object obj) {
        ...
        RatingCompat$$ExternalSyntheticApiModelOutline0.m(obj).writeToParcel(obtain, 0);
        obtain.setDataPosition(0);
        MediaMetadataCompat createFromParcel = CREATOR.createFromParcel(obtain);
        obtain.recycle();
        createFromParcel.mMetadataFwk = RatingCompat$$ExternalSyntheticApiModelOutline0.m(obj);
    ...
    public Object getMediaMetadata() {
        if (this.mMetadataFwk == null && Build.VERSION.SDK_INT >= 21) {
            ...
            obtain.setDataPosition(0);
            this.mMetadataFwk = RatingCompat$$ExternalSyntheticApiModelOutline0.m(MediaMetadata.CREATOR.createFromParcel(obtain));
            obtain.recycle();
        }
