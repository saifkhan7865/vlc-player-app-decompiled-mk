...
public class MediaSessionCompat {
    ...
    public static final class Token implements Parcelable {
        ...
        public static Token fromToken(Object obj, IMediaSession iMediaSession) {
            ...
            if (CarContext$$ExternalSyntheticApiModelOutline0.m$2(obj)) {
    ...
    public static final class QueueItem implements Parcelable {
        ...
        public Object getQueueItem() {
            ...
            MediaSession.QueueItem createQueueItem = Api21Impl.createQueueItem(RatingCompat$$ExternalSyntheticApiModelOutline0.m(this.mDescription.getMediaDescription()), this.mId);
        ...
        public static QueueItem fromQueueItem(Object obj) {
            ...
            MediaSession.QueueItem m = CarContext$$ExternalSyntheticApiModelOutline0.m(obj);
        ...
        private static class Api21Impl {
            ...
            static MediaDescription getDescription(MediaSession.QueueItem queueItem) {
                return CarContext$$ExternalSyntheticApiModelOutline0.m(queueItem);
            }
    ...
    static class MediaSessionImplApi19 extends MediaSessionImplApi18 {
        ...
        public void setCallback(Callback callback, Handler handler) {
            ...
            this.mRcc.setMetadataUpdateListener(new RemoteControlClient.OnMetadataUpdateListener() {
                public void onMetadataUpdate(int i, Object obj) {
                    if (i == 268435457 && CarContext$$ExternalSyntheticApiModelOutline0.m(obj)) {
        ...
        public RemoteControlClient.MetadataEditor buildRccMetadata(Bundle bundle) {
            ...
            if (bundle.containsKey(MediaMetadataCompat.METADATA_KEY_RATING)) {
                MediaMetadataEditor unused = buildRccMetadata.putObject(101, bundle.getParcelable(MediaMetadataCompat.METADATA_KEY_RATING));
            }
            if (bundle.containsKey(MediaMetadataCompat.METADATA_KEY_USER_RATING)) {
                MediaMetadataEditor unused2 = buildRccMetadata.putObject(268435457, bundle.getParcelable(MediaMetadataCompat.METADATA_KEY_USER_RATING));
            }
            return buildRccMetadata;
        }
    }
    ...
    static class MediaSessionImplApi21 implements MediaSessionImpl {
        ...
        MediaSessionImplApi21(Context context, String str, VersionedParcelable versionedParcelable, Bundle bundle) {
            ...
            this.mToken = new Token(CarContext$$ExternalSyntheticApiModelOutline0.m(createFwkMediaSession), new ExtraSession(), versionedParcelable);
            this.mSessionInfo = bundle;
            setFlags(3);
        }

        MediaSessionImplApi21(Object obj) {
            if (CarContext$$ExternalSyntheticApiModelOutline0.m$1(obj)) {
                MediaSession m = CarContext$$ExternalSyntheticApiModelOutline0.m(obj);
                this.mSessionFwk = m;
                this.mToken = new Token(CarContext$$ExternalSyntheticApiModelOutline0.m(m), new ExtraSession());
        ...
        public void setPlaybackToLocal(int i) {
            ...
            AudioAttributes.Builder unused = builder.setLegacyStreamType(i);
            this.mSessionFwk.setPlaybackToLocal(builder.build());
        }

        public void setPlaybackToRemote(VolumeProviderCompat volumeProviderCompat) {
            this.mSessionFwk.setPlaybackToRemote(CarContext$$ExternalSyntheticApiModelOutline0.m(volumeProviderCompat.getVolumeProvider()));
        }
        ...
        public boolean isActive() {
            return CarContext$$ExternalSyntheticApiModelOutline0.m(this.mSessionFwk);
        }
        ...
        public void release() {
            ...
            CarContext$$ExternalSyntheticApiModelOutline0.m(this.mSessionFwk);
        }
        ...
        public void setPlaybackState(PlaybackStateCompat playbackStateCompat) {
            ...
            if (playbackStateCompat == null) {
                ...
                playbackState = CarContext$$ExternalSyntheticApiModelOutline0.m(playbackStateCompat.getPlaybackState());
            }
        ...
        public void setMetadata(MediaMetadataCompat mediaMetadataCompat) {
            ...
            if (mediaMetadataCompat == null) {
                ...
                mediaMetadata = RatingCompat$$ExternalSyntheticApiModelOutline0.m(mediaMetadataCompat.getMediaMetadata());
            }
        ...
        public void setQueue(List<QueueItem> list) {
            ...
            for (QueueItem queueItem : list) {
                arrayList.add(CarContext$$ExternalSyntheticApiModelOutline0.m(queueItem.getQueueItem()));
            }
    ...
    static class MediaSessionImplApi28 extends MediaSessionImplApi22 {
        ...
        public final MediaSessionManager.RemoteUserInfo getCurrentControllerInfo() {
            return new MediaSessionManager.RemoteUserInfo(CarContext$$ExternalSyntheticApiModelOutline0.m(this.mSessionFwk));
        }
    }
    ...
    static class MediaSessionImplApi29 extends MediaSessionImplApi28 {
        ...
        MediaSessionImplApi29(Object obj) {
            super(obj);
            this.mSessionInfo = CarContext$$ExternalSyntheticApiModelOutline0.m(CarContext$$ExternalSyntheticApiModelOutline0.m(obj)).getSessionInfo();
        }
