...
public final class MediaBrowserCompat {
    ...
    public static class MediaItem implements Parcelable {
        ...
        public static MediaItem fromMediaItem(Object obj) {
            ...
            MediaBrowser.MediaItem m = RatingCompat$$ExternalSyntheticApiModelOutline0.m(obj);
            return new MediaItem(MediaDescriptionCompat.fromMediaDescription(Api21Impl.getDescription(m)), Api21Impl.getFlags(m));
        }
            ...
            if (i == 0 || i == 1) {
                ...
                this.mHandler.post(new Runnable() {
                    /* JADX WARNING: Code restructure failed: missing block: B:16:0x0061, code lost:
                        if (r5.this$0.mContext.bindService(r1, r5.this$0.mServiceConnection, 1) == false) goto L_0x0079;
                     */
                    ...
                    public void run() {
                        ...
                        L_0x0031:
                            ...
                            android.support.v4.media.MediaBrowserCompat$MediaBrowserImplBase r2 = android.support.v4.media.MediaBrowserCompat.MediaBrowserImplBase.this     // Catch:{ Exception -> 0x0064 }
                            android.content.Context r2 = r2.mContext     // Catch:{ Exception -> 0x0064 }
                            android.support.v4.media.MediaBrowserCompat$MediaBrowserImplBase r3 = android.support.v4.media.MediaBrowserCompat.MediaBrowserImplBase.this     // Catch:{ Exception -> 0x0064 }
                            android.support.v4.media.MediaBrowserCompat$MediaBrowserImplBase$MediaServiceConnection r3 = r3.mServiceConnection     // Catch:{ Exception -> 0x0064 }
                            r4 = 1
                            boolean r1 = r2.bindService(r1, r3, r4)     // Catch:{ Exception -> 0x0064 }
                        ...
                        L_0x00ac:
                            ...
                            r1.<init>(r2)
                            android.support.v4.media.MediaBrowserCompat$MediaBrowserImplBase r2 = android.support.v4.media.MediaBrowserCompat.MediaBrowserImplBase.this
                            android.support.v4.media.MediaBrowserCompat$ServiceBinderWrapper r2 = r2.mServiceBinderWrapper
                            r1.append(r2)
                            java.lang.String r1 = r1.toString()
                            r0.<init>(r1)
                            throw r0
    ...
    static class MediaBrowserImplApi21 implements MediaBrowserImpl, MediaBrowserServiceCallbackImpl, ConnectionCallback.ConnectionCallbackInternal {
        ...
        public void disconnect() {
            ...
            RatingCompat$$ExternalSyntheticApiModelOutline0.m(this.mBrowserFwk);
        }

        public boolean isConnected() {
            return RatingCompat$$ExternalSyntheticApiModelOutline0.m(this.mBrowserFwk);
        }
        ...
        public MediaSessionCompat.Token getSessionToken() {
            if (this.mMediaSessionToken == null) {
                this.mMediaSessionToken = MediaSessionCompat.Token.fromToken(RatingCompat$$ExternalSyntheticApiModelOutline0.m(this.mBrowserFwk));
            }
            return this.mMediaSessionToken;
        }
        ...
        public void getItem(final String str, final ItemCallback itemCallback) {
            if (TextUtils.isEmpty(str)) {
                ...
                throw new IllegalArgumentException("cb is null");
            } else if (!RatingCompat$$ExternalSyntheticApiModelOutline0.m(this.mBrowserFwk)) {
                Log.i(MediaBrowserCompat.TAG, "Not connected, unable to retrieve the MediaItem.");
                this.mHandler.post(new Runnable() {
                    public void run() {
                        itemCallback.onError(str);
        ...
        public void onConnected() {
            try {
                Bundle m = RatingCompat$$ExternalSyntheticApiModelOutline0.m(this.mBrowserFwk);
                if (m != null) {
                    this.mServiceVersion = m.getInt(MediaBrowserProtocol.EXTRA_SERVICE_VERSION, 0);
                    IBinder binder = BundleCompat.getBinder(m, MediaBrowserProtocol.EXTRA_MESSENGER_BINDER);
                    if (binder != null) {
                    ...
                    IMediaSession asInterface = IMediaSession.Stub.asInterface(BundleCompat.getBinder(m, MediaBrowserProtocol.EXTRA_SESSION_BINDER));
                    if (asInterface != null) {
                        this.mMediaSessionToken = MediaSessionCompat.Token.fromToken(RatingCompat$$ExternalSyntheticApiModelOutline0.m(this.mBrowserFwk), asInterface);
                    }
                }
    ...
    private static class Api21Impl {
        ...
        static MediaDescription getDescription(MediaBrowser.MediaItem mediaItem) {
            return RatingCompat$$ExternalSyntheticApiModelOutline0.m(mediaItem);
        }
