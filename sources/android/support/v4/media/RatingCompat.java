...
public final class RatingCompat implements Parcelable {
    ...
    public static RatingCompat fromRating(Object obj) {
        ...
        if (obj != null && Build.VERSION.SDK_INT >= 19) {
            int ratingStyle = Api19Impl.getRatingStyle(RatingCompat$$ExternalSyntheticApiModelOutline0.m(obj));
            if (Api19Impl.isRated(RatingCompat$$ExternalSyntheticApiModelOutline0.m(obj))) {
                switch (ratingStyle) {
                    case 1:
                        ratingCompat = newHeartRating(Api19Impl.hasHeart(RatingCompat$$ExternalSyntheticApiModelOutline0.m(obj)));
                        break;
                    case 2:
                        ratingCompat = newThumbRating(Api19Impl.isThumbUp(RatingCompat$$ExternalSyntheticApiModelOutline0.m(obj)));
                        break;
                    case 3:
                    case 4:
                    case 5:
                        ratingCompat = newStarRating(ratingStyle, Api19Impl.getStarRating(RatingCompat$$ExternalSyntheticApiModelOutline0.m(obj)));
                        break;
                    case 6:
                        ratingCompat = newPercentageRating(Api19Impl.getPercentRating(RatingCompat$$ExternalSyntheticApiModelOutline0.m(obj)));
                        break;
                    default:
                        return null;
                }
    ...
    private static class Api19Impl {
        ...
        static int getRatingStyle(Rating rating) {
            return RatingCompat$$ExternalSyntheticApiModelOutline0.m(rating);
        }

        static boolean isRated(Rating rating) {
            return RatingCompat$$ExternalSyntheticApiModelOutline0.m$1(rating);
        }
