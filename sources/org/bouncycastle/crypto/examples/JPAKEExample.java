...
public class JPAKEExample {
    ...
    public static void main(String[] strArr) throws CryptoException {
        ...
        SavableDigest savableDigest = newInstance;
        SecureRandom secureRandom = new SecureRandom();
        JPAKEParticipant jPAKEParticipant = new JPAKEParticipant("alice", "password".toCharArray(), jPAKEPrimeOrderGroup2, savableDigest, secureRandom);
        JPAKEParticipant jPAKEParticipant2 = new JPAKEParticipant("bob", "password".toCharArray(), jPAKEPrimeOrderGroup2, savableDigest, secureRandom);
        ...
        printStream6.println("g^{x1}=" + createRound1PayloadToSend.getGx1().toString(16));
        PrintStream printStream7 = System.out;
        printStream7.println("g^{x2}=" + createRound1PayloadToSend.getGx2().toString(16));
        PrintStream printStream8 = System.out;
        printStream8.println("KP{x1}={" + createRound1PayloadToSend.getKnowledgeProofForX1()[0].toString(16) + "};{" + createRound1PayloadToSend.getKnowledgeProofForX1()[1].toString(16) + "}");
        PrintStream printStream9 = System.out;
        printStream9.println("KP{x2}={" + createRound1PayloadToSend.getKnowledgeProofForX2()[0].toString(16) + "};{" + createRound1PayloadToSend.getKnowledgeProofForX2()[1].toString(16) + "}");
        System.out.println("");
        System.out.println("Bob sends to Alice: ");
        PrintStream printStream10 = System.out;
        printStream10.println("g^{x3}=" + createRound1PayloadToSend2.getGx1().toString(16));
        PrintStream printStream11 = System.out;
        printStream11.println("g^{x4}=" + createRound1PayloadToSend2.getGx2().toString(16));
        PrintStream printStream12 = System.out;
        printStream12.println("KP{x3}={" + createRound1PayloadToSend2.getKnowledgeProofForX1()[0].toString(16) + "};{" + createRound1PayloadToSend2.getKnowledgeProofForX1()[1].toString(16) + "}");
        PrintStream printStream13 = System.out;
        printStream13.println("KP{x4}={" + createRound1PayloadToSend2.getKnowledgeProofForX2()[0].toString(16) + "};{" + createRound1PayloadToSend2.getKnowledgeProofForX2()[1].toString(16) + "}");
        System.out.println("");
        ...
        printStream14.println("A=" + createRound2PayloadToSend.getA().toString(16));
        PrintStream printStream15 = System.out;
        printStream15.println("KP{x2*s}={" + createRound2PayloadToSend.getKnowledgeProofForX2s()[0].toString(16) + "},{" + createRound2PayloadToSend.getKnowledgeProofForX2s()[1].toString(16) + "}");
        System.out.println("");
        System.out.println("Bob sends to Alice");
        PrintStream printStream16 = System.out;
        printStream16.println("B=" + createRound2PayloadToSend2.getA().toString(16));
        PrintStream printStream17 = System.out;
        printStream17.println("KP{x4*s}={" + createRound2PayloadToSend2.getKnowledgeProofForX2s()[0].toString(16) + "},{" + createRound2PayloadToSend2.getKnowledgeProofForX2s()[1].toString(16) + "}");
        System.out.println("");
        ...
        printStream18.println("Alice computes key material \t K=" + calculateKeyingMaterial.toString(16));
        PrintStream printStream19 = System.out;
        printStream19.println("Bob computes key material \t K=" + calculateKeyingMaterial2.toString(16));
        System.out.println();
        ...
        printStream20.println("MacTag=" + createRound3PayloadToSend.getMacTag().toString(16));
        System.out.println("");
        System.out.println("Bob sends to Alice: ");
        PrintStream printStream21 = System.out;
        printStream21.println("MacTag=" + createRound3PayloadToSend2.getMacTag().toString(16));
        System.out.println("");
