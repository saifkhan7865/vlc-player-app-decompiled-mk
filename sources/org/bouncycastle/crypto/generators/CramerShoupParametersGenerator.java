...
public class CramerShoupParametersGenerator {
    ...
    public CramerShoupParameters generateParameters() {
        ...
        return new CramerShoupParameters(bigInteger, selectGenerator2, selectGenerator, SHA256Digest.newInstance());
    }
    ...
    public CramerShoupParameters generateParameters(DHParameters dHParameters) {
        ...
        return new CramerShoupParameters(p, g, selectGenerator, SHA256Digest.newInstance());
    }
