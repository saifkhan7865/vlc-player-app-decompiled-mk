...
public final class CryptoServicesRegistrar {
    ...
    private static final Map<String, Object[]> globalProperties = DesugarCollections.synchronizedMap(new HashMap());
    ...
    static {
        AnonymousClass1 r0 = new CryptoServicesConstraints() {
            public void check(CryptoServiceProperties cryptoServiceProperties) {
            }
        };
        noConstraintsImpl = r0;
    ...
    public static SecureRandom getSecureRandom() {
        ...
        LifecycleKt$$ExternalSyntheticBackportWithForwarding0.m(atomicReference, (Object) null, defaultRandomProviderImpl);
