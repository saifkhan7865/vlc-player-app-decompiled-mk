...
public class SM2Signer implements Signer, ECConstants {
    ...
    public void init(boolean z2, CipherParameters cipherParameters) {
        ...
        if (z2) {
            ...
            eCPoint = createBasePointMultiplier().multiply(this.ecParams.getG(), d).normalize();
        } else {
        ...
        CryptoServicesRegistrar.checkConstraints(Utils.getDefaultProperties("ECNR", this.ecKey, z2));
        byte[] z3 = getZ(bArr);
        this.z = z3;
