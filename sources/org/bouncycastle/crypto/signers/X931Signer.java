...
public class X931Signer implements Signer {
    ...
    public boolean verifySignature(byte[] r4) {
        /*
            r3 = this;
            r0 = 0
            org.bouncycastle.crypto.AsymmetricBlockCipher r1 = r3.cipher     // Catch:{ Exception -> 0x005e }
        ...
        L_0x002f:
            ...
            byte[] r0 = r3.block
            boolean r0 = org.bouncycastle.util.Arrays.constantTimeAreEqual((byte[]) r0, (byte[]) r4)
            int r1 = r3.trailer
