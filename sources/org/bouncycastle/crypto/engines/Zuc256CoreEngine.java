...
public class Zuc256CoreEngine extends Zuc128CoreEngine {
    private static final byte[] EK_d = {HttpConstants.DOUBLE_QUOTE, 47, 36, 42, 109, SignedBytes.MAX_POWER_OF_TWO, SignedBytes.MAX_POWER_OF_TWO, SignedBytes.MAX_POWER_OF_TWO, SignedBytes.MAX_POWER_OF_TWO, SignedBytes.MAX_POWER_OF_TWO, SignedBytes.MAX_POWER_OF_TWO, SignedBytes.MAX_POWER_OF_TWO, SignedBytes.MAX_POWER_OF_TWO, 82, Ascii.DLE, 48};
    private static final byte[] EK_d128 = {35, 47, 37, 42, 109, SignedBytes.MAX_POWER_OF_TWO, SignedBytes.MAX_POWER_OF_TWO, SignedBytes.MAX_POWER_OF_TWO, SignedBytes.MAX_POWER_OF_TWO, SignedBytes.MAX_POWER_OF_TWO, SignedBytes.MAX_POWER_OF_TWO, SignedBytes.MAX_POWER_OF_TWO, SignedBytes.MAX_POWER_OF_TWO, 82, Ascii.DLE, 48};
    private static final byte[] EK_d32 = {HttpConstants.DOUBLE_QUOTE, 47, 37, 42, 109, SignedBytes.MAX_POWER_OF_TWO, SignedBytes.MAX_POWER_OF_TWO, SignedBytes.MAX_POWER_OF_TWO, SignedBytes.MAX_POWER_OF_TWO, SignedBytes.MAX_POWER_OF_TWO, SignedBytes.MAX_POWER_OF_TWO, SignedBytes.MAX_POWER_OF_TWO, SignedBytes.MAX_POWER_OF_TWO, 82, Ascii.DLE, 48};
    private static final byte[] EK_d64 = {35, 47, 36, 42, 109, SignedBytes.MAX_POWER_OF_TWO, SignedBytes.MAX_POWER_OF_TWO, SignedBytes.MAX_POWER_OF_TWO, SignedBytes.MAX_POWER_OF_TWO, SignedBytes.MAX_POWER_OF_TWO, SignedBytes.MAX_POWER_OF_TWO, SignedBytes.MAX_POWER_OF_TWO, SignedBytes.MAX_POWER_OF_TWO, 82, Ascii.DLE, 48};
    private byte[] theD;
    ...
    private static int MAKEU31(byte b, byte b2, byte b3, byte b4) {
        return ((b & 255) << Ascii.ETB) | ((b2 & 255) << Ascii.DLE) | ((b3 & 255) << 8) | (b4 & 255);
    }
    ...
    public void setKeyAndIV(int[] iArr, byte[] bArr, byte[] bArr2) {
        ...
        if (bArr3 == null || bArr3.length != 32) {
            ...
            iArr[14] = MAKEU31(bArr3[14], (byte) (this.theD[14] | ((bArr3[31] >>> 4) & Ascii.SI)), bArr4[16], bArr4[9]);
            iArr[15] = MAKEU31(bArr3[15], (byte) (this.theD[15] | (bArr3[31] & Ascii.SI)), bArr3[30], bArr3[29]);
        }
    }
}
