...
public class NoekeonEngine implements BlockCipher {
    ...
    private int decryptBlock(byte[] bArr, int i, byte[] bArr2, int i2) {
        ...
        while (true) {
            ...
            byte b10 = b9 ^ -1;
            byte b11 = b8 ^ (rotateLeft4 & b10);
            byte b12 = (rotateLeft4 ^ (b10 ^ rotateLeft5)) ^ b11;
            byte b13 = b9 ^ (b11 | b12);
    ...
    private int encryptBlock(byte[] bArr, int i, byte[] bArr2, int i2) {
        ...
        while (true) {
            ...
            byte b11 = b10 ^ -1;
            byte b12 = b6 ^ (rotateLeft4 & b11);
            byte b13 = (rotateLeft4 ^ (b11 ^ rotateLeft5)) ^ b12;
            byte b14 = b10 ^ (b12 | b13);
            bigEndianToInt2 = Integers.rotateLeft(b14, 31);
            bigEndianToInt3 = Integers.rotateLeft(b13, 27);
            int rotateLeft6 = Integers.rotateLeft(b12, 30);
            bigEndianToInt = rotateLeft5 ^ (b13 & b14);
            bigEndianToInt4 = rotateLeft6;
        }
    }
