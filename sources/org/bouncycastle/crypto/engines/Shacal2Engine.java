...
public class Shacal2Engine implements BlockCipher {
    ...
    private void decryptBlock(byte[] bArr, int i, byte[] bArr2, int i2) {
        ...
        for (int i3 = 63; i3 > -1; i3--) {
            ...
            int i11 = iArr[7];
            iArr[6] = i11;
            iArr[7] = (((i8 - K[i3]) - this.workingKey[i3]) - ((((i9 >>> 6) | (i9 << -6)) ^ ((i9 >>> 11) | (i9 << -11))) ^ ((i9 >>> 25) | (i9 << -25)))) - (((-1 ^ i9) & i11) ^ (i9 & i10));
        }
    ...
    private void encryptBlock(byte[] bArr, int i, byte[] bArr2, int i2) {
        ...
        for (int i3 = 0; i3 < 64; i3++) {
            ...
            int i5 = iArr[5];
            int i6 = iArr[6];
            int i7 = ((((i4 >>> 6) | (i4 << -6)) ^ ((i4 >>> 11) | (i4 << -11))) ^ ((i4 >>> 25) | (i4 << -25))) + ((i4 & i5) ^ ((i4 ^ -1) & i6)) + iArr[7] + K[i3] + this.workingKey[i3];
            iArr[7] = i6;
            iArr[6] = i5;
            iArr[5] = i4;
            iArr[4] = iArr[3] + i7;
