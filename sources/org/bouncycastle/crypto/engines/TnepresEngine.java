...
public final class TnepresEngine extends SerpentEngineBase {
    ...
    public void decryptBlock(byte[] bArr, int i, byte[] bArr2, int i2) {
        ...
        int i3 = i2;
        int[] iArr = new int[4];
        iArr[3] = this.wKey[131] ^ Pack.bigEndianToInt(bArr, i);
        iArr[2] = this.wKey[130] ^ Pack.bigEndianToInt(bArr3, i + 4);
        iArr[1] = this.wKey[129] ^ Pack.bigEndianToInt(bArr3, i + 8);
        int bigEndianToInt = this.wKey[128] ^ Pack.bigEndianToInt(bArr3, i + 12);
        iArr[0] = bigEndianToInt;
        ...
        inverseLT(iArr);
        ib0(iArr, iArr[0], iArr[1], iArr[2], iArr[3]);
        Pack.intToBigEndian(iArr[3] ^ this.wKey[3], bArr4, i3);
        Pack.intToBigEndian(iArr[2] ^ this.wKey[2], bArr4, i3 + 4);
        Pack.intToBigEndian(iArr[1] ^ this.wKey[1], bArr4, i3 + 8);
        Pack.intToBigEndian(iArr[0] ^ this.wKey[0], bArr4, i3 + 12);
    }
    ...
    public void encryptBlock(byte[] bArr, int i, byte[] bArr2, int i2) {
        ...
        int i3 = i2;
        int[] iArr = new int[4];
        iArr[3] = Pack.bigEndianToInt(bArr, i);
        iArr[2] = Pack.bigEndianToInt(bArr3, i + 4);
        iArr[1] = Pack.bigEndianToInt(bArr3, i + 8);
        iArr[0] = Pack.bigEndianToInt(bArr3, i + 12);
        ...
        Pack.intToBigEndian(this.wKey[131] ^ iArr[3], bArr4, i3);
        Pack.intToBigEndian(this.wKey[130] ^ iArr[2], bArr4, i3 + 4);
        Pack.intToBigEndian(this.wKey[129] ^ iArr[1], bArr4, i3 + 8);
        Pack.intToBigEndian(this.wKey[128] ^ iArr[0], bArr4, i3 + 12);
    }
    ...
    public int[] makeWorkingKey(byte[] bArr) throws IllegalArgumentException {
        ...
        int i = 0;
        while (length > 0) {
            iArr[i] = Pack.bigEndianToInt(bArr2, length);
            length -= 4;
            i++;
        }
        if (length == 0) {
            int i2 = i + 1;
            iArr[i] = Pack.bigEndianToInt(bArr2, 0);
            if (i2 < 8) {
                iArr[i2] = 1;
            }
