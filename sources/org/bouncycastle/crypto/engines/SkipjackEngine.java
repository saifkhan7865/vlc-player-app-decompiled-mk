...
public class SkipjackEngine implements BlockCipher {
    ...
    static short[] ftable = {163, 215, 9, 131, 248, 72, 246, 244, 179, 33, 21, 120, 153, 177, 175, 249, 231, 45, 77, 138, 206, 76, 202, 46, 82, 149, 217, 30, 78, 56, 68, 40, 10, 223, 2, 160, 23, 241, 96, 104, 18, 183, 122, 195, 233, 250, 61, 83, 150, 132, 107, 186, 242, 99, 154, 25, 124, 174, 229, 245, 247, 22, 106, 162, 57, 182, 123, 15, 193, 147, 129, 27, 238, 180, 26, 234, 208, 145, 47, 184, 85, 185, 218, 133, 63, 65, 191, 224, 90, 88, 128, 95, 102, 11, 216, 144, 53, 213, 192, 167, 51, 6, 101, 105, 69, 0, 148, 86, 109, 152, 155, 118, 151, 252, 178, 194, 176, 254, 219, 32, 225, 235, 214, 228, 221, 71, 74, 29, 66, 237, 158, 110, 73, 60, 205, 67, 39, 210, 7, 212, 222, 199, 103, 24, 137, 203, 48, 31, 141, 198, 143, 170, 200, 116, 220, 201, 93, 92, 49, 164, 112, 136, 97, 44, 159, 13, 43, 135, 80, 130, 84, 100, 38, 125, 3, 64, 52, 75, 28, 115, 209, 196, 253, 59, 204, 251, 127, 171, 230, 62, 91, 165, 173, 4, 35, 156, 20, 81, 34, 240, 41, 121, 113, 126, Http2CodecUtil.MAX_UNSIGNED_BYTE, 140, 14, 226, 12, 239, 188, 114, 117, 111, 55, 161, 236, 211, 142, 98, 139, 134, 16, 232, 8, 119, 17, 190, 146, 79, 36, 197, 50, 54, 157, 207, 243, 166, 187, 172, 94, 108, 169, 19, 87, 37, 181, 227, 189, 168, 58, 1, 5, 89, 42, 70};
    ...
    private int g(int i, int i2) {
        short s = (i2 >> 8) & Http2CodecUtil.MAX_UNSIGNED_BYTE;
        short s2 = i2 & Http2CodecUtil.MAX_UNSIGNED_BYTE;
        short[] sArr = ftable;
        short s3 = s ^ sArr[this.key0[i] ^ s2];
        short s4 = s2 ^ sArr[this.key1[i] ^ s3];
        short s5 = s3 ^ sArr[this.key2[i] ^ s4];
        return (s5 << 8) + (sArr[this.key3[i] ^ s5] ^ s4);
    }
    ...
    private int h(int i, int i2) {
        short s = i2 & Http2CodecUtil.MAX_UNSIGNED_BYTE;
        short s2 = (i2 >> 8) & Http2CodecUtil.MAX_UNSIGNED_BYTE;
        short[] sArr = ftable;
