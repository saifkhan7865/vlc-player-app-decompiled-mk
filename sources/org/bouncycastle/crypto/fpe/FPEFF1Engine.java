...
public class FPEFF1Engine extends FPEEngine {
    ...
    public int decryptBlock(byte[] bArr, int i, int i2, byte[] bArr2, int i3) {
        ...
        if (this.fpeParameters.getRadix() > 256) {
            bArr3 = toByteArray(SP80038G.decryptFF1w(this.baseCipher, this.fpeParameters.getRadixConverter(), this.fpeParameters.getTweak(), toShortArray(bArr), i, i2 / 2));
        } else {
            bArr3 = SP80038G.decryptFF1(this.baseCipher, this.fpeParameters.getRadixConverter(), this.fpeParameters.getTweak(), bArr, i, i2);
        }
    ...
    public int encryptBlock(byte[] bArr, int i, int i2, byte[] bArr2, int i3) {
        byte[] bArr3;
        if (this.fpeParameters.getRadix() > 256) {
            bArr3 = toByteArray(SP80038G.encryptFF1w(this.baseCipher, this.fpeParameters.getRadixConverter(), this.fpeParameters.getTweak(), toShortArray(bArr), i, i2 / 2));
        } else {
            bArr3 = SP80038G.encryptFF1(this.baseCipher, this.fpeParameters.getRadixConverter(), this.fpeParameters.getTweak(), bArr, i, i2);
        }
        System.arraycopy(bArr3, 0, bArr2, i3, i2);
        return i2;
    }
