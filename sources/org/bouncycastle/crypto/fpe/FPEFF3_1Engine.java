...
public class FPEFF3_1Engine extends FPEEngine {
    ...
    public int decryptBlock(byte[] bArr, int i, int i2, byte[] bArr2, int i3) {
        ...
        if (this.fpeParameters.getRadix() > 256) {
            bArr3 = toByteArray(SP80038G.decryptFF3_1w(this.baseCipher, this.fpeParameters.getRadixConverter(), this.fpeParameters.getTweak(), toShortArray(bArr), i, i2 / 2));
        } else {
            bArr3 = SP80038G.decryptFF3_1(this.baseCipher, this.fpeParameters.getRadixConverter(), this.fpeParameters.getTweak(), bArr, i, i2);
        }
    ...
    public int encryptBlock(byte[] bArr, int i, int i2, byte[] bArr2, int i3) {
        byte[] bArr3;
        if (this.fpeParameters.getRadix() > 256) {
            bArr3 = toByteArray(SP80038G.encryptFF3_1w(this.baseCipher, this.fpeParameters.getRadixConverter(), this.fpeParameters.getTweak(), toShortArray(bArr), i, i2 / 2));
        } else {
            bArr3 = SP80038G.encryptFF3_1(this.baseCipher, this.fpeParameters.getRadixConverter(), this.fpeParameters.getTweak(), bArr, i, i2);
        }
        System.arraycopy(bArr3, 0, bArr2, i3, i2);
        return i2;
    }
