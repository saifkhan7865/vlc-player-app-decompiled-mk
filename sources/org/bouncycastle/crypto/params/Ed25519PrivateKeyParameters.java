...
public final class Ed25519PrivateKeyParameters extends AsymmetricKeyParameter {
    ...
    public void sign(int i, byte[] bArr, byte[] bArr2, int i2, int i3, byte[] bArr3, int i4) {
        ...
        if (i5 == 0) {
            int i6 = i3;
            if (bArr4 == null) {
                Ed25519.sign(this.data, 0, bArr5, 0, bArr2, i2, i3, bArr3, i4);
                return;
            }
            ...
            if (bArr4 == null) {
                ...
                Ed25519.sign(this.data, 0, bArr5, 0, bArr, bArr2, i2, i3, bArr3, i4);
            } else {
                throw new IllegalArgumentException("ctx");
            }
        } else if (i5 != 2) {
            ...
            Ed25519.signPrehash(this.data, 0, bArr5, 0, bArr, bArr2, i2, bArr3, i4);
        } else {
