...
public class CTRSP800DRBG implements SP80090DRBG {
    ...
    private void BCC(byte[] bArr, byte[] bArr2, byte[] bArr3, byte[] bArr4) {
        ...
        this._engine.processBlock(bArr3, 0, bArr6, 0);
        for (int i = 0; i < length; i++) {
            Bytes.xor(blockSize, bArr6, 0, bArr4, i * blockSize, bArr7, 0);
            this._engine.processBlock(bArr7, 0, bArr6, 0);
        }
