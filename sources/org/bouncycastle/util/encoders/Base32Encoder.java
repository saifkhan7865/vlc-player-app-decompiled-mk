...
public class Base32Encoder implements Encoder {
    ...
    public int decode(byte[] bArr, int i, int i2, OutputStream outputStream) throws IOException {
        ...
        int i22 = i21;
        int nextI9 = nextI(bArr2, nextI, i22);
        int nextI10 = nextI(bArr2, nextI9 + 1, i22);
        ...
        return i8 + decodeLastBlock(outputStream, (char) bArr2[nextI9], (char) bArr2[nextI10], (char) bArr2[nextI11], (char) bArr2[nextI12], (char) bArr2[nextI13], (char) bArr2[nextI14], (char) bArr2[nextI15], (char) bArr2[nextI(bArr2, nextI15 + 1, i22)]);
    }
