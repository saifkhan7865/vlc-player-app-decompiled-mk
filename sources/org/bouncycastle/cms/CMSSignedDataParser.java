...
public class CMSSignedDataParser extends CMSContentInfoParser {
    ...
    public CMSSignedDataParser(org.bouncycastle.operator.DigestCalculatorProvider r5, org.bouncycastle.cms.CMSTypedStream r6, java.io.InputStream r7) throws org.bouncycastle.cms.CMSException {
        /*
            ...
            org.bouncycastle.asn1.cms.ContentInfoParser r7 = r4._contentInfo     // Catch:{ IOException -> 0x0095 }
            r0 = 16
            org.bouncycastle.asn1.ASN1Encodable r7 = r7.getContent(r0)     // Catch:{ IOException -> 0x0095 }
            org.bouncycastle.asn1.cms.SignedDataParser r7 = org.bouncycastle.asn1.cms.SignedDataParser.getInstance(r7)     // Catch:{ IOException -> 0x0095 }
            ...
            org.bouncycastle.asn1.cms.SignedDataParser r7 = r4._signedData     // Catch:{ IOException -> 0x0095 }
            org.bouncycastle.asn1.ASN1SetParser r7 = r7.getDigestAlgorithms()     // Catch:{ IOException -> 0x0095 }
            java.util.HashSet r0 = new java.util.HashSet     // Catch:{ IOException -> 0x0095 }
            r0.<init>()     // Catch:{ IOException -> 0x0095 }
        L_0x0025:
            org.bouncycastle.asn1.ASN1Encodable r1 = r7.readObject()     // Catch:{ IOException -> 0x0095 }
            if (r1 == 0) goto L_0x0042
            org.bouncycastle.asn1.x509.AlgorithmIdentifier r1 = org.bouncycastle.asn1.x509.AlgorithmIdentifier.getInstance(r1)     // Catch:{ IOException -> 0x0095 }
            r0.add(r1)     // Catch:{ IOException -> 0x0095 }
            org.bouncycastle.operator.DigestCalculator r2 = r5.get(r1)     // Catch:{ OperatorCreationException -> 0x0025 }
            if (r2 == 0) goto L_0x0025
            java.util.Map r3 = r4.digests     // Catch:{ OperatorCreationException -> 0x0025 }
            org.bouncycastle.asn1.ASN1ObjectIdentifier r1 = r1.getAlgorithm()     // Catch:{ OperatorCreationException -> 0x0025 }
        ...
        L_0x0042:
            ...
            org.bouncycastle.asn1.cms.SignedDataParser r5 = r4._signedData     // Catch:{ IOException -> 0x0095 }
            org.bouncycastle.asn1.cms.ContentInfoParser r5 = r5.getEncapContentInfo()     // Catch:{ IOException -> 0x0095 }
            r7 = 4
            org.bouncycastle.asn1.ASN1Encodable r7 = r5.getContent(r7)     // Catch:{ IOException -> 0x0095 }
            boolean r0 = r7 instanceof org.bouncycastle.asn1.ASN1OctetStringParser     // Catch:{ IOException -> 0x0095 }
            if (r0 == 0) goto L_0x0071
            org.bouncycastle.asn1.ASN1OctetStringParser r7 = (org.bouncycastle.asn1.ASN1OctetStringParser) r7     // Catch:{ IOException -> 0x0095 }
            org.bouncycastle.cms.CMSTypedStream r0 = new org.bouncycastle.cms.CMSTypedStream     // Catch:{ IOException -> 0x0095 }
            org.bouncycastle.asn1.ASN1ObjectIdentifier r1 = r5.getContentType()     // Catch:{ IOException -> 0x0095 }
            java.io.InputStream r7 = r7.getOctetStream()     // Catch:{ IOException -> 0x0095 }
            r0.<init>((org.bouncycastle.asn1.ASN1ObjectIdentifier) r1, (java.io.InputStream) r7)     // Catch:{ IOException -> 0x0095 }
            org.bouncycastle.cms.CMSTypedStream r7 = r4._signedContent     // Catch:{ IOException -> 0x0095 }
        ...
        L_0x0071:
            ...
            org.bouncycastle.cms.PKCS7TypedStream r0 = new org.bouncycastle.cms.PKCS7TypedStream     // Catch:{ IOException -> 0x0095 }
            org.bouncycastle.asn1.ASN1ObjectIdentifier r1 = r5.getContentType()     // Catch:{ IOException -> 0x0095 }
        ...
        L_0x0084:
            ...
            org.bouncycastle.asn1.ASN1ObjectIdentifier r5 = r5.getContentType()     // Catch:{ IOException -> 0x0095 }
        L_0x008a:
            r4._signedContentType = r5     // Catch:{ IOException -> 0x0095 }
            goto L_0x0094
        L_0x008d:
            org.bouncycastle.cms.CMSTypedStream r5 = r4._signedContent     // Catch:{ IOException -> 0x0095 }
            org.bouncycastle.asn1.ASN1ObjectIdentifier r5 = r5.getContentType()     // Catch:{ IOException -> 0x0095 }
            goto L_0x008a
        L_0x0094:
            return
    ...
    public static OutputStream replaceCertificatesAndCRLs(InputStream inputStream, Store store, Store store2, Store store3, OutputStream outputStream) throws CMSException, IOException {
        ...
        bERSequenceGenerator2.addObject((ASN1Primitive) instance.getVersion());
    ...
    public static OutputStream replaceSigners(InputStream inputStream, SignerInformationStore signerInformationStore, OutputStream outputStream) throws CMSException, IOException {
        ...
        for (SignerInformation digestAlgorithmID : signerInformationStore.getSigners()) {
            aSN1EncodableVector.add(HELPER.fixDigestAlgID(digestAlgorithmID.getDigestAlgorithmID(), dgstAlgFinder));
        }
