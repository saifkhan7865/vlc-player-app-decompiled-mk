...
public class CanonicalOutputStream extends FilterOutputStream {
    ...
    public CanonicalOutputStream(SMimeParserContext sMimeParserContext, Headers headers, OutputStream outputStream) {
        super(outputStream);
        this.is7Bit = headers.getContentType() != null ? headers.getContentType() != null && !headers.getContentType().equals(HttpHeaders.Values.BINARY) : sMimeParserContext.getDefaultContentTransferEncoding().equals("7bit");
    }
