...
public class LDAPStoreHelper {
    ...
    /* JADX WARNING: Removed duplicated region for block: B:36:0x00d2 A[LOOP:1: B:34:0x00cc->B:36:0x00d2, LOOP_END] */
    ...
    private DirContext connectLDAP() throws NamingException {
        ...
        properties.setProperty("java.naming.batchsize", Constants.GROUP_VIDEOS_FOLDER);
    ...
    private java.util.List search(java.lang.String[] r10, java.lang.String r11, java.lang.String[] r12) throws org.bouncycastle.util.StoreException {
        ...
        L_0x009f:
            ...
            r10.<init>()
            javax.naming.directory.DirContext r3 = r9.connectLDAP()     // Catch:{ NamingException -> 0x00ff, all -> 0x00f8 }
            javax.naming.directory.SearchControls r0 = new javax.naming.directory.SearchControls     // Catch:{ NamingException -> 0x00ff, all -> 0x00f8 }
            r0.<init>()     // Catch:{ NamingException -> 0x00ff, all -> 0x00f8 }
            r1 = 2
            r0.setSearchScope(r1)     // Catch:{ NamingException -> 0x00ff, all -> 0x00f8 }
            r1 = 0
            r0.setCountLimit(r1)     // Catch:{ NamingException -> 0x00ff, all -> 0x00f8 }
            r0.setReturningAttributes(r12)     // Catch:{ NamingException -> 0x00ff, all -> 0x00f8 }
            org.bouncycastle.jce.X509LDAPCertStoreParameters r12 = r9.params     // Catch:{ NamingException -> 0x00ff, all -> 0x00f8 }
            java.lang.String r12 = r12.getBaseDN()     // Catch:{ NamingException -> 0x00ff, all -> 0x00f8 }
            javax.naming.NamingEnumeration r12 = r3.search(r12, r11, r0)     // Catch:{ NamingException -> 0x00ff, all -> 0x00f8 }
        L_0x00c3:
            boolean r0 = r12.hasMoreElements()     // Catch:{ NamingException -> 0x00ff, all -> 0x00f8 }
            if (r0 == 0) goto L_0x00ef
            java.lang.Object r0 = r12.next()     // Catch:{ NamingException -> 0x00ff, all -> 0x00f8 }
            javax.naming.directory.SearchResult r0 = (javax.naming.directory.SearchResult) r0     // Catch:{ NamingException -> 0x00ff, all -> 0x00f8 }
            javax.naming.directory.Attributes r0 = r0.getAttributes()     // Catch:{ NamingException -> 0x00ff, all -> 0x00f8 }
            javax.naming.NamingEnumeration r0 = r0.getAll()     // Catch:{ NamingException -> 0x00ff, all -> 0x00f8 }
            java.lang.Object r0 = r0.next()     // Catch:{ NamingException -> 0x00ff, all -> 0x00f8 }
            javax.naming.directory.Attribute r0 = (javax.naming.directory.Attribute) r0     // Catch:{ NamingException -> 0x00ff, all -> 0x00f8 }
            javax.naming.NamingEnumeration r0 = r0.getAll()     // Catch:{ NamingException -> 0x00ff, all -> 0x00f8 }
        L_0x00e1:
            boolean r1 = r0.hasMore()     // Catch:{ NamingException -> 0x00ff, all -> 0x00f8 }
            if (r1 == 0) goto L_0x00c3
            java.lang.Object r1 = r0.next()     // Catch:{ NamingException -> 0x00ff, all -> 0x00f8 }
            r10.add(r1)     // Catch:{ NamingException -> 0x00ff, all -> 0x00f8 }
            goto L_0x00e1
        L_0x00ef:
            r9.addToCache(r11, r10)     // Catch:{ NamingException -> 0x00ff, all -> 0x00f8 }
