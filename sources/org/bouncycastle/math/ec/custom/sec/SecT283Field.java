...
public class SecT283Field {
    ...
    protected static void implMultiply(long[] jArr, long[] jArr2, long[] jArr3) {
        ...
        long[] jArr9 = jArr3;
        implMulw(jArr9, j10 ^ jArr4[1], j12 ^ jArr5[1], jArr6, 20);
        long j17 = j2 ^ j14;
        long j18 = j4 ^ j16;
        long j19 = j17 ^ jArr4[2];
        long j20 = j18 ^ jArr5[2];
        long[] jArr10 = jArr6;
        implMulw(jArr9, j17, j18, jArr10, 22);
        implMulw(jArr9, j19, j20, jArr10, 24);
        implMulw(jArr9, j2, j4, jArr10, 10);
        implMulw(jArr9, j6, j8, jArr10, 12);
        implMulw(jArr9, j10, j12, jArr10, 14);
        implMulw(jArr9, j14, j16, jArr10, 16);
        jArr3[0] = jArr6[0];
        jArr3[9] = jArr6[9];
        long j21 = jArr6[0];
        ...
        jArr3[6] = (((((j21 ^ j30) ^ j36) ^ j31) ^ j45) ^ j43) ^ j42;
