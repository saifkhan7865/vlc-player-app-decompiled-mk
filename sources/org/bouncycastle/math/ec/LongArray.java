...
class LongArray implements Cloneable {
    ...
    public LongArray modMultiply(LongArray longArray, int i, int[] iArr) {
        ...
        while (i18 < i8) {
            ...
            while (true) {
                i4 = i17;
                int i20 = iArr3[((int) j2) & 15];
                int i21 = iArr3[((int) (j2 >>> 4)) & 15];
                i5 = i18;
                addBoth(jArr7, i19, jArr4, i20, jArr5, i21, i11);
                j2 >>>= 8;
                if (j2 == 0) {
                    break;
                }
    ...
    public LongArray modMultiplyAlt(LongArray longArray, int i, int[] iArr) {
        ...
        while (i15 < 8) {
            int i16 = i14 + i9;
            shiftUp(jArr3, i6, jArr3, i16, i9, i15);
            i15++;
            i14 = i16;
        }
        int i17 = 0;
        ...
        while (true) {
            ...
            while (true) {
                int i20 = i6;
                long j2 = jArr3[i19] >>> i17;
                int i21 = 0;
                while (true) {
                    int i22 = ((int) j2) & i18;
                    if (i22 != 0) {
                        add(jArr3, iArr4[i22] + i19, jArr3, i20, i9);
                    }
                    i21++;
                    if (i21 == 8) {
                        break;
        ...
        while (true) {
            ...
            if ((((long) i25) & 1) == 0) {
                addShiftedUp(jArr3, iArr4[i25 >>> 1], jArr3, iArr4[i25], i8, 16);
            } else {
                distribute(jArr3, iArr4[i25], iArr4[i24 - 2], iArr4[1], i8);
            }
            i24 = i25;
        }
    }
