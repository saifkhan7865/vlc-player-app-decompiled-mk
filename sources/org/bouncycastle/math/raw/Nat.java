...
public abstract class Nat {
    ...
    public static int caddTo(int i, int i2, int[] iArr, int[] iArr2) {
        ...
        long j2 = 0;
        for (int i3 = 0; i3 < i; i3++) {
            long j3 = j2 + (((long) iArr2[i3]) & 4294967295L) + (((long) iArr[i3]) & j);
            iArr2[i3] = (int) j3;
            j2 = j3 >>> 32;
        }
        return (int) j2;
    ...
    public static int mulAddTo(int i, int[] iArr, int i2, int[] iArr2, int i3, int[] iArr3, int i4) {
        ...
        for (int i5 = 0; i5 < i; i5++) {
            int i6 = i4 + i;
            long mulWordAddTo = j + (((long) mulWordAddTo(i, iArr[i2 + i5], iArr2, i3, iArr3, i4)) & 4294967295L) + (4294967295L & ((long) iArr3[i6]));
    ...
    public static int mulAddTo(int i, int[] iArr, int[] iArr2, int[] iArr3) {
        long j = 0;
        for (int i2 = 0; i2 < i; i2++) {
            long mulWordAddTo = j + (((long) mulWordAddTo(i, iArr[i2], iArr2, 0, iArr3, i2)) & 4294967295L);
            int i3 = i2 + i;
            long j2 = mulWordAddTo + (4294967295L & ((long) iArr3[i3]));
            iArr3[i3] = (int) j2;
            j = j2 >>> 32;
        }
        return (int) j;
