...
public class ESTResponse {
    ...
    public ESTResponse(ESTRequest eSTRequest, Source source2) throws IOException {
        ...
        this.inputStream = (asKeySet.contains(TvContractCompat.PARAM_INPUT) || asKeySet.contains("all")) ? new PrintingInputStream(source2.getInputStream()) : source2.getInputStream();
    ...
    private void process() throws IOException {
        ...
        boolean equalsIgnoreCase = this.headers.getFirstValueOrEmpty("Transfer-Encoding").equalsIgnoreCase(HttpHeaders.Values.CHUNKED);
        ...
        if (l2 != null) {
            ...
            if (this.contentLength.longValue() < 0) {
                ...
                if (HttpHeaders.Values.BASE64.equalsIgnoreCase(getHeader("content-transfer-encoding"))) {
                    this.inputStream = equalsIgnoreCase ? new CTEBase64InputStream(this.inputStream) : new CTEBase64InputStream(this.inputStream, this.contentLength);
                }
            } else {
