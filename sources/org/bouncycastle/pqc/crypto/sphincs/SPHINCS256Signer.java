...
public class SPHINCS256Signer implements MessageSigner {
    ...
    static void compute_authpath_wots(HashFunctions hashFunctions2, byte[] bArr, byte[] bArr2, int i, Tree.leafaddr leafaddr, byte[] bArr3, byte[] bArr4, int i2) {
        ...
        leafaddr3.subleaf = 0;
        while (leafaddr3.subleaf < 32) {
            wots.wots_pkgen(hashFunctions2, bArr7, (int) (leafaddr3.subleaf * 2144), bArr6, (int) (leafaddr3.subleaf * 32), bArr4, 0);
            leafaddr3.subleaf++;
            HashFunctions hashFunctions4 = hashFunctions2;
        }
        leafaddr3.subleaf = 0;
        while (leafaddr3.subleaf < 32) {
            Tree.l_tree(hashFunctions2, bArr5, (int) ((leafaddr3.subleaf * 32) + PlaybackStateCompat.ACTION_PLAY_FROM_MEDIA_ID), bArr7, (int) (leafaddr3.subleaf * 2144), bArr4, 0);
            leafaddr3.subleaf++;
        }
        int i3 = 0;
