            ...
            if (access$100 != null) {
                ...
                if (access$100.length == ceil + treeDigestSize + (access$000.getLayers() * height2)) {
                    ...
                    if (XMSSUtil.isIndexValid(access$000.getHeight(), bytesToXBigEndian)) {
                        ...
                        for (int i = ceil + treeDigestSize; i < access$100.length; i += height2) {
                            this.reducedSignatures.add(new XMSSReducedSignature.Builder(this.params.getXMSSParameters()).withReducedSignature(XMSSUtil.extractBytesAtOffset(access$100, i, height2)).build());
                        }
                        return;
                    }
