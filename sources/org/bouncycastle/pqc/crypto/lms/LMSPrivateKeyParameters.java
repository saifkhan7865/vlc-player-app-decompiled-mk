...
public class LMSPrivateKeyParameters extends LMSKeyParameters implements LMSContextBasedSigner {
    ...
    public static org.bouncycastle.pqc.crypto.lms.LMSPrivateKeyParameters getInstance(java.lang.Object r8) throws java.io.IOException {
        ...
        L_0x0072:
            ...
            r0 = 0
            java.io.DataInputStream r1 = new java.io.DataInputStream     // Catch:{ all -> 0x0090 }
            java.io.ByteArrayInputStream r2 = new java.io.ByteArrayInputStream     // Catch:{ all -> 0x0090 }
            byte[] r8 = (byte[]) r8     // Catch:{ all -> 0x0090 }
            byte[] r8 = (byte[]) r8     // Catch:{ all -> 0x0090 }
            r2.<init>(r8)     // Catch:{ all -> 0x0090 }
            r1.<init>(r2)     // Catch:{ all -> 0x0090 }
            org.bouncycastle.pqc.crypto.lms.LMSPrivateKeyParameters r8 = getInstance(r1)     // Catch:{ all -> 0x008d }
            r1.close()
            return r8
        L_0x008d:
            r8 = move-exception
