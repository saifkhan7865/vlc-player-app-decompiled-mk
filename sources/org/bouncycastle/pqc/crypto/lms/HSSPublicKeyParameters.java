...
public class HSSPublicKeyParameters extends LMSKeyParameters implements LMSContextBasedVerifier {
    ...
    public LMSContext generateLMSContext(byte[] bArr) {
        try {
            ...
            return (signedPubKey.length != 0 ? signedPubKey[signedPubKey.length - 1].getPublicKey() : getLMSPublicKey()).generateOtsContext(instance.getSignature()).withSignedPublicKeys(signedPubKey);
        } catch (IOException e) {
