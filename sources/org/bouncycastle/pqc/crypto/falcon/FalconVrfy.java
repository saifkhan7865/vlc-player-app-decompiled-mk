...
class FalconVrfy {
    ...
    public boolean complete_private(byte[] bArr, int i, byte[] bArr2, int i2, byte[] bArr3, int i3, byte[] bArr4, int i4, int i5, short[] sArr, int i6) {
        ...
        for (int i11 = 0; i11 < i9; i11++) {
            sArr2[i8 + i11] = (short) mq_conv_small(bArr3[i3 + i11]);
            sArr2[i10 + i11] = (short) mq_conv_small(bArr4[i4 + i11]);
        }
        mq_NTT(sArr2, i8, i7);
        mq_NTT(sArr2, i10, i7);
        mq_poly_tomonty(sArr2, i8, i7);
        mq_poly_montymul_ntt(sArr, i6, sArr, i10, i5);
        for (int i12 = 0; i12 < i9; i12++) {
            sArr2[i10 + i12] = (short) mq_conv_small(bArr2[i2 + i12]);
        }
        mq_NTT(sArr2, i10, i7);
        boolean z = true;
        for (int i13 = 0; i13 < i9; i13++) {
            short s = sArr2[i10 + i13];
            z &= s != 0;
            int i14 = i8 + i13;
            sArr2[i14] = (short) mq_div_12289(sArr2[i14], s);
        }
        mq_iNTT(sArr2, i8, i7);
        for (int i15 = 0; i15 < i9; i15++) {
            short s2 = sArr2[i8 + i15] & 65535;
            int i16 = s2 - (((-((s2 - 6144) >>> 31)) ^ -1) & 12289);
            z &= i16 >= -127 && i16 <= 127;
            bArr[i + i15] = (byte) i16;
        }
        return z;
        ...
        while (i3 < i4) {
            ...
            while (i7 < i3) {
                ...
                for (int i10 = i8; i10 < i9; i10++) {
                    int i11 = i + i10;
                    short s2 = sArr[i11] & 65535;
                    int i12 = i11 + i6;
                    int mq_montymul = mq_montymul(sArr[i12], s);
                    sArr[i11] = (short) mq_add(s2, mq_montymul);
                    sArr[i12] = (short) mq_sub(s2, mq_montymul);
                }
                i7++;
                i8 += i5;
            }
    ...
    public void mq_iNTT(short[] sArr, int i, int i2) {
        ...
        while (true) {
            ...
            while (i3 < i5) {
                int i9 = i8 + i6;
                short s = this.iGMb[i5 + i3];
                for (int i10 = i8; i10 < i9; i10++) {
                    int i11 = i + i10;
                    short s2 = sArr[i11] & 65535;
                    int i12 = i11 + i6;
                    short s3 = 65535 & sArr[i12];
                    sArr[i11] = (short) mq_add(s2, s3);
                    sArr[i12] = (short) mq_montymul(mq_sub(s2, s3), s);
                }
                i3++;
                i8 += i7;
            }
        ...
        int i13 = 4091;
        for (int i14 = i4; i14 > 1; i14 >>= 1) {
            i13 = mq_rshift1(i13);
        }
        while (i3 < i4) {
            int i15 = i + i3;
            sArr[i15] = (short) mq_montymul(sArr[i15], i13);
            i3++;
        }
    }
    ...
    public int verify_raw(short[] sArr, int i, short[] sArr2, int i2, short[] sArr3, int i3, int i4, short[] sArr4, int i5) {
        ...
        for (int i9 = 0; i9 < i8; i9++) {
            short s = sArr2[i2 + i9];
            sArr5[i7 + i9] = (short) (s + ((-(s >>> 31)) & 12289));
        }
        mq_NTT(sArr5, i7, i6);
        short[] sArr6 = sArr4;
        int i10 = i5;
        int i11 = i4;
        mq_poly_montymul_ntt(sArr6, i10, sArr3, i3, i11);
        mq_iNTT(sArr5, i7, i6);
        mq_poly_sub(sArr6, i10, sArr, i, i11);
        for (int i12 = 0; i12 < i8; i12++) {
            int i13 = i7 + i12;
            short s2 = sArr5[i13] & 65535;
            sArr5[i13] = (short) (s2 - ((-((6144 - s2) >>> 31)) & 12289));
        }
    ...
    public int verify_recover(short[] sArr, int i, short[] sArr2, int i2, short[] sArr3, int i3, short[] sArr4, int i4, int i5, short[] sArr5, int i6) {
        ...
        for (int i11 = 0; i11 < i10; i11++) {
            short s = sArr4[i4 + i11];
            sArr7[i9 + i11] = (short) (s + ((-(s >> 31)) & 12289));
            short s2 = sArr3[i3 + i11];
            sArr6[i7 + i11] = (short) mq_sub(sArr2[i2 + i11], 65535 & (s2 + ((-(s2 >>> 31)) & 12289)));
        }
        mq_NTT(sArr7, i9, i8);
        mq_NTT(sArr7, i7, i8);
        int i12 = 0;
        for (int i13 = 0; i13 < i10; i13++) {
            short s3 = sArr7[i9 + i13];
            i12 |= (s3 & 65535) - 1;
            int i14 = i7 + i13;
            sArr6[i14] = (short) mq_div_12289(sArr6[i14] & 65535, s3 & 65535);
        }
        mq_iNTT(sArr, i7, i8);
        return ((-this.common.is_short(sArr3, i3, sArr4, i4, i5)) & (i12 ^ -1)) >>> 31;
    }
}
