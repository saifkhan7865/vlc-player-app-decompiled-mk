...
public class GF2mField {
    ...
    private static String polyToString(int i) {
        ...
        String str = ((byte) (i & 1)) == 1 ? DiskLruCache.VERSION_1 : "";
        int i2 = i >>> 1;
        int i3 = 1;
        while (i2 != 0) {
            if (((byte) (i2 & 1)) == 1) {
    ...
    public String elementToStr(int i) {
        ...
        for (int i2 = 0; i2 < this.degree; i2++) {
            StringBuilder sb = (((byte) i) & 1) == 0 ? new StringBuilder(Constants.GROUP_VIDEOS_FOLDER) : new StringBuilder(DiskLruCache.VERSION_1);
            sb.append(str);
            str = sb.toString();
            i >>>= 1;
        }
