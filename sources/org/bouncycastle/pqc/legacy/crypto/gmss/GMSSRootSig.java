...
public class GMSSRootSig {
    ...
    public byte[] getStatLong() {
        long j = this.test8;
        byte b = (byte) ((int) ((j >> 16) & 255));
        byte b2 = (byte) ((int) ((j >> 24) & 255));
        byte b3 = (byte) ((int) ((j >> 40) & 255));
        byte b4 = (byte) ((int) ((j >> 48) & 255));
        long j2 = this.big8;
        byte b5 = b2;
        byte b6 = (byte) ((int) ((j >> 8) & 255));
        byte b7 = b3;
        byte b8 = b;
        byte b9 = b4;
        return new byte[]{(byte) ((int) (j & 255)), b6, b8, b5, (byte) ((int) ((j >> 32) & 255)), b7, b9, (byte) ((int) ((j >> 56) & 255)), (byte) ((int) (j2 & 255)), (byte) ((int) ((j2 >> 8) & 255)), (byte) ((int) ((j2 >> 16) & 255)), (byte) ((int) ((j2 >> 24) & 255)), (byte) ((int) ((j2 >> 32) & 255)), (byte) ((int) ((j2 >> 40) & 255)), (byte) ((int) ((j2 >> 48) & 255)), (byte) ((int) (255 & (j2 >> 56)))};
    }
    ...
    public String toString() {
        ...
        for (int i = 0; i < 9; i++) {
            str = str + statInt[i] + AnsiRenderer.CODE_TEXT_SEPARATOR;
        }
        for (int i2 = 0; i2 < 5; i2++) {
            str = str + new String(Hex.encode(statByte[i2])) + AnsiRenderer.CODE_TEXT_SEPARATOR;
        }
        return str;
    }
