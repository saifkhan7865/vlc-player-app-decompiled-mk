...
public class GMSSPrivateKeyParameters extends GMSSKeyParameters {
    ...
    public GMSSPrivateKeyParameters(int[] r17, byte[][] r18, byte[][] r19, byte[][][] r20, byte[][][] r21, byte[][][] r22, org.bouncycastle.pqc.legacy.crypto.gmss.Treehash[][] r23, org.bouncycastle.pqc.legacy.crypto.gmss.Treehash[][] r24, java.util.Vector[] r25, java.util.Vector[] r26, java.util.Vector[][] r27, java.util.Vector[][] r28, org.bouncycastle.pqc.legacy.crypto.gmss.GMSSLeaf[] r29, org.bouncycastle.pqc.legacy.crypto.gmss.GMSSLeaf[] r30, org.bouncycastle.pqc.legacy.crypto.gmss.GMSSLeaf[] r31, int[] r32, byte[][] r33, org.bouncycastle.pqc.legacy.crypto.gmss.GMSSRootCalc[] r34, byte[][] r35, org.bouncycastle.pqc.legacy.crypto.gmss.GMSSRootSig[] r36, org.bouncycastle.pqc.legacy.crypto.gmss.GMSSParameters r37, org.bouncycastle.pqc.legacy.crypto.gmss.GMSSDigestProvider r38) {
        /*
            r16 = this;
            r0 = r16
            r1 = r17
            ...
            org.bouncycastle.pqc.legacy.crypto.gmss.GMSSParameters r13 = r0.gmssPS
        ...
        L_0x00e2:
            ...
            r3 = 1
            int r2 = r2 - r3
            org.bouncycastle.pqc.legacy.crypto.gmss.GMSSRootCalc[] r2 = new org.bouncycastle.pqc.legacy.crypto.gmss.GMSSRootCalc[r2]
            r0.nextNextRoot = r2
            r2 = 0
        L_0x0103:
            int r4 = r0.numLayer
            ...
            org.bouncycastle.pqc.legacy.crypto.gmss.GMSSRootCalc[] r3 = r0.nextNextRoot
            org.bouncycastle.pqc.legacy.crypto.gmss.GMSSRootCalc r4 = new org.bouncycastle.pqc.legacy.crypto.gmss.GMSSRootCalc
            int[] r5 = r0.heightOfTrees
            int r11 = r2 + 1
            r5 = r5[r11]
            int[] r12 = r0.K
            r12 = r12[r11]
            org.bouncycastle.pqc.legacy.crypto.gmss.GMSSDigestProvider r13 = r0.digestProvider
            r4.<init>(r5, r12, r13)
            r3[r2] = r4
            r2 = r11
            r3 = 1
        ...
        L_0x013f:
            r5 = 1
            org.bouncycastle.pqc.legacy.crypto.gmss.util.GMSSRandom r2 = new org.bouncycastle.pqc.legacy.crypto.gmss.util.GMSSRandom
            ...
            r3 = 2
            int r2 = r2 - r3
            org.bouncycastle.pqc.legacy.crypto.gmss.GMSSLeaf[] r2 = new org.bouncycastle.pqc.legacy.crypto.gmss.GMSSLeaf[r2]
            r0.nextNextLeaf = r2
            r2 = 0
        L_0x0156:
            int r4 = r0.numLayer
            ...
            org.bouncycastle.pqc.legacy.crypto.gmss.GMSSLeaf[] r4 = r0.nextNextLeaf
            org.bouncycastle.pqc.legacy.crypto.gmss.GMSSLeaf r5 = new org.bouncycastle.pqc.legacy.crypto.gmss.GMSSLeaf
        ...
        L_0x017a:
            ...
            goto L_0x0181
        L_0x017d:
            org.bouncycastle.pqc.legacy.crypto.gmss.GMSSLeaf[] r2 = new org.bouncycastle.pqc.legacy.crypto.gmss.GMSSLeaf[r15]
            r0.nextNextLeaf = r2
        L_0x0181:
        ...
        L_0x018c:
            ...
            org.bouncycastle.pqc.legacy.crypto.gmss.GMSSLeaf[] r3 = r0.upperLeaf
            org.bouncycastle.pqc.legacy.crypto.gmss.GMSSLeaf r4 = new org.bouncycastle.pqc.legacy.crypto.gmss.GMSSLeaf
        ...
        L_0x01bc:
            ...
            org.bouncycastle.pqc.legacy.crypto.gmss.GMSSLeaf[] r3 = r0.upperTreehashLeaf
            org.bouncycastle.pqc.legacy.crypto.gmss.GMSSLeaf r4 = new org.bouncycastle.pqc.legacy.crypto.gmss.GMSSLeaf
            org.bouncycastle.crypto.Digest r5 = r38.get()
            int[] r6 = r0.otsIndex
            r6 = r6[r2]
        ...
        L_0x01f8:
            ...
            r4 = 1
            int r2 = r2 - r4
            org.bouncycastle.pqc.legacy.crypto.gmss.GMSSRootSig[] r2 = new org.bouncycastle.pqc.legacy.crypto.gmss.GMSSRootSig[r2]
            r0.nextRootSig = r2
            r2 = 0
        L_0x020b:
            int r5 = r0.numLayer
            ...
            org.bouncycastle.pqc.legacy.crypto.gmss.util.GMSSRandom r5 = r0.gmssRandom
            r5.nextSeed(r3)
            org.bouncycastle.pqc.legacy.crypto.gmss.util.GMSSRandom r5 = r0.gmssRandom
            byte[] r5 = r5.nextSeed(r3)
            org.bouncycastle.pqc.legacy.crypto.gmss.GMSSRootSig[] r6 = r0.nextRootSig
            org.bouncycastle.pqc.legacy.crypto.gmss.GMSSRootSig r7 = new org.bouncycastle.pqc.legacy.crypto.gmss.GMSSRootSig
            ...
            for (int i14 = 0; i14 < heightOfPhi; i14++) {
                if (i14 < i2) {
                    if (this.currentTreehash[i][i14].wasFinished()) {
                        ...
                        System.err.println("Treehash (" + i + AnsiRenderer.CODE_LIST_SEPARATOR + i14 + ") not finished when needed in AuthPathComputation");
                    }
                }
                if (i14 < i9 && i14 >= i2) {
                    int i15 = i14 - i2;
    ...
    private void updateKey(int i) {
        ...
        if (i > 0) {
            ...
            double d = (double) (this.heightOfTrees[i3] - this.K[i3]);
