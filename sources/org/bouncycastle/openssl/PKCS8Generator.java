...
public class PKCS8Generator implements PemObjectGenerator {
    ...
    private PemObject generate(PrivateKeyInfo privateKeyInfo, OutputEncryptor outputEncryptor2) throws PemGenerationException {
        try {
            ...
            outputStream.close();
            return new PemObject(PEMParser.TYPE_ENCRYPTED_PRIVATE_KEY, new EncryptedPrivateKeyInfo(outputEncryptor2.getAlgorithmIdentifier(), byteArrayOutputStream.toByteArray()).getEncoded());
        } catch (IOException e) {
