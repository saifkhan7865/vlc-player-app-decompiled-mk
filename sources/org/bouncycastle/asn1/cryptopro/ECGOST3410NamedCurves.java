...
public class ECGOST3410NamedCurves {
    ...
    static X9ECParametersHolder gostR3410_2001_CryptoPro_A = new X9ECParametersHolder() {
        ...
        public X9ECParameters createParameters() {
            ...
            return new X9ECParameters(curve, ECGOST3410NamedCurves.configureBasepoint(curve, ECConstants.ONE, ECGOST3410NamedCurves.fromHex("8D91E471E0989CDA27DF505A453F2B7635294F2DDF23E3B122ACC99C9E9F1E14")), curve.getOrder(), curve.getCofactor(), (byte[]) null);
        }
    };
    static X9ECParametersHolder gostR3410_2001_CryptoPro_B = new X9ECParametersHolder() {
        ...
        public X9ECParameters createParameters() {
            ECCurve curve = getCurve();
            return new X9ECParameters(curve, ECGOST3410NamedCurves.configureBasepoint(curve, ECConstants.ONE, ECGOST3410NamedCurves.fromHex("3FA8124359F96680B83D1C3EB2C070E5C545C9858D03ECFB744BF8D717717EFC")), curve.getOrder(), curve.getCofactor(), (byte[]) null);
        }
    };
    static X9ECParametersHolder gostR3410_2001_CryptoPro_C = new X9ECParametersHolder() {
        ...
        public X9ECParameters createParameters() {
            ECCurve curve = getCurve();
            return new X9ECParameters(curve, ECGOST3410NamedCurves.configureBasepoint(curve, ECConstants.ZERO, ECGOST3410NamedCurves.fromHex("41ECE55743711A8C3CBF3783CD08C0EE4D4DC440D4641A8F366E550DFDB3BB67")), curve.getOrder(), curve.getCofactor(), (byte[]) null);
        }
    };
    ...
    static X9ECParametersHolder id_tc26_gost_3410_12_512_paramSetA = new X9ECParametersHolder() {
        ...
        public X9ECParameters createParameters() {
            ECCurve curve = getCurve();
            return new X9ECParameters(curve, ECGOST3410NamedCurves.configureBasepoint(curve, ECConstants.THREE, ECGOST3410NamedCurves.fromHex("7503CFE87A836AE3A61B8816E25450E6CE5E1C93ACF1ABC1778064FDCBEFA921DF1626BE4FD036E93D75E6A50E3A41E98028FE5FC235F5B889A589CB5215F2A4")), curve.getOrder(), curve.getCofactor(), (byte[]) null);
        }
    };
    static X9ECParametersHolder id_tc26_gost_3410_12_512_paramSetB = new X9ECParametersHolder() {
        ...
        public X9ECParameters createParameters() {
            ECCurve curve = getCurve();
            return new X9ECParameters(curve, ECGOST3410NamedCurves.configureBasepoint(curve, ECConstants.TWO, ECGOST3410NamedCurves.fromHex("1A8F7EDA389B094C2C071E3647A8940F3C123B697578C213BE6DD9E6C8EC7335DCB228FD1EDF4A39152CBCAAF8C0398828041055F94CEEEC7E21340780FE41BD")), curve.getOrder(), curve.getCofactor(), (byte[]) null);
        }
    };
