...
public interface IANAObjectIdentifiers {
    ...
    static {
        ...
        security = branch;
        SNMPv2 = aSN1ObjectIdentifier.branch(Constants.GROUP_VIDEOS_NAME);
        mail = aSN1ObjectIdentifier.branch("7");
        ASN1ObjectIdentifier branch2 = branch.branch("5");
        security_mechanisms = branch2;
        security_nametypes = branch.branch(Constants.GROUP_VIDEOS_NAME);
        pkix = branch2.branch(Constants.GROUP_VIDEOS_NAME);
        ...
        hmacMD5 = branch4.branch(DiskLruCache.VERSION_1);
