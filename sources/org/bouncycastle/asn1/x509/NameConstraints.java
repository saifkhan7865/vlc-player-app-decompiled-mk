...
public class NameConstraints extends ASN1Object {
    ...
    public ASN1Primitive toASN1Primitive() {
        ...
        if (this.permitted != null) {
            aSN1EncodableVector.add(new DERTaggedObject(false, 0, (ASN1Encodable) new DERSequence((ASN1Encodable[]) this.permitted)));
        }
        if (this.excluded != null) {
            aSN1EncodableVector.add(new DERTaggedObject(false, 1, (ASN1Encodable) new DERSequence((ASN1Encodable[]) this.excluded)));
        }
