    ...
    public ASN1Primitive toASN1Primitive() {
        if (this.version == 1) {
            ...
            if (objectDigestInfo2 != null) {
                aSN1EncodableVector.add(new DERTaggedObject(false, 2, (ASN1Encodable) objectDigestInfo2));
            }
            return new DERSequence(aSN1EncodableVector);
        }
        GeneralNames generalNames2 = this.entityName;
        return generalNames2 != null ? new DERTaggedObject(true, 1, (ASN1Encodable) generalNames2) : new DERTaggedObject(true, 0, (ASN1Encodable) this.baseCertificateID);
    }
}
