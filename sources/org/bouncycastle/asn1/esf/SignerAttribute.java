...
public class SignerAttribute extends ASN1Object {
    ...
    public ASN1Primitive toASN1Primitive() {
        ...
        while (true) {
            ...
            aSN1EncodableVector.add(objArr[i] instanceof Attribute[] ? new DERTaggedObject(0, new DERSequence((ASN1Encodable[]) (Attribute[]) this.values[i])) : new DERTaggedObject(1, (AttributeCertificate) this.values[i]));
            i++;
        }
    }
}
