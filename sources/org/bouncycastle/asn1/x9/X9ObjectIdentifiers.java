...
public interface X9ObjectIdentifiers {
    ...
    static {
        ...
        id_fieldType = branch;
        prime_field = branch.branch(DiskLruCache.VERSION_1);
        ...
        ecdsa_with_SHA1 = branch3.branch(DiskLruCache.VERSION_1);
        ASN1ObjectIdentifier branch4 = aSN1ObjectIdentifier.branch("2");
        id_publicKeyType = branch4;
        id_ecPublicKey = branch4.branch(DiskLruCache.VERSION_1);
        ASN1ObjectIdentifier branch5 = branch3.branch("3");
        ecdsa_with_SHA2 = branch5;
        ecdsa_with_SHA224 = branch5.branch(DiskLruCache.VERSION_1);
        ...
        ASN1ObjectIdentifier branch7 = branch6.branch(Constants.GROUP_VIDEOS_FOLDER);
        cTwoCurve = branch7;
        c2pnb163v1 = branch7.branch(DiskLruCache.VERSION_1);
        c2pnb163v2 = branch7.branch("2");
        c2pnb163v3 = branch7.branch("3");
        c2pnb176w1 = branch7.branch("4");
        c2tnb191v1 = branch7.branch("5");
        c2tnb191v2 = branch7.branch(Constants.GROUP_VIDEOS_NAME);
        ...
        c2pnb272w1 = branch7.branch(AnsiConsole.JANSI_COLORS_16);
        c2pnb304w1 = branch7.branch("17");
        c2tnb359v1 = branch7.branch("18");
        c2pnb368w1 = branch7.branch("19");
        c2tnb431r1 = branch7.branch("20");
        ASN1ObjectIdentifier branch8 = branch6.branch(DiskLruCache.VERSION_1);
        primeCurve = branch8;
        prime192v1 = branch8.branch(DiskLruCache.VERSION_1);
        prime192v2 = branch8.branch("2");
        prime192v3 = branch8.branch("3");
        prime239v1 = branch8.branch("4");
        prime239v2 = branch8.branch("5");
        prime239v3 = branch8.branch(Constants.GROUP_VIDEOS_NAME);
        ...
        mqvSinglePass_sha1kdf_scheme = aSN1ObjectIdentifier2.branch(AnsiConsole.JANSI_COLORS_16);
        ...
        dhStatic = branch9.branch(DiskLruCache.VERSION_1);
        dhEphem = branch9.branch("2");
        dhOneFlow = branch9.branch("3");
        dhHybrid1 = branch9.branch("4");
        dhHybrid2 = branch9.branch("5");
        dhHybridOneFlow = branch9.branch(Constants.GROUP_VIDEOS_NAME);
        ...
        ASN1ObjectIdentifier branch10 = aSN1ObjectIdentifier4.branch(DiskLruCache.VERSION_1);
        x9_44_components = branch10;
        id_kdf_kdf2 = branch10.branch(DiskLruCache.VERSION_1);
