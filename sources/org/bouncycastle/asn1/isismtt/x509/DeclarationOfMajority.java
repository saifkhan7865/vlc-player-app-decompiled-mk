...
public class DeclarationOfMajority extends ASN1Object implements ASN1Choice {
    ...
    public DeclarationOfMajority(int i) {
        this.declaration = new DERTaggedObject(false, 0, (ASN1Encodable) new ASN1Integer((long) i));
    }
    ...
    public DeclarationOfMajority(boolean z, String str) {
        if (str.length() > 2) {
            ...
            this.declaration = new DERTaggedObject(false, 1, (ASN1Encodable) new DERSequence((ASN1Encodable) new DERPrintableString(str, true)));
        } else {
