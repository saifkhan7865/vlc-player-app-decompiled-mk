...
public class PKIHeaderBuilder {
    ...
    public PKIHeaderBuilder setRecipKID(byte[] bArr) {
        return setRecipKID((ASN1OctetString) bArr == null ? null : createClonedOctetString(bArr));
    }
    ...
    public PKIHeaderBuilder setRecipNonce(byte[] bArr) {
        return setRecipNonce((ASN1OctetString) bArr == null ? null : createClonedOctetString(bArr));
    }
    ...
    public PKIHeaderBuilder setSenderKID(byte[] bArr) {
        return setSenderKID((ASN1OctetString) bArr == null ? null : createClonedOctetString(bArr));
    }
    ...
    public PKIHeaderBuilder setSenderNonce(byte[] bArr) {
        return setSenderNonce((ASN1OctetString) bArr == null ? null : createClonedOctetString(bArr));
    }
    ...
    public PKIHeaderBuilder setTransactionID(byte[] bArr) {
        return setTransactionID((ASN1OctetString) bArr == null ? null : createClonedOctetString(bArr));
    }
}
