...
public class KeyRecRepContent extends ASN1Object {
    ...
    private KeyRecRepContent(ASN1Sequence aSN1Sequence) {
        ...
        while (objects.hasMoreElements()) {
            ...
            if (tagNo == 0) {
                this.newSigCert = CMPCertificate.getInstance(instance.getExplicitBaseObject());
            } else if (tagNo == 1) {
                this.caCerts = ASN1Sequence.getInstance(instance.getExplicitBaseObject());
            } else if (tagNo == 2) {
                this.keyPairHist = ASN1Sequence.getInstance(instance.getExplicitBaseObject());
            } else {
