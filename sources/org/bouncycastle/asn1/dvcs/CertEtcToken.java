    ...
    private CertEtcToken(ASN1TaggedObject aSN1TaggedObject) {
        ...
        switch (tagNo2) {
            case 0:
                ...
                break;
            case 1:
                aSN1Encodable = ESSCertID.getInstance(aSN1TaggedObject.getExplicitBaseObject());
                break;
            case 2:
                aSN1Encodable = PKIStatusInfo.getInstance(aSN1TaggedObject, false);
                break;
            case 3:
                aSN1Encodable = ContentInfo.getInstance(aSN1TaggedObject.getExplicitBaseObject());
                break;
            case 4:
                aSN1Encodable = CertificateList.getInstance(aSN1TaggedObject, false);
                break;
            case 5:
                aSN1Encodable = CertStatus.getInstance(aSN1TaggedObject.getExplicitBaseObject());
                break;
            case 6:
            ...
            case 7:
                ...
                break;
            case 8:
                aSN1Encodable = SMIMECapabilities.getInstance(aSN1TaggedObject.getExplicitBaseObject());
                break;
            default:
