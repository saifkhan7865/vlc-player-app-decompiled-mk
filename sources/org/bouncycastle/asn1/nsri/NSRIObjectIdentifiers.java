...
public interface NSRIObjectIdentifiers {
    ...
    static {
        ...
        id_pad_null = branch.branch(Constants.GROUP_VIDEOS_FOLDER);
        id_pad_1 = branch.branch(DiskLruCache.VERSION_1);
        id_aria128_ecb = branch2.branch(DiskLruCache.VERSION_1);
        ...
        id_aria192_ecb = branch2.branch(Constants.GROUP_VIDEOS_NAME);
        ...
        id_aria192_cmac = branch2.branch(NetworkServerDialog.SFTP_DEFAULT_PORT);
