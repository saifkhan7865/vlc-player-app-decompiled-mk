...
public class EnvelopedData extends ASN1Object {
    ...
    public static int calculateVersion(OriginatorInfo originatorInfo2, ASN1Set aSN1Set, ASN1Set aSN1Set2) {
        ...
        while (objects.hasMoreElements()) {
            RecipientInfo instance = RecipientInfo.getInstance(objects.nextElement());
            if (!instance.getVersion().hasValue(0)) {
                z2 = true;
            }
            ASN1Encodable info = instance.getInfo();
        ...
        return (!z2 && originatorInfo2 == null && aSN1Set2 == null) ? 0 : 2;
    }
