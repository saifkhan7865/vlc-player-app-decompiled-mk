...
public class CompositePublicKey implements PublicKey {
    ...
    public byte[] getEncoded() {
        ...
        try {
            return new SubjectPublicKeyInfo(new AlgorithmIdentifier(MiscObjectIdentifiers.id_composite_key), (ASN1Encodable) new DERSequence(aSN1EncodableVector)).getEncoded(ASN1Encoding.DER);
        } catch (IOException e) {
