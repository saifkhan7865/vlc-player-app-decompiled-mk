...
class X509CertificateObject extends X509CertificateImpl implements PKCS12BagAttributeCarrier {
    ...
    private static boolean[] createKeyUsage(Certificate certificate) throws CertificateParsingException {
        try {
            ...
            ASN1BitString instance = ASN1BitString.getInstance(ASN1Primitive.fromByteArray(extensionOctets));
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:12:0x0028, code lost:
        if (r6.validityValues != null) goto L_0x002c;
     */
    ...
    public long[] getValidityValues() {
        /*
            ...
            monitor-enter(r0)
            long[] r1 = r6.validityValues     // Catch:{ all -> 0x0033 }
            if (r1 == 0) goto L_0x0009
        ...
        L_0x0009:
            ...
            monitor-enter(r1)
            long[] r0 = r6.validityValues     // Catch:{ all -> 0x0030 }
            if (r0 != 0) goto L_0x002c
            r6.validityValues = r4     // Catch:{ all -> 0x0030 }
        L_0x002c:
            long[] r0 = r6.validityValues     // Catch:{ all -> 0x0030 }
