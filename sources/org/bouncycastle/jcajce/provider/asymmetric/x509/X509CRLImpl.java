    ...
    private void doVerify(PublicKey publicKey, SignatureCreator signatureCreator) throws CRLException, NoSuchAlgorithmException, InvalidKeyException, SignatureException, NoSuchProviderException {
        ...
        if (this.c.getSignatureAlgorithm().equals(this.c.getTBSCertList().getSignature())) {
            ...
            if ((publicKey instanceof CompositePublicKey) && X509SignatureUtil.isCompositeAlgorithm(this.c.getSignatureAlgorithm())) {
                ...
                ASN1Sequence instance2 = ASN1Sequence.getInstance(ASN1BitString.getInstance(this.c.getSignature()).getBytes());
                boolean z = false;
                while (i != publicKeys.size()) {
                    if (publicKeys.get(i) != null) {
                        AlgorithmIdentifier instance3 = AlgorithmIdentifier.getInstance(instance.getObjectAt(i));
                        try {
                            checkSignature(publicKeys.get(i), signatureCreator.createSignature(X509SignatureUtil.getSignatureName(instance3)), instance3.getParameters(), ASN1BitString.getInstance(instance2.getObjectAt(i)).getBytes());
                            e = null;
                            z = true;
                ...
                ASN1Sequence instance5 = ASN1Sequence.getInstance(ASN1BitString.getInstance(this.c.getSignature()).getBytes());
                boolean z2 = false;
                while (i != instance5.size()) {
                    AlgorithmIdentifier instance6 = AlgorithmIdentifier.getInstance(instance4.getObjectAt(i));
                    try {
                        checkSignature(publicKey, signatureCreator.createSignature(X509SignatureUtil.getSignatureName(instance6)), instance6.getParameters(), ASN1BitString.getInstance(instance5.getObjectAt(i)).getBytes());
                        e = null;
                        z2 = true;
    ...
    public String toString() {
        ...
        if (extensions != null) {
            ...
            if (oids.hasMoreElements()) {
                append = stringBuffer.append("           Extensions: ");
            ...
            while (oids.hasMoreElements()) {
                ...
                if (extension.getExtnValue() != null) {
                    ...
                    try {
                        ...
                        append = stringBuffer.append(" value = ").append("*****");
                    }
                    if (aSN1ObjectIdentifier.equals((ASN1Primitive) Extension.cRLNumber)) {
                        ...
                        if (aSN1ObjectIdentifier.equals((ASN1Primitive) Extension.deltaCRLIndicator)) {
                            append2 = stringBuffer.append("Base CRL: " + new CRLNumber(ASN1Integer.getInstance(aSN1InputStream.readObject()).getPositiveValue()));
                            ...
                            stringBuffer.append(aSN1ObjectIdentifier.getId());
                            append2 = stringBuffer.append(" value = ").append(ASN1Dump.dumpAsString(aSN1InputStream.readObject()));
                        }
                        append2.append(lineSeparator);
                    }
                    append2 = stringBuffer.append(instance);
                    append2.append(lineSeparator);
                } else {
