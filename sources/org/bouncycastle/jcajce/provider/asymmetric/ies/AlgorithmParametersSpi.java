    ...
    public void engineInit(byte[] bArr) throws IOException {
        try {
            ...
            if (aSN1Sequence.size() <= 5) {
                ...
                this.currentSpec = bigInteger != null ? new IESParameterSpec(bArr2, bArr3, bigInteger2.intValue(), bigInteger.intValue(), bArr4, z) : new IESParameterSpec(bArr2, bArr3, bigInteger2.intValue(), -1, (byte[]) null, z);
                return;
            }
