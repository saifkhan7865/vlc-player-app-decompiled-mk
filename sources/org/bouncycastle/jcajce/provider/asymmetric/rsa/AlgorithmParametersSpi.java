...
public abstract class AlgorithmParametersSpi extends java.security.AlgorithmParametersSpi {
    ...
    public static class PSS extends AlgorithmParametersSpi {
        ...
        public byte[] engineGetEncoded() throws IOException {
            ...
            AlgorithmIdentifier algorithmIdentifier = (NISTObjectIdentifiers.id_shake128.equals((ASN1Primitive) oid) || NISTObjectIdentifiers.id_shake256.equals((ASN1Primitive) oid)) ? new AlgorithmIdentifier(oid) : new AlgorithmIdentifier(oid, DERNull.INSTANCE);
        ...
        public void engineInit(byte[] bArr) throws IOException {
            ...
            try {
                ...
                if (algorithm.equals((ASN1Primitive) PKCSObjectIdentifiers.id_mgf1)) {
                    ...
                    if (!algorithm.equals((ASN1Primitive) NISTObjectIdentifiers.id_shake128)) {
                        if (!algorithm.equals((ASN1Primitive) NISTObjectIdentifiers.id_shake256)) {
                            throw new IOException("unknown mask generation function: " + instance.getMaskGenAlgorithm().getAlgorithm());
                        }
                    }
                    pSSParameterSpec = new PSSParameterSpec(MessageDigestUtils.getDigestName(instance.getHashAlgorithm().getAlgorithm()), algorithm.equals((ASN1Primitive) NISTObjectIdentifiers.id_shake128) ? "SHAKE128" : "SHAKE256", (AlgorithmParameterSpec) null, instance.getSaltLength().intValue(), instance.getTrailerField().intValue());
                }
