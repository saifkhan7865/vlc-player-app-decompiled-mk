...
public class BCECGOST3410_2012PrivateKey implements ECPrivateKey, org.bouncycastle.jce.interfaces.ECPrivateKey, PKCS12BagAttributeCarrier, ECPointEncoder {
    ...
    private void populateFromPrivKeyInfo(org.bouncycastle.asn1.pkcs.PrivateKeyInfo r11) throws java.io.IOException {
        ...
        L_0x017a:
            ...
            r10.d = r0
            org.bouncycastle.asn1.ASN1BitString r11 = r11.getPublicKey()
            r10.publicKey = r11
        L_0x018a:
            return
        */
    ...
    public byte[] getEncoded() {
        ...
        L_0x007c:
            ...
            org.bouncycastle.math.ec.ECPoint r2 = org.bouncycastle.jcajce.provider.asymmetric.util.EC5Util.convertPoint((org.bouncycastle.math.ec.ECCurve) r7, (java.security.spec.ECPoint) r2)
            boolean r3 = r12.withCompression
            r8.<init>((org.bouncycastle.math.ec.ECPoint) r2, (boolean) r3)
            java.security.spec.ECParameterSpec r2 = r12.ecSpec
            ...
            org.bouncycastle.asn1.x9.X962Parameters r2 = new org.bouncycastle.asn1.x9.X962Parameters
            r2.<init>((org.bouncycastle.asn1.x9.X9ECParameters) r0)
        L_0x00bb:
            org.bouncycastle.jcajce.provider.config.ProviderConfiguration r0 = org.bouncycastle.jce.provider.BouncyCastleProvider.CONFIGURATION
        ...
        L_0x00cb:
            org.bouncycastle.asn1.ASN1BitString r3 = r12.publicKey
            if (r3 == 0) goto L_0x00db
            org.bouncycastle.asn1.sec.ECPrivateKey r3 = new org.bouncycastle.asn1.sec.ECPrivateKey
            java.math.BigInteger r6 = r12.getS()
            org.bouncycastle.asn1.ASN1BitString r7 = r12.publicKey
            r3.<init>(r0, r6, r7, r2)
            goto L_0x00e4
        L_0x00db:
            org.bouncycastle.asn1.sec.ECPrivateKey r3 = new org.bouncycastle.asn1.sec.ECPrivateKey
        ...
        L_0x00e4:
            ...
            org.bouncycastle.asn1.ASN1Primitive r2 = r2.toASN1Primitive()     // Catch:{ IOException -> 0x00fb }
            r6.<init>(r1, r2)     // Catch:{ IOException -> 0x00fb }
