...
public class Blake2s {
    ...
    public static class Mappings extends DigestAlgorithmProvider {
        ...
        public void configure(ConfigurableProvider configurableProvider) {
            ...
            sb2.append(MiscObjectIdentifiers.id_blake2s224);
            configurableProvider.addAlgorithm(sb2.toString(), "BLAKE2S-224");
            ...
            sb3.append(MiscObjectIdentifiers.id_blake2s160);
            configurableProvider.addAlgorithm(sb3.toString(), "BLAKE2S-160");
            ...
            sb4.append(MiscObjectIdentifiers.id_blake2s128);
            configurableProvider.addAlgorithm(sb4.toString(), "BLAKE2S-128");
        }
    }
