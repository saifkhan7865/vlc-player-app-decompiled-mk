...
public final class DESede {
    ...
    public static class Mappings extends AlgorithmProvider {
        ...
        public void configure(ConfigurableProvider configurableProvider) {
            ...
            configurableProvider.addAlgorithm("Cipher", aSN1ObjectIdentifier2, str + "$Wrap");
            ...
            configurableProvider.addAlgorithm(sb3, str + "$KeyGenerator3");
            ...
            configurableProvider.addAlgorithm("SecretKeyFactory", aSN1ObjectIdentifier3, str + "$KeyFactory");
            ...
            StringBuilder sb4 = new StringBuilder("Alg.Alias.AlgorithmParameterGenerator.");
            sb4.append(PKCSObjectIdentifiers.des_EDE3_CBC);
            configurableProvider.addAlgorithm(sb4.toString(), "DESEDE");
