...
public class Ieee1609Dot2BaseTypes {
    ...
    static {
        OERDefinition.Builder typeName = OERDefinition.integer(0, 255).typeName("UINT8");
        UINT8 = typeName;
        OERDefinition.Builder typeName2 = OERDefinition.integer(0, (long) WebSocketProtocol.PAYLOAD_SHORT_MAX).typeName("UINT16");
        UINT16 = typeName2;
        OERDefinition.Builder typeName3 = OERDefinition.integer(0, 4294967295L).typeName("UINT32");
        UINT32 = typeName3;
        ...
        Point256 = typeName11;
        OERDefinition.Builder builder = typeName5;
        ...
        OERDefinition.Builder typeName21 = OERDefinition.integer().rangeToMAXFrom(0).typeName("Psid");
        Psid = typeName21;
        ...
        OERDefinition.Builder typeName25 = OERDefinition.seqof(OERDefinition.octets().rangeToMAXFrom(0)).typeName("SequenceOfOctetString");
        ...
        OERDefinition.Builder typeName31 = OERDefinition.seq(typeName.label("region"), builder.label("subregions")).typeName("RegionAndSubregions");
        ...
        OERDefinition.Builder typeName36 = OERDefinition.integer(-1799999999, 1800000001).typeName("OneEightyDegreeInt");
        OneEightyDegreeInt = typeName36;
        KnownLongitude = typeName36.copy().typeName("KnownLongitude");
        OERDefinition.Builder typeName37 = OERDefinition.integer(-900000000, 900000001).typeName("NinetyDegreeInt");
        ...
        OERDefinition.Builder typeName45 = OERDefinition.seqof(typeName41).rangeToMAXFrom(3).typeName("PolygonalRegion");
