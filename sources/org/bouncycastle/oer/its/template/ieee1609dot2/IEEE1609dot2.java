...
public class IEEE1609dot2 {
    ...
    static {
        ...
        ContributedExtensionBlockSwitch = r3;
        OERDefinition.Builder typeName5 = OERDefinition.seq(validSwitchValue.label("contributorId"), OERDefinition.aSwitch(r3).label("Extn")).typeName("ContributedExtensionBlock");
        ...
        OERDefinition.Builder builder = typeName3;
        ...
        OERDefinition.Builder builder2 = typeName15;
        ...
        OERDefinition.Builder builder3 = typeName;
        ...
        OERDefinition.Builder builder4 = typeName6;
        OERDefinition.Builder typeName22 = OERDefinition.choice(typeName21.label("linkageData"), Ieee1609Dot2BaseTypes.Hostname.label(ContentDisposition.Parameters.Name), OERDefinition.octets(1, 64).label("binaryId"), OERDefinition.nullValue().label("none"), OERDefinition.extension(new Object[0])).typeName("CertificateId");
        CertificateId = typeName22;
        OERDefinition.Builder builder5 = typeName2;
        ...
        OERDefinition.Builder typeName26 = OERDefinition.seq(Ieee1609Dot2BaseTypes.UINT8.label("version"), typeName25.label("type"), typeName24.label("issuer"), typeName23.label("toBeSigned"), OERDefinition.optional(Ieee1609Dot2BaseTypes.Signature.label("signature"))).label("signature").typeName("CertificateBase");
        ...
        OERDefinition.Builder builder6 = builder3;
        OERDefinition.Builder typeName31 = OERDefinition.choice(builder6.label("unsecuredData"), OERDefinition.deferred(new ElementSupplier() {
            private Element built;
        ...
        }).label("signedData").mayRecurse(true), builder2.label("encryptedData"), builder6.label("signedCertificateRequest"), OERDefinition.extension(new Object[0])).typeName("Ieee1609Dot2Content");
        Ieee1609Dot2Content = typeName31;
        CounterSignature = OERDefinition.seq(Ieee1609Dot2BaseTypes.UINT8.label("protocolVersion"), typeName31.label("content")).typeName("CounterSignature");
        OERDefinition.Builder typeName32 = OERDefinition.seq(Ieee1609Dot2BaseTypes.UINT8.validSwitchValue(new ASN1Integer(3)).label("protocolVersion"), typeName31.label("content")).typeName("Ieee1609Dot2Data");
        Ieee1609Dot2Data = typeName32;
        OERDefinition.Builder typeName33 = OERDefinition.seq(OERDefinition.optional(typeName32.label("data"), builder.label("extDataHash")), OERDefinition.extension(new Object[0])).typeName("SignedDataPayload");
