...
public class EtsiTs102941TrustLists {
    ...
    static {
        ...
        ToBeSignedCrl = OERDefinition.seq(EtsiTs102941BaseTypes.Version.label("version"), Ieee1609Dot2BaseTypes.Time32.label("thisUpdate"), Ieee1609Dot2BaseTypes.Time32.label("nextUpdate"), typeName2.label("entries"), OERDefinition.extension(new Object[0])).typeName("ToBeSignedCrl");
        ...
        DcDelete = typeName4;
        OERDefinition.Builder typeName5 = OERDefinition.seq(typeName3.label(RtspHeaders.Values.URL), Ieee1609Dot2BaseTypes.SequenceOfHashedId8.label("cert")).typeName("DcEntry");
        DcEntry = typeName5;
        ...
        OERDefinition.Builder typeName14 = OERDefinition.seq(EtsiTs102941BaseTypes.Version.label("version"), Ieee1609Dot2BaseTypes.Time32.label("nextUpdate"), OERDefinition.bool().label("isFullCtl"), OERDefinition.integer(0, 255).label("ctlSequence"), typeName13.label("ctlCommands"), OERDefinition.extension(new Object[0])).typeName("CtlFormat");
