...
public class CtlFormat extends ASN1Object {
    ...
    public static class Builder {
        ...
        public Builder setVersion(Version version2) {
    ...
    protected CtlFormat(ASN1Sequence aSN1Sequence) {
        if (aSN1Sequence.size() == 5) {
            ...
            this.isFullCtl = ASN1Boolean.getInstance((Object) aSN1Sequence.getObjectAt(2));
    ...
    public CtlFormat(Version version2, Time32 time32, ASN1Boolean aSN1Boolean, UINT8 uint8, SequenceOfCtlCommand sequenceOfCtlCommand) {
        this.version = version2;
        this.nextUpdate = time32;
        this.isFullCtl = aSN1Boolean;
        this.ctlSequence = uint8;
