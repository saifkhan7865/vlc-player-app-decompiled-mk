...
public class PsidGroupPermissions extends ASN1Object {
    ...
    public static class Builder {
        ...
        public Builder setSubjectPermissions(SubjectPermissions subjectPermissions2) {
            this.subjectPermissions = subjectPermissions2;
            return this;
        }
    }
    ...
    public PsidGroupPermissions(SubjectPermissions subjectPermissions2, ASN1Integer aSN1Integer, ASN1Integer aSN1Integer2, EndEntityType endEntityType) {
        this.subjectPermissions = subjectPermissions2;
        this.minChainLength = aSN1Integer;
