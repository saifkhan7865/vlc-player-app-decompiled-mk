...
public class CertificateBase extends ASN1Object {
    ...
    public static class Builder {
        ...
        public Builder setSignature(Signature signature2) {
    ...
    public CertificateBase(UINT8 uint8, CertificateType certificateType, IssuerIdentifier issuerIdentifier, ToBeSignedCertificate toBeSignedCertificate, Signature signature2) {
        this.version = uint8;
        this.type = certificateType;
        this.issuer = issuerIdentifier;
        this.toBeSigned = toBeSignedCertificate;
