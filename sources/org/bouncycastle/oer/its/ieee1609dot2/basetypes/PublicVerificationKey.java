...
public class PublicVerificationKey extends ASN1Object implements ASN1Choice {
    ...
    private PublicVerificationKey(ASN1TaggedObject aSN1TaggedObject) {
        ...
        this.choice = tagNo;
        if (tagNo == 0 || tagNo == 1) {
            instance = EccP256CurvePoint.getInstance(aSN1TaggedObject.getExplicitBaseObject());
        } else if (tagNo == 2) {
            instance = EccP384CurvePoint.getInstance(aSN1TaggedObject.getExplicitBaseObject());
        } else {
