...
public class Ieee1609Dot2Content extends ASN1Object implements ASN1Choice {
    ...
    private Ieee1609Dot2Content(ASN1TaggedObject aSN1TaggedObject) {
        ...
        if (tagNo != 0) {
            if (tagNo == 1) {
                instance = SignedData.getInstance(aSN1TaggedObject.getExplicitBaseObject());
            } else if (tagNo == 2) {
                instance = EncryptedData.getInstance(aSN1TaggedObject.getExplicitBaseObject());
            } else if (tagNo != 3) {
                throw new IllegalArgumentException("invalid choice value " + aSN1TaggedObject.getTagNo());
            }
            this.ieee1609Dot2Content = instance;
        }
        instance = Opaque.getInstance(aSN1TaggedObject.getExplicitBaseObject());
        this.ieee1609Dot2Content = instance;
    }
