...
public class PKCS10CertificationRequest extends CertificationRequest {
    ...
    public PKCS10CertificationRequest(java.lang.String r5, org.bouncycastle.asn1.x509.X509Name r6, java.security.PublicKey r7, org.bouncycastle.asn1.ASN1Set r8, java.security.PrivateKey r9, java.lang.String r10) throws java.security.NoSuchAlgorithmException, java.security.NoSuchProviderException, java.security.InvalidKeyException, java.security.SignatureException {
        ...
        L_0x004b:
            ...
            goto L_0x0030
        L_0x0053:
            byte[] r7 = r7.getEncoded()     // Catch:{ IOException -> 0x00a2 }
            org.bouncycastle.asn1.ASN1Primitive r7 = org.bouncycastle.asn1.ASN1Primitive.fromByteArray(r7)     // Catch:{ IOException -> 0x00a2 }
            org.bouncycastle.asn1.ASN1Sequence r7 = (org.bouncycastle.asn1.ASN1Sequence) r7     // Catch:{ IOException -> 0x00a2 }
            org.bouncycastle.asn1.pkcs.CertificationRequestInfo r0 = new org.bouncycastle.asn1.pkcs.CertificationRequestInfo     // Catch:{ IOException -> 0x00a2 }
            org.bouncycastle.asn1.x509.SubjectPublicKeyInfo r7 = org.bouncycastle.asn1.x509.SubjectPublicKeyInfo.getInstance(r7)     // Catch:{ IOException -> 0x00a2 }
            r0.<init>((org.bouncycastle.asn1.x509.X509Name) r6, (org.bouncycastle.asn1.x509.SubjectPublicKeyInfo) r7, (org.bouncycastle.asn1.ASN1Set) r8)     // Catch:{ IOException -> 0x00a2 }
            r4.reqInfo = r0     // Catch:{ IOException -> 0x00a2 }
