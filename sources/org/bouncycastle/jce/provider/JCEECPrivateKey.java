...
public class JCEECPrivateKey implements ECPrivateKey, org.bouncycastle.jce.interfaces.ECPrivateKey, PKCS12BagAttributeCarrier, ECPointEncoder {
    ...
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r2v4, resolved type: org.bouncycastle.jce.spec.ECNamedCurveSpec} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r4v2, resolved type: org.bouncycastle.jce.spec.ECNamedCurveSpec} */
    ...
    public byte[] getEncoded() {
        ...
        int orderBitLength = eCParameterSpec2 == null ? ECUtil.getOrderBitLength((ProviderConfiguration) null, (BigInteger) null, getS()) : ECUtil.getOrderBitLength((ProviderConfiguration) null, eCParameterSpec2.getOrder(), getS());
