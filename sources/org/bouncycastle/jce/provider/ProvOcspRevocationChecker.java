...
class ProvOcspRevocationChecker implements PKIXCertRevocationChecker {
    ...
    public void check(java.security.cert.Certificate certificate) throws CertPathValidatorException {
        ...
        Map m = ProvRevocationChecker$$ExternalSyntheticApiModelOutline0.m(this.parent);
        URI m2 = ProvRevocationChecker$$ExternalSyntheticApiModelOutline0.m(this.parent);
        if (m2 == null) {
            if (this.ocspURL != null) {
                try {
                    m2 = new URI(this.ocspURL);
                ...
                m2 = getOcspResponderURI(x509Certificate);
            }
        }
        URI uri = m2;
        if (m.get(x509Certificate) != null || uri == null) {
            List m3 = ProvRevocationChecker$$ExternalSyntheticApiModelOutline0.m(this.parent);
            bArr = null;
            for (int i = 0; i != m3.size(); i++) {
                java.security.cert.Extension m4 = AppUtils$$ExternalSyntheticApiModelOutline0.m(m3.get(i));
                byte[] m5 = AppUtils$$ExternalSyntheticApiModelOutline0.m(m4);
                if (OCSPObjectIdentifiers.id_pkix_ocsp_nonce.getId().equals(AppUtils$$ExternalSyntheticApiModelOutline0.m(m4))) {
                    bArr = m5;
                }
            }
            z = false;
        } else if (this.ocspURL == null && ProvRevocationChecker$$ExternalSyntheticApiModelOutline0.m(this.parent) == null && !this.isEnabledOCSP) {
            ...
            try {
                m.put(x509Certificate, OcspCache.getOcspResponse(createCertID(new AlgorithmIdentifier(OIWObjectIdentifiers.idSHA1), extractCert(), new ASN1Integer(x509Certificate.getSerialNumber())), this.parameters, uri, ProvRevocationChecker$$ExternalSyntheticApiModelOutline0.m(this.parent), ProvRevocationChecker$$ExternalSyntheticApiModelOutline0.m(this.parent), this.helper).getEncoded());
                bArr = null;
                z = true;
        ...
        if (!m.isEmpty()) {
            OCSPResponse instance = OCSPResponse.getInstance(m.get(x509Certificate));
            ...
            if (instance == null) {
                ...
                if (instance2.getResponseType().equals((ASN1Primitive) OCSPObjectIdentifiers.id_pkix_ocsp_basic)) {
                    try {
                        ...
                        if (z || validatedOcspResponse(instance3, this.parameters, bArr, ProvRevocationChecker$$ExternalSyntheticApiModelOutline0.m(this.parent), this.helper)) {
