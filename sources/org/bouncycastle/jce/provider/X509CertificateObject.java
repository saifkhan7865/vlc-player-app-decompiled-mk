        ...
        try {
            ...
            try {
                ...
                if (extensionBytes2 != null) {
                    ASN1BitString instance = ASN1BitString.getInstance(ASN1Primitive.fromByteArray(extensionBytes2));
            ...
            while (oids.hasMoreElements()) {
                ...
                if (extension.getExtnValue() != null) {
                    ...
                    try {
                        ...
                        append = stringBuffer2.append(verisignCzagExtension);
                        append.append(lineSeparator);
                    } catch (Exception unused) {
                        stringBuffer2.append(aSN1ObjectIdentifier.getId());
                        stringBuffer2.append(" value = *****").append(lineSeparator);
                    }
                } else {
