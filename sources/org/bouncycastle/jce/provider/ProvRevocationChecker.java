...
class ProvRevocationChecker extends PKIXRevocationChecker implements PKIXCertRevocationChecker {
    ...
    private boolean hasOption(PKIXRevocationChecker.Option option) {
        return ProvRevocationChecker$$ExternalSyntheticApiModelOutline0.m(this).contains(option);
    }

    public void check(Certificate certificate, Collection<String> collection) throws CertPathValidatorException {
        X509Certificate x509Certificate = (X509Certificate) certificate;
        if (hasOption(AppUtils$$ExternalSyntheticApiModelOutline0.m()) && x509Certificate.getBasicConstraints() != -1) {
            return;
        }
