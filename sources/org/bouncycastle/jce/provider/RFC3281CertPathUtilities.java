...
class RFC3281CertPathUtilities {
                ...
                while (it2.hasNext() && certStatus.getCertStatus() == 11 && !reasonsMask.isAllReasons()) {
                    try {
                        ...
                        if (!processCRLD.hasNewReasons(reasonsMask2)) {
                            ...
                            it = it2;
                            try {
                                X509CRL x509crl4 = x509crl3;
                                PublicKey processCRLG = RFC3280CertPathUtilities.processCRLG(x509crl4, RFC3280CertPathUtilities.processCRLF(x509crl2, x509AttributeCertificate, (X509Certificate) null, (PublicKey) null, pKIXExtendedParameters, list, jcaJceHelper));
                                if (pKIXExtendedParameters.isUseDeltasEnabled()) {
                                    try {
                                        x509crl = RFC3280CertPathUtilities.processCRLH(CertPathValidatorUtilities.getDeltaCRLs(date, x509crl4, pKIXExtendedParameters.getCertStores(), pKIXExtendedParameters.getCRLStores(), jcaJceHelper), processCRLG);
                                ...
                                if (pKIXExtendedParameters.getValidityModel() != 1) {
                                    if (x509AttributeCertificate.getNotAfter().getTime() < x509crl4.getThisUpdate().getTime()) {
                                        throw new AnnotatedException("No valid CRL for current time found.");
                                    }
                                }
                                RFC3280CertPathUtilities.processCRLB1(distributionPoint2, x509AttributeCertificate2, x509crl4);
                                RFC3280CertPathUtilities.processCRLB2(distributionPoint2, x509AttributeCertificate2, x509crl4);
                                RFC3280CertPathUtilities.processCRLC(x509crl, x509crl4, pKIXExtendedParameters2);
                                RFC3280CertPathUtilities.processCRLI(date3, x509crl, x509AttributeCertificate2, certStatus2, pKIXExtendedParameters2);
                                RFC3280CertPathUtilities.processCRLJ(date3, x509crl4, x509AttributeCertificate2, certStatus2);
    ...
    protected static void checkCRLs(org.bouncycastle.x509.X509AttributeCertificate r20, org.bouncycastle.jcajce.PKIXExtendedParameters r21, java.util.Date r22, java.util.Date r23, java.security.cert.X509Certificate r24, java.util.List r25, org.bouncycastle.jcajce.util.JcaJceHelper r26) throws java.security.cert.CertPathValidatorException {
        /*
            ...
            java.lang.String r0 = CRL_DISTRIBUTION_POINTS     // Catch:{ AnnotatedException -> 0x0183 }
            org.bouncycastle.asn1.ASN1Primitive r0 = org.bouncycastle.jce.provider.CertPathValidatorUtilities.getExtensionValue(r11, r0)     // Catch:{ AnnotatedException -> 0x0183 }
            org.bouncycastle.asn1.x509.CRLDistPoint r0 = org.bouncycastle.asn1.x509.CRLDistPoint.getInstance(r0)     // Catch:{ AnnotatedException -> 0x0183 }
            java.util.ArrayList r1 = new java.util.ArrayList
            r1.<init>()
            java.util.Map r2 = r21.getNamedCRLStoreMap()     // Catch:{ AnnotatedException -> 0x017a }
            r12 = r23
            r13 = r26
            java.util.List r2 = org.bouncycastle.jce.provider.CertPathValidatorUtilities.getAdditionalStoresFromCRLDistributionPoint(r0, r2, r12, r13)     // Catch:{ AnnotatedException -> 0x017a }
            r1.addAll(r2)     // Catch:{ AnnotatedException -> 0x017a }
