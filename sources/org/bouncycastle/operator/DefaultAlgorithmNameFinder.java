...
public class DefaultAlgorithmNameFinder implements AlgorithmNameFinder {
    ...
    static {
        ...
        hashMap.put(BCObjectIdentifiers.sphincsPlus_sha2_128s_r3, "SPHINCS+");
        hashMap.put(BCObjectIdentifiers.sphincsPlus_sha2_128f_r3, "SPHINCS+");
        hashMap.put(BCObjectIdentifiers.sphincsPlus_shake_128s_r3, "SPHINCS+");
        hashMap.put(BCObjectIdentifiers.sphincsPlus_shake_128f_r3, "SPHINCS+");
        hashMap.put(BCObjectIdentifiers.sphincsPlus_haraka_128s_r3, "SPHINCS+");
        hashMap.put(BCObjectIdentifiers.sphincsPlus_haraka_128f_r3, "SPHINCS+");
        hashMap.put(BCObjectIdentifiers.sphincsPlus_sha2_192s_r3, "SPHINCS+");
        hashMap.put(BCObjectIdentifiers.sphincsPlus_sha2_192f_r3, "SPHINCS+");
        hashMap.put(BCObjectIdentifiers.sphincsPlus_shake_192s_r3, "SPHINCS+");
        hashMap.put(BCObjectIdentifiers.sphincsPlus_shake_192f_r3, "SPHINCS+");
        hashMap.put(BCObjectIdentifiers.sphincsPlus_haraka_192s_r3, "SPHINCS+");
        hashMap.put(BCObjectIdentifiers.sphincsPlus_haraka_192f_r3, "SPHINCS+");
        hashMap.put(BCObjectIdentifiers.sphincsPlus_sha2_256s_r3, "SPHINCS+");
        hashMap.put(BCObjectIdentifiers.sphincsPlus_sha2_256f_r3, "SPHINCS+");
        hashMap.put(BCObjectIdentifiers.sphincsPlus_shake_256s_r3, "SPHINCS+");
        hashMap.put(BCObjectIdentifiers.sphincsPlus_shake_256f_r3, "SPHINCS+");
        hashMap.put(BCObjectIdentifiers.sphincsPlus_haraka_256s_r3, "SPHINCS+");
        hashMap.put(BCObjectIdentifiers.sphincsPlus_haraka_256f_r3, "SPHINCS+");
        hashMap.put(BCObjectIdentifiers.sphincsPlus_sha2_128s_r3_simple, "SPHINCS+");
        hashMap.put(BCObjectIdentifiers.sphincsPlus_sha2_128f_r3_simple, "SPHINCS+");
        hashMap.put(BCObjectIdentifiers.sphincsPlus_shake_128s_r3_simple, "SPHINCS+");
        hashMap.put(BCObjectIdentifiers.sphincsPlus_shake_128f_r3_simple, "SPHINCS+");
        hashMap.put(BCObjectIdentifiers.sphincsPlus_haraka_128s_r3_simple, "SPHINCS+");
        hashMap.put(BCObjectIdentifiers.sphincsPlus_haraka_128f_r3_simple, "SPHINCS+");
        hashMap.put(BCObjectIdentifiers.sphincsPlus_sha2_192s_r3_simple, "SPHINCS+");
        hashMap.put(BCObjectIdentifiers.sphincsPlus_sha2_192f_r3_simple, "SPHINCS+");
        hashMap.put(BCObjectIdentifiers.sphincsPlus_shake_192s_r3_simple, "SPHINCS+");
        hashMap.put(BCObjectIdentifiers.sphincsPlus_shake_192f_r3_simple, "SPHINCS+");
        hashMap.put(BCObjectIdentifiers.sphincsPlus_haraka_192s_r3_simple, "SPHINCS+");
        hashMap.put(BCObjectIdentifiers.sphincsPlus_haraka_192f_r3_simple, "SPHINCS+");
        hashMap.put(BCObjectIdentifiers.sphincsPlus_sha2_256s_r3_simple, "SPHINCS+");
        hashMap.put(BCObjectIdentifiers.sphincsPlus_sha2_256f_r3_simple, "SPHINCS+");
        hashMap.put(BCObjectIdentifiers.sphincsPlus_shake_256s_r3_simple, "SPHINCS+");
        hashMap.put(BCObjectIdentifiers.sphincsPlus_shake_256f_r3_simple, "SPHINCS+");
        hashMap.put(BCObjectIdentifiers.sphincsPlus_haraka_256s_r3_simple, "SPHINCS+");
        hashMap.put(BCObjectIdentifiers.sphincsPlus_haraka_256f_r3_simple, "SPHINCS+");
