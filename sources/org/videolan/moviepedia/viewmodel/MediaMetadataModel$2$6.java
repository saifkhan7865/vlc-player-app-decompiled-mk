...
final class MediaMetadataModel$2$6 extends Lambda implements Function1<List<? extends Person>, Unit> {
    final /* synthetic */ MediaMetadataFull $mediaMetadataFull;
    final /* synthetic */ MediaMetadataModel this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    MediaMetadataModel$2$6(MediaMetadataFull mediaMetadataFull, MediaMetadataModel mediaMetadataModel) {
        super(1);
    ...
    public final void invoke(List<Person> list) {
        this.$mediaMetadataFull.setDirectors(list);
