...
public final class Writer {
    ...
    public static /* synthetic */ Writer copy$default(Writer writer, Person person2, String str, int i, Object obj) {
        if ((i & 1) != 0) {
            person2 = writer.person;
        }
        if ((i & 2) != 0) {
            str = writer.source;
        }
        return writer.copy(person2, str);
    }
    ...
    public final Writer copy(Person person2, String str) {
        Intrinsics.checkNotNullParameter(person2, "person");
        Intrinsics.checkNotNullParameter(str, "source");
        return new Writer(person2, str);
    }
    ...
    public boolean equals(Object obj) {
        ...
        return Intrinsics.areEqual((Object) this.person, (Object) writer.person) && Intrinsics.areEqual((Object) this.source, (Object) writer.source);
    }
    ...
    public String toString() {
        return "Writer(person=" + this.person + ", source=" + this.source + ')';
    }

    public Writer(Person person2, String str) {
        Intrinsics.checkNotNullParameter(person2, "person");
        Intrinsics.checkNotNullParameter(str, "source");
        this.person = person2;
        this.source = str;
