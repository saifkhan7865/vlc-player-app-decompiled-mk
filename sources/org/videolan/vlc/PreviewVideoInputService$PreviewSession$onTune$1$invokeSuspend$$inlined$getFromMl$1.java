...
@DebugMetadata(c = "org.videolan.vlc.PreviewVideoInputService$PreviewSession$onTune$1$invokeSuspend$$inlined$getFromMl$1", f = "PreviewVideoInputService.kt", i = {0, 0, 0}, l = {338}, m = "invokeSuspend", n = {"$this$withContext", "ml", "scan"}, s = {"L$0", "L$1", "I$0"})
...
public final class PreviewVideoInputService$PreviewSession$onTune$1$invokeSuspend$$inlined$getFromMl$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super MediaWrapper>, Object> {
    ...
    public PreviewVideoInputService$PreviewSession$onTune$1$invokeSuspend$$inlined$getFromMl$1(Context context, Continuation continuation, long j) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        PreviewVideoInputService$PreviewSession$onTune$1$invokeSuspend$$inlined$getFromMl$1 previewVideoInputService$PreviewSession$onTune$1$invokeSuspend$$inlined$getFromMl$1 = new PreviewVideoInputService$PreviewSession$onTune$1$invokeSuspend$$inlined$getFromMl$1(this.$this_getFromMl, continuation, this.$id$inlined);
        previewVideoInputService$PreviewSession$onTune$1$invokeSuspend$$inlined$getFromMl$1.L$0 = obj;
    ...
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super MediaWrapper> continuation) {
        return ((PreviewVideoInputService$PreviewSession$onTune$1$invokeSuspend$$inlined$getFromMl$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            if (instance.isStarted()) {
                return instance.getMedia(this.$id$inlined);
            }
            ...
            final AnonymousClass1 r4 = new Medialibrary.OnMedialibraryReadyListener() {
                ...
                @DebugMetadata(c = "org.videolan.vlc.PreviewVideoInputService$PreviewSession$onTune$1$invokeSuspend$$inlined$getFromMl$1$1$1", f = "PreviewVideoInputService.kt", i = {}, l = {46}, m = "invokeSuspend", n = {}, s = {})
                /* renamed from: org.videolan.vlc.PreviewVideoInputService$PreviewSession$onTune$1$invokeSuspend$$inlined$getFromMl$1$1$1  reason: invalid class name */
                /* compiled from: Extensions.kt */
