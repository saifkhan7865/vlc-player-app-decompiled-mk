...
public class PlaylistsFragmentBindingImpl extends PlaylistsFragmentBinding {
    ...
    static {
        ...
        sparseIntArray.put(R.id.playlist_list, 2);
        sparseIntArray.put(R.id.songs_fast_scroller_playlist, 3);
        sparseIntArray.put(R.id.empty_loading, 4);
    }

    public PlaylistsFragmentBindingImpl(DataBindingComponent dataBindingComponent, View view) {
