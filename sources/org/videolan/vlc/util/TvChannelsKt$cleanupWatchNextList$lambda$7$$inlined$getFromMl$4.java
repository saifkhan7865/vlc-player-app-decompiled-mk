...
@DebugMetadata(c = "org.videolan.vlc.util.TvChannelsKt$cleanupWatchNextList$lambda$7$$inlined$getFromMl$4", f = "TvChannels.kt", i = {0, 0, 0}, l = {339}, m = "invokeSuspend", n = {"$this$withContext", "ml", "scan"}, s = {"L$0", "L$1", "I$0"})
/* compiled from: Extensions.kt */
public final class TvChannelsKt$cleanupWatchNextList$lambda$7$$inlined$getFromMl$4 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super MediaWrapper>, Object> {
    ...
    public TvChannelsKt$cleanupWatchNextList$lambda$7$$inlined$getFromMl$4(Context context, Continuation continuation, String str) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        TvChannelsKt$cleanupWatchNextList$lambda$7$$inlined$getFromMl$4 tvChannelsKt$cleanupWatchNextList$lambda$7$$inlined$getFromMl$4 = new TvChannelsKt$cleanupWatchNextList$lambda$7$$inlined$getFromMl$4(this.$this_getFromMl, continuation, this.$contentId$inlined);
        tvChannelsKt$cleanupWatchNextList$lambda$7$$inlined$getFromMl$4.L$0 = obj;
        return tvChannelsKt$cleanupWatchNextList$lambda$7$$inlined$getFromMl$4;
    }

    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super MediaWrapper> continuation) {
        return ((TvChannelsKt$cleanupWatchNextList$lambda$7$$inlined$getFromMl$4) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            if (instance.isStarted()) {
                Intrinsics.checkNotNull(this.$contentId$inlined);
                return instance.getMedia(Uri.parse(this.$contentId$inlined));
            }
            ...
            final String str = this.$contentId$inlined;
            final AnonymousClass1 r5 = new Medialibrary.OnMedialibraryReadyListener() {
                ...
                @DebugMetadata(c = "org.videolan.vlc.util.TvChannelsKt$cleanupWatchNextList$lambda$7$$inlined$getFromMl$4$1$1", f = "TvChannels.kt", i = {}, l = {46}, m = "invokeSuspend", n = {}, s = {})
                /* renamed from: org.videolan.vlc.util.TvChannelsKt$cleanupWatchNextList$lambda$7$$inlined$getFromMl$4$1$1  reason: invalid class name */
                /* compiled from: Extensions.kt */
                public static final class AnonymousClass1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
                    ...
                    public final Object invokeSuspend(Object obj) {
                        ...
                        if (i == 0) {
                            ...
                            cancellableContinuation.resumeWith(Result.m1774constructorimpl(medialibrary.getMedia(Uri.parse(str))));
                            this.label = 1;
