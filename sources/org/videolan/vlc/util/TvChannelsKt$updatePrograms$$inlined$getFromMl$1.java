...
@DebugMetadata(c = "org.videolan.vlc.util.TvChannelsKt$updatePrograms$$inlined$getFromMl$1", f = "TvChannels.kt", i = {0, 0, 0}, l = {338}, m = "invokeSuspend", n = {"$this$withContext", "ml", "scan"}, s = {"L$0", "L$1", "I$0"})
/* compiled from: Extensions.kt */
public final class TvChannelsKt$updatePrograms$$inlined$getFromMl$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super MediaWrapper[]>, Object> {
    ...
    public TvChannelsKt$updatePrograms$$inlined$getFromMl$1(Context context, Continuation continuation) {
        super(2, continuation);
        this.$this_getFromMl = context;
    }

    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        TvChannelsKt$updatePrograms$$inlined$getFromMl$1 tvChannelsKt$updatePrograms$$inlined$getFromMl$1 = new TvChannelsKt$updatePrograms$$inlined$getFromMl$1(this.$this_getFromMl, continuation);
        tvChannelsKt$updatePrograms$$inlined$getFromMl$1.L$0 = obj;
        return tvChannelsKt$updatePrograms$$inlined$getFromMl$1;
    }

    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super MediaWrapper[]> continuation) {
        return ((TvChannelsKt$updatePrograms$$inlined$getFromMl$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            if (instance.isStarted()) {
                return instance.getRecentVideos();
            }
            ...
            final AnonymousClass1 r5 = new Medialibrary.OnMedialibraryReadyListener() {
                ...
                @DebugMetadata(c = "org.videolan.vlc.util.TvChannelsKt$updatePrograms$$inlined$getFromMl$1$1$1", f = "TvChannels.kt", i = {}, l = {46}, m = "invokeSuspend", n = {}, s = {})
                /* renamed from: org.videolan.vlc.util.TvChannelsKt$updatePrograms$$inlined$getFromMl$1$1$1  reason: invalid class name */
                /* compiled from: Extensions.kt */
                public static final class AnonymousClass1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
                    ...
                    public final Object invokeSuspend(Object obj) {
                        ...
                        if (i == 0) {
                            ...
                            cancellableContinuation.resumeWith(Result.m1774constructorimpl(medialibrary.getRecentVideos()));
                            this.label = 1;
