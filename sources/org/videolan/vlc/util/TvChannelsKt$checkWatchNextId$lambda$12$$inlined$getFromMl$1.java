...
@DebugMetadata(c = "org.videolan.vlc.util.TvChannelsKt$checkWatchNextId$lambda$12$$inlined$getFromMl$1", f = "TvChannels.kt", i = {0, 0, 0}, l = {339}, m = "invokeSuspend", n = {"$this$withContext", "ml", "scan"}, s = {"L$0", "L$1", "I$0"})
/* compiled from: Extensions.kt */
public final class TvChannelsKt$checkWatchNextId$lambda$12$$inlined$getFromMl$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super MediaWrapper>, Object> {
    ...
    public TvChannelsKt$checkWatchNextId$lambda$12$$inlined$getFromMl$1(Context context, Continuation continuation, String str) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        TvChannelsKt$checkWatchNextId$lambda$12$$inlined$getFromMl$1 tvChannelsKt$checkWatchNextId$lambda$12$$inlined$getFromMl$1 = new TvChannelsKt$checkWatchNextId$lambda$12$$inlined$getFromMl$1(this.$this_getFromMl, continuation, this.$contentId$inlined);
        tvChannelsKt$checkWatchNextId$lambda$12$$inlined$getFromMl$1.L$0 = obj;
        return tvChannelsKt$checkWatchNextId$lambda$12$$inlined$getFromMl$1;
    }

    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super MediaWrapper> continuation) {
        return ((TvChannelsKt$checkWatchNextId$lambda$12$$inlined$getFromMl$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            final AnonymousClass1 r5 = new Medialibrary.OnMedialibraryReadyListener() {
                ...
                @DebugMetadata(c = "org.videolan.vlc.util.TvChannelsKt$checkWatchNextId$lambda$12$$inlined$getFromMl$1$1$1", f = "TvChannels.kt", i = {}, l = {46}, m = "invokeSuspend", n = {}, s = {})
                /* renamed from: org.videolan.vlc.util.TvChannelsKt$checkWatchNextId$lambda$12$$inlined$getFromMl$1$1$1  reason: invalid class name */
                /* compiled from: Extensions.kt */
