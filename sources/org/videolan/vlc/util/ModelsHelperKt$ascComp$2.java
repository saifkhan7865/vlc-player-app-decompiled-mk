...
final class ModelsHelperKt$ascComp$2 extends Lambda implements Function0<Comparator<MediaLibraryItem>> {
    public static final ModelsHelperKt$ascComp$2 INSTANCE = new ModelsHelperKt$ascComp$2();

    ModelsHelperKt$ascComp$2() {
        super(0);
    }

    public final Comparator<MediaLibraryItem> invoke() {
        return new ModelsHelperKt$ascComp$2$$ExternalSyntheticLambda0();
    }
    ...
    public static final int invoke$lambda$0(org.videolan.medialibrary.media.MediaLibraryItem r4, org.videolan.medialibrary.media.MediaLibraryItem r5) {
        ...
        L_0x0067:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: org.videolan.vlc.util.ModelsHelperKt$ascComp$2.invoke$lambda$0(org.videolan.medialibrary.media.MediaLibraryItem, org.videolan.medialibrary.media.MediaLibraryItem):int");
    }
}
