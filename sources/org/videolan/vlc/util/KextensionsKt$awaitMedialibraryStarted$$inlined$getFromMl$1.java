...
@DebugMetadata(c = "org.videolan.vlc.util.KextensionsKt$awaitMedialibraryStarted$$inlined$getFromMl$1", f = "Kextensions.kt", i = {0, 0, 0}, l = {338}, m = "invokeSuspend", n = {"$this$withContext", "ml", "scan"}, s = {"L$0", "L$1", "I$0"})
/* compiled from: Extensions.kt */
public final class KextensionsKt$awaitMedialibraryStarted$$inlined$getFromMl$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Boolean>, Object> {
    ...
    public KextensionsKt$awaitMedialibraryStarted$$inlined$getFromMl$1(Context context, Continuation continuation) {
        super(2, continuation);
        this.$this_getFromMl = context;
    }

    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        KextensionsKt$awaitMedialibraryStarted$$inlined$getFromMl$1 kextensionsKt$awaitMedialibraryStarted$$inlined$getFromMl$1 = new KextensionsKt$awaitMedialibraryStarted$$inlined$getFromMl$1(this.$this_getFromMl, continuation);
        kextensionsKt$awaitMedialibraryStarted$$inlined$getFromMl$1.L$0 = obj;
        return kextensionsKt$awaitMedialibraryStarted$$inlined$getFromMl$1;
    }

    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Boolean> continuation) {
        return ((KextensionsKt$awaitMedialibraryStarted$$inlined$getFromMl$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            if (instance.isStarted()) {
                return Boxing.boxBoolean(instance.isStarted());
            }
            ...
            final AnonymousClass1 r5 = new Medialibrary.OnMedialibraryReadyListener() {
                ...
                @DebugMetadata(c = "org.videolan.vlc.util.KextensionsKt$awaitMedialibraryStarted$$inlined$getFromMl$1$1$1", f = "Kextensions.kt", i = {}, l = {46}, m = "invokeSuspend", n = {}, s = {})
                /* renamed from: org.videolan.vlc.util.KextensionsKt$awaitMedialibraryStarted$$inlined$getFromMl$1$1$1  reason: invalid class name */
                /* compiled from: Extensions.kt */
                public static final class AnonymousClass1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
                    ...
                    public final Object invokeSuspend(Object obj) {
                        ...
                        if (i == 0) {
                            ...
                            cancellableContinuation.resumeWith(Result.m1774constructorimpl(Boxing.boxBoolean(medialibrary.isStarted())));
                            this.label = 1;
