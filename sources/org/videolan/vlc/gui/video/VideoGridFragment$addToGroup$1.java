...
final class VideoGridFragment$addToGroup$1 extends Lambda implements Function0<Unit> {
    final /* synthetic */ List<MediaLibraryItem> $selection;
    final /* synthetic */ VideoGridFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    VideoGridFragment$addToGroup$1(VideoGridFragment videoGridFragment, List<? extends MediaLibraryItem> list) {
        super(0);
    ...
    @DebugMetadata(c = "org.videolan.vlc.gui.video.VideoGridFragment$addToGroup$1$1", f = "VideoGridFragment.kt", i = {}, l = {485}, m = "invokeSuspend", n = {}, s = {})
    ...
    static final class AnonymousClass1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return new AnonymousClass1(videoGridFragment, list, continuation);
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i == 0) {
                ...
                this.label = 1;
                obj = ((VideosViewModel) videoGridFragment.getViewModel()).createGroup(MediaUtilsKt.getAll$default(list, 0, false, false, 7, (Object) null), this);
            ...
            if (videoGroup != null) {
                VideoGridFragment videoGridFragment = videoGridFragment;
                if (((VideosViewModel) videoGridFragment.getViewModel()).getGroupingType() == VideoGroupingType.NONE) {
