...
final class VideoTouchDelegate$rightContainer$2 extends Lambda implements Function0<CircularRevealFrameLayout> {
    final /* synthetic */ VideoTouchDelegate this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    VideoTouchDelegate$rightContainer$2(VideoTouchDelegate videoTouchDelegate) {
        super(0);
        this.this$0 = videoTouchDelegate;
    }

    public final CircularRevealFrameLayout invoke() {
        return (CircularRevealFrameLayout) this.this$0.player.findViewById(R.id.rightContainer);
    }
}
