...
public final class VideoTipsDelegate$swipe$$inlined$doOnEnd$1 implements Animator.AnimatorListener {
    final /* synthetic */ ObjectAnimator $slideAnimator$inlined;
    ...
    public VideoTipsDelegate$swipe$$inlined$doOnEnd$1(ObjectAnimator objectAnimator) {
        this.$slideAnimator$inlined = objectAnimator;
    }

    public void onAnimationEnd(Animator animator) {
        this.$slideAnimator$inlined.start();
    }
}
