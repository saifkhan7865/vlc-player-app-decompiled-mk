...
public final class VideoTipsDelegate$next$$inlined$doOnEnd$2 implements Animator.AnimatorListener {
    final /* synthetic */ AnimatorSet $tapLeft$inlined;
    ...
    public VideoTipsDelegate$next$$inlined$doOnEnd$2(AnimatorSet animatorSet) {
        this.$tapLeft$inlined = animatorSet;
    }

    public void onAnimationEnd(Animator animator) {
        this.$tapLeft$inlined.start();
    }
}
