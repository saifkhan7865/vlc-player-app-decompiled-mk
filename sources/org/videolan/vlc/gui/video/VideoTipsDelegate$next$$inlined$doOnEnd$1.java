...
public final class VideoTipsDelegate$next$$inlined$doOnEnd$1 implements Animator.AnimatorListener {
    final /* synthetic */ AnimatorSet $tapRight$inlined;
    ...
    public VideoTipsDelegate$next$$inlined$doOnEnd$1(AnimatorSet animatorSet) {
        this.$tapRight$inlined = animatorSet;
    }

    public void onAnimationEnd(Animator animator) {
        this.$tapRight$inlined.start();
    }
}
