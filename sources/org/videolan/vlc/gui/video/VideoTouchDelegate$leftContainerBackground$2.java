...
final class VideoTouchDelegate$leftContainerBackground$2 extends Lambda implements Function0<HalfCircleView> {
    final /* synthetic */ VideoTouchDelegate this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    VideoTouchDelegate$leftContainerBackground$2(VideoTouchDelegate videoTouchDelegate) {
        super(0);
        this.this$0 = videoTouchDelegate;
    }

    public final HalfCircleView invoke() {
        return (HalfCircleView) this.this$0.player.findViewById(R.id.leftContainerBackground);
    }
}
