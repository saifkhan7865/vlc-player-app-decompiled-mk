...
final class StoragePermissionsDelegate$Companion$getWritePermission$2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Boolean>, Object> {
    final /* synthetic */ Uri $uri;
    int label;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    StoragePermissionsDelegate$Companion$getWritePermission$2(Uri uri, Continuation<? super StoragePermissionsDelegate$Companion$getWritePermission$2> continuation) {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (this.label == 0) {
            ...
            return Boxing.boxBoolean(FileUtils.INSTANCE.canWrite(this.$uri));
        }
