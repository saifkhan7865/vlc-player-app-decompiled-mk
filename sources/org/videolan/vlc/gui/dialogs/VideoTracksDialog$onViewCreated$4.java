...
final class VideoTracksDialog$onViewCreated$4 extends Lambda implements Function0<Unit> {
    final /* synthetic */ VideoTracksDialog this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    VideoTracksDialog$onViewCreated$4(VideoTracksDialog videoTracksDialog) {
        super(0);
    ...
    public final void invoke() {
        ...
        KotlinExtensionsKt.setGone(access$getBinding$p.subtitleTracks.trackMore);
        ...
        playerOverlayTracksBinding.subtitleTracks.options.lock();
    }
}
