...
final class VideoTracksDialog$onViewCreated$2 extends Lambda implements Function1<Float, Unit> {
    final /* synthetic */ VideoTracksDialog this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    VideoTracksDialog$onViewCreated$2(VideoTracksDialog videoTracksDialog) {
        super(1);
    ...
    public final void invoke(float f) {
        ...
        ImageView imageView = access$getBinding$p.subtitleTracks.trackMore;
        ...
        imageView.setRotation(playerOverlayTracksBinding.subtitleTracks.options.isCollapsed() ? 180.0f - (f * 180.0f) : 180.0f * f);
    }
}
