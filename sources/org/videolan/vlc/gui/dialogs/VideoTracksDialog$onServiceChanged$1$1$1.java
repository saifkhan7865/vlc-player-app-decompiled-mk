...
final class VideoTracksDialog$onServiceChanged$1$1$1 extends Lambda implements Function1<VlcTrack, Unit> {
    final /* synthetic */ VideoTracksDialog this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    VideoTracksDialog$onServiceChanged$1$1$1(VideoTracksDialog videoTracksDialog) {
        super(1);
    ...
    public final void invoke(VlcTrack vlcTrack) {
        ...
        this.this$0.getTrackSelectionListener().invoke(vlcTrack.getId(), VideoTracksDialog.TrackType.VIDEO);
    }
}
