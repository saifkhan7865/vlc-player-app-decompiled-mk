...
@DebugMetadata(c = "org.videolan.vlc.gui.AudioPlayerContainerActivity$proposeCard$1$invokeSuspend$$inlined$getFromMl$1", f = "AudioPlayerContainerActivity.kt", i = {0, 0, 0}, l = {339}, m = "invokeSuspend", n = {"$this$withContext", "ml", "scan"}, s = {"L$0", "L$1", "I$0"})
/* compiled from: Extensions.kt */
public final class AudioPlayerContainerActivity$proposeCard$1$invokeSuspend$$inlined$getFromMl$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super MediaWrapper>, Object> {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        ...
        audioPlayerContainerActivity$proposeCard$1$invokeSuspend$$inlined$getFromMl$1.L$0 = obj;
    ...
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super MediaWrapper> continuation) {
        return ((AudioPlayerContainerActivity$proposeCard$1$invokeSuspend$$inlined$getFromMl$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            if (instance.isStarted()) {
                return instance.getMedia(Uri.parse(this.$song$inlined));
            }
            ...
            final String str = this.$song$inlined;
            final AnonymousClass1 r5 = new Medialibrary.OnMedialibraryReadyListener() {
                ...
                @DebugMetadata(c = "org.videolan.vlc.gui.AudioPlayerContainerActivity$proposeCard$1$invokeSuspend$$inlined$getFromMl$1$1$1", f = "AudioPlayerContainerActivity.kt", i = {}, l = {46}, m = "invokeSuspend", n = {}, s = {})
                /* renamed from: org.videolan.vlc.gui.AudioPlayerContainerActivity$proposeCard$1$invokeSuspend$$inlined$getFromMl$1$1$1  reason: invalid class name */
                /* compiled from: Extensions.kt */
