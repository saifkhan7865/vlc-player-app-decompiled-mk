...
@DebugMetadata(c = "org.videolan.vlc.gui.SearchActivity$performSearh$1$invokeSuspend$$inlined$getFromMl$1", f = "SearchActivity.kt", i = {0, 0, 0}, l = {338}, m = "invokeSuspend", n = {"$this$withContext", "ml", "scan"}, s = {"L$0", "L$1", "I$0"})
/* compiled from: Extensions.kt */
public final class SearchActivity$performSearh$1$invokeSuspend$$inlined$getFromMl$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super SearchAggregate>, Object> {
    ...
    public SearchActivity$performSearh$1$invokeSuspend$$inlined$getFromMl$1(Context context, Continuation continuation, String str) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        SearchActivity$performSearh$1$invokeSuspend$$inlined$getFromMl$1 searchActivity$performSearh$1$invokeSuspend$$inlined$getFromMl$1 = new SearchActivity$performSearh$1$invokeSuspend$$inlined$getFromMl$1(this.$this_getFromMl, continuation, this.$query$inlined);
        searchActivity$performSearh$1$invokeSuspend$$inlined$getFromMl$1.L$0 = obj;
        return searchActivity$performSearh$1$invokeSuspend$$inlined$getFromMl$1;
    }

    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super SearchAggregate> continuation) {
        return ((SearchActivity$performSearh$1$invokeSuspend$$inlined$getFromMl$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            final AnonymousClass1 r6 = new Medialibrary.OnMedialibraryReadyListener() {
                ...
                @DebugMetadata(c = "org.videolan.vlc.gui.SearchActivity$performSearh$1$invokeSuspend$$inlined$getFromMl$1$1$1", f = "SearchActivity.kt", i = {}, l = {46}, m = "invokeSuspend", n = {}, s = {})
                /* renamed from: org.videolan.vlc.gui.SearchActivity$performSearh$1$invokeSuspend$$inlined$getFromMl$1$1$1  reason: invalid class name */
                /* compiled from: Extensions.kt */
