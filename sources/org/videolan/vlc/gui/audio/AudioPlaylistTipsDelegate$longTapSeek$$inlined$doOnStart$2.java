...
public final class AudioPlaylistTipsDelegate$longTapSeek$$inlined$doOnStart$2 implements Animator.AnimatorListener {
    ...
    public AudioPlaylistTipsDelegate$longTapSeek$$inlined$doOnStart$2(SeekBar seekBar) {
        this.$seekView$inlined = seekBar;
    }

    public void onAnimationStart(Animator animator) {
        ValueAnimator ofInt = ValueAnimator.ofInt(new int[]{410, 660});
        ofInt.setStartDelay(200);
        ofInt.setDuration(1400);
        ofInt.setInterpolator(new AccelerateInterpolator());
        ofInt.addUpdateListener(new AudioPlaylistTipsDelegate$longTapSeek$2$1(this.$seekView$inlined));
        ofInt.start();
    }
}
