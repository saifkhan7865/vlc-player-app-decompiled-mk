...
public final class AudioPlaylistTipsDelegate$dragAndDrop$$inlined$doOnEnd$2 implements Animator.AnimatorListener {
    final /* synthetic */ AnimatorSet $animatorSet$inlined;
    ...
    public AudioPlaylistTipsDelegate$dragAndDrop$$inlined$doOnEnd$2(AnimatorSet animatorSet) {
        this.$animatorSet$inlined = animatorSet;
    }

    public void onAnimationEnd(Animator animator) {
        this.$animatorSet$inlined.start();
    }
}
