...
final class AudioAlbumsSongsFragment$onViewCreated$5 extends Lambda implements Function1<SparseArrayCompat<String>, Unit> {
    final /* synthetic */ AudioAlbumsSongsFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    AudioAlbumsSongsFragment$onViewCreated$5(AudioAlbumsSongsFragment audioAlbumsSongsFragment) {
        super(1);
    ...
    public final void invoke(SparseArrayCompat<String> sparseArrayCompat) {
        ...
        access$getLists$p[0].invalidateItemDecorations();
    }
}
