...
final class AudioBrowserFragment$onCreate$1 extends Lambda implements Function1<MediaWrapper, Unit> {
    final /* synthetic */ AudioBrowserFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    AudioBrowserFragment$onCreate$1(AudioBrowserFragment audioBrowserFragment) {
        super(1);
