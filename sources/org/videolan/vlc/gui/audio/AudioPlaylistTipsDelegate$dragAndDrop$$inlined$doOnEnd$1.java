...
public final class AudioPlaylistTipsDelegate$dragAndDrop$$inlined$doOnEnd$1 implements Animator.AnimatorListener {
    final /* synthetic */ View $draggedView$inlined;
    ...
    public AudioPlaylistTipsDelegate$dragAndDrop$$inlined$doOnEnd$1(View view) {
        this.$draggedView$inlined = view;
    }

    public void onAnimationEnd(Animator animator) {
        this.$draggedView$inlined.animate().setDuration(300).translationY(0.0f);
    }
}
