...
@DebugMetadata(c = "org.videolan.vlc.gui.audio.AudioBrowserFragment$setupProvider$1", f = "AudioBrowserFragment.kt", i = {}, l = {487}, m = "invokeSuspend", n = {}, s = {})
/* compiled from: AudioBrowserFragment.kt */
final class AudioBrowserFragment$setupProvider$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    AudioBrowserFragment$setupProvider$1(MedialibraryProvider<? extends MediaLibraryItem> medialibraryProvider, AudioBrowserFragment audioBrowserFragment, int i, Continuation<? super AudioBrowserFragment$setupProvider$1> continuation) {
    ...
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((AudioBrowserFragment$setupProvider$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            this.label = 1;
            if (BuildersKt.withContext(Dispatchers.getIO(), new AudioBrowserFragment$setupProvider$1$invokeSuspend$$inlined$waitForML$1((Continuation) null), this) == coroutine_suspended) {
