...
@DebugMetadata(c = "org.videolan.vlc.gui.preferences.PreferencesAdvanced$onPreferenceTreeClick$1$1", f = "PreferencesAdvanced.kt", i = {}, l = {139}, m = "invokeSuspend", n = {}, s = {})
...
final class PreferencesAdvanced$onPreferenceTreeClick$1$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    PreferencesAdvanced$onPreferenceTreeClick$1$1(PreferencesAdvanced preferencesAdvanced, Continuation<? super PreferencesAdvanced$onPreferenceTreeClick$1$1> continuation) {
        super(2, continuation);
        this.this$0 = preferencesAdvanced;
    }

    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new PreferencesAdvanced$onPreferenceTreeClick$1$1(this.this$0, continuation);
    }
        ...
        if (i == 0) {
            ...
            if (autoUpdate.checkUpdate(application, true, new Function2<String, Date, Unit>() {
                ...
                public final void invoke(String str, Date date) {
                    ...
                    updateDialog.show(preferencesAdvanced.requireActivity().getSupportFragmentManager(), "fragment_update");
                }
