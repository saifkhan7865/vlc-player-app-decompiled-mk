...
final class MLStorageBrowserFragment$onViewCreated$3 extends Lambda implements Function1<Pair<? extends Integer, ? extends String>, Unit> {
    final /* synthetic */ MLStorageBrowserFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    MLStorageBrowserFragment$onViewCreated$3(MLStorageBrowserFragment mLStorageBrowserFragment) {
        super(1);
    ...
    public final void invoke(Pair<Integer, String> pair) {
        if (pair != null) {
            ...
            access$getStorageBrowserAdapter$p.notifyItemChanged(pair.getFirst().intValue(), pair.getSecond());
        }
    }
}
