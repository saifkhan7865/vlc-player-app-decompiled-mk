...
@DebugMetadata(c = "org.videolan.vlc.gui.browser.BaseBrowserFragment$getMediaWithMeta$$inlined$getFromMl$1", f = "BaseBrowserFragment.kt", i = {0, 0, 0}, l = {338}, m = "invokeSuspend", n = {"$this$withContext", "ml", "scan"}, s = {"L$0", "L$1", "I$0"})
/* compiled from: Extensions.kt */
public final class BaseBrowserFragment$getMediaWithMeta$$inlined$getFromMl$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super MediaWrapper>, Object> {
    ...
    public BaseBrowserFragment$getMediaWithMeta$$inlined$getFromMl$1(Context context, Continuation continuation, MediaWrapper mediaWrapper) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        BaseBrowserFragment$getMediaWithMeta$$inlined$getFromMl$1 baseBrowserFragment$getMediaWithMeta$$inlined$getFromMl$1 = new BaseBrowserFragment$getMediaWithMeta$$inlined$getFromMl$1(this.$this_getFromMl, continuation, this.$mw$inlined);
        baseBrowserFragment$getMediaWithMeta$$inlined$getFromMl$1.L$0 = obj;
        return baseBrowserFragment$getMediaWithMeta$$inlined$getFromMl$1;
    }

    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super MediaWrapper> continuation) {
        return ((BaseBrowserFragment$getMediaWithMeta$$inlined$getFromMl$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            if (instance.isStarted()) {
                MediaWrapper media = instance.getMedia(this.$mw$inlined.getUri());
                if (media == null) {
                    return this.$mw$inlined;
                }
            ...
            final MediaWrapper mediaWrapper = this.$mw$inlined;
            final AnonymousClass1 r5 = new Medialibrary.OnMedialibraryReadyListener() {
                ...
                @DebugMetadata(c = "org.videolan.vlc.gui.browser.BaseBrowserFragment$getMediaWithMeta$$inlined$getFromMl$1$1$1", f = "BaseBrowserFragment.kt", i = {}, l = {46}, m = "invokeSuspend", n = {}, s = {})
                /* renamed from: org.videolan.vlc.gui.browser.BaseBrowserFragment$getMediaWithMeta$$inlined$getFromMl$1$1$1  reason: invalid class name */
                /* compiled from: Extensions.kt */
                public static final class AnonymousClass1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
                    ...
                    public final Object invokeSuspend(Object obj) {
                        ...
                        if (i == 0) {
                            ...
                            continuation.resumeWith(Result.m1774constructorimpl(media));
                            this.label = 1;
