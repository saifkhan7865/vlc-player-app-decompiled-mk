...
final class MainBrowserFragment$onViewCreated$6 extends Lambda implements Function1<Pair<? extends Integer, ? extends String>, Unit> {
    final /* synthetic */ BaseBrowserAdapter $favoritesAdapter;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    MainBrowserFragment$onViewCreated$6(BaseBrowserAdapter baseBrowserAdapter) {
        super(1);
    ...
    public final void invoke(Pair<Integer, String> pair) {
        if (pair != null) {
            this.$favoritesAdapter.notifyItemChanged(pair.getFirst().intValue(), pair.getSecond());
        }
    }
}
