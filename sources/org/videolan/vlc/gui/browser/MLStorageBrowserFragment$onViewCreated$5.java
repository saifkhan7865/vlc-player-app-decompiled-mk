...
final class MLStorageBrowserFragment$onViewCreated$5 extends Lambda implements Function1<Boolean, Unit> {
    final /* synthetic */ MLStorageBrowserFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    MLStorageBrowserFragment$onViewCreated$5(MLStorageBrowserFragment mLStorageBrowserFragment) {
        super(1);
    ...
    public final void invoke(Boolean bool) {
        ...
        TitleListView access$getNetworkEntry$p2 = mLStorageBrowserFragment.networkEntry;
        if (access$getNetworkEntry$p2 == null) {
            Intrinsics.throwUninitializedPropertyAccessException("networkEntry");
        } else {
            titleListView = access$getNetworkEntry$p2;
        }
        mLStorageBrowserFragment.updateNetworkEmptyView(titleListView.getLoading());
    }
}
