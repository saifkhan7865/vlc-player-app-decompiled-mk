...
final class MediaBrowserFragment$removeItems$1 extends Lambda implements Function0<Unit> {
    final /* synthetic */ List<MediaLibraryItem> $items;
    final /* synthetic */ MediaBrowserFragment<T> this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    MediaBrowserFragment$removeItems$1(List<? extends MediaLibraryItem> list, MediaBrowserFragment<T> mediaBrowserFragment) {
        super(0);
        this.$items = list;
    ...
    public final void invoke() {
        for (MediaLibraryItem deleteItem : this.$items) {
            MediaUtils mediaUtils = MediaUtils.INSTANCE;
            FragmentActivity requireActivity = this.this$0.requireActivity();
            Intrinsics.checkNotNullExpressionValue(requireActivity, "requireActivity(...)");
            final MediaBrowserFragment<T> mediaBrowserFragment = this.this$0;
            mediaUtils.deleteItem(requireActivity, deleteItem, new Function1<MediaLibraryItem, Unit>() {
