...
final class StorageFragmentDelegate$checkBoxAction$1 extends Lambda implements Function1<String, Boolean> {
    final /* synthetic */ String $path;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    StorageFragmentDelegate$checkBoxAction$1(String str) {
        super(1);
        this.$path = str;
    }
