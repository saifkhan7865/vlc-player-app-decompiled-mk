...
final class HeaderMediaListActivity$onCreate$4 extends Lambda implements Function1<SparseArrayCompat<String>, Unit> {
    final /* synthetic */ HeaderMediaListActivity this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    HeaderMediaListActivity$onCreate$4(HeaderMediaListActivity headerMediaListActivity) {
        super(1);
    ...
    public final void invoke(SparseArrayCompat<String> sparseArrayCompat) {
        ...
        access$getBinding$p.songs.invalidateItemDecorations();
    }
}
