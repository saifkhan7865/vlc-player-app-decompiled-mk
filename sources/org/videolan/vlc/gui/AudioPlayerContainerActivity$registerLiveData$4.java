...
final class AudioPlayerContainerActivity$registerLiveData$4 extends Lambda implements Function1<List<String>, Unit> {
    final /* synthetic */ AudioPlayerContainerActivity this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    AudioPlayerContainerActivity$registerLiveData$4(AudioPlayerContainerActivity audioPlayerContainerActivity) {
        super(1);
