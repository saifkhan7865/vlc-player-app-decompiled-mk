...
@DebugMetadata(c = "org.videolan.vlc.ArtworkProvider$getPlayAllImage$bitmap$1$invokeSuspend$$inlined$getFromMl$3", f = "ArtworkProvider.kt", i = {0, 0, 0}, l = {338}, m = "invokeSuspend", n = {"$this$withContext", "ml", "scan"}, s = {"L$0", "L$1", "I$0"})
/* compiled from: Extensions.kt */
public final class ArtworkProvider$getPlayAllImage$bitmap$1$invokeSuspend$$inlined$getFromMl$3 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super List<? extends MediaWrapper>>, Object> {
    ...
    public ArtworkProvider$getPlayAllImage$bitmap$1$invokeSuspend$$inlined$getFromMl$3(Context context, Continuation continuation, long j) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        ArtworkProvider$getPlayAllImage$bitmap$1$invokeSuspend$$inlined$getFromMl$3 artworkProvider$getPlayAllImage$bitmap$1$invokeSuspend$$inlined$getFromMl$3 = new ArtworkProvider$getPlayAllImage$bitmap$1$invokeSuspend$$inlined$getFromMl$3(this.$this_getFromMl, continuation, this.$id$inlined);
        artworkProvider$getPlayAllImage$bitmap$1$invokeSuspend$$inlined$getFromMl$3.L$0 = obj;
        return artworkProvider$getPlayAllImage$bitmap$1$invokeSuspend$$inlined$getFromMl$3;
    }

    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super List<? extends MediaWrapper>> continuation) {
        return ((ArtworkProvider$getPlayAllImage$bitmap$1$invokeSuspend$$inlined$getFromMl$3) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            final AnonymousClass1 r4 = new Medialibrary.OnMedialibraryReadyListener() {
                ...
                @DebugMetadata(c = "org.videolan.vlc.ArtworkProvider$getPlayAllImage$bitmap$1$invokeSuspend$$inlined$getFromMl$3$1$1", f = "ArtworkProvider.kt", i = {}, l = {46}, m = "invokeSuspend", n = {}, s = {})
                /* renamed from: org.videolan.vlc.ArtworkProvider$getPlayAllImage$bitmap$1$invokeSuspend$$inlined$getFromMl$3$1$1  reason: invalid class name */
                /* compiled from: Extensions.kt */
