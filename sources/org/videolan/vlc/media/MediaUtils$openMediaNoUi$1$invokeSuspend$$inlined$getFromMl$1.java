...
@DebugMetadata(c = "org.videolan.vlc.media.MediaUtils$openMediaNoUi$1$invokeSuspend$$inlined$getFromMl$1", f = "MediaUtils.kt", i = {0, 0, 0}, l = {338}, m = "invokeSuspend", n = {"$this$withContext", "ml", "scan"}, s = {"L$0", "L$1", "I$0"})
...
public final class MediaUtils$openMediaNoUi$1$invokeSuspend$$inlined$getFromMl$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super MediaWrapper>, Object> {
    ...
    public MediaUtils$openMediaNoUi$1$invokeSuspend$$inlined$getFromMl$1(Context context, Continuation continuation, long j) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        MediaUtils$openMediaNoUi$1$invokeSuspend$$inlined$getFromMl$1 mediaUtils$openMediaNoUi$1$invokeSuspend$$inlined$getFromMl$1 = new MediaUtils$openMediaNoUi$1$invokeSuspend$$inlined$getFromMl$1(this.$this_getFromMl, continuation, this.$id$inlined);
        mediaUtils$openMediaNoUi$1$invokeSuspend$$inlined$getFromMl$1.L$0 = obj;
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            final AnonymousClass1 r4 = new Medialibrary.OnMedialibraryReadyListener() {
                ...
                @DebugMetadata(c = "org.videolan.vlc.media.MediaUtils$openMediaNoUi$1$invokeSuspend$$inlined$getFromMl$1$1$1", f = "MediaUtils.kt", i = {}, l = {46}, m = "invokeSuspend", n = {}, s = {})
                /* renamed from: org.videolan.vlc.media.MediaUtils$openMediaNoUi$1$invokeSuspend$$inlined$getFromMl$1$1$1  reason: invalid class name */
                /* compiled from: Extensions.kt */
