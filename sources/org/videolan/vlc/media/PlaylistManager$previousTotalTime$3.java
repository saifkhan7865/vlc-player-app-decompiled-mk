...
final class PlaylistManager$previousTotalTime$3 extends Lambda implements Function1<MediaWrapper, Long> {
    public static final PlaylistManager$previousTotalTime$3 INSTANCE = new PlaylistManager$previousTotalTime$3();

    PlaylistManager$previousTotalTime$3() {
        super(1);
    }
