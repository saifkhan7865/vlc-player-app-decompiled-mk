...
@DebugMetadata(c = "org.videolan.vlc.media.MediaUtils$openPlaylist$1$invokeSuspend$$inlined$getFromMl$1", f = "MediaUtils.kt", i = {0, 0, 0}, l = {338}, m = "invokeSuspend", n = {"$this$withContext", "ml", "scan"}, s = {"L$0", "L$1", "I$0"})
/* compiled from: Extensions.kt */
public final class MediaUtils$openPlaylist$1$invokeSuspend$$inlined$getFromMl$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Playlist>, Object> {
    final /* synthetic */ long $playlistId$inlined;
    ...
    public MediaUtils$openPlaylist$1$invokeSuspend$$inlined$getFromMl$1(Context context, Continuation continuation, long j) {
        super(2, continuation);
        this.$this_getFromMl = context;
        this.$playlistId$inlined = j;
    }

    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        MediaUtils$openPlaylist$1$invokeSuspend$$inlined$getFromMl$1 mediaUtils$openPlaylist$1$invokeSuspend$$inlined$getFromMl$1 = new MediaUtils$openPlaylist$1$invokeSuspend$$inlined$getFromMl$1(this.$this_getFromMl, continuation, this.$playlistId$inlined);
        mediaUtils$openPlaylist$1$invokeSuspend$$inlined$getFromMl$1.L$0 = obj;
        return mediaUtils$openPlaylist$1$invokeSuspend$$inlined$getFromMl$1;
    }

    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Playlist> continuation) {
        return ((MediaUtils$openPlaylist$1$invokeSuspend$$inlined$getFromMl$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            if (instance.isStarted()) {
                return instance.getPlaylist(this.$playlistId$inlined, Settings.INSTANCE.getIncludeMissing(), false);
            }
            ...
            final long j = this.$playlistId$inlined;
            ...
            final AnonymousClass1 r4 = new Medialibrary.OnMedialibraryReadyListener() {
                ...
                @DebugMetadata(c = "org.videolan.vlc.media.MediaUtils$openPlaylist$1$invokeSuspend$$inlined$getFromMl$1$1$1", f = "MediaUtils.kt", i = {}, l = {46}, m = "invokeSuspend", n = {}, s = {})
                /* renamed from: org.videolan.vlc.media.MediaUtils$openPlaylist$1$invokeSuspend$$inlined$getFromMl$1$1$1  reason: invalid class name */
                /* compiled from: Extensions.kt */
                public static final class AnonymousClass1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
                    ...
                    public final Object invokeSuspend(Object obj) {
                        ...
                        if (i == 0) {
                            ...
                            cancellableContinuation.resumeWith(Result.m1774constructorimpl(medialibrary.getPlaylist(j, Settings.INSTANCE.getIncludeMissing(), false)));
                            this.label = 1;
