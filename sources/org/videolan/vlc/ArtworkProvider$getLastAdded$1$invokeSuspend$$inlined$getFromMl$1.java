...
@DebugMetadata(c = "org.videolan.vlc.ArtworkProvider$getLastAdded$1$invokeSuspend$$inlined$getFromMl$1", f = "ArtworkProvider.kt", i = {0, 0, 0}, l = {338}, m = "invokeSuspend", n = {"$this$withContext", "ml", "scan"}, s = {"L$0", "L$1", "I$0"})
/* compiled from: Extensions.kt */
public final class ArtworkProvider$getLastAdded$1$invokeSuspend$$inlined$getFromMl$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super MediaWrapper[]>, Object> {
    ...
    public ArtworkProvider$getLastAdded$1$invokeSuspend$$inlined$getFromMl$1(Context context, Continuation continuation) {
        super(2, continuation);
        this.$this_getFromMl = context;
    }

    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        ArtworkProvider$getLastAdded$1$invokeSuspend$$inlined$getFromMl$1 artworkProvider$getLastAdded$1$invokeSuspend$$inlined$getFromMl$1 = new ArtworkProvider$getLastAdded$1$invokeSuspend$$inlined$getFromMl$1(this.$this_getFromMl, continuation);
        artworkProvider$getLastAdded$1$invokeSuspend$$inlined$getFromMl$1.L$0 = obj;
        return artworkProvider$getLastAdded$1$invokeSuspend$$inlined$getFromMl$1;
    }

    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super MediaWrapper[]> continuation) {
        return ((ArtworkProvider$getLastAdded$1$invokeSuspend$$inlined$getFromMl$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            final AnonymousClass1 r5 = new Medialibrary.OnMedialibraryReadyListener() {
                ...
                @DebugMetadata(c = "org.videolan.vlc.ArtworkProvider$getLastAdded$1$invokeSuspend$$inlined$getFromMl$1$1$1", f = "ArtworkProvider.kt", i = {}, l = {46}, m = "invokeSuspend", n = {}, s = {})
                /* renamed from: org.videolan.vlc.ArtworkProvider$getLastAdded$1$invokeSuspend$$inlined$getFromMl$1$1$1  reason: invalid class name */
                /* compiled from: Extensions.kt */
