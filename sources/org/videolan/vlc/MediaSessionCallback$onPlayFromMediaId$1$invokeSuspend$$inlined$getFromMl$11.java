...
@DebugMetadata(c = "org.videolan.vlc.MediaSessionCallback$onPlayFromMediaId$1$invokeSuspend$$inlined$getFromMl$11", f = "MediaSessionCallback.kt", i = {0, 0, 0}, l = {338}, m = "invokeSuspend", n = {"$this$withContext", "ml", "scan"}, s = {"L$0", "L$1", "I$0"})
/* compiled from: Extensions.kt */
public final class MediaSessionCallback$onPlayFromMediaId$1$invokeSuspend$$inlined$getFromMl$11 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super MediaWrapper[]>, Object> {
    ...
    public MediaSessionCallback$onPlayFromMediaId$1$invokeSuspend$$inlined$getFromMl$11(Context context, Continuation continuation, long j) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        MediaSessionCallback$onPlayFromMediaId$1$invokeSuspend$$inlined$getFromMl$11 mediaSessionCallback$onPlayFromMediaId$1$invokeSuspend$$inlined$getFromMl$11 = new MediaSessionCallback$onPlayFromMediaId$1$invokeSuspend$$inlined$getFromMl$11(this.$this_getFromMl, continuation, this.$id$inlined);
        mediaSessionCallback$onPlayFromMediaId$1$invokeSuspend$$inlined$getFromMl$11.L$0 = obj;
        return mediaSessionCallback$onPlayFromMediaId$1$invokeSuspend$$inlined$getFromMl$11;
    }

    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super MediaWrapper[]> continuation) {
        return ((MediaSessionCallback$onPlayFromMediaId$1$invokeSuspend$$inlined$getFromMl$11) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            if (instance.isStarted()) {
                MediaWrapper media = instance.getMedia(this.$id$inlined);
                if (media != null) {
            ...
            final AnonymousClass1 r4 = new Medialibrary.OnMedialibraryReadyListener() {
                ...
                @DebugMetadata(c = "org.videolan.vlc.MediaSessionCallback$onPlayFromMediaId$1$invokeSuspend$$inlined$getFromMl$11$1$1", f = "MediaSessionCallback.kt", i = {}, l = {46}, m = "invokeSuspend", n = {}, s = {})
                /* renamed from: org.videolan.vlc.MediaSessionCallback$onPlayFromMediaId$1$invokeSuspend$$inlined$getFromMl$11$1$1  reason: invalid class name */
                /* compiled from: Extensions.kt */
                public static final class AnonymousClass1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
                    ...
                    public final Object invokeSuspend(Object obj) {
                        ...
                        if (i == 0) {
                            ...
                            MediaWrapper media = medialibrary.getMedia(j);
                            continuation.resumeWith(Result.m1774constructorimpl(media != null ? media.getTracks() : null));
                            this.label = 1;
