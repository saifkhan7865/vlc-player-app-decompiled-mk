...
final class RemoteAccessServer$generateServer$2$2 extends Lambda implements Function1<Application, Unit> {
    final /* synthetic */ RemoteAccessServer this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    RemoteAccessServer$generateServer$2$2(RemoteAccessServer remoteAccessServer) {
        super(1);
    ...
    static final class AnonymousClass1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (this.label == 0) {
                ...
                PlaylistManager.Companion.getShowAudioPlayer().removeObserver(remoteAccessServer.miniPlayerObserver);
                DialogActivity.Companion.getLoginDialogShown().removeObserver(remoteAccessServer.loginObserver);
    ...
    public final void invoke(Application application) {
        ...
        this.this$0._serverStatus.postValue(ServerStatus.STOPPED);
    }
}
