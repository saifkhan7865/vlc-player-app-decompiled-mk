...
public final class RemoteAccessOnboardingOtpFragment$onViewCreated$$inlined$doOnEnd$1 implements Animator.AnimatorListener {
    ...
    public RemoteAccessOnboardingOtpFragment$onViewCreated$$inlined$doOnEnd$1(RemoteAccessOnboardingOtpFragment remoteAccessOnboardingOtpFragment, int i, Ref.IntRef intRef) {
    ...
    public void onAnimationEnd(Animator animator) {
        Job unused = BuildersKt__Builders_commonKt.launch$default(LifecycleOwnerKt.getLifecycleScope(this.this$0), (CoroutineContext) null, (CoroutineStart) null, new RemoteAccessOnboardingOtpFragment$onViewCreated$2$1(this.this$0, this.$orange$inlined, this.$iteration$inlined, (Continuation<? super RemoteAccessOnboardingOtpFragment$onViewCreated$2$1>) null), 3, (Object) null);
    }
}
