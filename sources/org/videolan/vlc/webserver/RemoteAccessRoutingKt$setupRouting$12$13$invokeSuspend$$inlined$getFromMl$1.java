...
@DebugMetadata(c = "org.videolan.vlc.webserver.RemoteAccessRoutingKt$setupRouting$12$13$invokeSuspend$$inlined$getFromMl$1", f = "RemoteAccessRouting.kt", i = {0, 0, 0}, l = {350}, m = "invokeSuspend", n = {"$this$withContext", "ml", "scan"}, s = {"L$0", "L$1", "I$0"})
/* compiled from: Extensions.kt */
public final class RemoteAccessRoutingKt$setupRouting$12$13$invokeSuspend$$inlined$getFromMl$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super MediaWrapper[]>, Object> {
    ...
    public RemoteAccessRoutingKt$setupRouting$12$13$invokeSuspend$$inlined$getFromMl$1(Context context, Continuation continuation, String str, Long l) {
        super(2, continuation);
        this.$this_getFromMl = context;
        this.$mediaType$inlined = str;
        this.$mediaId$inlined = l;
    }

    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        RemoteAccessRoutingKt$setupRouting$12$13$invokeSuspend$$inlined$getFromMl$1 remoteAccessRoutingKt$setupRouting$12$13$invokeSuspend$$inlined$getFromMl$1 = new RemoteAccessRoutingKt$setupRouting$12$13$invokeSuspend$$inlined$getFromMl$1(this.$this_getFromMl, continuation, this.$mediaType$inlined, this.$mediaId$inlined);
        remoteAccessRoutingKt$setupRouting$12$13$invokeSuspend$$inlined$getFromMl$1.L$0 = obj;
        return remoteAccessRoutingKt$setupRouting$12$13$invokeSuspend$$inlined$getFromMl$1;
    }

    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super MediaWrapper[]> continuation) {
        return ((RemoteAccessRoutingKt$setupRouting$12$13$invokeSuspend$$inlined$getFromMl$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            if (instance.isStarted()) {
                String str = this.$mediaType$inlined;
                switch (str.hashCode()) {
                    case -1797815808:
                        if (str.equals("video-folder")) {
                            Folder folder = instance.getFolder(Folder.TYPE_FOLDER_VIDEO, this.$mediaId$inlined.longValue());
                    ...
                    case -1409097913:
                        if (str.equals(ArtworkProvider.ARTIST)) {
                            return instance.getArtist(this.$mediaId$inlined.longValue()).getTracks();
                        }
                        break;
                    case -56977747:
                        if (str.equals("video-group")) {
                            VideoGroup videoGroup = instance.getVideoGroup(this.$mediaId$inlined.longValue());
                            return videoGroup.media(0, false, false, false, videoGroup.mediaCount(), 0);
                        }
                        break;
                    case 92896879:
                        if (str.equals(ArtworkProvider.ALBUM)) {
                            return instance.getAlbum(this.$mediaId$inlined.longValue()).getTracks();
                        }
                        break;
                    case 98240899:
                        if (str.equals("genre")) {
                            return instance.getGenre(this.$mediaId$inlined.longValue()).getTracks();
                        }
                        break;
                }
                return new MediaWrapper[]{instance.getMedia(this.$mediaId$inlined.longValue())};
            }
            ...
            final String str2 = this.$mediaType$inlined;
            final Long l = this.$mediaId$inlined;
            ...
            final AnonymousClass1 r4 = new Medialibrary.OnMedialibraryReadyListener() {
                ...
                @DebugMetadata(c = "org.videolan.vlc.webserver.RemoteAccessRoutingKt$setupRouting$12$13$invokeSuspend$$inlined$getFromMl$1$1$1", f = "RemoteAccessRouting.kt", i = {}, l = {46}, m = "invokeSuspend", n = {}, s = {})
                /* renamed from: org.videolan.vlc.webserver.RemoteAccessRoutingKt$setupRouting$12$13$invokeSuspend$$inlined$getFromMl$1$1$1  reason: invalid class name */
                /* compiled from: Extensions.kt */
                public static final class AnonymousClass1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
                    int label;

                    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
                        return new AnonymousClass1(cancellableContinuation, medialibrary, this, continuation, str, l);
                    }
                    ...
                    public final java.lang.Object invokeSuspend(java.lang.Object r15) {
                        ...
                        L_0x0018:
                            ...
                            int r4 = r3.hashCode()
                            switch(r4) {
                                case -1797815808: goto L_0x009b;
                                case -1409097913: goto L_0x0083;
                                case -56977747: goto L_0x0062;
                                case 92896879: goto L_0x0048;
                                case 98240899: goto L_0x002e;
                        ...
                        L_0x0052:
                            ...
                            goto L_0x00d2
                        L_0x0062:
                            java.lang.String r4 = "video-group"
                            boolean r3 = r3.equals(r4)
                        ...
                        L_0x00c2:
                            ...
                            java.lang.Long r4 = r10
                            long r4 = r4.longValue()
                            org.videolan.medialibrary.interfaces.media.MediaWrapper r1 = r1.getMedia((long) r4)
                            r4 = 0
                            r3[r4] = r1
                            r1 = r3
                        L_0x00d2:
                        ...
                        L_0x00e5:
                            ...
                            org.videolan.vlc.webserver.RemoteAccessRoutingKt$setupRouting$12$13$invokeSuspend$$inlined$getFromMl$1$1 r0 = r7
                            ...
                            return r15
                        */
                        throw new UnsupportedOperationException("Method not decompiled: org.videolan.vlc.webserver.RemoteAccessRoutingKt$setupRouting$12$13$invokeSuspend$$inlined$getFromMl$1.AnonymousClass1.AnonymousClass1.invokeSuspend(java.lang.Object):java.lang.Object");
                    }
                }
