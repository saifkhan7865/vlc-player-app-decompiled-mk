...
@DebugMetadata(c = "org.videolan.vlc.ArtworkProvider$getPlaylistImage$bitmap$1$invokeSuspend$$inlined$getFromMl$1", f = "ArtworkProvider.kt", i = {0, 0, 0}, l = {338}, m = "invokeSuspend", n = {"$this$withContext", "ml", "scan"}, s = {"L$0", "L$1", "I$0"})
/* compiled from: Extensions.kt */
public final class ArtworkProvider$getPlaylistImage$bitmap$1$invokeSuspend$$inlined$getFromMl$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super List<? extends MediaWrapper>>, Object> {
    ...
    public ArtworkProvider$getPlaylistImage$bitmap$1$invokeSuspend$$inlined$getFromMl$1(Context context, Continuation continuation, long j) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        ArtworkProvider$getPlaylistImage$bitmap$1$invokeSuspend$$inlined$getFromMl$1 artworkProvider$getPlaylistImage$bitmap$1$invokeSuspend$$inlined$getFromMl$1 = new ArtworkProvider$getPlaylistImage$bitmap$1$invokeSuspend$$inlined$getFromMl$1(this.$this_getFromMl, continuation, this.$id$inlined);
        artworkProvider$getPlaylistImage$bitmap$1$invokeSuspend$$inlined$getFromMl$1.L$0 = obj;
        return artworkProvider$getPlaylistImage$bitmap$1$invokeSuspend$$inlined$getFromMl$1;
    }

    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super List<? extends MediaWrapper>> continuation) {
        return ((ArtworkProvider$getPlaylistImage$bitmap$1$invokeSuspend$$inlined$getFromMl$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            if (instance.isStarted()) {
                Playlist playlist = instance.getPlaylist(this.$id$inlined, true, false);
                if (playlist == null || (tracks = playlist.getTracks()) == null) {
                    return null;
                }
                Intrinsics.checkNotNull(tracks);
                return ArraysKt.toList((T[]) tracks);
            }
            ...
            final AnonymousClass1 r4 = new Medialibrary.OnMedialibraryReadyListener() {
                ...
                @DebugMetadata(c = "org.videolan.vlc.ArtworkProvider$getPlaylistImage$bitmap$1$invokeSuspend$$inlined$getFromMl$1$1$1", f = "ArtworkProvider.kt", i = {}, l = {46}, m = "invokeSuspend", n = {}, s = {})
                /* renamed from: org.videolan.vlc.ArtworkProvider$getPlaylistImage$bitmap$1$invokeSuspend$$inlined$getFromMl$1$1$1  reason: invalid class name */
                /* compiled from: Extensions.kt */
                public static final class AnonymousClass1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
                    ...
                    public final Object invokeSuspend(Object obj) {
                        ...
                        if (i == 0) {
                            ...
                            Playlist playlist = medialibrary.getPlaylist(j, true, false);
                            if (playlist == null || (tracks = playlist.getTracks()) == null) {
                                list = null;
                            } else {
                                Intrinsics.checkNotNull(tracks);
                                list = ArraysKt.toList((T[]) tracks);
                            }
                            continuation.resumeWith(Result.m1774constructorimpl(list));
                            this.label = 1;
