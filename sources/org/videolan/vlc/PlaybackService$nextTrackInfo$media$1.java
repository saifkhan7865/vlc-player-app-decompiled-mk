...
final class PlaybackService$nextTrackInfo$media$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super IMedia>, Object> {
    final /* synthetic */ MediaWrapper $mediaWrapper;
    int label;
    final /* synthetic */ PlaybackService this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    PlaybackService$nextTrackInfo$media$1(PlaybackService playbackService, MediaWrapper mediaWrapper, Continuation<? super PlaybackService$nextTrackInfo$media$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new PlaybackService$nextTrackInfo$media$1(this.this$0, this.$mediaWrapper, continuation);
    }

    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super IMedia> continuation) {
        return ((PlaybackService$nextTrackInfo$media$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
