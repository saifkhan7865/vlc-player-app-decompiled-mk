...
final class MainTvFragment$registerDatasets$9 extends Lambda implements Function1<List<? extends MediaLibraryItem>, Unit> {
    final /* synthetic */ MainTvFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    MainTvFragment$registerDatasets$9(MainTvFragment mainTvFragment) {
        super(1);
    ...
    public final void invoke(List<? extends MediaLibraryItem> list) {
        ...
        mainTvFragment.displayPlaylist = !list.isEmpty();
        ArrayObjectAdapter access$getPlaylistAdapter$p = this.this$0.playlistAdapter;
        if (access$getPlaylistAdapter$p == null) {
            Intrinsics.throwUninitializedPropertyAccessException("playlistAdapter");
            access$getPlaylistAdapter$p = null;
        }
        access$getPlaylistAdapter$p.setItems(list, TvUtil.INSTANCE.getDiffCallback());
        this.this$0.resetLines();
        this.this$0.addAndCheckLoadedLines(8);
    }
}
