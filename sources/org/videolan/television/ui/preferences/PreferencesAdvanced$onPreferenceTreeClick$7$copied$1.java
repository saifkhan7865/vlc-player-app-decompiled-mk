...
@DebugMetadata(c = "org.videolan.television.ui.preferences.PreferencesAdvanced$onPreferenceTreeClick$7$copied$1", f = "PreferencesAdvanced.kt", i = {}, l = {}, m = "invokeSuspend", n = {}, s = {})
...
final class PreferencesAdvanced$onPreferenceTreeClick$7$copied$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Boolean>, Object> {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (this.label == 0) {
            ...
            return Boxing.boxBoolean(FileUtils.INSTANCE.copyFile(new File(this.this$0.getActivity().getDir("db", 0).toString() + Medialibrary.VLC_MEDIA_DB_NAME), this.$dst));
        }
