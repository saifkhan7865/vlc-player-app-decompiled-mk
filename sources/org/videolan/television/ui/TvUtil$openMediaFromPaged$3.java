...
final class TvUtil$openMediaFromPaged$3 extends Lambda implements Function2<List<? extends MediaWrapper>, PlaybackService, Unit> {
    final /* synthetic */ FragmentActivity $activity;
    final /* synthetic */ Object $item;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    TvUtil$openMediaFromPaged$3(FragmentActivity fragmentActivity, Object obj) {
        super(2);
    ...
    public final void invoke(List<? extends MediaWrapper> list, PlaybackService playbackService) {
        ...
        TvUtil.INSTANCE.playAudioList(this.$activity, list, KotlinExtensionsKt.getposition(list, this.$item));
    }
}
