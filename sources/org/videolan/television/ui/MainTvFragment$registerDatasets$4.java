...
final class MainTvFragment$registerDatasets$4 extends Lambda implements Function1<List<? extends MediaLibraryItem>, Unit> {
    final /* synthetic */ MainTvFragment this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    MainTvFragment$registerDatasets$4(MainTvFragment mainTvFragment) {
        super(1);
    ...
    public final void invoke(List<? extends MediaLibraryItem> list) {
        ArrayObjectAdapter access$getVideoAdapter$p = this.this$0.videoAdapter;
        if (access$getVideoAdapter$p == null) {
            Intrinsics.throwUninitializedPropertyAccessException("videoAdapter");
            access$getVideoAdapter$p = null;
        }
        access$getVideoAdapter$p.setItems(list, TvUtil.INSTANCE.getDiffCallback());
        this.this$0.addAndCheckLoadedLines(0);
    }
}
