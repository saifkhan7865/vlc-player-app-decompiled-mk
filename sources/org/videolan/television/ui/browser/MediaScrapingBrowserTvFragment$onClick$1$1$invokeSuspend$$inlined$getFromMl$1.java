...
@DebugMetadata(c = "org.videolan.television.ui.browser.MediaScrapingBrowserTvFragment$onClick$1$1$invokeSuspend$$inlined$getFromMl$1", f = "MediaScrapingBrowserTvFragment.kt", i = {0, 0, 0}, l = {338}, m = "invokeSuspend", n = {"$this$withContext", "ml", "scan"}, s = {"L$0", "L$1", "I$0"})
/* compiled from: Extensions.kt */
public final class MediaScrapingBrowserTvFragment$onClick$1$1$invokeSuspend$$inlined$getFromMl$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super MediaWrapper>, Object> {
    ...
    public MediaScrapingBrowserTvFragment$onClick$1$1$invokeSuspend$$inlined$getFromMl$1(Context context, Continuation continuation, long j) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        MediaScrapingBrowserTvFragment$onClick$1$1$invokeSuspend$$inlined$getFromMl$1 mediaScrapingBrowserTvFragment$onClick$1$1$invokeSuspend$$inlined$getFromMl$1 = new MediaScrapingBrowserTvFragment$onClick$1$1$invokeSuspend$$inlined$getFromMl$1(this.$this_getFromMl, continuation, this.$it$inlined);
        mediaScrapingBrowserTvFragment$onClick$1$1$invokeSuspend$$inlined$getFromMl$1.L$0 = obj;
        return mediaScrapingBrowserTvFragment$onClick$1$1$invokeSuspend$$inlined$getFromMl$1;
    }

    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super MediaWrapper> continuation) {
        return ((MediaScrapingBrowserTvFragment$onClick$1$1$invokeSuspend$$inlined$getFromMl$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            final AnonymousClass1 r4 = new Medialibrary.OnMedialibraryReadyListener() {
                ...
                @DebugMetadata(c = "org.videolan.television.ui.browser.MediaScrapingBrowserTvFragment$onClick$1$1$invokeSuspend$$inlined$getFromMl$1$1$1", f = "MediaScrapingBrowserTvFragment.kt", i = {}, l = {46}, m = "invokeSuspend", n = {}, s = {})
                /* renamed from: org.videolan.television.ui.browser.MediaScrapingBrowserTvFragment$onClick$1$1$invokeSuspend$$inlined$getFromMl$1$1$1  reason: invalid class name */
                /* compiled from: Extensions.kt */
