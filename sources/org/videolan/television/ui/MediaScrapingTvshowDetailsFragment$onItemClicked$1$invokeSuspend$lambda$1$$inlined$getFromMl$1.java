...
@DebugMetadata(c = "org.videolan.television.ui.MediaScrapingTvshowDetailsFragment$onItemClicked$1$invokeSuspend$lambda$1$$inlined$getFromMl$1", f = "MediaScrapingTvshowDetailsFragment.kt", i = {0, 0, 0}, l = {338}, m = "invokeSuspend", n = {"$this$withContext", "ml", "scan"}, s = {"L$0", "L$1", "I$0"})
/* compiled from: Extensions.kt */
public final class MediaScrapingTvshowDetailsFragment$onItemClicked$1$invokeSuspend$lambda$1$$inlined$getFromMl$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super MediaWrapper>, Object> {
    ...
    public MediaScrapingTvshowDetailsFragment$onItemClicked$1$invokeSuspend$lambda$1$$inlined$getFromMl$1(Context context, Continuation continuation, long j) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        MediaScrapingTvshowDetailsFragment$onItemClicked$1$invokeSuspend$lambda$1$$inlined$getFromMl$1 mediaScrapingTvshowDetailsFragment$onItemClicked$1$invokeSuspend$lambda$1$$inlined$getFromMl$1 = new MediaScrapingTvshowDetailsFragment$onItemClicked$1$invokeSuspend$lambda$1$$inlined$getFromMl$1(this.$this_getFromMl, continuation, this.$it$inlined);
        mediaScrapingTvshowDetailsFragment$onItemClicked$1$invokeSuspend$lambda$1$$inlined$getFromMl$1.L$0 = obj;
        return mediaScrapingTvshowDetailsFragment$onItemClicked$1$invokeSuspend$lambda$1$$inlined$getFromMl$1;
    }

    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super MediaWrapper> continuation) {
        return ((MediaScrapingTvshowDetailsFragment$onItemClicked$1$invokeSuspend$lambda$1$$inlined$getFromMl$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            if (instance.isStarted()) {
                return instance.getMedia(this.$it$inlined);
            }
            ...
            final AnonymousClass1 r4 = new Medialibrary.OnMedialibraryReadyListener() {
                ...
                @DebugMetadata(c = "org.videolan.television.ui.MediaScrapingTvshowDetailsFragment$onItemClicked$1$invokeSuspend$lambda$1$$inlined$getFromMl$1$1$1", f = "MediaScrapingTvshowDetailsFragment.kt", i = {}, l = {46}, m = "invokeSuspend", n = {}, s = {})
                /* renamed from: org.videolan.television.ui.MediaScrapingTvshowDetailsFragment$onItemClicked$1$invokeSuspend$lambda$1$$inlined$getFromMl$1$1$1  reason: invalid class name */
                /* compiled from: Extensions.kt */
