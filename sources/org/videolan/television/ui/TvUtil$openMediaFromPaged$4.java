...
final class TvUtil$openMediaFromPaged$4 extends Lambda implements Function1<PlaybackService, List<? extends MediaWrapper>> {
    final /* synthetic */ MedialibraryProvider<? extends MediaLibraryItem> $provider;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    TvUtil$openMediaFromPaged$4(MedialibraryProvider<? extends MediaLibraryItem> medialibraryProvider) {
        super(1);
    ...
    public final List<MediaWrapper> invoke(PlaybackService playbackService) {
        ...
        List list = ArraysKt.toList((T[]) this.$provider.getAll());
