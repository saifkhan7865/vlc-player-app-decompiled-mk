...
@DebugMetadata(c = "org.videolan.television.viewmodel.MainTvModel$updateRecentlyPlayed$1$invokeSuspend$$inlined$getFromMl$1", f = "MainTvModel.kt", i = {0, 0, 0}, l = {338}, m = "invokeSuspend", n = {"$this$withContext", "ml", "scan"}, s = {"L$0", "L$1", "I$0"})
/* compiled from: Extensions.kt */
public final class MainTvModel$updateRecentlyPlayed$1$invokeSuspend$$inlined$getFromMl$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super List<MediaWrapper>>, Object> {
    ...
    public MainTvModel$updateRecentlyPlayed$1$invokeSuspend$$inlined$getFromMl$1(Context context, Continuation continuation) {
        super(2, continuation);
        this.$this_getFromMl = context;
    }

    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        MainTvModel$updateRecentlyPlayed$1$invokeSuspend$$inlined$getFromMl$1 mainTvModel$updateRecentlyPlayed$1$invokeSuspend$$inlined$getFromMl$1 = new MainTvModel$updateRecentlyPlayed$1$invokeSuspend$$inlined$getFromMl$1(this.$this_getFromMl, continuation);
        mainTvModel$updateRecentlyPlayed$1$invokeSuspend$$inlined$getFromMl$1.L$0 = obj;
        return mainTvModel$updateRecentlyPlayed$1$invokeSuspend$$inlined$getFromMl$1;
    }

    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super List<MediaWrapper>> continuation) {
        return ((MainTvModel$updateRecentlyPlayed$1$invokeSuspend$$inlined$getFromMl$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            final AnonymousClass1 r5 = new Medialibrary.OnMedialibraryReadyListener() {
                ...
                @DebugMetadata(c = "org.videolan.television.viewmodel.MainTvModel$updateRecentlyPlayed$1$invokeSuspend$$inlined$getFromMl$1$1$1", f = "MainTvModel.kt", i = {}, l = {46}, m = "invokeSuspend", n = {}, s = {})
                /* renamed from: org.videolan.television.viewmodel.MainTvModel$updateRecentlyPlayed$1$invokeSuspend$$inlined$getFromMl$1$1$1  reason: invalid class name */
                /* compiled from: Extensions.kt */
                public static final class AnonymousClass1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
                    ...
                    public final Object invokeSuspend(Object obj) {
                        ...
                        if (i == 0) {
                            ...
                            Intrinsics.checkNotNullExpressionValue(history, "history(...)");
                            cancellableContinuation.resumeWith(Result.m1774constructorimpl(ArraysKt.toMutableList((T[]) (Object[]) history)));
                            this.label = 1;
