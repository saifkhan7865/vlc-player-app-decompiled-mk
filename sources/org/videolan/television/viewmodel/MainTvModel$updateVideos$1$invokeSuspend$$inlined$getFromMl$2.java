...
@DebugMetadata(c = "org.videolan.television.viewmodel.MainTvModel$updateVideos$1$invokeSuspend$$inlined$getFromMl$2", f = "MainTvModel.kt", i = {0, 0, 0}, l = {338}, m = "invokeSuspend", n = {"$this$withContext", "ml", "scan"}, s = {"L$0", "L$1", "I$0"})
/* compiled from: Extensions.kt */
public final class MainTvModel$updateVideos$1$invokeSuspend$$inlined$getFromMl$2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super MediaWrapper[]>, Object> {
    ...
    public MainTvModel$updateVideos$1$invokeSuspend$$inlined$getFromMl$2(Context context, Continuation continuation) {
        super(2, continuation);
        this.$this_getFromMl = context;
    }

    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        MainTvModel$updateVideos$1$invokeSuspend$$inlined$getFromMl$2 mainTvModel$updateVideos$1$invokeSuspend$$inlined$getFromMl$2 = new MainTvModel$updateVideos$1$invokeSuspend$$inlined$getFromMl$2(this.$this_getFromMl, continuation);
        mainTvModel$updateVideos$1$invokeSuspend$$inlined$getFromMl$2.L$0 = obj;
        return mainTvModel$updateVideos$1$invokeSuspend$$inlined$getFromMl$2;
    }

    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super MediaWrapper[]> continuation) {
        return ((MainTvModel$updateVideos$1$invokeSuspend$$inlined$getFromMl$2) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            if (instance.isStarted()) {
                return instance.getPagedVideos(3, true, true, false, 5, 0);
            }
            ...
            final AnonymousClass1 r5 = new Medialibrary.OnMedialibraryReadyListener() {
                ...
                @DebugMetadata(c = "org.videolan.television.viewmodel.MainTvModel$updateVideos$1$invokeSuspend$$inlined$getFromMl$2$1$1", f = "MainTvModel.kt", i = {}, l = {46}, m = "invokeSuspend", n = {}, s = {})
                /* renamed from: org.videolan.television.viewmodel.MainTvModel$updateVideos$1$invokeSuspend$$inlined$getFromMl$2$1$1  reason: invalid class name */
                /* compiled from: Extensions.kt */
                public static final class AnonymousClass1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
                    ...
                    public final Object invokeSuspend(Object obj) {
                        ...
                        if (i == 0) {
                            ...
                            cancellableContinuation.resumeWith(Result.m1774constructorimpl(medialibrary.getPagedVideos(3, true, true, false, 5, 0)));
                            this.label = 1;
