...
public class BottomSheetBehavior<V extends View> extends CoordinatorLayout.Behavior<V> implements MaterialBackHandler {
    ...
    private final ViewDragHelper.Callback dragCallback = new ViewDragHelper.Callback() {
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:10:0x003e, code lost:
            if (r9 > r7.this$0.halfExpandedOffset) goto L_0x0136;
         */
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:36:0x00d4, code lost:
            if (r7.this$0.shouldSkipHalfExpandedStateWhenDragging() == false) goto L_0x0136;
         */
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:46:0x0114, code lost:
            if (r7.this$0.shouldSkipHalfExpandedStateWhenDragging() != false) goto L_0x00b2;
         */
        /* JADX WARNING: Code restructure failed: missing block: B:50:0x0132, code lost:
            if (r7.this$0.shouldSkipHalfExpandedStateWhenDragging() == false) goto L_0x0136;
         */
        /* JADX WARNING: Code restructure failed: missing block: B:8:0x0037, code lost:
            if (r7.this$0.shouldExpandOnUpwardDrag(r3, (((float) r9) * 100.0f) / ((float) r7.this$0.parentHeight)) != false) goto L_0x0010;
         */
    ...
    private float calculateInterpolationWithCornersRemoved() {
        ...
        if (!isAtTopOfScreen() || (m = WindowIdApi18$$ExternalSyntheticApiModelOutline0.m(view)) == null) {
            return 0.0f;
        }
        return Math.max(calculateCornerInterpolation(this.materialShapeDrawable.getTopLeftCornerResolvedSize(), m.getRoundedCorner(0)), calculateCornerInterpolation(this.materialShapeDrawable.getTopRightCornerResolvedSize(), m.getRoundedCorner(1)));
    }

    private float calculateCornerInterpolation(float f, RoundedCorner roundedCorner) {
        if (roundedCorner != null) {
            float m = (float) roundedCorner.getRadius();
            if (m > 0.0f && f > 0.0f) {
                return m / f;
            }
        }
        ...
        if (this.paddingBottomSystemWindowInsets || this.paddingLeftSystemWindowInsets || this.paddingRightSystemWindowInsets || this.marginLeftSystemWindowInsets || this.marginRightSystemWindowInsets || this.marginTopSystemWindowInsets || z) {
            ViewUtils.doOnApplyWindowInsets(view, new ViewUtils.OnApplyWindowInsetsListener() {
                ...
                public androidx.core.view.WindowInsetsCompat onApplyWindowInsets(android.view.View r11, androidx.core.view.WindowInsetsCompat r12, com.google.android.material.internal.ViewUtils.RelativePadding r13) {
                    ...
                    L_0x0041:
                        com.google.android.material.bottomsheet.BottomSheetBehavior r6 = com.google.android.material.bottomsheet.BottomSheetBehavior.this
                        boolean r6 = r6.paddingLeftSystemWindowInsets
                    ...
                    L_0x0066:
                        ...
                        com.google.android.material.bottomsheet.BottomSheetBehavior r2 = com.google.android.material.bottomsheet.BottomSheetBehavior.this
                        boolean r2 = r2.marginLeftSystemWindowInsets
                        r6 = 1
                        r7 = 0
                    ...
                    L_0x0083:
                        ...
                        boolean r8 = r8.marginRightSystemWindowInsets
                    ...
                    L_0x00af:
                        ...
                        int r13 = r1.bottom
                        int unused = r11.gestureInsetBottom = r13
                    L_0x00c1:
                        com.google.android.material.bottomsheet.BottomSheetBehavior r11 = com.google.android.material.bottomsheet.BottomSheetBehavior.this
                        boolean r11 = r11.paddingBottomSystemWindowInsets
                        if (r11 != 0) goto L_0x00cd
                        boolean r11 = r0
                        if (r11 == 0) goto L_0x00d2
                    L_0x00cd:
                        com.google.android.material.bottomsheet.BottomSheetBehavior r11 = com.google.android.material.bottomsheet.BottomSheetBehavior.this
                        r11.updatePeekHeight(r7)
                    L_0x00d2:
                        return r12
                    */
