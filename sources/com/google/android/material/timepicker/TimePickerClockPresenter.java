...
class TimePickerClockPresenter implements ClockHandView.OnRotateListener, TimePickerView.OnSelectionChange, TimePickerView.OnPeriodChangeListener, ClockHandView.OnActionUpListener, TimePickerPresenter {
    ...
    private static final String[] HOUR_CLOCK_24_VALUES = {"00", DiskLruCache.VERSION_1, "2", "3", "4", "5", Constants.GROUP_VIDEOS_NAME, "7", "8", "9", "10", "11", "12", "13", "14", "15", AnsiConsole.JANSI_COLORS_16, "17", "18", "19", "20", "21", NetworkServerDialog.SFTP_DEFAULT_PORT, "23"};
    private static final String[] HOUR_CLOCK_VALUES = {"12", DiskLruCache.VERSION_1, "2", "3", "4", "5", Constants.GROUP_VIDEOS_NAME, "7", "8", "9", "10", "11"};
    ...
    private int getHourRotation() {
        return (this.time.getHourForDisplay() * 30) % Spread.ROUND;
    }
}
