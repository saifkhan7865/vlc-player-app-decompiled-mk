...
public final class MaterialContainerTransform extends Transition {
    ...
    private static void captureValues(TransitionValues transitionValues, View view, int i, ShapeAppearanceModel shapeAppearanceModel) {
        if (i != -1) {
            transitionValues.view = TransitionUtils.findDescendantOrAncestorById(FragmentUtil$$ExternalSyntheticApiModelOutline0.m(transitionValues), i);
        } else if (view != null) {
            transitionValues.view = view;
        } else if (FragmentUtil$$ExternalSyntheticApiModelOutline0.m(transitionValues).getTag(R.id.mtrl_motion_snapshot_view) instanceof View) {
            FragmentUtil$$ExternalSyntheticApiModelOutline0.m(transitionValues).setTag(R.id.mtrl_motion_snapshot_view, (Object) null);
            transitionValues.view = (View) FragmentUtil$$ExternalSyntheticApiModelOutline0.m(transitionValues).getTag(R.id.mtrl_motion_snapshot_view);
        }
        View m = FragmentUtil$$ExternalSyntheticApiModelOutline0.m(transitionValues);
        if (ViewCompat.isLaidOut(m) || m.getWidth() != 0 || m.getHeight() != 0) {
            RectF relativeBounds = m.getParent() == null ? TransitionUtils.getRelativeBounds(m) : TransitionUtils.getLocationOnScreen(m);
            FragmentUtil$$ExternalSyntheticApiModelOutline0.m(transitionValues).put(PROP_BOUNDS, relativeBounds);
            FragmentUtil$$ExternalSyntheticApiModelOutline0.m(transitionValues).put(PROP_SHAPE_APPEARANCE, captureShapeAppearance(m, relativeBounds, shapeAppearanceModel));
        }
    }
    ...
    public Animator createAnimator(ViewGroup viewGroup, TransitionValues transitionValues, TransitionValues transitionValues2) {
        ...
        if (!(transitionValues == null || transitionValues2 == null)) {
            RectF rectF = (RectF) FragmentUtil$$ExternalSyntheticApiModelOutline0.m(transitionValues).get(PROP_BOUNDS);
            ShapeAppearanceModel shapeAppearanceModel = (ShapeAppearanceModel) FragmentUtil$$ExternalSyntheticApiModelOutline0.m(transitionValues).get(PROP_SHAPE_APPEARANCE);
            if (rectF == null || shapeAppearanceModel == null) {
                Log.w(TAG, "Skipping due to null start bounds. Ensure start view is laid out and measured.");
            } else {
                RectF rectF2 = (RectF) FragmentUtil$$ExternalSyntheticApiModelOutline0.m(transitionValues2).get(PROP_BOUNDS);
                ShapeAppearanceModel shapeAppearanceModel2 = (ShapeAppearanceModel) FragmentUtil$$ExternalSyntheticApiModelOutline0.m(transitionValues2).get(PROP_SHAPE_APPEARANCE);
                if (rectF2 == null || shapeAppearanceModel2 == null) {
                    Log.w(TAG, "Skipping due to null end bounds. Ensure end view is laid out and measured.");
                    return null;
                }
                final View m = FragmentUtil$$ExternalSyntheticApiModelOutline0.m(transitionValues);
                final View m2 = FragmentUtil$$ExternalSyntheticApiModelOutline0.m(transitionValues2);
                View view3 = m2.getParent() != null ? m2 : m;
                if (this.drawingViewId == view3.getId()) {
                    view = (View) view3.getParent();
                    view2 = view3;
                } else {
                    view = TransitionUtils.findAncestorById(view3, this.drawingViewId);
                }
                ...
                if (!this.appliedThemeValues) {
                    maybeApplyThemeValues(view3.getContext(), isEntering);
                }
                final TransitionDrawable transitionDrawable = new TransitionDrawable(Chip$$ExternalSyntheticApiModelOutline1.m(this), m, rectF, shapeAppearanceModel, getElevationOrDefault(this.startElevation, m), m2, rectF2, shapeAppearanceModel2, getElevationOrDefault(this.endElevation, m2), this.containerColor, this.startContainerColor, this.endContainerColor, this.scrimColor, isEntering, this.elevationShadowEnabled, FadeModeEvaluators.get(this.fadeMode, isEntering), FitModeEvaluators.get(this.fitMode, isEntering, rectF, rectF2), buildThresholdsGroup(isEntering), this.drawDebugEnabled);
                ...
                Transition unused = addListener(new TransitionListenerAdapter() {
                    ...
                    public void onTransitionEnd(Transition transition) {
                        Transition unused = MaterialContainerTransform.this.removeListener(this);
    ...
    private ProgressThresholdsGroup buildThresholdsGroup(boolean z) {
        PathMotion m = Chip$$ExternalSyntheticApiModelOutline1.m(this);
        if (Chip$$ExternalSyntheticApiModelOutline1.m$1((Object) m) || (m instanceof MaterialArcMotion)) {
