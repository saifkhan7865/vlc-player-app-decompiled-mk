...
public class CollapsingToolbarLayout extends FrameLayout {
    ...
    private static boolean isToolbar(View view) {
        return (view instanceof Toolbar) || (Build.VERSION.SDK_INT >= 21 && WindowIdApi18$$ExternalSyntheticApiModelOutline0.m$1((Object) view));
    }
    ...
    private void updateCollapsedBounds(boolean z) {
        ...
        } else if (Build.VERSION.SDK_INT < 24 || !WindowIdApi18$$ExternalSyntheticApiModelOutline0.m$1((Object) this.toolbar)) {
            i3 = 0;
            i4 = 0;
            i2 = 0;
            i = 0;
        } else {
            android.widget.Toolbar m = WindowIdApi18$$ExternalSyntheticApiModelOutline0.m((Object) this.toolbar);
            i3 = WindowIdApi18$$ExternalSyntheticApiModelOutline0.m(m);
            i2 = m.getTitleMarginEnd();
            i = m.getTitleMarginTop();
            i4 = m.getTitleMarginBottom();
        }
    ...
    private static CharSequence getToolbarTitle(View view) {
        ...
        if (Build.VERSION.SDK_INT < 21 || !WindowIdApi18$$ExternalSyntheticApiModelOutline0.m$1((Object) view)) {
            return null;
        }
        return WindowIdApi18$$ExternalSyntheticApiModelOutline0.m(WindowIdApi18$$ExternalSyntheticApiModelOutline0.m((Object) view));
    }
