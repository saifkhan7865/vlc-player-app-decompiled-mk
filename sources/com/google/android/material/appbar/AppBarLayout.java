...
public class AppBarLayout extends LinearLayout implements CoordinatorLayout.AttachedBehavior {
    ...
    public AppBarLayout(android.content.Context r11, android.util.AttributeSet r12, int r13) {
        /*
            ...
            android.view.ViewOutlineProvider r0 = androidx.transition.WindowIdApi18$$ExternalSyntheticApiModelOutline0.m((com.google.android.material.appbar.AppBarLayout) r10)
    ...
    private void initializeLiftOnScrollWithColor(MaterialShapeDrawable materialShapeDrawable, ColorStateList colorStateList, ColorStateList colorStateList2) {
        this.liftOnScrollColorUpdateListener = new AppBarLayout$$ExternalSyntheticLambda3(this, colorStateList, colorStateList2, materialShapeDrawable, MaterialColors.getColorOrNull(getContext(), R.attr.colorSurface));
    ...
    public /* synthetic */ void m1342lambda$initializeLiftOnScrollWithColor$0$comgoogleandroidmaterialappbarAppBarLayout(ColorStateList colorStateList, ColorStateList colorStateList2, MaterialShapeDrawable materialShapeDrawable, Integer num, ValueAnimator valueAnimator) {
        Integer num2;
    ...
    private void initializeLiftOnScrollWithElevation(Context context, MaterialShapeDrawable materialShapeDrawable) {
        ...
        this.liftOnScrollColorUpdateListener = new AppBarLayout$$ExternalSyntheticLambda4(this, materialShapeDrawable);
        ViewCompat.setBackground(this, materialShapeDrawable);
    }
    ...
    public /* synthetic */ void m1343lambda$initializeLiftOnScrollWithElevation$1$comgoogleandroidmaterialappbarAppBarLayout(MaterialShapeDrawable materialShapeDrawable, ValueAnimator valueAnimator) {
    ...
    protected static class BaseBehavior<T extends AppBarLayout> extends HeaderBehavior<T> {
        ...
        private void updateAppBarLayoutDrawableState(CoordinatorLayout coordinatorLayout, T t, int i, int i2, boolean z) {
            ...
            if (z || (liftedState && shouldJumpElevationState(coordinatorLayout, t))) {
                ...
                if (Build.VERSION.SDK_INT >= 23 && WindowIdApi18$$ExternalSyntheticApiModelOutline0.m((AppBarLayout) t) != null) {
                    WindowIdApi18$$ExternalSyntheticApiModelOutline0.m((AppBarLayout) t).jumpToCurrentState();
                }
                if (Build.VERSION.SDK_INT >= 21 && WindowIdApi18$$ExternalSyntheticApiModelOutline0.m((AppBarLayout) t) != null) {
                    WindowIdApi18$$ExternalSyntheticApiModelOutline0.m((AppBarLayout) t).jumpToCurrentState();
                }
            }
        }
