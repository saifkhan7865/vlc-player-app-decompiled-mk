...
public final class MaterialBackOrchestrator {
    ...
    private static class Api33BackCallbackDelegate implements BackCallbackDelegate {
        ...
        public void startListeningForBackCallbacks(MaterialBackHandler materialBackHandler, View view, boolean z) {
            ...
            if (this.onBackInvokedCallback == null && (m = Chip$$ExternalSyntheticApiModelOutline1.m(view)) != null) {
                ...
                m.registerOnBackInvokedCallback(z ? DurationKt.NANOS_IN_MILLIS : 0, createOnBackInvokedCallback);
            }
        }

        public void stopListeningForBackCallbacks(View view) {
            OnBackInvokedDispatcher m = Chip$$ExternalSyntheticApiModelOutline1.m(view);
            if (m != null) {
        ...
        public OnBackInvokedCallback createOnBackInvokedCallback(MaterialBackHandler materialBackHandler) {
            ...
            return new MaterialBackOrchestrator$Api33BackCallbackDelegate$$ExternalSyntheticLambda1(materialBackHandler);
        }
    }
}
