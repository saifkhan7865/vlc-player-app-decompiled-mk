...
public final class TemperatureCache {
    ...
    public List<Hct> getAnalogousColors(int i, int i2) {
        ...
        while (true) {
            ...
            while (z && arrayList.size() < i4) {
                arrayList.add(hct2);
                double size2 = (double) (arrayList.size() + i7);
                Double.isNaN(size2);
                z = d >= size2 * d4;
                i7++;
            }
        ...
        double d5 = (double) i3;
        Double.isNaN(d5);
        int floor = (int) Math.floor((d5 - 1.0d) / 2.0d);
    ...
    private List<Hct> getHctsByTemp() {
        ...
        Collections.sort(arrayList, Comparator.CC.comparing(new TemperatureCache$$ExternalSyntheticLambda0(this), new TemperatureCache$$ExternalSyntheticLambda1()));
    ...
    public /* synthetic */ Double m1390lambda$getHctsByTemp$0$comgoogleandroidmaterialcolorutilitiesTemperatureCache(Hct hct) {
