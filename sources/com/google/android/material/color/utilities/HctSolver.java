...
public class HctSolver {
    ...
    static double chromaticAdaptation(double d) {
        ...
        double signum = (double) MathUtils.signum(d);
        Double.isNaN(signum);
        ...
        for (int i3 = 0; i3 < 3; i3++) {
            ...
            if (d3 != d4) {
                ...
                for (int i6 = 0; i6 < 8 && Math.abs(i5 - i4) > 1; i6++) {
                    double d5 = (double) (i4 + i5);
                    Double.isNaN(d5);
                    int floor = (int) Math.floor(d5 / 2.0d);
    ...
    static int findResultByJ(double d, double d2, double d3) {
        ...
        while (true) {
            ...
            matrixMultiply = MathUtils.matrixMultiply(new double[]{inverseChromaticAdaptation((((451.0d * d8) + d10) + (288.0d * d9)) / 1403.0d), inverseChromaticAdaptation(((d10 - (891.0d * d8)) - (261.0d * d9)) / 1403.0d), inverseChromaticAdaptation(((d10 - (d8 * 220.0d)) - (d9 * 6300.0d)) / 1403.0d)}, LINRGB_FROM_SCALED_DISCOUNT);
