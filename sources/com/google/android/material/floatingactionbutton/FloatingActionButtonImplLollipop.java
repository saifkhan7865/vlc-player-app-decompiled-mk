...
class FloatingActionButtonImplLollipop extends FloatingActionButtonImpl {
    ...
    public void setRippleColor(ColorStateList colorStateList) {
        if (CarContext$$ExternalSyntheticApiModelOutline0.m$3((Object) this.rippleDrawable)) {
            WindowIdApi18$$ExternalSyntheticApiModelOutline0.m((Object) this.rippleDrawable).setColor(RippleUtils.sanitizeRippleDrawableColor(colorStateList));
        } else {
    ...
    public void onElevationsChanged(float f, float f2, float f3) {
        ...
        } else if (Chip$$ExternalSyntheticApiModelOutline1.m(this.view) == this.stateListAnimator) {
    ...
    private StateListAnimator createDefaultStateListAnimator(float f, float f2, float f3) {
        ...
        if (Build.VERSION.SDK_INT >= 22 && Build.VERSION.SDK_INT <= 24) {
            arrayList.add(ObjectAnimator.ofFloat(this.view, Chip$$ExternalSyntheticApiModelOutline1.m(), new float[]{Chip$$ExternalSyntheticApiModelOutline1.m(this.view)}).setDuration(100));
        }
        arrayList.add(ObjectAnimator.ofFloat(this.view, Chip$$ExternalSyntheticApiModelOutline1.m(), new float[]{0.0f}).setDuration(100));
    ...
    private Animator createElevationAnimator(float f, float f2) {
        AnimatorSet animatorSet = new AnimatorSet();
        animatorSet.play(ObjectAnimator.ofFloat(this.view, "elevation", new float[]{f}).setDuration(0)).with(ObjectAnimator.ofFloat(this.view, Chip$$ExternalSyntheticApiModelOutline1.m(), new float[]{f2}).setDuration(100));
        animatorSet.setInterpolator(ELEVATION_ANIM_INTERPOLATOR);
        return animatorSet;
    }
