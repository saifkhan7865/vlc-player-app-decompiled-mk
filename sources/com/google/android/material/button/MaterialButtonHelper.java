...
class MaterialButtonHelper {
    ...
    public void setRippleColor(ColorStateList colorStateList) {
        if (this.rippleColor != colorStateList) {
            ...
            if (z && CarContext$$ExternalSyntheticApiModelOutline0.m$3((Object) this.materialButton.getBackground())) {
                WindowIdApi18$$ExternalSyntheticApiModelOutline0.m((Object) this.materialButton.getBackground()).setColor(RippleUtils.sanitizeRippleDrawableColor(colorStateList));
