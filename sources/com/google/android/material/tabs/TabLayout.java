...
public class TabLayout extends HorizontalScrollView {
    ...
    public TabLayout(android.content.Context r10, android.util.AttributeSet r11, int r12) {
        ...
        L_0x00f0:
            ...
            int r2 = androidx.appcompat.R.styleable.TextAppearance_android_textSize     // Catch:{ all -> 0x021d }
            int r2 = r1.getDimensionPixelSize(r2, r6)     // Catch:{ all -> 0x021d }
            float r2 = (float) r2     // Catch:{ all -> 0x021d }
            r9.tabTextSize = r2     // Catch:{ all -> 0x021d }
            int r2 = androidx.appcompat.R.styleable.TextAppearance_android_textColor     // Catch:{ all -> 0x021d }
            android.content.res.ColorStateList r2 = com.google.android.material.resources.MaterialResources.getColorStateList((android.content.Context) r7, (android.content.res.TypedArray) r1, (int) r2)     // Catch:{ all -> 0x021d }
            r9.tabTextColors = r2     // Catch:{ all -> 0x021d }
            r1.recycle()
        ...
        L_0x0124:
            ...
            int r1 = androidx.appcompat.R.styleable.TextAppearance_android_textSize     // Catch:{ all -> 0x0161 }
            float r2 = r9.tabTextSize     // Catch:{ all -> 0x0161 }
            int r2 = (int) r2     // Catch:{ all -> 0x0161 }
            int r1 = r12.getDimensionPixelSize(r1, r2)     // Catch:{ all -> 0x0161 }
            float r1 = (float) r1     // Catch:{ all -> 0x0161 }
            r9.selectedTabTextSize = r1     // Catch:{ all -> 0x0161 }
            int r1 = androidx.appcompat.R.styleable.TextAppearance_android_textColor     // Catch:{ all -> 0x0161 }
            android.content.res.ColorStateList r1 = com.google.android.material.resources.MaterialResources.getColorStateList((android.content.Context) r7, (android.content.res.TypedArray) r12, (int) r1)     // Catch:{ all -> 0x0161 }
            if (r1 == 0) goto L_0x015d
            android.content.res.ColorStateList r2 = r9.tabTextColors     // Catch:{ all -> 0x0161 }
            int r2 = r2.getDefaultColor()     // Catch:{ all -> 0x0161 }
            r3 = 16842913(0x10100a1, float:2.369401E-38)
            int[] r3 = new int[]{r3}     // Catch:{ all -> 0x0161 }
            int r4 = r1.getDefaultColor()     // Catch:{ all -> 0x0161 }
            int r1 = r1.getColorForState(r3, r4)     // Catch:{ all -> 0x0161 }
            android.content.res.ColorStateList r1 = createColorStateList(r2, r1)     // Catch:{ all -> 0x0161 }
            r9.tabTextColors = r1     // Catch:{ all -> 0x0161 }
        L_0x015d:
            r12.recycle()
            goto L_0x0166
        L_0x0161:
