...
public class SideSheetBehavior<V extends View> extends CoordinatorLayout.Behavior<V> implements Sheet<SideSheetCallback> {
    ...
    public /* synthetic */ void m1413lambda$setState$0$comgoogleandroidmaterialsidesheetSideSheetBehavior(int i) {
    ...
    public /* synthetic */ void m1412lambda$getCoplanarFinishAnimatorUpdateListener$1$comgoogleandroidmaterialsidesheetSideSheetBehavior(ViewGroup.MarginLayoutParams marginLayoutParams, int i, View view, ValueAnimator valueAnimator) {
    ...
    class StateSettlingTracker {
        ...
        public /* synthetic */ void m1414lambda$new$0$comgoogleandroidmaterialsidesheetSideSheetBehavior$StateSettlingTracker() {
    ...
    public /* synthetic */ boolean m1411lambda$createAccessibilityViewCommandForState$2$comgoogleandroidmaterialsidesheetSideSheetBehavior(int i, View view, AccessibilityViewCommand.CommandArguments commandArguments) {
        setState(i);
        return true;
    }
}
