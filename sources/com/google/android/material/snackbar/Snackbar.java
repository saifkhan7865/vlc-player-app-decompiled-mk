...
public class Snackbar extends BaseTransientBottomBar<Snackbar> {
    ...
    public Snackbar setAction(CharSequence charSequence, View.OnClickListener onClickListener) {
        ...
        if (TextUtils.isEmpty(charSequence) || onClickListener == null) {
            ...
            actionView.setOnClickListener(new Snackbar$$ExternalSyntheticLambda1(this, onClickListener));
        }
        return this;
    }
    ...
    public /* synthetic */ void m1415lambda$setAction$0$comgoogleandroidmaterialsnackbarSnackbar(View.OnClickListener onClickListener, View view) {
