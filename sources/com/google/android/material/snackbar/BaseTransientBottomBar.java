...
public abstract class BaseTransientBottomBar<B extends BaseTransientBottomBar<B>> {
    ...
    public void onAttachedToWindow() {
        WindowInsets m;
        if (Build.VERSION.SDK_INT >= 29 && (m = this.view.getRootWindowInsets()) != null) {
            this.extraBottomMarginGestureInset = WindowInsetsCompat$$ExternalSyntheticApiModelOutline0.m$1(m).bottom;
            updateMargins();
        }
    }
