...
public class RangeDateSelector implements DateSelector<Pair<Long, Long>> {
    ...
    private final String invalidRangeEndError = AnsiRenderer.CODE_TEXT_SEPARATOR;
    ...
    private void clearInvalidRange(TextInputLayout textInputLayout, TextInputLayout textInputLayout2) {
        ...
        if (textInputLayout2.getError() != null && AnsiRenderer.CODE_TEXT_SEPARATOR.contentEquals(textInputLayout2.getError())) {
    ...
    private void setInvalidRange(TextInputLayout textInputLayout, TextInputLayout textInputLayout2) {
        ...
        textInputLayout2.setError(AnsiRenderer.CODE_TEXT_SEPARATOR);
    }
