...
class UtcDates {
    ...
    private static android.icu.util.TimeZone getUtcAndroidTimeZone() {
        return Chip$$ExternalSyntheticApiModelOutline1.m(UTC);
    }
    ...
    private static DateFormat getAndroidFormat(String str, Locale locale) {
        DateFormat m = DateFormat.getInstanceForSkeleton(str, locale);
        m.setTimeZone(getUtcAndroidTimeZone());
        m.setContext(Chip$$ExternalSyntheticApiModelOutline1.m());
        return m;
    }
    ...
    private static String removeYearFromDateFormatPattern(String str) {
        ...
        return str.replace(str.substring(findCharactersInDateFormatPattern(str, str2, -1, findCharactersInDateFormatPattern) + 1, findCharactersInDateFormatPattern2), AnsiRenderer.CODE_TEXT_SEPARATOR).trim();
    }
