...
public class MaterialCheckBox extends AppCompatCheckBox {
    ...
    private static final int FRAMEWORK_BUTTON_DRAWABLE_RES_ID = Resources.getSystem().getIdentifier("btn_check_material_anim", Constants.DRAWABLE, "android");
    ...
    public MaterialCheckBox(android.content.Context r9, android.util.AttributeSet r10, int r11) {
        ...
        L_0x00c4:
            ...
            android.graphics.drawable.Drawable r9 = r8.buttonIconDrawable
            if (r9 == 0) goto L_0x00dc
            com.google.android.material.checkbox.MaterialCheckBox$$ExternalSyntheticLambda6 r9 = new com.google.android.material.checkbox.MaterialCheckBox$$ExternalSyntheticLambda6
            r9.<init>(r8)
            r8.post(r9)
        L_0x00dc:
            return
    ...
    public /* synthetic */ void m1348lambda$new$0$comgoogleandroidmaterialcheckboxMaterialCheckBox() {
    ...
    public void setCheckedState(int i) {
        ...
        if (this.checkedState != i) {
            ...
            if (!this.broadcasting) {
                ...
                if (Build.VERSION.SDK_INT >= 26 && (m = WindowIdApi18$$ExternalSyntheticApiModelOutline0.m(getContext().getSystemService(WindowIdApi18$$ExternalSyntheticApiModelOutline0.m$1()))) != null) {
    ...
    private void setUpDefaultButtonDrawableAnimationIfNeeded() {
        if (this.usingMaterialButtonDrawable) {
            ...
            if (Build.VERSION.SDK_INT >= 24 && WindowIdApi18$$ExternalSyntheticApiModelOutline0.m$2((Object) this.buttonDrawable) && this.transitionToUnchecked != null) {
                WindowIdApi18$$ExternalSyntheticApiModelOutline0.m((Object) this.buttonDrawable).addTransition(R.id.checked, R.id.unchecked, this.transitionToUnchecked, false);
                WindowIdApi18$$ExternalSyntheticApiModelOutline0.m((Object) this.buttonDrawable).addTransition(R.id.indeterminate, R.id.unchecked, this.transitionToUnchecked, false);
            }
        }
    }
    ...
    private boolean isButtonDrawableLegacy(TintTypedArray tintTypedArray) {
        ...
        if (Build.VERSION.SDK_INT < 21) {
            if (resourceId == R.drawable.abc_btn_check_material && resourceId2 == R.drawable.abc_btn_check_material_anim) {
                return true;
            }
            return false;
        } else if (resourceId == FRAMEWORK_BUTTON_DRAWABLE_RES_ID && resourceId2 == 0) {
            return true;
        } else {
            return false;
        }
