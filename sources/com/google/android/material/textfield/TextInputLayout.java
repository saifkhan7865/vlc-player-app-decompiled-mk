...
public class TextInputLayout extends LinearLayout implements ViewTreeObserver.OnGlobalLayoutListener {
    ...
    public TextInputLayout(android.content.Context r17, android.util.AttributeSet r18, int r19) {
        /*
            ...
            com.google.android.material.textfield.TextInputLayout$$ExternalSyntheticLambda11 r1 = new com.google.android.material.textfield.TextInputLayout$$ExternalSyntheticLambda11
            r1.<init>()
            r0.lengthCounter = r1
    ...
    public void onGlobalLayout() {
        ...
        if (updateEditTextHeightBasedOnIcon || updateDummyDrawables) {
            this.editText.post(new TextInputLayout$$ExternalSyntheticLambda10(this));
        }
    }
    ...
    public /* synthetic */ void m1429lambda$onGlobalLayout$1$comgoogleandroidmaterialtextfieldTextInputLayout() {
    ...
    public void dispatchProvideAutofillStructure(ViewStructure viewStructure, int i) {
        ...
        if (this.originalHint != null) {
            ...
            Chip$$ExternalSyntheticApiModelOutline1.m(viewStructure, this.inputFrame.getChildCount());
            for (int i2 = 0; i2 < this.inputFrame.getChildCount(); i2++) {
                View childAt = this.inputFrame.getChildAt(i2);
                ViewStructure m = Chip$$ExternalSyntheticApiModelOutline1.m(viewStructure, i2);
                childAt.dispatchProvideAutofillStructure(m, i);
    ...
    private void setEditText(EditText editText2) {
        if (this.editText == null) {
            ...
            if (Build.VERSION.SDK_INT >= 21) {
                this.collapsingTextHelper.setExpandedLetterSpacing(Chip$$ExternalSyntheticApiModelOutline1.m(this.editText));
            }
    ...
    private void updateCursorColor() {
        ...
        EditText editText2 = this.editText;
        if (editText2 != null && Chip$$ExternalSyntheticApiModelOutline1.m(editText2) != null) {
            Drawable mutate = DrawableCompat.wrap(Chip$$ExternalSyntheticApiModelOutline1.m(this.editText)).mutate();
