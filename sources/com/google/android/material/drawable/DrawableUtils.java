...
public final class DrawableUtils {
    ...
    public static void setRippleDrawableRadius(RippleDrawable rippleDrawable, int i) {
        ...
        try {
            Chip$$ExternalSyntheticApiModelOutline1.m().getDeclaredMethod("setMaxRadius", new Class[]{Integer.TYPE}).invoke(rippleDrawable, new Object[]{Integer.valueOf(i)});
    ...
    public static Drawable compositeTwoLayeredDrawable(Drawable drawable, Drawable drawable2, int i, int i2) {
        ScaledDrawableWrapper scaledDrawableWrapper = drawable2;
        int i3 = i;
        int i4 = i2;
        if (drawable == null) {
        ...
        if (z) {
            scaledDrawableWrapper = new ScaledDrawableWrapper(scaledDrawableWrapper, i3, i4);
        }
    ...
    public static ColorStateList getColorStateListOrNull(Drawable drawable) {
        ...
        if (Build.VERSION.SDK_INT < 29 || !Chip$$ExternalSyntheticApiModelOutline1.m((Object) drawable)) {
            return null;
        }
        return Chip$$ExternalSyntheticApiModelOutline1.m((Object) drawable).getColorStateList();
    }
}
