...
public final class CodaBarReader extends OneDReader {
        ...
        if (i2 >= this.counterLength || i5 >= i6 / 2) {
            ...
            if (arrayContains(cArr, charAt)) {
                ...
                if (!arrayContains(cArr, sb2.charAt(sb2.length() - 1))) {
                    ...
                    float f2 = (float) i9;
                    float f3 = (float) i;
                    return new Result(this.decodeRowResult.toString(), (byte[]) null, new ResultPoint[]{new ResultPoint(f, f3), new ResultPoint(f2, f3)}, BarcodeFormat.CODABAR);
                } else {
                    throw NotFoundException.getNotFoundInstance();
                }
            } else {
    ...
    private void validatePattern(int i) throws NotFoundException {
        ...
        for (int i7 = 0; i7 < 2; i7++) {
            ...
            fArr2[i8] = f2;
            fArr[i7] = f2;
            fArr[i8] = ((((float) i9) * MAX_ACCEPTABLE) + PADDING) / ((float) i10);
        }
        int i11 = i;
        int i12 = 0;
        loop3:
