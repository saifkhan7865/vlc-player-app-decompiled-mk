...
final class Fingerprint2011 extends AbstractNonStreamingHashFunction {
    ...
    private static long fullFingerprint(byte[] bArr, int i, int i2) {
        ...
        long load643 = LittleEndianByteArray.load64(bArr2, i4 - 56) ^ K0;
        long[] jArr = new long[2];
        long j = (long) i3;
        byte[] bArr3 = bArr;
        long[] jArr2 = new long[2];
        long[] jArr3 = jArr;
        weakHashLength32WithSeeds(bArr3, i4 - 64, j, load642, jArr);
        weakHashLength32WithSeeds(bArr3, i4 - 32, j * K1, K0, jArr2);
        ...
        int i6 = (i3 - 1) & -64;
        while (true) {
            long rotateRight3 = Long.rotateRight(rotateRight + rotateRight2 + jArr3[0] + LittleEndianByteArray.load64(bArr2, i5 + 16), 37) * K1;
            long rotateRight4 = Long.rotateRight(rotateRight2 + jArr3[1] + LittleEndianByteArray.load64(bArr2, i5 + 48), 42) * K1;
            long j2 = rotateRight3 ^ jArr2[1];
            long j3 = rotateRight4 ^ jArr3[0];
            long rotateRight5 = Long.rotateRight(shiftMix ^ jArr2[0], 33);
            byte[] bArr4 = bArr;
            weakHashLength32WithSeeds(bArr4, i5, jArr3[1] * K1, j2 + jArr2[0], jArr3);
            weakHashLength32WithSeeds(bArr4, i5 + 32, jArr2[1] + rotateRight5, j3, jArr2);
            i5 += 64;
            i6 -= 64;
            if (i6 == 0) {
                return hash128to64(hash128to64(jArr3[0], jArr2[0]) + (shiftMix(j3) * K1) + j2, hash128to64(jArr3[1], jArr2[1]) + rotateRight5);
            }
    ...
    private static long hashLength33To64(byte[] bArr, int i, int i2) {
        ...
        long load647 = load645 + LittleEndianByteArray.load64(bArr2, i4 - 24);
        long load648 = load647 + LittleEndianByteArray.load64(bArr2, i5);
        long rotateRight6 = rotateRight4 + Long.rotateRight(load648, 31);
        long j4 = j3;
        return shiftMix((shiftMix(((j2 + rotateRight6 + rotateRight5 + Long.rotateRight(load647, 7)) * K2) + ((load646 + load648 + j4) * K0)) * K0) + j4) * K2;
    }
