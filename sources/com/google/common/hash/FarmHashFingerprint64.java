...
final class FarmHashFingerprint64 extends AbstractNonStreamingHashFunction {
    ...
    private static long hashLength65Plus(byte[] bArr, int i, int i2) {
        ...
        int i8 = i;
        while (true) {
            long rotateRight = Long.rotateRight(load64 + j2 + jArr[0] + LittleEndianByteArray.load64(bArr2, i8 + 8), 37) * K1;
            long rotateRight2 = Long.rotateRight(j2 + jArr[1] + LittleEndianByteArray.load64(bArr2, i8 + 48), 42) * K1;
            ...
            if (i9 == i4) {
                ...
                jArr[0] = j6;
                jArr2[0] = jArr2[0] + j6;
                long rotateRight4 = (Long.rotateRight(((rotateRight3 + load642) + jArr[0]) + LittleEndianByteArray.load64(bArr2, i6 - 55), 37) * j4) ^ (jArr2[1] * 9);
                long rotateRight5 = (Long.rotateRight(load642 + jArr[1] + LittleEndianByteArray.load64(bArr2, i6 - 15), 42) * j4) + (jArr[0] * 9) + LittleEndianByteArray.load64(bArr2, i6 - 23);
                long rotateRight6 = Long.rotateRight(j3 + jArr2[0], 33) * j4;
                byte[] bArr3 = bArr;
                weakHashLength32WithSeeds(bArr3, i7, jArr[1] * j4, rotateRight4 + jArr2[0], jArr);
                weakHashLength32WithSeeds(bArr3, i6 - 31, rotateRight6 + jArr2[1], rotateRight5 + LittleEndianByteArray.load64(bArr2, i6 - 47), jArr2);
                long j7 = j4;
