    ...
    private static List<StackTraceElement> jlaStackTrace(final Throwable th) {
        ...
        return new AbstractList<StackTraceElement>() {
            public StackTraceElement get(int i) {
                return (StackTraceElement) Throwables.invokeAccessibleNonThrowingMethod((Method) Objects.requireNonNull(Throwables.getStackTraceElementMethod), Objects.requireNonNull(Throwables.jla), th, Integer.valueOf(i));
            }

            public int size() {
                return ((Integer) Throwables.invokeAccessibleNonThrowingMethod((Method) Objects.requireNonNull(Throwables.getStackTraceDepthMethod), Objects.requireNonNull(Throwables.jla), th)).intValue();
            }
        };
    }
