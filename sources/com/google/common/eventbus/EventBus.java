...
public class EventBus {
    ...
    public EventBus() {
        this(AnsiConsole.JANSI_MODE_DEFAULT);
    }
    ...
    public EventBus(SubscriberExceptionHandler subscriberExceptionHandler) {
        this(AnsiConsole.JANSI_MODE_DEFAULT, MoreExecutors.directExecutor(), Dispatcher.perThreadDispatchQueue(), subscriberExceptionHandler);
    }
