...
public final class MediaType {
            ...
            while (tokenizer.hasMore()) {
                ...
                if ('\"' == tokenizer.previewChar()) {
                    ...
                    while ('\"' != tokenizer.previewChar()) {
                        if ('\\' == tokenizer.previewChar()) {
                            tokenizer.consumeCharacter((char) AbstractJsonLexerKt.STRING_ESC);
    ...
    private String computeToString() {
        ...
        if (!this.parameters.isEmpty()) {
            sb.append("; ");
            PARAMETER_JOINER.appendTo(sb, (Iterable<? extends Map.Entry<?, ?>>) Multimaps.transformValues(this.parameters, new MediaType$$ExternalSyntheticLambda0()).entries());
        }
        return sb.toString();
    }
