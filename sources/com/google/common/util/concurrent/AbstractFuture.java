        ...
        if (!Thread.interrupted()) {
            ...
            if (nanos + 1000 < 0) {
                ...
                if (convert > 0) {
                    ...
                    sb3.append(valueOf);
                    sb3.append(convert);
                    sb3.append(AnsiRenderer.CODE_TEXT_SEPARATOR);
                    sb3.append(lowerCase);
                    String sb4 = sb3.toString();
                    if (z) {
                        sb4 = String.valueOf(sb4).concat(AnsiRenderer.CODE_LIST_SEPARATOR);
                    }
                    concat = String.valueOf(sb4).concat(AnsiRenderer.CODE_TEXT_SEPARATOR);
                }
                if (z) {
