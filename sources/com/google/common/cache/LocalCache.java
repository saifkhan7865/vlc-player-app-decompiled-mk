...
class LocalCache<K, V> extends AbstractMap<K, V> implements ConcurrentMap<K, V>, j$.util.concurrent.ConcurrentMap {
    ...
    static class Segment<K, V> extends ReentrantLock {
        ...
        public V getAndRecordStats(K r5, int r6, com.google.common.cache.LocalCache.LoadingValueReference<K, V> r7, com.google.common.util.concurrent.ListenableFuture<V> r8) throws java.util.concurrent.ExecutionException {
            /*
                r4 = this;
                java.lang.Object r8 = com.google.common.util.concurrent.Uninterruptibles.getUninterruptibly(r8)     // Catch:{ all -> 0x004d }
    ...
    static class LoadingValueReference<K, V> implements ValueReference<K, V> {
        ...
        public ListenableFuture<V> loadFuture(K k, CacheLoader<? super K, V> cacheLoader) {
            try {
                ...
                return Futures.transform(reload, new com.google.common.base.Function<V, V>() {
                    public V apply(V v) {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:24:0x0085, code lost:
        if (r8.hasNext() != false) goto L_0x0087;
     */
    ...
    public com.google.common.collect.ImmutableMap<K, V> getAll(java.lang.Iterable<? extends K> r8) throws java.util.concurrent.ExecutionException {
        ...
        L_0x002d:
            ...
            goto L_0x000e
        L_0x0030:
            boolean r8 = r1.isEmpty()     // Catch:{ all -> 0x00a6 }
            if (r8 != 0) goto L_0x0097
            java.util.Set r8 = java.util.Collections.unmodifiableSet(r1)     // Catch:{ UnsupportedLoadingOperationException -> 0x007d }
            com.google.common.cache.CacheLoader<? super K, V> r4 = r7.defaultLoader     // Catch:{ UnsupportedLoadingOperationException -> 0x007d }
            java.util.Map r8 = r7.loadAll(r8, r4)     // Catch:{ UnsupportedLoadingOperationException -> 0x007d }
            java.util.Iterator r4 = r1.iterator()     // Catch:{ UnsupportedLoadingOperationException -> 0x007d }
        L_0x0044:
            boolean r5 = r4.hasNext()     // Catch:{ UnsupportedLoadingOperationException -> 0x007d }
            if (r5 == 0) goto L_0x0097
            java.lang.Object r5 = r4.next()     // Catch:{ UnsupportedLoadingOperationException -> 0x007d }
            java.lang.Object r6 = r8.get(r5)     // Catch:{ UnsupportedLoadingOperationException -> 0x007d }
            if (r6 == 0) goto L_0x0058
            r0.put(r5, r6)     // Catch:{ UnsupportedLoadingOperationException -> 0x007d }
            goto L_0x0044
        L_0x0058:
            com.google.common.cache.CacheLoader$InvalidCacheLoadException r8 = new com.google.common.cache.CacheLoader$InvalidCacheLoadException     // Catch:{ UnsupportedLoadingOperationException -> 0x007d }
            java.lang.String r4 = java.lang.String.valueOf(r5)     // Catch:{ UnsupportedLoadingOperationException -> 0x007d }
            java.lang.String r5 = java.lang.String.valueOf(r4)     // Catch:{ UnsupportedLoadingOperationException -> 0x007d }
            int r5 = r5.length()     // Catch:{ UnsupportedLoadingOperationException -> 0x007d }
            int r5 = r5 + 37
            java.lang.StringBuilder r6 = new java.lang.StringBuilder     // Catch:{ UnsupportedLoadingOperationException -> 0x007d }
            r6.<init>(r5)     // Catch:{ UnsupportedLoadingOperationException -> 0x007d }
            java.lang.String r5 = "loadAll failed to return a value for "
            r6.append(r5)     // Catch:{ UnsupportedLoadingOperationException -> 0x007d }
            r6.append(r4)     // Catch:{ UnsupportedLoadingOperationException -> 0x007d }
            java.lang.String r4 = r6.toString()     // Catch:{ UnsupportedLoadingOperationException -> 0x007d }
            r8.<init>(r4)     // Catch:{ UnsupportedLoadingOperationException -> 0x007d }
            throw r8     // Catch:{ UnsupportedLoadingOperationException -> 0x007d }
        L_0x007d:
            java.util.Iterator r8 = r1.iterator()     // Catch:{ all -> 0x00a6 }
        L_0x0081:
            boolean r1 = r8.hasNext()     // Catch:{ all -> 0x00a6 }
            if (r1 == 0) goto L_0x0097
            java.lang.Object r1 = r8.next()     // Catch:{ all -> 0x00a6 }
            int r3 = r3 + -1
            com.google.common.cache.CacheLoader<? super K, V> r4 = r7.defaultLoader     // Catch:{ all -> 0x00a6 }
            java.lang.Object r4 = r7.get(r1, r4)     // Catch:{ all -> 0x00a6 }
            r0.put(r1, r4)     // Catch:{ all -> 0x00a6 }
            goto L_0x0081
        L_0x0097:
            com.google.common.collect.ImmutableMap r8 = com.google.common.collect.ImmutableMap.copyOf(r0)     // Catch:{ all -> 0x00a6 }
