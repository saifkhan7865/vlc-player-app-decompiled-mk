...
public final class LongMath {
    ...
    static final int[] biggestBinomials = {Integer.MAX_VALUE, Integer.MAX_VALUE, Integer.MAX_VALUE, 3810779, 121977, 16175, 4337, 1733, 887, 534, 361, MediaPlayer.Event.EndReached, 206, 169, 143, 125, 111, 101, 94, 88, 83, 79, 76, 74, 72, 70, 69, 68, 67, 67, 66, 66, 66, 66};
    ...
    static final long[] powersOf10 = {1, 10, 100, 1000, 10000, 100000, PickTimeFragment.SECONDS_IN_MICROS, 10000000, 100000000, 1000000000, 10000000000L, 100000000000L, 1000000000000L, 10000000000000L, 100000000000000L, 1000000000000000L, 10000000000000000L, 100000000000000000L, 1000000000000000000L};
    ...
    public static long checkedPow(long j, int i) {
        ...
        if ((j >= -2) && (j <= 2)) {
            ...
            while (i3 != 0) {
                ...
                long checkedMultiply = (i3 & 1) != 0 ? checkedMultiply(j2, j3) : j2;
                int i4 = i3 >> 1;
                if (i4 > 0) {
