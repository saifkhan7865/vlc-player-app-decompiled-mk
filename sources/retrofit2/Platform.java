...
class Platform {
    ...
    public Object invokeDefaultMethod(Method method, Class<?> cls, Object obj, @Nullable Object... objArr) throws Throwable {
        Constructor declaredConstructor = Platform$$ExternalSyntheticApiModelOutline0.m$1().getDeclaredConstructor(new Class[]{Class.class, Integer.TYPE});
        declaredConstructor.setAccessible(true);
        return Platform$$ExternalSyntheticApiModelOutline0.m(declaredConstructor.newInstance(new Object[]{cls, -1})).unreflectSpecial(method, cls).bindTo(obj).invokeWithArguments(objArr);
    }
