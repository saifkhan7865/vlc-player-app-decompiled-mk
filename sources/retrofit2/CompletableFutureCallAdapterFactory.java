...
final class CompletableFutureCallAdapterFactory extends CallAdapter.Factory {
            ...
            call.enqueue(new Callback<R>() {
                public void onResponse(Call<R> call, Response<R> response) {
                    if (response.isSuccessful()) {
                        boolean unused = r0.complete(response.body());
                    } else {
                        boolean unused2 = r0.completeExceptionally(new HttpException(response));
                    }
                }

                public void onFailure(Call<R> call, Throwable th) {
                    boolean unused = r0.completeExceptionally(th);
                }
            });
            return r0;
        }
    ...
    private static final class ResponseCallAdapter<R> implements CallAdapter<R, CompletableFuture<Response<R>>> {
        ...
        public CompletableFuture<Response<R>> adapt(final Call<R> call) {
            ...
            call.enqueue(new Callback<R>() {
                public void onResponse(Call<R> call, Response<R> response) {
                    boolean unused = r0.complete(response);
                }
