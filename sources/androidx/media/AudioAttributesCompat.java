...
public class AudioAttributesCompat implements VersionedParcelable {
    ...
    public static AudioAttributesCompat wrap(Object obj) {
        ...
        if (Build.VERSION.SDK_INT >= 26) {
            return new AudioAttributesCompat(new AudioAttributesImplApi26(Trace$$ExternalSyntheticApiModelOutline0.m(obj)));
        }
        if (Build.VERSION.SDK_INT >= 21) {
            return new AudioAttributesCompat(new AudioAttributesImplApi21(Trace$$ExternalSyntheticApiModelOutline0.m(obj)));
        }
        return null;
    }
