...
public abstract class MediaBrowserServiceCompat extends Service {
    ...
    class MediaBrowserServiceImplApi21 implements MediaBrowserServiceImpl {
        ...
        public void onCreate() {
            ...
            Trace$$ExternalSyntheticApiModelOutline0.m((MediaBrowserService) mediaBrowserServiceApi21);
        }
        ...
        public void setSessionTokenOnHandler(MediaSessionCompat.Token token) {
            ...
            this.mServiceFwk.setSessionToken(RatingCompat$$ExternalSyntheticApiModelOutline0.m(token.getToken()));
        }
    ...
    class MediaBrowserServiceImplApi23 extends MediaBrowserServiceImplApi21 {
        ...
        public void onCreate() {
            ...
            Trace$$ExternalSyntheticApiModelOutline0.m(this.mServiceFwk);
        }
    ...
    class MediaBrowserServiceImplApi26 extends MediaBrowserServiceImplApi23 {
        ...
        public Bundle getBrowserRootHints() {
            if (MediaBrowserServiceCompat.this.mCurConnection == null) {
                ...
                return Trace$$ExternalSyntheticApiModelOutline0.m(this.mServiceFwk);
            } else {
    ...
    class MediaBrowserServiceImplApi28 extends MediaBrowserServiceImplApi26 {
        ...
        public MediaSessionManager.RemoteUserInfo getCurrentBrowserInfo() {
            if (MediaBrowserServiceCompat.this.mCurConnection == null) {
                ...
                return new MediaSessionManager.RemoteUserInfo(Trace$$ExternalSyntheticApiModelOutline0.m(this.mServiceFwk));
            } else {
                return MediaBrowserServiceCompat.this.mCurConnection.browserInfo;
            }
        }
    ...
    static class ResultWrapper<T> {
        ...
        public void sendResult(T t) {
            if (t instanceof List) {
                ...
                this.mResultFwk.sendResult(Trace$$ExternalSyntheticApiModelOutline0.m().createFromParcel(parcel));
                parcel.recycle();
            } else {
        ...
        public List<MediaBrowser.MediaItem> parcelListToItemList(List<Parcel> list) {
            ...
            for (Parcel next : list) {
                ...
                arrayList.add(RatingCompat$$ExternalSyntheticApiModelOutline0.m(Trace$$ExternalSyntheticApiModelOutline0.m().createFromParcel(next)));
                next.recycle();
            }
            return arrayList;
        }
