...
class AppCompatDelegateImpl extends AppCompatDelegate implements MenuBuilder.Callback, LayoutInflater.Factory2 {
        ...
        if (z && !sInstalledExceptionHandler) {
            ...
            Thread.setDefaultUncaughtExceptionHandler(new Thread.UncaughtExceptionHandler() {
                ...
                private boolean shouldWrapException(Throwable th) {
                    ...
                    if (message.contains(Constants.DRAWABLE) || message.contains("Drawable")) {
                        return true;
                    }
                    return false;
                }
    ...
    static class Api24Impl {
        ...
        static void generateConfigDelta_locale(Configuration configuration, Configuration configuration2, Configuration configuration3) {
            LocaleList m = CarContext$$ExternalSyntheticApiModelOutline0.m(configuration);
            LocaleList m2 = CarContext$$ExternalSyntheticApiModelOutline0.m(configuration2);
            if (!m.equals(m2)) {
        ...
        static LocaleListCompat getLocales(Configuration configuration) {
            return LocaleListCompat.forLanguageTags(CarContext$$ExternalSyntheticApiModelOutline0.m(CarContext$$ExternalSyntheticApiModelOutline0.m(configuration)));
        }
        ...
        public static void setDefaultLocales(LocaleListCompat localeListCompat) {
            CarContext$$ExternalSyntheticApiModelOutline0.m(LocaleList.forLanguageTags(localeListCompat.toLanguageTags()));
        }
    }
    ...
    static class Api26Impl {
        ...
        static void generateConfigDelta_colorMode(Configuration configuration, Configuration configuration2, Configuration configuration3) {
            if ((CarContext$$ExternalSyntheticApiModelOutline0.m(configuration) & 3) != (CarContext$$ExternalSyntheticApiModelOutline0.m(configuration2) & 3)) {
                configuration3.colorMode = CarContext$$ExternalSyntheticApiModelOutline0.m(configuration3) | (CarContext$$ExternalSyntheticApiModelOutline0.m(configuration2) & 3);
            }
            if ((CarContext$$ExternalSyntheticApiModelOutline0.m(configuration) & 12) != (CarContext$$ExternalSyntheticApiModelOutline0.m(configuration2) & 12)) {
                configuration3.colorMode = CarContext$$ExternalSyntheticApiModelOutline0.m(configuration3) | (CarContext$$ExternalSyntheticApiModelOutline0.m(configuration2) & 12);
            }
        }
    }
    ...
    static class Api33Impl {
        ...
        static OnBackInvokedCallback registerOnBackPressedCallback(Object obj, AppCompatDelegateImpl appCompatDelegateImpl) {
            ...
            CarContext$$ExternalSyntheticApiModelOutline0.m(obj).registerOnBackInvokedCallback(DurationKt.NANOS_IN_MILLIS, appCompatDelegateImpl$Api33Impl$$ExternalSyntheticLambda5);
        ...
        static void unregisterOnBackInvokedCallback(Object obj, Object obj2) {
            CarContext$$ExternalSyntheticApiModelOutline0.m(obj).unregisterOnBackInvokedCallback(CarContext$$ExternalSyntheticApiModelOutline0.m(obj2));
        }
