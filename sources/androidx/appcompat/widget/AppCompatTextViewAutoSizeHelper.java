...
class AppCompatTextViewAutoSizeHelper {
    ...
    private static class Impl23 extends Impl {
        ...
        /* access modifiers changed from: package-private */
        public void computeAndSetTextDirection(StaticLayout.Builder builder, TextView textView) {
            StaticLayout.Builder unused = builder.setTextDirection(CarContext$$ExternalSyntheticApiModelOutline0.m(AppCompatTextViewAutoSizeHelper.invokeAndReturnWithDefault(textView, "getTextDirectionHeuristic", CarContext$$ExternalSyntheticApiModelOutline0.m())));
        }
    }
    ...
    private static class Impl29 extends Impl23 {
        ...
        /* access modifiers changed from: package-private */
        public boolean isHorizontallyScrollable(TextView textView) {
            return CarContext$$ExternalSyntheticApiModelOutline0.m(textView);
        }

        /* access modifiers changed from: package-private */
        public void computeAndSetTextDirection(StaticLayout.Builder builder, TextView textView) {
            StaticLayout.Builder unused = builder.setTextDirection(CarContext$$ExternalSyntheticApiModelOutline0.m(textView));
        }
    }
    ...
    static <T> T invokeAndReturnWithDefault(java.lang.Object r3, java.lang.String r4, T r5) {
        /*
            ...
            java.lang.reflect.Method r1 = getTextViewMethod(r4)     // Catch:{ Exception -> 0x000e, all -> 0x000c }
            r2 = 0
            java.lang.Object r5 = r1.invoke(r3, r2)     // Catch:{ Exception -> 0x000e, all -> 0x000c }
            goto L_0x0025
        L_0x000c:
            r3 = move-exception
            throw r3
