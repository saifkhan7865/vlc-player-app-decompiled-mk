                    ...
                    while (true) {
                        ...
                        if (next == 1) {
                            ...
                            if (TAG_HISTORICAL_RECORD.equals(newPullParser.getName())) {
                                list.add(new HistoricalRecord(newPullParser.getAttributeValue((String) null, ATTRIBUTE_ACTIVITY), Long.parseLong(newPullParser.getAttributeValue((String) null, "time")), Float.parseFloat(newPullParser.getAttributeValue((String) null, "weight"))));
                            } else {
    ...
    private final class PersistHistoryAsyncTask extends AsyncTask<Object, Void, Void> {
        ...
        public java.lang.Void doInBackground(java.lang.Object... r15) {
            /*
                ...
                r6 = 0
                androidx.appcompat.widget.ActivityChooserModel r7 = androidx.appcompat.widget.ActivityChooserModel.this     // Catch:{ FileNotFoundException -> 0x00e1 }
                android.content.Context r7 = r7.mContext     // Catch:{ FileNotFoundException -> 0x00e1 }
                java.io.FileOutputStream r15 = r7.openFileOutput(r15, r3)     // Catch:{ FileNotFoundException -> 0x00e1 }
                org.xmlpull.v1.XmlSerializer r7 = android.util.Xml.newSerializer()
                r7.setOutput(r15, r6)     // Catch:{ IllegalArgumentException -> 0x00b6, IllegalStateException -> 0x0096, IOException -> 0x0076 }
                java.lang.String r8 = "UTF-8"
                java.lang.Boolean r9 = java.lang.Boolean.valueOf(r5)     // Catch:{ IllegalArgumentException -> 0x00b6, IllegalStateException -> 0x0096, IOException -> 0x0076 }
                r7.startDocument(r8, r9)     // Catch:{ IllegalArgumentException -> 0x00b6, IllegalStateException -> 0x0096, IOException -> 0x0076 }
                r7.startTag(r6, r1)     // Catch:{ IllegalArgumentException -> 0x00b6, IllegalStateException -> 0x0096, IOException -> 0x0076 }
                int r8 = r4.size()     // Catch:{ IllegalArgumentException -> 0x00b6, IllegalStateException -> 0x0096, IOException -> 0x0076 }
                r9 = 0
            L_0x0031:
                if (r9 >= r8) goto L_0x0064
                java.lang.Object r10 = r4.remove(r3)     // Catch:{ IllegalArgumentException -> 0x00b6, IllegalStateException -> 0x0096, IOException -> 0x0076 }
                androidx.appcompat.widget.ActivityChooserModel$HistoricalRecord r10 = (androidx.appcompat.widget.ActivityChooserModel.HistoricalRecord) r10     // Catch:{ IllegalArgumentException -> 0x00b6, IllegalStateException -> 0x0096, IOException -> 0x0076 }
                r7.startTag(r6, r0)     // Catch:{ IllegalArgumentException -> 0x00b6, IllegalStateException -> 0x0096, IOException -> 0x0076 }
                java.lang.String r11 = "activity"
                android.content.ComponentName r12 = r10.activity     // Catch:{ IllegalArgumentException -> 0x00b6, IllegalStateException -> 0x0096, IOException -> 0x0076 }
                java.lang.String r12 = r12.flattenToString()     // Catch:{ IllegalArgumentException -> 0x00b6, IllegalStateException -> 0x0096, IOException -> 0x0076 }
                r7.attribute(r6, r11, r12)     // Catch:{ IllegalArgumentException -> 0x00b6, IllegalStateException -> 0x0096, IOException -> 0x0076 }
                java.lang.String r11 = "time"
                long r12 = r10.time     // Catch:{ IllegalArgumentException -> 0x00b6, IllegalStateException -> 0x0096, IOException -> 0x0076 }
                java.lang.String r12 = java.lang.String.valueOf(r12)     // Catch:{ IllegalArgumentException -> 0x00b6, IllegalStateException -> 0x0096, IOException -> 0x0076 }
                r7.attribute(r6, r11, r12)     // Catch:{ IllegalArgumentException -> 0x00b6, IllegalStateException -> 0x0096, IOException -> 0x0076 }
                java.lang.String r11 = "weight"
                float r10 = r10.weight     // Catch:{ IllegalArgumentException -> 0x00b6, IllegalStateException -> 0x0096, IOException -> 0x0076 }
                java.lang.String r10 = java.lang.String.valueOf(r10)     // Catch:{ IllegalArgumentException -> 0x00b6, IllegalStateException -> 0x0096, IOException -> 0x0076 }
                r7.attribute(r6, r11, r10)     // Catch:{ IllegalArgumentException -> 0x00b6, IllegalStateException -> 0x0096, IOException -> 0x0076 }
                r7.endTag(r6, r0)     // Catch:{ IllegalArgumentException -> 0x00b6, IllegalStateException -> 0x0096, IOException -> 0x0076 }
                int r9 = r9 + 1
                goto L_0x0031
            L_0x0064:
                r7.endTag(r6, r1)     // Catch:{ IllegalArgumentException -> 0x00b6, IllegalStateException -> 0x0096, IOException -> 0x0076 }
                r7.endDocument()     // Catch:{ IllegalArgumentException -> 0x00b6, IllegalStateException -> 0x0096, IOException -> 0x0076 }
            ...
            L_0x0070:
                r15.close()     // Catch:{ IOException -> 0x00d6 }
                goto L_0x00d6
            L_0x0074:
                r0 = move-exception
                goto L_0x00d7
            L_0x0076:
                r0 = move-exception
                java.lang.String r1 = androidx.appcompat.widget.ActivityChooserModel.LOG_TAG     // Catch:{ all -> 0x0074 }
                ...
                androidx.appcompat.widget.ActivityChooserModel r2 = androidx.appcompat.widget.ActivityChooserModel.this     // Catch:{ all -> 0x0074 }
                java.lang.String r2 = r2.mHistoryFileName     // Catch:{ all -> 0x0074 }
                r3.append(r2)     // Catch:{ all -> 0x0074 }
                java.lang.String r2 = r3.toString()     // Catch:{ all -> 0x0074 }
                android.util.Log.e(r1, r2, r0)     // Catch:{ all -> 0x0074 }
                androidx.appcompat.widget.ActivityChooserModel r0 = androidx.appcompat.widget.ActivityChooserModel.this
                r0.mCanReadHistoricalData = r5
                if (r15 == 0) goto L_0x00d6
                goto L_0x0070
            ...
            L_0x00d7:
                ...
                r15.close()     // Catch:{ IOException -> 0x00e0 }
            L_0x00e0:
                throw r0
            L_0x00e1:
                r0 = move-exception
