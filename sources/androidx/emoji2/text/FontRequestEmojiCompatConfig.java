...
public class FontRequestEmojiCompatConfig extends EmojiCompat.Config {
    ...
    private static class FontRequestMetadataLoader implements EmojiCompat.MetadataRepoLoader {
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:54:?, code lost:
            androidx.core.os.TraceCompat.endSection();
         */
        /* JADX WARNING: Code restructure failed: missing block: B:55:0x0079, code lost:
            throw r0;
         */
        ...
        public void createMetadata() {
            /*
                ...
                monitor-enter(r1)
                androidx.emoji2.text.EmojiCompat$MetadataRepoLoaderCallback r2 = r9.mCallback     // Catch:{ all -> 0x00a4 }
                if (r2 != 0) goto L_0x000b
                monitor-exit(r1)     // Catch:{ all -> 0x00a4 }
                return
            L_0x000b:
                monitor-exit(r1)     // Catch:{ all -> 0x00a4 }
                androidx.core.provider.FontsContractCompat$FontInfo r1 = r9.retrieveFontInfo()     // Catch:{ all -> 0x0091 }
                int r2 = r1.getResultCode()     // Catch:{ all -> 0x0091 }
                r3 = 2
                if (r2 != r3) goto L_0x0036
                java.lang.Object r3 = r9.mLock     // Catch:{ all -> 0x0091 }
                monitor-enter(r3)     // Catch:{ all -> 0x0091 }
                androidx.emoji2.text.FontRequestEmojiCompatConfig$RetryPolicy r4 = r9.mRetryPolicy     // Catch:{ all -> 0x0033 }
                if (r4 == 0) goto L_0x0031
                ...
                r9.scheduleRetry(r0, r4)     // Catch:{ all -> 0x0033 }
            ...
            L_0x0036:
                ...
                androidx.core.os.TraceCompat.endSection()     // Catch:{ all -> 0x0091 }
                java.lang.Object r1 = r9.mLock     // Catch:{ all -> 0x0091 }
                monitor-enter(r1)     // Catch:{ all -> 0x0091 }
                androidx.emoji2.text.EmojiCompat$MetadataRepoLoaderCallback r2 = r9.mCallback     // Catch:{ all -> 0x006a }
                if (r2 == 0) goto L_0x0065
                r2.onLoaded(r0)     // Catch:{ all -> 0x006a }
            L_0x0065:
                monitor-exit(r1)     // Catch:{ all -> 0x006a }
                r9.cleanUp()     // Catch:{ all -> 0x0091 }
                goto L_0x00a0
            L_0x006a:
                r0 = move-exception
                monitor-exit(r1)     // Catch:{ all -> 0x006a }
            ...
            L_0x0091:
                ...
                monitor-enter(r2)
                androidx.emoji2.text.EmojiCompat$MetadataRepoLoaderCallback r1 = r9.mCallback     // Catch:{ all -> 0x00a1 }
                if (r1 == 0) goto L_0x009c
                r1.onFailed(r0)     // Catch:{ all -> 0x00a1 }
            L_0x009c:
