...
public class GridLayout extends ViewGroup {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:16:0x0026, code lost:
        if (r6.min == 0) goto L_0x0031;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:18:0x002f, code lost:
        if (r6.max == r0.getCount()) goto L_0x0031;
     */
    ...
    private int getDefaultMargin(android.view.View r5, androidx.gridlayout.widget.GridLayout.LayoutParams r6, boolean r7, boolean r8) {
        ...
        L_0x0031:
            r1 = 1
        L_0x0032:
            int r5 = r4.getDefaultMargin((android.view.View) r5, (boolean) r1, (boolean) r7, (boolean) r8)
            return r5
        */
    ...
    static class Bounds {
        ...
        public String toString() {
            return "Bounds{before=" + this.before + ", after=" + this.after + AbstractJsonLexerKt.END_OBJ;
        }
    }
