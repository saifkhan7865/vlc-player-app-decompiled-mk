...
public abstract class PreferenceFragmentCompat extends Fragment implements PreferenceManager.OnPreferenceTreeClickListener, PreferenceManager.OnDisplayPreferenceDialogListener, PreferenceManager.OnNavigateToScreenListener, DialogPreference.TargetFragment {
    ...
    public void setPreferencesFromResource(int i, String str) {
        requirePreferenceManager();
        PreferenceScreen inflateFromResource = this.mPreferenceManager.inflateFromResource(requireContext(), i, (PreferenceScreen) null);
    ...
    public boolean onPreferenceTreeClick(Preference preference) {
        ...
        while (!onPreferenceStartFragment && fragment != null) {
    ...
    public void onNavigateToScreen(PreferenceScreen preferenceScreen) {
        ...
        Fragment fragment = this;
        while (!onPreferenceStartScreen && fragment != null) {
    ...
    public void onDisplayPreferenceDialog(Preference preference) {
        ...
        Fragment fragment = this;
        while (!onPreferenceDisplayDialog && fragment != null) {
