...
public final class RoomTrackingLiveData<T> extends LiveData<T> {
    ...
    public static final void refreshRunnable$lambda$0(androidx.room.RoomTrackingLiveData r5) {
        ...
        L_0x001a:
            ...
            r3 = 0
        L_0x0024:
            java.util.concurrent.atomic.AtomicBoolean r4 = r5.invalid     // Catch:{ all -> 0x0054 }
            boolean r4 = r4.compareAndSet(r2, r1)     // Catch:{ all -> 0x0054 }
            if (r4 == 0) goto L_0x003f
            java.util.concurrent.Callable<T> r0 = r5.computeFunction     // Catch:{ Exception -> 0x0034 }
        ...
        L_0x0034:
            ...
            r2.<init>(r3, r0)     // Catch:{ all -> 0x0054 }
            throw r2     // Catch:{ all -> 0x0054 }
        L_0x003f:
            if (r3 == 0) goto L_0x0044
            r5.postValue(r0)     // Catch:{ all -> 0x0054 }
        L_0x0044:
            java.util.concurrent.atomic.AtomicBoolean r0 = r5.computing
            r0.set(r1)
