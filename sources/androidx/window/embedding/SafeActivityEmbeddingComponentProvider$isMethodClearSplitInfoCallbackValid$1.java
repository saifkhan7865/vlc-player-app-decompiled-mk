...
final class SafeActivityEmbeddingComponentProvider$isMethodClearSplitInfoCallbackValid$1 extends Lambda implements Function0<Boolean> {
    ...
    public final Boolean invoke() {
        Method method = this.this$0.getActivityEmbeddingComponentClass().getMethod("clearSplitInfoCallback", (Class[]) null);
        ReflectionUtils reflectionUtils = ReflectionUtils.INSTANCE;
        Intrinsics.checkNotNullExpressionValue(method, "clearSplitInfoCallbackMethod");
