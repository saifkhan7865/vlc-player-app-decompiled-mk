...
final class SafeActivityEmbeddingComponentProvider$isMethodSetSplitInfoCallbackWindowConsumerValid$1 extends Lambda implements Function0<Boolean> {
    ...
    public final Boolean invoke() {
        Method method = this.this$0.getActivityEmbeddingComponentClass().getMethod("setSplitInfoCallback", new Class[]{Consumer.class});
        ReflectionUtils reflectionUtils = ReflectionUtils.INSTANCE;
        Intrinsics.checkNotNullExpressionValue(method, "setSplitInfoCallbackMethod");
