...
final class SafeActivityEmbeddingComponentProvider$isMethodIsActivityEmbeddedValid$1 extends Lambda implements Function0<Boolean> {
    ...
    public final Boolean invoke() {
        boolean z = true;
        Method method = this.this$0.getActivityEmbeddingComponentClass().getMethod("isActivityEmbedded", new Class[]{Activity.class});
        ReflectionUtils reflectionUtils = ReflectionUtils.INSTANCE;
        Intrinsics.checkNotNullExpressionValue(method, "isActivityEmbeddedMethod");
        if (!reflectionUtils.isPublic$window_release(method) || !ReflectionUtils.INSTANCE.doesReturn$window_release(method, (Class<?>) Boolean.TYPE)) {
            z = false;
        }
