...
final class WindowInfoTrackerImpl$windowLayoutInfo$1 extends SuspendLambda implements Function2<ProducerScope<? super WindowLayoutInfo>, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            final WindowInfoTrackerImpl$windowLayoutInfo$1$$ExternalSyntheticLambda0 windowInfoTrackerImpl$windowLayoutInfo$1$$ExternalSyntheticLambda0 = new WindowInfoTrackerImpl$windowLayoutInfo$1$$ExternalSyntheticLambda0(producerScope);
            this.this$0.windowBackend.registerLayoutChangeCallback(this.$context, new ProfileInstallReceiver$$ExternalSyntheticLambda0(), windowInfoTrackerImpl$windowLayoutInfo$1$$ExternalSyntheticLambda0);
            ...
            if (ProduceKt.awaitClose(producerScope, new Function0<Unit>() {
                public final void invoke() {
                    windowInfoTrackerImpl.windowBackend.unregisterLayoutChangeCallback(windowInfoTrackerImpl$windowLayoutInfo$1$$ExternalSyntheticLambda0);
                }
