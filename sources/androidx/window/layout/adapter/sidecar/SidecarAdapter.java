...
public final class SidecarAdapter {
    ...
    public SidecarAdapter() {
        this((VerificationMode) null, 1, (DefaultConstructorMarker) null);
    }

    public SidecarAdapter(VerificationMode verificationMode2) {
    ...
    public /* synthetic */ SidecarAdapter(VerificationMode verificationMode2, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this((i & 1) != 0 ? VerificationMode.QUIET : verificationMode2);
    }
    ...
    public final WindowLayoutInfo translate(SidecarWindowLayoutInfo sidecarWindowLayoutInfo, SidecarDeviceState sidecarDeviceState) {
        Intrinsics.checkNotNullParameter(sidecarDeviceState, OAuth2RequestParameters.State);
