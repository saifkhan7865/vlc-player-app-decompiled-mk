        ...
        if (str != null) {
            ...
            if (method == null) {
                try {
                    ...
                    Log.e(TypedValues.TriggerType.NAME, "Could not find method \"" + str + "\"on class " + view.getClass().getSimpleName() + AnsiRenderer.CODE_TEXT_SEPARATOR + Debug.getName(view));
                    return;
                }
            }
            try {
                ...
                Log.e(TypedValues.TriggerType.NAME, "Exception in call \"" + this.mCross + "\"on class " + view.getClass().getSimpleName() + AnsiRenderer.CODE_TEXT_SEPARATOR + Debug.getName(view));
            }
        }
    }
