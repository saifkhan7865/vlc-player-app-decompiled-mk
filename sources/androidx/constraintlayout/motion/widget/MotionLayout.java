...
public class MotionLayout extends ConstraintLayout implements NestedScrollingParent3 {
    ...
    class Model {
        ...
        private void debugLayoutParam(String str, ConstraintLayout.LayoutParams layoutParams) {
            String concat = AnsiRenderer.CODE_TEXT_SEPARATOR.concat(layoutParams.startToStart != -1 ? "SS" : "__");
        ...
        private void debugWidget(String str, ConstraintWidget constraintWidget) {
            ...
            String str3;
            String str4;
            StringBuilder sb = new StringBuilder(AnsiRenderer.CODE_TEXT_SEPARATOR);
            String str5 = "T";
            String str6 = "__";
        ...
        private void debugLayout(String str, ConstraintWidgetContainer constraintWidgetContainer) {
            String str2 = str + AnsiRenderer.CODE_TEXT_SEPARATOR + Debug.getName((View) constraintWidgetContainer.getCompanionWidget());
            ...
            for (int i = 0; i < size; i++) {
                ...
                Log.v(MotionLayout.TAG, str3 + "  " + name + AnsiRenderer.CODE_TEXT_SEPARATOR + constraintWidget + AnsiRenderer.CODE_TEXT_SEPARATOR + sb6);
            }
    ...
    private void debugPos() {
        for (int i = 0; i < getChildCount(); i++) {
            View childAt = getChildAt(i);
            Log.v(TAG, AnsiRenderer.CODE_TEXT_SEPARATOR + Debug.getLocation() + AnsiRenderer.CODE_TEXT_SEPARATOR + Debug.getName(this) + AnsiRenderer.CODE_TEXT_SEPARATOR + Debug.getName(getContext(), this.mCurrentState) + AnsiRenderer.CODE_TEXT_SEPARATOR + Debug.getName(childAt) + childAt.getLeft() + AnsiRenderer.CODE_TEXT_SEPARATOR + childAt.getTop());
        }
    }
    ...
    /* JADX WARNING: Removed duplicated region for block: B:117:0x01c1  */
    /* JADX WARNING: Removed duplicated region for block: B:124:0x01d6  */
    /* JADX WARNING: Removed duplicated region for block: B:125:0x01e8  */
    /* JADX WARNING: Removed duplicated region for block: B:135:0x0210  */
    /* JADX WARNING: Removed duplicated region for block: B:144:0x0226  */
