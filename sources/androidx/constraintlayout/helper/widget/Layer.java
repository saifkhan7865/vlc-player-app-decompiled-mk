...
public class Layer extends ConstraintHelper {
    ...
    public void onAttachedToWindow() {
        ...
        if (this.mApplyVisibilityOnAttach || this.mApplyElevationOnAttach) {
            ...
            float m = Build.VERSION.SDK_INT >= 21 ? getElevation() : 0.0f;
            for (int i = 0; i < this.mCount; i++) {
                ...
                if (viewById != null) {
                    ...
                    if (this.mApplyElevationOnAttach && m > 0.0f && Build.VERSION.SDK_INT >= 21) {
                        viewById.setTranslationZ(viewById.getTranslationZ() + m);
                    }
                }
            }
        }
