...
class TreeDocumentFile extends DocumentFile {
    ...
    public DocumentFile[] listFiles() {
        ...
        Uri uri = this.mUri;
        Uri m$1 = DocumentsContract.buildChildDocumentsUriUsingTree(uri, DocumentsContract.getDocumentId(uri));
        ArrayList arrayList = new ArrayList();
        Cursor cursor = null;
        try {
            cursor = contentResolver.query(m$1, new String[]{"document_id"}, (String) null, (String[]) null, (String) null);
    ...
    public boolean renameTo(String str) {
        try {
            Uri m = DocumentsContract.renameDocument(this.mContext.getContentResolver(), this.mUri, str);
            if (m != null) {
                this.mUri = m;
                return true;
            }
