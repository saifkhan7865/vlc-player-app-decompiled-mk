...
class GhostViewHolder extends FrameLayout {
    ...
    private static boolean isOnTop(View view, View view2) {
        ...
        if (Build.VERSION.SDK_INT < 21 || Trace$$ExternalSyntheticApiModelOutline0.m(view) == Trace$$ExternalSyntheticApiModelOutline0.m(view2)) {
            ...
            return true;
        } else if (Trace$$ExternalSyntheticApiModelOutline0.m(view) > Trace$$ExternalSyntheticApiModelOutline0.m(view2)) {
            return true;
        } else {
            return false;
        }
