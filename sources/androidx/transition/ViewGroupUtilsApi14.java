...
class ViewGroupUtilsApi14 {
    ...
    static void suppressLayout(android.view.ViewGroup r5, boolean r6) {
        ...
        L_0x0066:
            ...
            boolean r6 = r6.getBoolean(r5)     // Catch:{ IllegalAccessException -> 0x0077 }
    ...
    private static void cancelLayoutTransition(LayoutTransition layoutTransition) {
        if (!sCancelMethodFetched) {
            try {
                Method declaredMethod = LayoutTransition.class.getDeclaredMethod("cancel", (Class[]) null);
        ...
        if (method != null) {
            try {
                method.invoke(layoutTransition, (Object[]) null);
