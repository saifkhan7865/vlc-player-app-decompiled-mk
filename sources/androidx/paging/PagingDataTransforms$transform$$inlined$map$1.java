...
public final class PagingDataTransforms$transform$$inlined$map$1 implements Flow<PageEvent<R>> {
    ...
    public Object collect(final FlowCollector flowCollector, Continuation continuation) {
        ...
        final Function2 function2 = this.$transform$inlined;
        Object collect = flow.collect(new FlowCollector() {
            ...
            public final Object emit$$forInline(Object obj, Continuation continuation) {
                ...
                Object invoke = r2.invoke((PageEvent) obj, continuation);
                InlineMarker.mark(0);
    ...
    public Object collect$$forInline(final FlowCollector flowCollector, Continuation continuation) {
        ...
        flow.collect(new FlowCollector() {
            ...
            public final Object emit$$forInline(Object obj, Continuation continuation) {
                ...
                Object invoke = function2.invoke((PageEvent) obj, continuation);
                InlineMarker.mark(0);
                flowCollector.emit(invoke, continuation);
                InlineMarker.mark(1);
                return Unit.INSTANCE;
