...
public final class LivePagedList<Key, Value> extends LiveData<PagedList<Value>> {
    ...
    public LivePagedList(CoroutineScope coroutineScope2, Key key, PagedList.Config config2, PagedList.BoundaryCallback<Value> boundaryCallback2, Function0<? extends PagingSource<Key, Value>> function0, CoroutineDispatcher coroutineDispatcher, CoroutineDispatcher coroutineDispatcher2) {
        ...
        LivePagedList$$ExternalSyntheticLambda0 livePagedList$$ExternalSyntheticLambda0 = new LivePagedList$$ExternalSyntheticLambda0(this);
    ...
    public static final void refreshRetryCallback$lambda$0(LivePagedList livePagedList) {
        Intrinsics.checkNotNullParameter(livePagedList, "this$0");
    ...
    public final void invalidate(boolean z) {
        ...
        if (job == null || z) {
            ...
            this.currentJob = BuildersKt__Builders_commonKt.launch$default(this.coroutineScope, this.fetchDispatcher, (CoroutineStart) null, new LivePagedList$invalidate$1(this, (Continuation<? super LivePagedList$invalidate$1>) null), 2, (Object) null);
        }
    }
