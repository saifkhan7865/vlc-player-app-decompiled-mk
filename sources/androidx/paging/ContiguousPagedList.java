...
public class ContiguousPagedList<K, V> extends PagedList<V> implements PagedStorage.Callback, LegacyPageFetcher.PageConsumer<V> {
    ...
    public ContiguousPagedList(PagingSource<K, V> pagingSource2, CoroutineScope coroutineScope, CoroutineDispatcher coroutineDispatcher, CoroutineDispatcher coroutineDispatcher2, PagedList.BoundaryCallback<V> boundaryCallback2, PagedList.Config config, PagingSource.LoadResult.Page<K, V> page, K k) {
    ...
    @Metadata(d1 = {"\u0000\u0014\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\b\n\u0002\b\b\b\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J%\u0010\u0003\u001a\u00020\u00042\u0006\u0010\u0005\u001a\u00020\u00042\u0006\u0010\u0006\u001a\u00020\u00042\u0006\u0010\u0007\u001a\u00020\u0004H\u0000¢\u0006\u0002\b\bJ%\u0010\t\u001a\u00020\u00042\u0006\u0010\u0005\u001a\u00020\u00042\u0006\u0010\u0006\u001a\u00020\u00042\u0006\u0010\n\u001a\u00020\u0004H\u0000¢\u0006\u0002\b\u000b¨\u0006\f"}, d2 = {"Landroidx/paging/ContiguousPagedList$Companion;", "", "()V", "getAppendItemsRequested", "", "prefetchDistance", "index", "itemsBeforeTrailingNulls", "getAppendItemsRequested$paging_common", "getPrependItemsRequested", "leadingNulls", "getPrependItemsRequested$paging_common", "paging-common"}, k = 1, mv = {1, 8, 0}, xi = 48)
    /* compiled from: ContiguousPagedList.kt */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:18:0x0069, code lost:
        if ((!r0.isEmpty()) != false) goto L_0x0098;
     */
    ...
    public final void deferBoundaryCallbacks$paging_common(boolean z, boolean z2, boolean z3) {
        if (this.boundaryCallback != null) {
            ...
            if (z || z2 || z3) {
                Job unused = BuildersKt__Builders_commonKt.launch$default(getCoroutineScope$paging_common(), getNotifyDispatcher$paging_common(), (CoroutineStart) null, new ContiguousPagedList$deferBoundaryCallbacks$1(z, this, z2, z3, (Continuation<? super ContiguousPagedList$deferBoundaryCallbacks$1>) null), 2, (Object) null);
                return;
            }
            return;
        }
    ...
    public final void tryDispatchBoundaryCallbacks(boolean z) {
        ...
        if (z3 || z2) {
            ...
            if (z) {
                Job unused = BuildersKt__Builders_commonKt.launch$default(getCoroutineScope$paging_common(), getNotifyDispatcher$paging_common(), (CoroutineStart) null, new ContiguousPagedList$tryDispatchBoundaryCallbacks$1(this, z3, z2, (Continuation<? super ContiguousPagedList$tryDispatchBoundaryCallbacks$1>) null), 2, (Object) null);
            } else {
