...
public class WrapperDataSource<Key, ValueFrom, ValueTo> extends DataSource<Key, ValueTo> {
        ...
        if (identityHashMap != null) {
            synchronized (identityHashMap) {
                ...
                for (int i = 0; i < size; i++) {
                    ...
                    this.keyMap.put(obj, ((ItemKeyedDataSource) dataSource).getKey(list.get(i)));
                }
    ...
    static /* synthetic */ <Key, ValueFrom, ValueTo> java.lang.Object load$suspendImpl(androidx.paging.WrapperDataSource<Key, ValueFrom, ValueTo> r4, androidx.paging.DataSource.Params<Key> r5, kotlin.coroutines.Continuation<? super androidx.paging.DataSource.BaseResult<ValueTo>> r6) {
        /*
