...
public abstract class ComputableLiveData<T> {
    ...
    public static final void refreshRunnable$lambda$0(androidx.lifecycle.ComputableLiveData r5) {
        ...
        L_0x0005:
            ...
            r3 = 0
        L_0x0011:
            java.util.concurrent.atomic.AtomicBoolean r4 = r5.invalid     // Catch:{ all -> 0x0038 }
            boolean r4 = r4.compareAndSet(r2, r1)     // Catch:{ all -> 0x0038 }
            if (r4 == 0) goto L_0x001f
            java.lang.Object r0 = r5.compute()     // Catch:{ all -> 0x0038 }
            r3 = 1
            goto L_0x0011
        L_0x001f:
            if (r3 == 0) goto L_0x0028
            androidx.lifecycle.LiveData r2 = r5.getLiveData()     // Catch:{ all -> 0x0038 }
            r2.postValue(r0)     // Catch:{ all -> 0x0038 }
        L_0x0028:
            java.util.concurrent.atomic.AtomicBoolean r0 = r5.computing
            r0.set(r1)
