...
public final class SavedStateHandle {
    ...
    public SavedStateHandle(Map<String, ? extends Object> map) {
        ...
        this.savedStateProvider = new SavedStateHandle$$ExternalSyntheticLambda2(this);
        ...
        public final SavedStateHandle createHandle(Bundle bundle, Bundle bundle2) {
            if (bundle != null) {
                ...
                for (String str : bundle2.keySet()) {
                    Intrinsics.checkNotNullExpressionValue(str, LeanbackPreferenceDialogFragment.ARG_KEY);
