    ...
    public static class Axis {
        ...
        public final int getScroll(int r9) {
            ...
            L_0x005d:
                return r5
            L_0x005e:
                int r9 = r8.calculateScrollToKeyLine(r9, r1)
                return r9
            */
        ...
        public String toString() {
            return " min:" + this.mMinEdge + AnsiRenderer.CODE_TEXT_SEPARATOR + this.mMinScroll + " max:" + this.mMaxEdge + AnsiRenderer.CODE_TEXT_SEPARATOR + this.mMaxScroll;
        }
    }
