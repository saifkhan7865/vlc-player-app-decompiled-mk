...
class SlideKitkat extends Visibility {
    ...
    public Animator onAppear(ViewGroup viewGroup, TransitionValues transitionValues, int i, TransitionValues transitionValues2, int i2) {
        View m = transitionValues2 != null ? FragmentUtil$$ExternalSyntheticApiModelOutline0.m(transitionValues2) : null;
        if (m == null) {
            return null;
        }
        float here = this.mSlideCalculator.getHere(m);
        return createAnimation(m, this.mSlideCalculator.getProperty(), this.mSlideCalculator.getGone(m), here, here, sDecelerate, 0);
    }

    public Animator onDisappear(ViewGroup viewGroup, TransitionValues transitionValues, int i, TransitionValues transitionValues2, int i2) {
        View m = transitionValues != null ? FragmentUtil$$ExternalSyntheticApiModelOutline0.m(transitionValues) : null;
        if (m == null) {
            return null;
        }
        float here = this.mSlideCalculator.getHere(m);
        return createAnimation(m, this.mSlideCalculator.getProperty(), here, this.mSlideCalculator.getGone(m), here, sAccelerate, 4);
    }
