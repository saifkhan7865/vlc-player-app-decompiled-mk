...
public class VectorDrawableCompat extends VectorDrawableCommon {
    ...
    private static class VectorDrawableDelegateState extends Drawable.ConstantState {
        ...
        public Drawable newDrawable() {
            VectorDrawableCompat vectorDrawableCompat = new VectorDrawableCompat();
            vectorDrawableCompat.mDelegateDrawable = WindowIdApi18$$ExternalSyntheticApiModelOutline0.m((Object) this.mDelegateState.newDrawable());
            return vectorDrawableCompat;
        }

        public Drawable newDrawable(Resources resources) {
            VectorDrawableCompat vectorDrawableCompat = new VectorDrawableCompat();
            vectorDrawableCompat.mDelegateDrawable = WindowIdApi18$$ExternalSyntheticApiModelOutline0.m((Object) this.mDelegateState.newDrawable(resources));
            return vectorDrawableCompat;
        }

        public Drawable newDrawable(Resources resources, Resources.Theme theme) {
            VectorDrawableCompat vectorDrawableCompat = new VectorDrawableCompat();
            vectorDrawableCompat.mDelegateDrawable = WindowIdApi18$$ExternalSyntheticApiModelOutline0.m((Object) this.mDelegateState.newDrawable(resources, theme));
            return vectorDrawableCompat;
        }
        ...
        public String nodesToString(PathParser.PathDataNode[] pathDataNodeArr) {
            ...
            for (int i = 0; i < pathDataNodeArr.length; i++) {
                ...
                for (int i2 = 0; i2 < fArr.length; i2++) {
                    str = str + fArr[i2] + AnsiRenderer.CODE_LIST_SEPARATOR;
                }
            }
            return str;
        }
