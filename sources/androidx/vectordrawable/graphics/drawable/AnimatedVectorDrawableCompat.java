...
public class AnimatedVectorDrawableCompat extends VectorDrawableCommon implements Animatable2Compat {
    ...
    public boolean isRunning() {
        if (this.mDelegateDrawable != null) {
            return WindowIdApi18$$ExternalSyntheticApiModelOutline0.m(WindowIdApi18$$ExternalSyntheticApiModelOutline0.m((Object) this.mDelegateDrawable));
        }
    ...
    public void start() {
        if (this.mDelegateDrawable != null) {
            WindowIdApi18$$ExternalSyntheticApiModelOutline0.m((Object) this.mDelegateDrawable).start();
    ...
    public void stop() {
        if (this.mDelegateDrawable != null) {
            WindowIdApi18$$ExternalSyntheticApiModelOutline0.m(WindowIdApi18$$ExternalSyntheticApiModelOutline0.m((Object) this.mDelegateDrawable));
        } else {
    ...
    private static boolean unregisterPlatformCallback(AnimatedVectorDrawable animatedVectorDrawable, Animatable2Compat.AnimationCallback animationCallback) {
        return WindowIdApi18$$ExternalSyntheticApiModelOutline0.m(animatedVectorDrawable, animationCallback.getPlatformCallback());
    }

    public void registerAnimationCallback(Animatable2Compat.AnimationCallback animationCallback) {
        if (this.mDelegateDrawable != null) {
            registerPlatformCallback(WindowIdApi18$$ExternalSyntheticApiModelOutline0.m((Object) this.mDelegateDrawable), animationCallback);
    ...
    private static void registerPlatformCallback(AnimatedVectorDrawable animatedVectorDrawable, Animatable2Compat.AnimationCallback animationCallback) {
        WindowIdApi18$$ExternalSyntheticApiModelOutline0.m(animatedVectorDrawable, animationCallback.getPlatformCallback());
    }
    ...
    public boolean unregisterAnimationCallback(Animatable2Compat.AnimationCallback animationCallback) {
        if (this.mDelegateDrawable != null) {
            unregisterPlatformCallback(WindowIdApi18$$ExternalSyntheticApiModelOutline0.m((Object) this.mDelegateDrawable), animationCallback);
        }
    ...
    public void clearAnimationCallbacks() {
        if (this.mDelegateDrawable != null) {
            WindowIdApi18$$ExternalSyntheticApiModelOutline0.m((Object) this.mDelegateDrawable).clearAnimationCallbacks();
            return;
        }
        removeAnimatorSetListener();
        ArrayList<Animatable2Compat.AnimationCallback> arrayList = this.mAnimationCallbacks;
    ...
    public static void registerAnimationCallback(Drawable drawable, Animatable2Compat.AnimationCallback animationCallback) {
        if (drawable != null && animationCallback != null && (drawable instanceof Animatable)) {
            if (Build.VERSION.SDK_INT >= 24) {
                registerPlatformCallback(WindowIdApi18$$ExternalSyntheticApiModelOutline0.m((Object) drawable), animationCallback);
            } else {
    ...
    public static boolean unregisterAnimationCallback(Drawable drawable, Animatable2Compat.AnimationCallback animationCallback) {
        ...
        if (Build.VERSION.SDK_INT >= 24) {
            return unregisterPlatformCallback(WindowIdApi18$$ExternalSyntheticApiModelOutline0.m((Object) drawable), animationCallback);
        }
    ...
    public static void clearAnimationCallbacks(Drawable drawable) {
        if (drawable instanceof Animatable) {
            if (Build.VERSION.SDK_INT >= 24) {
                WindowIdApi18$$ExternalSyntheticApiModelOutline0.m((Object) drawable).clearAnimationCallbacks();
            } else {
