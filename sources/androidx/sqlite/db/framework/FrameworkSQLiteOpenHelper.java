...
public final class FrameworkSQLiteOpenHelper implements SupportSQLiteOpenHelper {
    ...
    private static final class OpenHelper extends SQLiteOpenHelper {
        ...
        private final android.database.sqlite.SQLiteDatabase innerGetDatabase(boolean r5) {
            ...
            L_0x0032:
                android.database.sqlite.SQLiteDatabase r5 = r4.getWritableOrReadableDatabase(r5)     // Catch:{ all -> 0x0037 }
                return r5
            L_0x0037:
                super.close()
            ...
            L_0x007b:
                ...
                android.database.sqlite.SQLiteDatabase r5 = r4.getWritableOrReadableDatabase(r5)     // Catch:{ CallbackException -> 0x0085 }
                return r5
            L_0x0085:
                r5 = move-exception
