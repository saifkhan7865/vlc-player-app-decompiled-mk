    ...
    public void onMeasure(int i, int i2) {
        ...
        while (true) {
            ...
            if (childAt.getVisibility() == 8) {
                ...
                childAt.measure(i9, getChildMeasureSpec(i10, getPaddingTop() + getPaddingBottom(), layoutParams.height));
            ...
            while (i16 < childCount) {
                ...
                if (childAt2.getVisibility() != i5) {
                    ...
                    if (z2) {
                        ...
                        i7 = i6 + ((int) ((layoutParams2.weight * ((float) Math.max(0, i15))) / f));
                        i8 = View.MeasureSpec.makeMeasureSpec(i7, 1073741824);
                    } else {
                        i7 = i6;
                        i8 = 0;
                    ...
                    if (i6 != i7) {
                        childAt2.measure(i8, measureChildHeight);
        ...
        if (splitViewPositions != null && !z2) {
            for (int i17 = 0; i17 < childCount; i17++) {
                ...
                if (childAt3.getVisibility() != 8) {
                    Rect rect = splitViewPositions.get(i17);
        ...
        setMeasuredDimension(i14, i4 + getPaddingTop() + getPaddingBottom());
        this.mCanSlide = z2;
    ...
    public void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        while (i12 < childCount) {
            ...
            if (childAt.getVisibility() == 8) {
                ...
                paddingRight += childAt.getWidth() + Math.abs((foldingFeature == null || foldingFeature.getOrientation() != FoldingFeature.Orientation.VERTICAL || !this.mFoldingFeature.isSeparating()) ? 0 : this.mFoldingFeature.getBounds().width());
            }
            i12++;
            i11 = i5;
        }
