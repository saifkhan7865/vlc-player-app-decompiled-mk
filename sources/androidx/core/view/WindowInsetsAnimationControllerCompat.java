...
public final class WindowInsetsAnimationControllerCompat {
    ...
    private static class Impl30 extends Impl {
        ...
        public Insets getShownStateInsets() {
            return Insets.toCompatInsets(WindowInsetsCompat$$ExternalSyntheticApiModelOutline0.m(this.mController));
        }

        public Insets getCurrentInsets() {
            return Insets.toCompatInsets(WindowInsetsCompat$$ExternalSyntheticApiModelOutline0.m$1(this.mController));
        }

        public float getCurrentFraction() {
            return WindowInsetsCompat$$ExternalSyntheticApiModelOutline0.m(this.mController);
        }

        public float getCurrentAlpha() {
            return WindowInsetsCompat$$ExternalSyntheticApiModelOutline0.m$1(this.mController);
        }
