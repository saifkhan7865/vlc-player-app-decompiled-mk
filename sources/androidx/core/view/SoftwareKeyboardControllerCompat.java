    ...
    private static class Impl30 extends Impl20 {
        ...
        public void show() {
            ...
            if (windowInsetsController == null) {
                View view = this.mView;
                windowInsetsController = view != null ? BundleKt$$ExternalSyntheticApiModelOutline0.m(view) : null;
            }
            if (windowInsetsController != null) {
                windowInsetsController.show(BundleKt$$ExternalSyntheticApiModelOutline0.m());
            } else {
                super.show();
            }
        }
        ...
        public void hide() {
            ...
            if (windowInsetsController == null) {
                ...
                windowInsetsController = view2 != null ? BundleKt$$ExternalSyntheticApiModelOutline0.m(view2) : null;
            }
            if (windowInsetsController != null) {
                ...
                windowInsetsController.hide(BundleKt$$ExternalSyntheticApiModelOutline0.m());
                return;
            }
            super.hide();
        }
