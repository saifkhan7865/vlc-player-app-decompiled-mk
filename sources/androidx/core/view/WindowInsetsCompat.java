...
public class WindowInsetsCompat {
    ...
    private static class Impl20 extends Impl {
        ...
        /* access modifiers changed from: package-private */
        public boolean isRound() {
            return WindowInsetsCompat$$ExternalSyntheticApiModelOutline0.m(this.mPlatformInsets);
        }
        ...
        public final Insets getSystemWindowInsets() {
            if (this.mSystemWindowInsets == null) {
                this.mSystemWindowInsets = Insets.of(WindowInsetsCompat$$ExternalSyntheticApiModelOutline0.m(this.mPlatformInsets), WindowInsetsCompat$$ExternalSyntheticApiModelOutline0.m$1(this.mPlatformInsets), WindowInsetsCompat$$ExternalSyntheticApiModelOutline0.m$2(this.mPlatformInsets), this.mPlatformInsets.getSystemWindowInsetBottom());
            }
    ...
    private static class Impl21 extends Impl20 {
        ...
        /* access modifiers changed from: package-private */
        public boolean isConsumed() {
            return WindowInsetsCompat$$ExternalSyntheticApiModelOutline0.m$1(this.mPlatformInsets);
        }

        /* access modifiers changed from: package-private */
        public WindowInsetsCompat consumeStableInsets() {
            return WindowInsetsCompat.toWindowInsetsCompat(WindowInsetsCompat$$ExternalSyntheticApiModelOutline0.m(this.mPlatformInsets));
        }

        /* access modifiers changed from: package-private */
        public WindowInsetsCompat consumeSystemWindowInsets() {
            return WindowInsetsCompat.toWindowInsetsCompat(WindowInsetsCompat$$ExternalSyntheticApiModelOutline0.m$1(this.mPlatformInsets));
        }
    ...
    private static class Impl28 extends Impl21 {
        ...
        /* access modifiers changed from: package-private */
        public DisplayCutoutCompat getDisplayCutout() {
            return DisplayCutoutCompat.wrap(WindowInsetsCompat$$ExternalSyntheticApiModelOutline0.m(this.mPlatformInsets));
        }

        /* access modifiers changed from: package-private */
        public WindowInsetsCompat consumeDisplayCutout() {
            return WindowInsetsCompat.toWindowInsetsCompat(WindowInsetsCompat$$ExternalSyntheticApiModelOutline0.m$2(this.mPlatformInsets));
        }
    ...
    private static class Impl29 extends Impl28 {
        ...
        public Insets getSystemGestureInsets() {
            if (this.mSystemGestureInsets == null) {
                this.mSystemGestureInsets = Insets.toCompatInsets(WindowInsetsCompat$$ExternalSyntheticApiModelOutline0.m$2(this.mPlatformInsets));
            }
        ...
        public Insets getMandatorySystemGestureInsets() {
            if (this.mMandatorySystemGestureInsets == null) {
                this.mMandatorySystemGestureInsets = Insets.toCompatInsets(WindowInsetsCompat$$ExternalSyntheticApiModelOutline0.m$1(this.mPlatformInsets));
            }
        ...
        public Insets getTappableElementInsets() {
            if (this.mTappableElementInsets == null) {
                this.mTappableElementInsets = Insets.toCompatInsets(WindowInsetsCompat$$ExternalSyntheticApiModelOutline0.m(this.mPlatformInsets));
            }
    ...
    private static class Impl30 extends Impl29 {
        static final WindowInsetsCompat CONSUMED = WindowInsetsCompat.toWindowInsetsCompat(WindowInsetsCompat$$ExternalSyntheticApiModelOutline0.m());
        ...
        public Insets getInsetsIgnoringVisibility(int i) {
            return Insets.toCompatInsets(WindowInsetsCompat$$ExternalSyntheticApiModelOutline0.m(this.mPlatformInsets, TypeImpl30.toPlatformType(i)));
        }

        public boolean isVisible(int i) {
            return WindowInsetsCompat$$ExternalSyntheticApiModelOutline0.m(this.mPlatformInsets, TypeImpl30.toPlatformType(i));
        }
    }
    ...
    private static class BuilderImpl20 extends BuilderImpl {
        ...
        private static WindowInsets createWindowInsetsInstance() {
            if (!sConsumedFieldFetched) {
                try {
                    sConsumedField = WindowInsetsCompat$$ExternalSyntheticApiModelOutline0.m().getDeclaredField("CONSUMED");
                } catch (ReflectiveOperationException e) {
            ...
            if (field != null) {
                try {
                    WindowInsets m = WindowInsetsCompat$$ExternalSyntheticApiModelOutline0.m(field.get((Object) null));
                    if (m != null) {
            ...
            if (!sConstructorFetched) {
                try {
                    sConstructor = WindowInsetsCompat$$ExternalSyntheticApiModelOutline0.m().getConstructor(new Class[]{Rect.class});
            ...
            if (constructor != null) {
                try {
                    return WindowInsetsCompat$$ExternalSyntheticApiModelOutline0.m((Object) constructor.newInstance(new Object[]{new Rect()}));
    ...
    private static final class TypeImpl30 {
        ...
        static int toPlatformType(int i) {
            ...
            for (int i4 = 1; i4 <= 256; i4 <<= 1) {
                if ((i & i4) != 0) {
                    if (i4 == 1) {
                        i2 = WindowInsetsCompat$$ExternalSyntheticApiModelOutline0.m();
                    } else if (i4 == 2) {
                        i2 = WindowInsets.Type.navigationBars();
                    } else if (i4 == 4) {
                        i2 = WindowInsets.Type.captionBar();
                    } else if (i4 == 8) {
                        i2 = BundleKt$$ExternalSyntheticApiModelOutline0.m();
                    } else if (i4 == 16) {
