...
public final class ContentInfoCompat {
    ...
    public ContentInfo toContentInfo() {
        return BundleKt$$ExternalSyntheticApiModelOutline0.m(Objects.requireNonNull(this.mCompat.getWrapped()));
    }
    ...
    private static final class Compat31Impl implements Compat {
        ...
        Compat31Impl(ContentInfo contentInfo) {
            this.mWrapped = BundleKt$$ExternalSyntheticApiModelOutline0.m(Preconditions.checkNotNull(contentInfo));
        }
        ...
        public ClipData getClip() {
            return BundleKt$$ExternalSyntheticApiModelOutline0.m(this.mWrapped);
        }
