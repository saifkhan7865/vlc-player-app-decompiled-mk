...
public final class WindowInsetsAnimationCompat {
    ...
    private static class Impl21 extends Impl {
        ...
        private static class Impl21OnApplyWindowInsetsListener implements View.OnApplyWindowInsetsListener {
            ...
            public WindowInsets onApplyWindowInsets(View view, WindowInsets windowInsets) {
                ...
                if (!BundleKt$$ExternalSyntheticApiModelOutline0.m(view)) {
    ...
    private static class Impl30 extends Impl {
        ...
        public int getTypeMask() {
            return WindowInsetsCompat$$ExternalSyntheticApiModelOutline0.m(this.mWrapped);
        }
        ...
        private static class ProxyCallback extends WindowInsetsAnimation.Callback {
            ...
            public WindowInsets onProgress(WindowInsets windowInsets, List<WindowInsetsAnimation> list) {
                ...
                for (int size = list.size() - 1; size >= 0; size--) {
                    WindowInsetsAnimation m = WindowInsetsCompat$$ExternalSyntheticApiModelOutline0.m((Object) list.get(size));
                    WindowInsetsAnimationCompat windowInsetsAnimationCompat = getWindowInsetsAnimationCompat(m);
                    windowInsetsAnimationCompat.setFraction(WindowInsetsCompat$$ExternalSyntheticApiModelOutline0.m(m));
