...
public final class AppOpsManagerCompat {
    ...
    public static int noteOp(Context context, String str, int i, String str2) {
        if (Build.VERSION.SDK_INT >= 19) {
            return Api19Impl.noteOp(AnimatorKt$$ExternalSyntheticApiModelOutline0.m(context.getSystemService("appops")), str, i, str2);
        }
        return 1;
    }
    ...
    public static int noteOpNoThrow(Context context, String str, int i, String str2) {
        if (Build.VERSION.SDK_INT >= 19) {
            return Api19Impl.noteOpNoThrow(AnimatorKt$$ExternalSyntheticApiModelOutline0.m(context.getSystemService("appops")), str, i, str2);
        }
        return 1;
    }
    ...
    public static int noteProxyOp(Context context, String str, String str2) {
        if (Build.VERSION.SDK_INT >= 23) {
            return Api23Impl.noteProxyOp(AnimatorKt$$ExternalSyntheticApiModelOutline0.m(Api23Impl.getSystemService(context, AnimatorKt$$ExternalSyntheticApiModelOutline0.m())), str, str2);
        }
        return 1;
    }
    ...
    public static int noteProxyOpNoThrow(Context context, String str, String str2) {
        if (Build.VERSION.SDK_INT >= 23) {
            return Api23Impl.noteProxyOpNoThrow(AnimatorKt$$ExternalSyntheticApiModelOutline0.m(Api23Impl.getSystemService(context, AnimatorKt$$ExternalSyntheticApiModelOutline0.m())), str, str2);
        }
        return 1;
    }
