...
public final class NotificationManagerCompat {
    ...
    public boolean areNotificationsEnabled() {
        ...
        AppOpsManager m = AnimatorKt$$ExternalSyntheticApiModelOutline0.m(this.mContext.getSystemService("appops"));
        ApplicationInfo applicationInfo = this.mContext.getApplicationInfo();
        String packageName = this.mContext.getApplicationContext().getPackageName();
        int i = applicationInfo.uid;
        try {
            Class<?> cls = Class.forName(AnimatorKt$$ExternalSyntheticApiModelOutline0.m().getName());
            Class cls2 = Integer.TYPE;
            Method method = cls.getMethod(CHECK_OP_NO_THROW, new Class[]{cls2, cls2, String.class});
            Integer num = (Integer) cls.getDeclaredField(OP_POST_NOTIFICATION).get(Integer.class);
            num.intValue();
            if (((Integer) method.invoke(m, new Object[]{num, Integer.valueOf(i), packageName})).intValue() == 0) {
                return true;
            }
            return false;
    ...
    public void deleteUnlistedNotificationChannels(Collection<String> collection) {
        if (Build.VERSION.SDK_INT >= 26) {
            for (NotificationChannel m : Api26Impl.getNotificationChannels(this.mNotificationManager)) {
                NotificationChannel m2 = AnimatorKt$$ExternalSyntheticApiModelOutline0.m((Object) m);
                if (!collection.contains(Api26Impl.getId(m2)) && (Build.VERSION.SDK_INT < 30 || !collection.contains(Api30Impl.getParentChannelId(m2)))) {
                    Api26Impl.deleteNotificationChannel(this.mNotificationManager, Api26Impl.getId(m2));
                }
            }
        }
    }
    ...
    public NotificationChannelGroup getNotificationChannelGroup(String str) {
        ...
        if (Build.VERSION.SDK_INT >= 26) {
            for (NotificationChannelGroup m : getNotificationChannelGroups()) {
                NotificationChannelGroup m2 = AnimatorKt$$ExternalSyntheticApiModelOutline0.m((Object) m);
                if (Api26Impl.getId(m2).equals(str)) {
                    return m2;
                }
            }
        }
        ...
        if (Build.VERSION.SDK_INT >= 26) {
            ...
            if (!notificationChannels.isEmpty()) {
                ...
                for (NotificationChannel m : notificationChannels) {
                    arrayList.add(new NotificationChannelCompat(AnimatorKt$$ExternalSyntheticApiModelOutline0.m((Object) m)));
                }
                return arrayList;
            }
        }
