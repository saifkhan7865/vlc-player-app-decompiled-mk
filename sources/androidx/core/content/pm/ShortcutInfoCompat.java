...
public class ShortcutInfoCompat {
    ...
    public ShortcutInfo toShortcutInfo() {
        ShortcutInfo.Builder m = new ShortcutInfo.Builder(this.mContext, this.mId).setShortLabel(this.mLabel).setIntents(this.mIntents);
    ...
    static Person[] getPersonsFromExtra(PersistableBundle persistableBundle) {
        if (persistableBundle == null || !AnimatorKt$$ExternalSyntheticApiModelOutline0.m(persistableBundle, EXTRA_PERSON_COUNT)) {
            return null;
        }
        int m = AnimatorKt$$ExternalSyntheticApiModelOutline0.m(persistableBundle, EXTRA_PERSON_COUNT);
        Person[] personArr = new Person[m];
        int i = 0;
        while (i < m) {
            StringBuilder sb = new StringBuilder(EXTRA_PERSON_);
            int i2 = i + 1;
            sb.append(i2);
            personArr[i] = Person.fromPersistableBundle(AnimatorKt$$ExternalSyntheticApiModelOutline0.m(persistableBundle, sb.toString()));
            i = i2;
        }
        return personArr;
    }
    ...
    static boolean getLongLivedFromExtra(PersistableBundle persistableBundle) {
        if (persistableBundle == null || !AnimatorKt$$ExternalSyntheticApiModelOutline0.m(persistableBundle, EXTRA_LONG_LIVED)) {
            return false;
        }
    ...
    static List<ShortcutInfoCompat> fromShortcuts(Context context, List<ShortcutInfo> list) {
        ...
        for (ShortcutInfo m : list) {
            arrayList.add(new Builder(context, PathKt$$ExternalSyntheticApiModelOutline0.m((Object) m)).build());
        }
        return arrayList;
    }
    ...
    static LocusIdCompat getLocusId(ShortcutInfo shortcutInfo) {
        ...
        if (PathKt$$ExternalSyntheticApiModelOutline0.m(shortcutInfo) == null) {
            return null;
        }
        return LocusIdCompat.toLocusIdCompat(PathKt$$ExternalSyntheticApiModelOutline0.m(shortcutInfo));
    }
    ...
    private static LocusIdCompat getLocusIdFromExtra(PersistableBundle persistableBundle) {
        String m;
        if (persistableBundle == null || (m = persistableBundle.getString(EXTRA_LOCUS_ID)) == null) {
            return null;
        }
        return new LocusIdCompat(m);
    }
    ...
    public static class Builder {
        ...
        public Builder(Context context, ShortcutInfo shortcutInfo) {
            ...
            this.mInfo = shortcutInfoCompat;
            shortcutInfoCompat.mContext = context;
            shortcutInfoCompat.mId = PathKt$$ExternalSyntheticApiModelOutline0.m(shortcutInfo);
            shortcutInfoCompat.mPackageName = PathKt$$ExternalSyntheticApiModelOutline0.m$1(shortcutInfo);
            Intent[] m = PathKt$$ExternalSyntheticApiModelOutline0.m(shortcutInfo);
            shortcutInfoCompat.mIntents = (Intent[]) Arrays.copyOf(m, m.length);
            shortcutInfoCompat.mActivity = PathKt$$ExternalSyntheticApiModelOutline0.m(shortcutInfo);
            shortcutInfoCompat.mLabel = PathKt$$ExternalSyntheticApiModelOutline0.m(shortcutInfo);
            shortcutInfoCompat.mLongLabel = PathKt$$ExternalSyntheticApiModelOutline0.m$1(shortcutInfo);
            shortcutInfoCompat.mDisabledMessage = PathKt$$ExternalSyntheticApiModelOutline0.m$2(shortcutInfo);
            if (Build.VERSION.SDK_INT >= 28) {
                shortcutInfoCompat.mDisabledReason = PathKt$$ExternalSyntheticApiModelOutline0.m$1(shortcutInfo);
            } else {
                shortcutInfoCompat.mDisabledReason = shortcutInfo.isEnabled() ? 0 : 3;
            }
            shortcutInfoCompat.mCategories = PathKt$$ExternalSyntheticApiModelOutline0.m(shortcutInfo);
            shortcutInfoCompat.mPersons = ShortcutInfoCompat.getPersonsFromExtra(shortcutInfo.getExtras());
            shortcutInfoCompat.mUser = PathKt$$ExternalSyntheticApiModelOutline0.m(shortcutInfo);
            shortcutInfoCompat.mLastChangedTimestamp = PathKt$$ExternalSyntheticApiModelOutline0.m(shortcutInfo);
            if (Build.VERSION.SDK_INT >= 30) {
                shortcutInfoCompat.mIsCached = PathKt$$ExternalSyntheticApiModelOutline0.m(shortcutInfo);
            }
            shortcutInfoCompat.mIsDynamic = PathKt$$ExternalSyntheticApiModelOutline0.m$1(shortcutInfo);
            shortcutInfoCompat.mIsPinned = PathKt$$ExternalSyntheticApiModelOutline0.m$2(shortcutInfo);
            ...
            shortcutInfoCompat.mRank = PathKt$$ExternalSyntheticApiModelOutline0.m(shortcutInfo);
