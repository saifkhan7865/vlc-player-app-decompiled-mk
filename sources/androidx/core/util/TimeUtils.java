...
public final class TimeUtils {
    ...
    private static int formatDurationLocked(long j, int i) {
        ...
        boolean z = i7 != 0;
        int i12 = i11;
        int printField = printField(cArr, i2, GMTDateParser.DAY_OF_MONTH, i11, false, 0);
        int printField2 = printField(cArr, i3, GMTDateParser.HOURS, printField, printField != i12, z ? 2 : 0);
        int printField3 = printField(cArr, i5, GMTDateParser.MINUTES, printField2, printField2 != i12, z ? 2 : 0);
        int printField4 = printField(cArr, i4, GMTDateParser.SECONDS, printField3, printField3 != i12, z ? 2 : 0);
        int printField5 = printField(cArr, i9, GMTDateParser.MINUTES, printField4, true, (!z || printField4 == i12) ? 0 : 3);
        cArr[printField5] = GMTDateParser.SECONDS;
