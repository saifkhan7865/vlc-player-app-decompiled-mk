...
public final class SparseLongArrayKt {
    ...
    public static final boolean contains(SparseLongArray sparseLongArray, int i) {
        return BundleKt$$ExternalSyntheticApiModelOutline0.m(sparseLongArray, i) >= 0;
    }

    public static final void set(SparseLongArray sparseLongArray, int i, long j) {
        BundleKt$$ExternalSyntheticApiModelOutline0.m(sparseLongArray, i, j);
    }
    ...
    public static final long getOrDefault(SparseLongArray sparseLongArray, int i, long j) {
        return BundleKt$$ExternalSyntheticApiModelOutline0.m(sparseLongArray, i, j);
    }

    public static final long getOrElse(SparseLongArray sparseLongArray, int i, Function0<Long> function0) {
        int m = BundleKt$$ExternalSyntheticApiModelOutline0.m(sparseLongArray, i);
        return m >= 0 ? BundleKt$$ExternalSyntheticApiModelOutline0.m(sparseLongArray, m) : function0.invoke().longValue();
    }
    ...
    public static final boolean remove(SparseLongArray sparseLongArray, int i, long j) {
        int m = BundleKt$$ExternalSyntheticApiModelOutline0.m(sparseLongArray, i);
        if (m < 0 || j != BundleKt$$ExternalSyntheticApiModelOutline0.m(sparseLongArray, m)) {
            return false;
        }
        BundleKt$$ExternalSyntheticApiModelOutline0.m(sparseLongArray, m);
        return true;
    }

    public static final void forEach(SparseLongArray sparseLongArray, Function2<? super Integer, ? super Long, Unit> function2) {
        int m = sparseLongArray.size();
        for (int i = 0; i < m; i++) {
            function2.invoke(Integer.valueOf(sparseLongArray.keyAt(i)), Long.valueOf(BundleKt$$ExternalSyntheticApiModelOutline0.m(sparseLongArray, i)));
        }
    }
    ...
    public static final void putAll(SparseLongArray sparseLongArray, SparseLongArray sparseLongArray2) {
        int m = sparseLongArray2.size();
        for (int i = 0; i < m; i++) {
            BundleKt$$ExternalSyntheticApiModelOutline0.m(sparseLongArray, sparseLongArray2.keyAt(i), BundleKt$$ExternalSyntheticApiModelOutline0.m(sparseLongArray2, i));
        }
    }
}
