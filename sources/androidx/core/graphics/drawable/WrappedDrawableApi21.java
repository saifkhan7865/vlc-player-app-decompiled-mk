...
class WrappedDrawableApi21 extends WrappedDrawableApi14 {
    ...
    public boolean isCompatTintEnabled() {
        ...
        if ((drawable instanceof GradientDrawable) || (drawable instanceof DrawableContainer) || (drawable instanceof InsetDrawable) || CarContext$$ExternalSyntheticApiModelOutline0.m$3((Object) drawable)) {
            return true;
        }
        return false;
    }
    ...
    public boolean isProjected() {
        ...
        try {
            return ((Boolean) method.invoke(this.mDrawable, (Object[]) null)).booleanValue();
        } catch (Exception e) {
