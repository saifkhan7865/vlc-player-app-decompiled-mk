...
public final class PathKt {
    ...
    public static final Path plus(Path path, Path path2) {
        ...
        boolean unused = path3.op(path2, PathKt$$ExternalSyntheticApiModelOutline0.m());
        return path3;
    }

    public static final Path minus(Path path, Path path2) {
        Path path3 = new Path(path);
        boolean unused = path3.op(path2, Path.Op.DIFFERENCE);
        return path3;
    }

    public static final Path and(Path path, Path path2) {
        Path path3 = new Path();
        boolean unused = path3.op(path, path2, Path.Op.INTERSECT);
        return path3;
    }

    public static final Path xor(Path path, Path path2) {
        Path path3 = new Path(path);
        boolean unused = path3.op(path2, Path.Op.XOR);
        return path3;
    }
