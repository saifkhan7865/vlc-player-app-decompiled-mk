...
public class TypefaceCompat {
    ...
    public static Typeface create(Context context, Typeface typeface, int i, boolean z) {
        if (context != null) {
            Preconditions.checkArgumentInRange(i, 1, 1000, TvContractCompat.PreviewPrograms.COLUMN_WEIGHT);
            if (typeface == null) {
    ...
    public static class ResourcesCallbackAdapter extends FontsContractCompat.FontRequestCallback {
        ...
        public void onTypefaceRetrieved(Typeface typeface) {
            ...
            if (fontCallback != null) {
                fontCallback.m63lambda$callbackSuccessAsync$0$androidxcorecontentresResourcesCompat$FontCallback(typeface);
            }
        }
        ...
        public void onTypefaceRequestFailed(int i) {
            ResourcesCompat.FontCallback fontCallback = this.mFontCallback;
            if (fontCallback != null) {
                fontCallback.m62lambda$callbackFailAsync$1$androidxcorecontentresResourcesCompat$FontCallback(i);
            }
        }
    }
}
