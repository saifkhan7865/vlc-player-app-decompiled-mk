...
public class PrecomputedTextCompat implements Spannable {
    ...
    public static final class Params {
        ...
        public static class Builder {
            ...
            public Builder(TextPaint textPaint) {
                ...
                if (Build.VERSION.SDK_INT >= 18) {
                    this.mTextDir = CarContext$$ExternalSyntheticApiModelOutline0.m();
                } else {
                    this.mTextDir = null;
                }
            }
        ...
        public Params(PrecomputedText.Params params) {
            this.mPaint = BundleKt$$ExternalSyntheticApiModelOutline0.m(params);
            this.mTextDir = BundleKt$$ExternalSyntheticApiModelOutline0.m(params);
            this.mBreakStrategy = params.getBreakStrategy();
            this.mHyphenationFrequency = BundleKt$$ExternalSyntheticApiModelOutline0.m(params);
        ...
        public boolean equalsWithoutTextDirection(Params params) {
            ...
            if ((Build.VERSION.SDK_INT >= 21 && (BundleKt$$ExternalSyntheticApiModelOutline0.m(this.mPaint) != BundleKt$$ExternalSyntheticApiModelOutline0.m(params.getTextPaint()) || !TextUtils.equals(BundleKt$$ExternalSyntheticApiModelOutline0.m(this.mPaint), BundleKt$$ExternalSyntheticApiModelOutline0.m(params.getTextPaint())))) || this.mPaint.getFlags() != params.getTextPaint().getFlags()) {
                return false;
            }
            if (Build.VERSION.SDK_INT >= 24) {
                if (!BundleKt$$ExternalSyntheticApiModelOutline0.m(this.mPaint).equals(BundleKt$$ExternalSyntheticApiModelOutline0.m(params.getTextPaint()))) {
                    return false;
                }
        ...
        public int hashCode() {
            if (Build.VERSION.SDK_INT >= 24) {
                return ObjectsCompat.hash(Float.valueOf(this.mPaint.getTextSize()), Float.valueOf(this.mPaint.getTextScaleX()), Float.valueOf(this.mPaint.getTextSkewX()), Float.valueOf(BundleKt$$ExternalSyntheticApiModelOutline0.m(this.mPaint)), Integer.valueOf(this.mPaint.getFlags()), BundleKt$$ExternalSyntheticApiModelOutline0.m(this.mPaint), this.mPaint.getTypeface(), Boolean.valueOf(BundleKt$$ExternalSyntheticApiModelOutline0.m(this.mPaint)), this.mTextDir, Integer.valueOf(this.mBreakStrategy), Integer.valueOf(this.mHyphenationFrequency));
            } else if (Build.VERSION.SDK_INT >= 21) {
                return ObjectsCompat.hash(Float.valueOf(this.mPaint.getTextSize()), Float.valueOf(this.mPaint.getTextScaleX()), Float.valueOf(this.mPaint.getTextSkewX()), Float.valueOf(BundleKt$$ExternalSyntheticApiModelOutline0.m(this.mPaint)), Integer.valueOf(this.mPaint.getFlags()), this.mPaint.getTextLocale(), this.mPaint.getTypeface(), Boolean.valueOf(BundleKt$$ExternalSyntheticApiModelOutline0.m(this.mPaint)), this.mTextDir, Integer.valueOf(this.mBreakStrategy), Integer.valueOf(this.mHyphenationFrequency));
        ...
        public String toString() {
            ...
            if (Build.VERSION.SDK_INT >= 21) {
                sb.append(", letterSpacing=" + BundleKt$$ExternalSyntheticApiModelOutline0.m(this.mPaint));
                sb.append(", elegantTextHeight=" + BundleKt$$ExternalSyntheticApiModelOutline0.m(this.mPaint));
            }
            if (Build.VERSION.SDK_INT >= 24) {
                sb.append(", textLocale=" + BundleKt$$ExternalSyntheticApiModelOutline0.m(this.mPaint));
            } else {
    ...
    public PrecomputedText getPrecomputedText() {
        if (BundleKt$$ExternalSyntheticApiModelOutline0.m$2(this.mText)) {
            return BundleKt$$ExternalSyntheticApiModelOutline0.m((Object) this.mText);
        }
        return null;
    }
