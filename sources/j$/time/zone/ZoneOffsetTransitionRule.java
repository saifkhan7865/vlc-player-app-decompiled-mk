...
public final class ZoneOffsetTransitionRule implements Serializable {
    ...
    static ZoneOffsetTransitionRule readExternal(DataInput dataInput) {
        ...
        int i5 = (readInt & 12) >>> 2;
        int i6 = readInt & 3;
        LocalTime ofSecondOfDay = i3 == 31 ? LocalTime.ofSecondOfDay((long) dataInput.readInt()) : LocalTime.of(i3 % 24, 0);
        ZoneOffset ofTotalSeconds = ZoneOffset.ofTotalSeconds(i4 == 255 ? dataInput.readInt() : (i4 - 128) * 900);
        return of(of, i, of2, ofSecondOfDay, i3 == 24, timeDefinition2, ofTotalSeconds, ZoneOffset.ofTotalSeconds(i5 == 3 ? dataInput.readInt() : ofTotalSeconds.getTotalSeconds() + (i5 * 1800)), ZoneOffset.ofTotalSeconds(i6 == 3 ? dataInput.readInt() : ofTotalSeconds.getTotalSeconds() + (i6 * 1800)));
    }
    ...
    public void writeExternal(DataOutput dataOutput) {
        int secondOfDay = this.timeEndOfDay ? HelpersKt.LENGTH_DAY : this.time.toSecondOfDay();
