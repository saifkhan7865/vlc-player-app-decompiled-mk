...
public final class JapaneseChronology extends AbstractChronology implements Serializable {
    ...
    private ChronoLocalDate resolveYD(JapaneseEra japaneseEra, int i, Map map, ResolverStyle resolverStyle) {
        ...
        if (resolverStyle == ResolverStyle.LENIENT) {
            ...
            return dateYearDay(prolepticYearLenient, 1).plus(Instant$$ExternalSyntheticBackport6.m(((Long) map.remove(ChronoField.DAY_OF_YEAR)).longValue(), 1), (TemporalUnit) ChronoUnit.DAYS);
        }
    ...
    private ChronoLocalDate resolveYMD(JapaneseEra japaneseEra, int i, Map map, ResolverStyle resolverStyle) {
        ...
        if (resolverStyle == ResolverStyle.LENIENT) {
            ...
            return date(prolepticYearLenient, 1, 1).plus(m, (TemporalUnit) ChronoUnit.MONTHS).plus(Instant$$ExternalSyntheticBackport6.m(((Long) map.remove(ChronoField.DAY_OF_MONTH)).longValue(), 1), (TemporalUnit) ChronoUnit.DAYS);
        }
        ...
        if (i >= 1) {
            ...
            throw new DateTimeException("Invalid YearOfEra for Era: " + japaneseEra + AnsiRenderer.CODE_TEXT_SEPARATOR + i);
        }
