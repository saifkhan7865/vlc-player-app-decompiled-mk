...
public final class IsoChronology extends AbstractChronology implements Serializable {
    ...
    public void resolveProlepticMonth(Map map, ResolverStyle resolverStyle) {
        ...
        if (l != null) {
            ...
            addFieldValue(map, ChronoField.MONTH_OF_YEAR, (long) (IsoChronology$$ExternalSyntheticBackport0.m(l.longValue(), 12) + 1));
            addFieldValue(map, ChronoField.YEAR, DesugarLocalDate$$ExternalSyntheticBackport0.m(l.longValue(), (long) 12));
        }
    }
    ...
    public LocalDate resolveYMD(Map map, ResolverStyle resolverStyle) {
        ...
        if (resolverStyle == ResolverStyle.LENIENT) {
            ...
            return LocalDate.of(checkValidIntValue, 1, 1).plusMonths(m).plusDays(Instant$$ExternalSyntheticBackport6.m(((Long) map.remove(ChronoField.DAY_OF_MONTH)).longValue(), 1));
        }
        ...
        if (resolverStyle == ResolverStyle.SMART) {
            if (checkValidIntValue2 == 4 || checkValidIntValue2 == 6 || checkValidIntValue2 == 9 || checkValidIntValue2 == 11) {
                ...
                i = Month.FEBRUARY.length(Year.isLeap((long) checkValidIntValue));
            }
    ...
    public j$.time.LocalDate resolveYearOfEra(java.util.Map r10, j$.time.format.ResolverStyle r11) {
        ...
        L_0x0015:
            ...
            goto L_0x0042
        L_0x003e:
            long r0 = j$.time.Instant$$ExternalSyntheticBackport6.m(r5, r0)
        L_0x0042:
