...
public final class HijrahDate extends ChronoLocalDateImpl implements ChronoLocalDate, Serializable {
    ...
    public HijrahDate plusMonths(long j) {
        ...
        return resolvePreviousValid(this.chrono.checkValidYear(DesugarLocalDate$$ExternalSyntheticBackport0.m(j2, 12)), ((int) Clock$TickClock$$ExternalSyntheticBackport0.m(j2, 12)) + 1, this.dayOfMonth);
    }
    ...
    public ValueRange range(TemporalField temporalField) {
        ...
        if (isSupported(temporalField)) {
            ...
            return i != 1 ? i != 2 ? i != 3 ? getChronology().range(chronoField) : ValueRange.of(1, 5) : ValueRange.of(1, (long) lengthOfYear()) : ValueRange.of(1, (long) lengthOfMonth());
        }
