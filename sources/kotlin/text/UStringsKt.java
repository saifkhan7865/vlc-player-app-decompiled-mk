...
public final class UStringsKt {
    ...
    public static final String m2262toStringLxnNnR4(byte b, int i) {
    ...
    public static final String m2264toStringolVBNx4(short s, int i) {
    ...
    public static final String m2263toStringV7xB4Y4(int i, int i2) {
    ...
    public static final String m2261toStringJSWoG40(long j, int i) {
    ...
    public static final byte toUByte(String str) {
        ...
        if (uByteOrNull != null) {
            return uByteOrNull.m1842unboximpl();
        }
    ...
    public static final short toUShort(String str) {
        ...
        if (uShortOrNull != null) {
            return uShortOrNull.m2105unboximpl();
        }
        StringsKt.numberFormatError(str);
        throw new KotlinNothingValueException();
    }
    ...
    public static final int toUInt(String str) {
        ...
        if (uIntOrNull != null) {
            return uIntOrNull.m1921unboximpl();
        }
        StringsKt.numberFormatError(str);
        throw new KotlinNothingValueException();
    }
    ...
    public static final UByte toUByteOrNull(String str, int i) {
        ...
        int r1 = uIntOrNull.m1921unboximpl();
        if (UInt$$ExternalSyntheticBackport0.m(r1 ^ Integer.MIN_VALUE, UInt.m1869constructorimpl(255) ^ Integer.MIN_VALUE) > 0) {
            return null;
        }
        return UByte.m1786boximpl(UByte.m1792constructorimpl((byte) r1));
    }
    ...
    public static final UShort toUShortOrNull(String str, int i) {
        ...
        int r1 = uIntOrNull.m1921unboximpl();
        if (UInt$$ExternalSyntheticBackport0.m(r1 ^ Integer.MIN_VALUE, UInt.m1869constructorimpl(65535) ^ Integer.MIN_VALUE) > 0) {
            return null;
        }
        return UShort.m2049boximpl(UShort.m2055constructorimpl((short) r1));
    }
    ...
    public static final UInt toUIntOrNull(String str, int i) {
        ...
        int r3 = UInt.m1869constructorimpl(i);
        int i4 = 119304647;
        while (i2 < length) {
            ...
            if (UInt$$ExternalSyntheticBackport0.m(i3 ^ Integer.MIN_VALUE, i4 ^ Integer.MIN_VALUE) > 0) {
                if (i4 == 119304647) {
                    i4 = UInt$$ExternalSyntheticBackport0.m$1(-1, r3);
                    if (UInt$$ExternalSyntheticBackport0.m(i3 ^ Integer.MIN_VALUE, i4 ^ Integer.MIN_VALUE) > 0) {
                    }
                }
                return null;
            }
            int r2 = UInt.m1869constructorimpl(i3 * r3);
            int r7 = UInt.m1869constructorimpl(UInt.m1869constructorimpl(digitOf) + r2);
            if (UInt$$ExternalSyntheticBackport0.m(r7 ^ Integer.MIN_VALUE, r2 ^ Integer.MIN_VALUE) < 0) {
                return null;
            }
            i2++;
            i3 = r7;
        }
        return UInt.m1863boximpl(i3);
    }
    ...
    public static final ULong toULongOrNull(String str, int i) {
        ...
        long r5 = ULong.m1948constructorimpl((long) i2);
        long j = 0;
        ...
        while (i3 < length) {
            ...
            if (UInt$$ExternalSyntheticBackport0.m(j, j2) > 0) {
                if (j2 == 512409557603043100L) {
                    j2 = UInt$$ExternalSyntheticBackport0.m$1(-1, r5);
                    if (UInt$$ExternalSyntheticBackport0.m(j, j2) > 0) {
                    }
                }
                return null;
            }
            long r9 = ULong.m1948constructorimpl(j * r5);
            long r13 = ULong.m1948constructorimpl(ULong.m1948constructorimpl(((long) UInt.m1869constructorimpl(digitOf)) & 4294967295L) + r9);
            if (UInt$$ExternalSyntheticBackport0.m(r13, r9) < 0) {
                return null;
            }
            i3++;
            j = r13;
