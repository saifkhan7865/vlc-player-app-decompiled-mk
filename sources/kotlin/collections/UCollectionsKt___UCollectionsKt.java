...
class UCollectionsKt___UCollectionsKt {
    public static final byte[] toUByteArray(Collection<UByte> collection) {
        ...
        byte[] r0 = UByteArray.m1844constructorimpl(collection.size());
        int i = 0;
        for (UByte r2 : collection) {
            UByteArray.m1855setVurrAj0(r0, i, r2.m1842unboximpl());
            i++;
        }
        return r0;
    }
    ...
    public static final int[] toUIntArray(Collection<UInt> collection) {
        Intrinsics.checkNotNullParameter(collection, "<this>");
        int[] r0 = UIntArray.m1923constructorimpl(collection.size());
        int i = 0;
        for (UInt r2 : collection) {
            UIntArray.m1934setVXSXFK8(r0, i, r2.m1921unboximpl());
            i++;
        }
        return r0;
    }
    ...
    public static final long[] toULongArray(Collection<ULong> collection) {
        Intrinsics.checkNotNullParameter(collection, "<this>");
        long[] r0 = ULongArray.m2002constructorimpl(collection.size());
        int i = 0;
        for (ULong r2 : collection) {
            ULongArray.m2013setk8EXiF4(r0, i, r2.m2000unboximpl());
            i++;
        }
        return r0;
    }
    ...
    public static final short[] toUShortArray(Collection<UShort> collection) {
        Intrinsics.checkNotNullParameter(collection, "<this>");
        short[] r0 = UShortArray.m2107constructorimpl(collection.size());
        int i = 0;
        for (UShort r2 : collection) {
            UShortArray.m2118set01HTLdE(r0, i, r2.m2105unboximpl());
            i++;
        }
        return r0;
    }
    ...
    public static final int sumOfUInt(Iterable<UInt> iterable) {
        ...
        for (UInt r1 : iterable) {
            i = UInt.m1869constructorimpl(i + r1.m1921unboximpl());
        }
        return i;
    }
    ...
    public static final long sumOfULong(Iterable<ULong> iterable) {
        ...
        for (ULong r2 : iterable) {
            j = ULong.m1948constructorimpl(j + r2.m2000unboximpl());
        }
        return j;
    }
    ...
    public static final int sumOfUByte(Iterable<UByte> iterable) {
        ...
        for (UByte r1 : iterable) {
            i = UInt.m1869constructorimpl(i + UInt.m1869constructorimpl(r1.m1842unboximpl() & 255));
        }
        return i;
    }
    ...
    public static final int sumOfUShort(Iterable<UShort> iterable) {
        ...
        for (UShort r1 : iterable) {
            i = UInt.m1869constructorimpl(i + UInt.m1869constructorimpl(r1.m2105unboximpl() & 65535));
        }
        return i;
    }
}
