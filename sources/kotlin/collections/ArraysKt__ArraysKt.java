...
class ArraysKt__ArraysKt extends ArraysKt__ArraysJVMKt {
                                                    ...
                                                    if (!(t instanceof UByteArray) || !(t2 instanceof UByteArray)) {
                                                        if (!(t instanceof UShortArray) || !(t2 instanceof UShortArray)) {
                                                            if (!(t instanceof UIntArray) || !(t2 instanceof UIntArray)) {
                                                                ...
                                                                } else if (!UArraysKt.m345contentEqualslec5QzE(((ULongArray) t).m2017unboximpl(), ((ULongArray) t2).m2017unboximpl())) {
                                                                    return false;
                                                                }
                                                            } else if (!UArraysKt.m343contentEqualsKJPZfPQ(((UIntArray) t).m1938unboximpl(), ((UIntArray) t2).m1938unboximpl())) {
                                                                return false;
                                                            }
                                                        } else if (!UArraysKt.m342contentEqualsFGO6Aew(((UShortArray) t).m2122unboximpl(), ((UShortArray) t2).m2122unboximpl())) {
                                                            return false;
                                                        }
                                                    } else if (!UArraysKt.m344contentEqualskV0jMPg(((UByteArray) t).m1859unboximpl(), ((UByteArray) t2).m1859unboximpl())) {
                                                        return false;
                                                    }
    ...
    private static final <T> void contentDeepToStringInternal$ArraysKt__ArraysKt(T[] r5, java.lang.StringBuilder r6, java.util.List<java.lang.Object[]> r7) {
        ...
        L_0x00c5:
            ...
            byte[] r4 = r2.m1859unboximpl()
        L_0x00d2:
            java.lang.String r2 = kotlin.collections.unsigned.UArraysKt.m350contentToString2csIQuQ(r4)
            r6.append(r2)
            goto L_0x011d
        L_0x00da:
            ...
            short[] r4 = r2.m2122unboximpl()
        L_0x00e6:
            java.lang.String r2 = kotlin.collections.unsigned.UArraysKt.m352contentToStringd6D3K8(r4)
            r6.append(r2)
            goto L_0x011d
        L_0x00ee:
            ...
            int[] r4 = r2.m1938unboximpl()
        L_0x00fa:
            java.lang.String r2 = kotlin.collections.unsigned.UArraysKt.m351contentToStringXUkPCBk(r4)
            r6.append(r2)
            goto L_0x011d
        L_0x0102:
            ...
            long[] r4 = r2.m2017unboximpl()
        L_0x010e:
            java.lang.String r2 = kotlin.collections.unsigned.UArraysKt.m353contentToStringuLth9ew(r4)
            r6.append(r2)
            goto L_0x011d
        L_0x0116:
