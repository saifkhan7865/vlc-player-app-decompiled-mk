...
public final class ULongArray implements Collection<ULong>, KMappedMarker {
    ...
    public static long[] m2003constructorimpl(long[] jArr) {
    ...
    public static boolean m2006equalsimpl(long[] jArr, Object obj) {
        return (obj instanceof ULongArray) && Intrinsics.areEqual((Object) jArr, (Object) ((ULongArray) obj).m2017unboximpl());
    }

    /* renamed from: equals-impl0  reason: not valid java name */
    public static final boolean m2007equalsimpl0(long[] jArr, long[] jArr2) {
    ...
    public boolean m2015addVKZWuLQ(long j) {
        throw new UnsupportedOperationException("Operation is not supported for read-only collection");
    }
    ...
    public final /* synthetic */ long[] m2017unboximpl() {
        return this.storage;
    }
    ...
    public final /* bridge */ boolean contains(Object obj) {
        ...
        return m2016containsVKZWuLQ(((ULong) obj).m2000unboximpl());
    }
    ...
    public static final long m2008getsVKNKU(long[] jArr, int i) {
        return ULong.m1948constructorimpl(jArr[i]);
    }
    ...
    private static final class Iterator implements java.util.Iterator<ULong>, KMappedMarker {
        ...
        public /* bridge */ /* synthetic */ Object next() {
            return ULong.m1942boximpl(m2018nextsVKNKU());
        }
    ...
    public boolean m2016containsVKZWuLQ(long j) {
    ...
    public boolean containsAll(Collection<? extends Object> collection) {
        ...
        return m2005containsAllimpl(this.storage, collection);
    }

    /* JADX WARNING: Removed duplicated region for block: B:5:0x001c  */
    /* renamed from: containsAll-impl  reason: not valid java name */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static boolean m2005containsAllimpl(long[] r4, java.util.Collection<kotlin.ULong> r5) {
        /*
        ...
        L_0x0032:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: kotlin.ULongArray.m2005containsAllimpl(long[], java.util.Collection):boolean");
    }
