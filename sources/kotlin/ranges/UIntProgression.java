...
public class UIntProgression implements Iterable<UInt>, KMappedMarker {
    ...
    private UIntProgression(int i, int i2, int i3) {
        if (i3 == 0) {
            ...
            this.first = i;
            this.last = UProgressionUtilKt.m2195getProgressionLastElementNkh28Cs(i, i2, i3);
            this.step = i3;
        } else {
    ...
    public final int m2209getFirstpVg5ArA() {
        return this.first;
    }

    /* renamed from: getLast-pVg5ArA  reason: not valid java name */
    public final int m2210getLastpVg5ArA() {
        return this.last;
    }
    ...
    public boolean isEmpty() {
        if (this.step > 0) {
            if (UInt$$ExternalSyntheticBackport0.m(this.first ^ Integer.MIN_VALUE, this.last ^ Integer.MIN_VALUE) > 0) {
                return true;
            }
        } else if (UInt$$ExternalSyntheticBackport0.m(this.first ^ Integer.MIN_VALUE, this.last ^ Integer.MIN_VALUE) < 0) {
            return true;
        }
        return false;
    }
    ...
    public String toString() {
        ...
        if (this.step > 0) {
            ...
            sb.append(UInt.m1915toStringimpl(this.first));
            sb.append("..");
            sb.append(UInt.m1915toStringimpl(this.last));
            sb.append(" step ");
            i = this.step;
        } else {
            sb = new StringBuilder();
    ...
    public static final class Companion {
        ...
        public final UIntProgression m2211fromClosedRangeNkh28Cs(int i, int i2, int i3) {
