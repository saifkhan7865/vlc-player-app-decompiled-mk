...
final class UIntProgressionIterator implements Iterator<UInt>, KMappedMarker {
    ...
    private UIntProgressionIterator(int i, int i2, int i3) {
        ...
        boolean z = true;
        if (i3 <= 0 ? UInt$$ExternalSyntheticBackport0.m(i ^ Integer.MIN_VALUE, i2 ^ Integer.MIN_VALUE) < 0 : UInt$$ExternalSyntheticBackport0.m(i ^ Integer.MIN_VALUE, i2 ^ Integer.MIN_VALUE) > 0) {
            z = false;
        }
        this.hasNext = z;
        this.step = UInt.m1869constructorimpl(i3);
        this.next = !this.hasNext ? i2 : i;
    }

    public /* bridge */ /* synthetic */ Object next() {
        return UInt.m1863boximpl(m2212nextpVg5ArA());
    }
    ...
    public int m2212nextpVg5ArA() {
        int i = this.next;
        if (i != this.finalElement) {
            this.next = UInt.m1869constructorimpl(this.step + i);
