...
public final class JavaToKotlinClassMap {
    ...
    private static final String NUMBERED_FUNCTION_PREFIX = (FunctionTypeKind.Function.INSTANCE.getPackageFqName().toString() + '.' + FunctionTypeKind.Function.INSTANCE.getClassNamePrefix());
    private static final String NUMBERED_K_FUNCTION_PREFIX = (FunctionTypeKind.KFunction.INSTANCE.getPackageFqName().toString() + '.' + FunctionTypeKind.KFunction.INSTANCE.getClassNamePrefix());
    private static final String NUMBERED_K_SUSPEND_FUNCTION_PREFIX = (FunctionTypeKind.KSuspendFunction.INSTANCE.getPackageFqName().toString() + '.' + FunctionTypeKind.KSuspendFunction.INSTANCE.getClassNamePrefix());
    private static final String NUMBERED_SUSPEND_FUNCTION_PREFIX = (FunctionTypeKind.SuspendFunction.INSTANCE.getPackageFqName().toString() + '.' + FunctionTypeKind.SuspendFunction.INSTANCE.getClassNamePrefix());
