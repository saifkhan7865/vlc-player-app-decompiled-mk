...
final class JvmBuiltInsCustomizer$deprecationForSomeOfTheListMethods$1 extends Lambda implements Function1<Pair<? extends String, ? extends String>, Annotations> {
    ...
    public final Annotations invoke(Pair<String, String> pair) {
        ...
        return Annotations.Companion.create(CollectionsKt.listOf(AnnotationUtilKt.createDeprecatedAnnotation$default(this.this$0.moduleDescriptor.getBuiltIns(), "'" + pair.component1() + "()' member of List is redundant in Kotlin and might be removed soon. Please use '" + component2 + "()' stdlib extension instead", component2 + "()", (String) null, true, 4, (Object) null)));
    }
}
