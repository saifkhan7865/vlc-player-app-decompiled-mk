...
public abstract class DeserializedPackageFragmentImpl extends DeserializedPackageFragment {
    ...
    public void initialize(DeserializationComponents deserializationComponents) {
        ...
        if (packageFragment != null) {
            ...
            this._memberScope = new DeserializedPackageMemberScope(this, packageR, this.nameResolver, binaryVersion, deserializedContainerSource, deserializationComponents, "scope of " + this, new DeserializedPackageFragmentImpl$initialize$1(this));
            return;
        }
