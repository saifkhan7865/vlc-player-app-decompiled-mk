...
public final class CacheByClassKt {
    ...
    static {
        ...
        try {
            ...
            z = Result.m1774constructorimpl(Class.forName("java.lang.ClassValue"));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.Companion;
            z = Result.m1774constructorimpl(ResultKt.createFailure(th));
        }
        if (Result.m1781isSuccessimpl(z)) {
            Result.Companion companion3 = Result.Companion;
            Class cls = (Class) z;
            z = true;
        }
        Object r0 = Result.m1774constructorimpl(z);
        if (Result.m1780isFailureimpl(r0)) {
            r0 = false;
        }
