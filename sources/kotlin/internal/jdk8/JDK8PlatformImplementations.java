...
public class JDK8PlatformImplementations extends JDK7PlatformImplementations {
    ...
    public MatchGroup getMatchResultNamedGroup(MatchResult matchResult, String str) {
        ...
        if (matcher != null) {
            IntRange intRange = new IntRange(LinkFollowing$$ExternalSyntheticApiModelOutline0.m(matcher, str), matcher.end(str) - 1);
            if (intRange.getStart().intValue() < 0) {
                return null;
            }
            String m = LinkFollowing$$ExternalSyntheticApiModelOutline0.m(matcher, str);
            Intrinsics.checkNotNullExpressionValue(m, "group(...)");
