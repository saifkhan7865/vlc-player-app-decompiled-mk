...
class PathsKt__PathReadWriteKt {
    static /* synthetic */ InputStreamReader reader$default(Path path, Charset charset, OpenOption[] openOptionArr, int i, Object obj) throws IOException {
        ...
        return new InputStreamReader(LinkFollowing$$ExternalSyntheticApiModelOutline0.m(path, (OpenOption[]) Arrays.copyOf(openOptionArr, openOptionArr.length)), charset);
    }
    ...
    static /* synthetic */ BufferedReader bufferedReader$default(Path path, Charset charset, int i, OpenOption[] openOptionArr, int i2, Object obj) throws IOException {
        ...
        Intrinsics.checkNotNullParameter(charset, "charset");
        Intrinsics.checkNotNullParameter(openOptionArr, "options");
        return new BufferedReader(new InputStreamReader(LinkFollowing$$ExternalSyntheticApiModelOutline0.m(path, (OpenOption[]) Arrays.copyOf(openOptionArr, openOptionArr.length)), charset), i);
    }
    ...
    static /* synthetic */ OutputStreamWriter writer$default(Path path, Charset charset, OpenOption[] openOptionArr, int i, Object obj) throws IOException {
        ...
        Intrinsics.checkNotNullParameter(charset, "charset");
        Intrinsics.checkNotNullParameter(openOptionArr, "options");
        return new OutputStreamWriter(LinkFollowing$$ExternalSyntheticApiModelOutline0.m(path, (OpenOption[]) Arrays.copyOf(openOptionArr, openOptionArr.length)), charset);
    }
    ...
    static /* synthetic */ BufferedWriter bufferedWriter$default(Path path, Charset charset, int i, OpenOption[] openOptionArr, int i2, Object obj) throws IOException {
        ...
        Intrinsics.checkNotNullParameter(charset, "charset");
        Intrinsics.checkNotNullParameter(openOptionArr, "options");
        return new BufferedWriter(new OutputStreamWriter(LinkFollowing$$ExternalSyntheticApiModelOutline0.m(path, (OpenOption[]) Arrays.copyOf(openOptionArr, openOptionArr.length)), charset), i);
    }
    ...
    private static final byte[] readBytes(Path path) throws IOException {
        Intrinsics.checkNotNullParameter(path, "<this>");
        byte[] m = LinkFollowing$$ExternalSyntheticApiModelOutline0.m(path);
        Intrinsics.checkNotNullExpressionValue(m, "readAllBytes(...)");
        return m;
    }
    ...
    private static final void appendBytes(Path path, byte[] bArr) throws IOException {
        Intrinsics.checkNotNullParameter(path, "<this>");
        Intrinsics.checkNotNullParameter(bArr, "array");
        Path unused = Files.write(path, bArr, new OpenOption[]{LinkFollowing$$ExternalSyntheticApiModelOutline0.m()});
    }
    ...
    public static final java.lang.String readText(java.nio.file.Path r3, java.nio.charset.Charset r4) throws java.io.IOException {
        /*
            ...
            java.io.InputStream r3 = kotlin.io.path.LinkFollowing$$ExternalSyntheticApiModelOutline0.m((java.nio.file.Path) r3, (java.nio.file.OpenOption[]) r0)
            r2.<init>(r3, r4)
    ...
    public static final void writeText(java.nio.file.Path r1, java.lang.CharSequence r2, java.nio.charset.Charset r3, java.nio.file.OpenOption... r4) throws java.io.IOException {
        /*
            ...
            java.io.OutputStream r1 = kotlin.io.path.LinkFollowing$$ExternalSyntheticApiModelOutline0.m((java.nio.file.Path) r1, (java.nio.file.OpenOption[]) r4)
    ...
    public static final void appendText(java.nio.file.Path r3, java.lang.CharSequence r4, java.nio.charset.Charset r5) throws java.io.IOException {
        /*
            ...
            r1 = 0
            java.nio.file.StandardOpenOption r2 = kotlin.io.path.LinkFollowing$$ExternalSyntheticApiModelOutline0.m()
            r0[r1] = r2
            java.io.OutputStream r3 = kotlin.io.path.LinkFollowing$$ExternalSyntheticApiModelOutline0.m((java.nio.file.Path) r3, (java.nio.file.OpenOption[]) r0)
    ...
    static /* synthetic */ void forEachLine$default(java.nio.file.Path r1, java.nio.charset.Charset r2, kotlin.jvm.functions.Function1 r3, int r4, java.lang.Object r5) throws java.io.IOException {
        ...
        L_0x0006:
            ...
            java.io.BufferedReader r1 = kotlin.io.path.LinkFollowing$$ExternalSyntheticApiModelOutline0.m((java.nio.file.Path) r1, (java.nio.charset.Charset) r2)
    ...
    private static final void forEachLine(java.nio.file.Path r3, java.nio.charset.Charset r4, kotlin.jvm.functions.Function1<? super java.lang.String, kotlin.Unit> r5) throws java.io.IOException {
        /*
            ...
            kotlin.jvm.internal.Intrinsics.checkNotNullParameter(r5, r0)
            java.io.BufferedReader r3 = kotlin.io.path.LinkFollowing$$ExternalSyntheticApiModelOutline0.m((java.nio.file.Path) r3, (java.nio.charset.Charset) r4)
    ...
    private static final InputStream inputStream(Path path, OpenOption... openOptionArr) throws IOException {
        ...
        Intrinsics.checkNotNullExpressionValue(m, "newInputStream(...)");
        return m;
    }
    ...
    private static final OutputStream outputStream(Path path, OpenOption... openOptionArr) throws IOException {
        ...
        Intrinsics.checkNotNullExpressionValue(m, "newOutputStream(...)");
        return m;
    }
    ...
    static /* synthetic */ List readLines$default(Path path, Charset charset, int i, Object obj) throws IOException {
        ...
        Intrinsics.checkNotNullParameter(path, "<this>");
        Intrinsics.checkNotNullParameter(charset, "charset");
        List m = LinkFollowing$$ExternalSyntheticApiModelOutline0.m(path, charset);
        Intrinsics.checkNotNullExpressionValue(m, "readAllLines(...)");
        return m;
    }
    ...
    private static final List<String> readLines(Path path, Charset charset) throws IOException {
        Intrinsics.checkNotNullParameter(path, "<this>");
        Intrinsics.checkNotNullParameter(charset, "charset");
        List<String> m = LinkFollowing$$ExternalSyntheticApiModelOutline0.m(path, charset);
        Intrinsics.checkNotNullExpressionValue(m, "readAllLines(...)");
        return m;
    }
    ...
    static /* synthetic */ java.lang.Object useLines$default(java.nio.file.Path r0, java.nio.charset.Charset r1, kotlin.jvm.functions.Function1 r2, int r3, java.lang.Object r4) throws java.io.IOException {
        ...
        L_0x0006:
            ...
            java.io.BufferedReader r0 = kotlin.io.path.LinkFollowing$$ExternalSyntheticApiModelOutline0.m((java.nio.file.Path) r0, (java.nio.charset.Charset) r1)
            java.io.Closeable r0 = (java.io.Closeable) r0
            r1 = 0
            r3 = r0
    ...
    private static final <T> T useLines(java.nio.file.Path r2, java.nio.charset.Charset r3, kotlin.jvm.functions.Function1<? super kotlin.sequences.Sequence<java.lang.String>, ? extends T> r4) throws java.io.IOException {
        /*
            ...
            kotlin.jvm.internal.Intrinsics.checkNotNullParameter(r4, r0)
            java.io.BufferedReader r2 = kotlin.io.path.LinkFollowing$$ExternalSyntheticApiModelOutline0.m((java.nio.file.Path) r2, (java.nio.charset.Charset) r3)
            java.io.Closeable r2 = (java.io.Closeable) r2
            r3 = 0
            r0 = 1
            r1 = r2
    ...
    static /* synthetic */ Path writeLines$default(Path path, Iterable iterable, Charset charset, OpenOption[] openOptionArr, int i, Object obj) throws IOException {
        ...
        Intrinsics.checkNotNullExpressionValue(m, "write(...)");
        return m;
    }
    ...
    static /* synthetic */ Path appendLines$default(Path path, Iterable iterable, Charset charset, int i, Object obj) throws IOException {
        ...
        Intrinsics.checkNotNullParameter(iterable, "lines");
        Intrinsics.checkNotNullParameter(charset, "charset");
        Path m = Files.write(path, iterable, charset, new OpenOption[]{LinkFollowing$$ExternalSyntheticApiModelOutline0.m()});
        Intrinsics.checkNotNullExpressionValue(m, "write(...)");
        return m;
    }
    ...
    static /* synthetic */ Path appendLines$default(Path path, Sequence sequence, Charset charset, int i, Object obj) throws IOException {
        ...
        Intrinsics.checkNotNullParameter(sequence, "lines");
        Intrinsics.checkNotNullParameter(charset, "charset");
        Path m = Files.write(path, SequencesKt.asIterable(sequence), charset, new OpenOption[]{LinkFollowing$$ExternalSyntheticApiModelOutline0.m()});
        Intrinsics.checkNotNullExpressionValue(m, "write(...)");
        return m;
    }
