...
final class DefaultCopyActionContext implements CopyActionContext {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:3:0x0038, code lost:
        if (java.nio.file.Files.isDirectory(r6, (java.nio.file.LinkOption[]) java.util.Arrays.copyOf(new java.nio.file.LinkOption[]{kotlin.io.path.LinkFollowing$$ExternalSyntheticApiModelOutline0.m()}, 1)) == false) goto L_0x003a;
     */
    ...
    public kotlin.io.path.CopyActionResult copyToIgnoringExistingDirectory(java.nio.file.Path r5, java.nio.file.Path r6, boolean r7) {
        /*
            ...
            r2 = 0
            java.nio.file.LinkOption r3 = kotlin.io.path.LinkFollowing$$ExternalSyntheticApiModelOutline0.m()
            r1[r2] = r3
