...
final class DirectoryEntriesReader extends SimpleFileVisitor<Path> {
    ...
    public final List<PathNode> readEntries(PathNode pathNode) {
        ...
        Path unused = Files.walkFileTree(pathNode.getPath(), LinkFollowing.INSTANCE.toVisitOptions(this.followLinks), 1, NioPathKt$$ExternalSyntheticApiModelOutline0.m((Object) this));
    ...
    public FileVisitResult preVisitDirectory(Path path, BasicFileAttributes basicFileAttributes) {
        ...
        this.entries.add(new PathNode(path, LinkFollowing$$ExternalSyntheticApiModelOutline0.m(basicFileAttributes), this.directoryNode));
