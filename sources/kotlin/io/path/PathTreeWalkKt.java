...
public final class PathTreeWalkKt {
    ...
    public static final Object keyOf(Path path, LinkOption[] linkOptionArr) {
        try {
            ...
            BasicFileAttributes m = LinkFollowing$$ExternalSyntheticApiModelOutline0.m(path, LinkFollowing$$ExternalSyntheticApiModelOutline0.m(), (LinkOption[]) Arrays.copyOf(linkOptionArr2, linkOptionArr2.length));
    ...
    public static final boolean createsCycle(PathNode pathNode) {
        for (PathNode parent = pathNode.getParent(); parent != null; parent = parent.getParent()) {
            if (parent.getKey() == null || pathNode.getKey() == null) {
                try {
                    if (LinkFollowing$$ExternalSyntheticApiModelOutline0.m(parent.getPath(), pathNode.getPath())) {
                        return true;
                    }
