...
final class ExceptionsCollector {
    ...
    public final void enterEntry(Path path2) {
        Intrinsics.checkNotNullParameter(path2, ContentDisposition.Parameters.Name);
    ...
    public final void exitEntry(Path path2) {
        ...
        if (Intrinsics.areEqual((Object) path2, (Object) path3 != null ? path3.getFileName() : null)) {
            ...
            if (path5 != null) {
                path4 = NioPathKt$$ExternalSyntheticApiModelOutline0.m(path5);
            }
            this.path = path4;
            return;
        }
    ...
    public final void collect(Exception exc) {
        ...
        if (this.collectedExceptions.size() < this.limit) {
            if (this.path != null) {
                Throwable m = new FileSystemException(String.valueOf(this.path)).initCause(exc);
                Intrinsics.checkNotNull(m, "null cannot be cast to non-null type java.nio.file.FileSystemException");
                exc = LinkFollowing$$ExternalSyntheticApiModelOutline0.m((Object) m);
            }
