...
class FilesKt__FileReadWriteKt extends FilesKt__FilePathComponentsKt {
    ...
    public static final byte[] readBytes(java.io.File r11) {
        /*
            ...
            int r3 = (int) r2
            byte[] r2 = new byte[r3]     // Catch:{ all -> 0x00ac }
            r4 = 0
            r5 = r3
            r7 = 0
        L_0x0022:
            if (r5 <= 0) goto L_0x002d
            int r8 = r1.read(r2, r7, r5)     // Catch:{ all -> 0x00ac }
        ...
        L_0x002d:
            ...
            byte[] r2 = java.util.Arrays.copyOf(r2, r7)     // Catch:{ all -> 0x00ac }
            kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(r2, r8)     // Catch:{ all -> 0x00ac }
            goto L_0x006f
        L_0x003a:
            int r5 = r1.read()     // Catch:{ all -> 0x00ac }
            r7 = -1
        ...
        L_0x0042:
            ...
            r7.write(r5)     // Catch:{ all -> 0x00ac }
            java.io.InputStream r1 = (java.io.InputStream) r1     // Catch:{ all -> 0x00ac }
            r5 = r7
            java.io.OutputStream r5 = (java.io.OutputStream) r5     // Catch:{ all -> 0x00ac }
            r10 = 2
            kotlin.io.ByteStreamsKt.copyTo$default(r1, r5, r4, r10, r9)     // Catch:{ all -> 0x00ac }
            int r1 = r7.size()     // Catch:{ all -> 0x00ac }
            int r1 = r1 + r3
            if (r1 < 0) goto L_0x0073
            byte[] r11 = r7.getBuffer()     // Catch:{ all -> 0x00ac }
            byte[] r1 = java.util.Arrays.copyOf(r2, r1)     // Catch:{ all -> 0x00ac }
            kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(r1, r8)     // Catch:{ all -> 0x00ac }
            int r2 = r7.size()     // Catch:{ all -> 0x00ac }
            byte[] r2 = kotlin.collections.ArraysKt.copyInto((byte[]) r11, (byte[]) r1, (int) r3, (int) r4, (int) r2)     // Catch:{ all -> 0x00ac }
        L_0x006f:
