...
public final class MonotonicTimeSource implements TimeSource.WithComparableMarks {
    ...
    public long m2291markNowz9LOYto() {
        return TimeSource.Monotonic.ValueTimeMark.m2303constructorimpl(read());
    }

    /* renamed from: elapsedFrom-6eNON_k  reason: not valid java name */
    public final long m2290elapsedFrom6eNON_k(long j) {
    ...
    public final long m2289differenceBetweenfRLX17w(long j, long j2) {
        return LongSaturatedMathKt.saturatingOriginsDiff(j, j2, DurationUnit.NANOSECONDS);
    }

    /* renamed from: adjustReading-6QKq23U  reason: not valid java name */
    public final long m2288adjustReading6QKq23U(long j, long j2) {
        return TimeSource.Monotonic.ValueTimeMark.m2303constructorimpl(LongSaturatedMathKt.m2286saturatingAddNuflL3o(j, DurationUnit.NANOSECONDS, j2));
    }
}
