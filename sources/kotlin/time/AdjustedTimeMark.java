...
final class AdjustedTimeMark implements TimeMark {
    ...
    public final long m2278getAdjustmentUwyO8pc() {
    ...
    public TimeMark m2279minusLRDsOJo(long j) {
        return TimeMark.DefaultImpls.m2297minusLRDsOJo(this, j);
    }

    /* renamed from: elapsedNow-UwyO8pc  reason: not valid java name */
    public long m2277elapsedNowUwyO8pc() {
        return Duration.m1027minusLRDsOJo(this.mark.m2294elapsedNowUwyO8pc(), this.adjustment);
    }

    /* renamed from: plus-LRDsOJo  reason: not valid java name */
    public TimeMark m2280plusLRDsOJo(long j) {
        return new AdjustedTimeMark(this.mark, Duration.m1028plusLRDsOJo(this.adjustment, j), (DefaultConstructorMarker) null);
    }
}
