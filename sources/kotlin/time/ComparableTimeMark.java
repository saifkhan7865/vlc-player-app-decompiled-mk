...
public interface ComparableTimeMark extends TimeMark, Comparable<ComparableTimeMark> {
    ...
    ComparableTimeMark m2281minusLRDsOJo(long j);

    /* renamed from: minus-UwyO8pc  reason: not valid java name */
    long m2282minusUwyO8pc(ComparableTimeMark comparableTimeMark);

    /* renamed from: plus-LRDsOJo  reason: not valid java name */
    ComparableTimeMark m2283plusLRDsOJo(long j);
    ...
    public static final class DefaultImpls {
        ...
        /* renamed from: minus-LRDsOJo  reason: not valid java name */
        public static ComparableTimeMark m2284minusLRDsOJo(ComparableTimeMark comparableTimeMark, long j) {
            return comparableTimeMark.m2283plusLRDsOJo(Duration.m1045unaryMinusUwyO8pc(j));
        }
        ...
        public static int compareTo(ComparableTimeMark comparableTimeMark, ComparableTimeMark comparableTimeMark2) {
            ...
            return Duration.m991compareToLRDsOJo(comparableTimeMark.m2282minusUwyO8pc(comparableTimeMark2), Duration.Companion.m1095getZEROUwyO8pc());
        }
    }
}
