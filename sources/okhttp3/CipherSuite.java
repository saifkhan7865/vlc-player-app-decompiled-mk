...
public final class CipherSuite {
    ...
    public final String m1172deprecated_javaName() {
        return this.javaName;
    }
    ...
    static {
        ...
        TLS_RSA_WITH_AES_128_CBC_SHA = companion.init(Ciphers.TLS_RSA_WITH_AES_128_CBC_SHA, 47);
        TLS_DHE_DSS_WITH_AES_128_CBC_SHA = companion.init(Ciphers.TLS_DHE_DSS_WITH_AES_128_CBC_SHA, 50);
        TLS_DHE_RSA_WITH_AES_128_CBC_SHA = companion.init(Ciphers.TLS_DHE_RSA_WITH_AES_128_CBC_SHA, 51);
        TLS_DH_anon_WITH_AES_128_CBC_SHA = companion.init(Ciphers.TLS_DH_anon_WITH_AES_128_CBC_SHA, 52);
        TLS_RSA_WITH_AES_256_CBC_SHA = companion.init(Ciphers.TLS_RSA_WITH_AES_256_CBC_SHA, 53);
        TLS_DHE_DSS_WITH_AES_256_CBC_SHA = companion.init(Ciphers.TLS_DHE_DSS_WITH_AES_256_CBC_SHA, 56);
        TLS_DHE_RSA_WITH_AES_256_CBC_SHA = companion.init(Ciphers.TLS_DHE_RSA_WITH_AES_256_CBC_SHA, 57);
        TLS_DH_anon_WITH_AES_256_CBC_SHA = companion.init(Ciphers.TLS_DH_anon_WITH_AES_256_CBC_SHA, 58);
        TLS_RSA_WITH_NULL_SHA256 = companion.init("TLS_RSA_WITH_NULL_SHA256", 59);
        TLS_RSA_WITH_AES_128_CBC_SHA256 = companion.init(Ciphers.TLS_RSA_WITH_AES_128_CBC_SHA256, 60);
        TLS_RSA_WITH_AES_256_CBC_SHA256 = companion.init(Ciphers.TLS_RSA_WITH_AES_256_CBC_SHA256, 61);
        TLS_DHE_DSS_WITH_AES_128_CBC_SHA256 = companion.init(Ciphers.TLS_DHE_DSS_WITH_AES_128_CBC_SHA256, 64);
        ...
        TLS_DHE_RSA_WITH_AES_128_CBC_SHA256 = companion.init(Ciphers.TLS_DHE_RSA_WITH_AES_128_CBC_SHA256, 103);
        TLS_DHE_DSS_WITH_AES_256_CBC_SHA256 = companion.init(Ciphers.TLS_DHE_DSS_WITH_AES_256_CBC_SHA256, 106);
        TLS_DHE_RSA_WITH_AES_256_CBC_SHA256 = companion.init(Ciphers.TLS_DHE_RSA_WITH_AES_256_CBC_SHA256, 107);
        TLS_DH_anon_WITH_AES_128_CBC_SHA256 = companion.init(Ciphers.TLS_DH_anon_WITH_AES_128_CBC_SHA256, 108);
        TLS_DH_anon_WITH_AES_256_CBC_SHA256 = companion.init(Ciphers.TLS_DH_anon_WITH_AES_256_CBC_SHA256, 109);
        ...
        TLS_PSK_WITH_AES_128_CBC_SHA = companion.init(Ciphers.TLS_PSK_WITH_AES_128_CBC_SHA, 140);
        TLS_PSK_WITH_AES_256_CBC_SHA = companion.init(Ciphers.TLS_PSK_WITH_AES_256_CBC_SHA, 141);
        TLS_RSA_WITH_SEED_CBC_SHA = companion.init("TLS_RSA_WITH_SEED_CBC_SHA", 150);
        TLS_RSA_WITH_AES_128_GCM_SHA256 = companion.init(Ciphers.TLS_RSA_WITH_AES_128_GCM_SHA256, 156);
        TLS_RSA_WITH_AES_256_GCM_SHA384 = companion.init(Ciphers.TLS_RSA_WITH_AES_256_GCM_SHA384, 157);
        TLS_DHE_RSA_WITH_AES_128_GCM_SHA256 = companion.init(Ciphers.TLS_DHE_RSA_WITH_AES_128_GCM_SHA256, 158);
        TLS_DHE_RSA_WITH_AES_256_GCM_SHA384 = companion.init(Ciphers.TLS_DHE_RSA_WITH_AES_256_GCM_SHA384, 159);
        TLS_DHE_DSS_WITH_AES_128_GCM_SHA256 = companion.init(Ciphers.TLS_DHE_DSS_WITH_AES_128_GCM_SHA256, 162);
        TLS_DHE_DSS_WITH_AES_256_GCM_SHA384 = companion.init(Ciphers.TLS_DHE_DSS_WITH_AES_256_GCM_SHA384, 163);
        TLS_DH_anon_WITH_AES_128_GCM_SHA256 = companion.init(Ciphers.TLS_DH_anon_WITH_AES_128_GCM_SHA256, 166);
        TLS_DH_anon_WITH_AES_256_GCM_SHA384 = companion.init(Ciphers.TLS_DH_anon_WITH_AES_256_GCM_SHA384, 167);
        ...
        TLS_ECDHE_ECDSA_WITH_AES_128_CBC_SHA = companion.init(Ciphers.TLS_ECDHE_ECDSA_WITH_AES_128_CBC_SHA, 49161);
        TLS_ECDHE_ECDSA_WITH_AES_256_CBC_SHA = companion.init(Ciphers.TLS_ECDHE_ECDSA_WITH_AES_256_CBC_SHA, 49162);
        ...
        TLS_ECDHE_RSA_WITH_AES_128_CBC_SHA = companion.init(Ciphers.TLS_ECDHE_RSA_WITH_AES_128_CBC_SHA, 49171);
        TLS_ECDHE_RSA_WITH_AES_256_CBC_SHA = companion.init(Ciphers.TLS_ECDHE_RSA_WITH_AES_256_CBC_SHA, 49172);
        ...
        TLS_ECDH_anon_WITH_AES_128_CBC_SHA = companion.init(Ciphers.TLS_ECDH_anon_WITH_AES_128_CBC_SHA, 49176);
        TLS_ECDH_anon_WITH_AES_256_CBC_SHA = companion.init(Ciphers.TLS_ECDH_anon_WITH_AES_256_CBC_SHA, 49177);
        TLS_ECDHE_ECDSA_WITH_AES_128_CBC_SHA256 = companion.init(Ciphers.TLS_ECDHE_ECDSA_WITH_AES_128_CBC_SHA256, 49187);
        TLS_ECDHE_ECDSA_WITH_AES_256_CBC_SHA384 = companion.init(Ciphers.TLS_ECDHE_ECDSA_WITH_AES_256_CBC_SHA384, 49188);
        ...
        TLS_ECDHE_RSA_WITH_AES_128_CBC_SHA256 = companion.init(Ciphers.TLS_ECDHE_RSA_WITH_AES_128_CBC_SHA256, 49191);
        TLS_ECDHE_RSA_WITH_AES_256_CBC_SHA384 = companion.init(Ciphers.TLS_ECDHE_RSA_WITH_AES_256_CBC_SHA384, 49192);
        ...
        TLS_ECDHE_ECDSA_WITH_AES_128_GCM_SHA256 = companion.init(Ciphers.TLS_ECDHE_ECDSA_WITH_AES_128_GCM_SHA256, 49195);
        TLS_ECDHE_ECDSA_WITH_AES_256_GCM_SHA384 = companion.init(Ciphers.TLS_ECDHE_ECDSA_WITH_AES_256_GCM_SHA384, 49196);
        ...
        TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256 = companion.init(Ciphers.TLS_ECDHE_RSA_WITH_AES_128_GCM_SHA256, 49199);
        TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384 = companion.init(Ciphers.TLS_ECDHE_RSA_WITH_AES_256_GCM_SHA384, 49200);
        ...
        TLS_ECDHE_PSK_WITH_AES_128_CBC_SHA = companion.init(Ciphers.TLS_ECDHE_PSK_WITH_AES_128_CBC_SHA, 49205);
        TLS_ECDHE_PSK_WITH_AES_256_CBC_SHA = companion.init(Ciphers.TLS_ECDHE_PSK_WITH_AES_256_CBC_SHA, 49206);
        TLS_ECDHE_RSA_WITH_CHACHA20_POLY1305_SHA256 = companion.init(Ciphers.TLS_ECDHE_RSA_WITH_CHACHA20_POLY1305_SHA256, 52392);
        TLS_ECDHE_ECDSA_WITH_CHACHA20_POLY1305_SHA256 = companion.init(Ciphers.TLS_ECDHE_ECDSA_WITH_CHACHA20_POLY1305_SHA256, 52393);
        TLS_DHE_RSA_WITH_CHACHA20_POLY1305_SHA256 = companion.init(Ciphers.TLS_DHE_RSA_WITH_CHACHA20_POLY1305_SHA256, 52394);
        TLS_ECDHE_PSK_WITH_CHACHA20_POLY1305_SHA256 = companion.init(Ciphers.TLS_ECDHE_PSK_WITH_CHACHA20_POLY1305_SHA256, 52396);
        TLS_AES_128_GCM_SHA256 = companion.init(Ciphers.TLS_AES_128_GCM_SHA256, 4865);
        TLS_AES_256_GCM_SHA384 = companion.init(Ciphers.TLS_AES_256_GCM_SHA384, 4866);
        TLS_CHACHA20_POLY1305_SHA256 = companion.init(Ciphers.TLS_CHACHA20_POLY1305_SHA256, 4867);
