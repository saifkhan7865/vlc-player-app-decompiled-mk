...
public final class Cookie {
    ...
    public int hashCode() {
        return ((((((((((((((((527 + this.name.hashCode()) * 31) + this.value.hashCode()) * 31) + UInt$$ExternalSyntheticBackport0.m(this.expiresAt)) * 31) + this.domain.hashCode()) * 31) + this.path.hashCode()) * 31) + UInt$$ExternalSyntheticBackport0.m(this.secure)) * 31) + UInt$$ExternalSyntheticBackport0.m(this.httpOnly)) * 31) + UInt$$ExternalSyntheticBackport0.m(this.persistent)) * 31) + UInt$$ExternalSyntheticBackport0.m(this.hostOnly);
    }
    ...
    public final String m1180deprecated_name() {
        return this.name;
    }

    @Deprecated(level = DeprecationLevel.ERROR, message = "moved to val", replaceWith = @ReplaceWith(expression = "value", imports = {}))
    /* renamed from: -deprecated_value  reason: not valid java name */
    public final String m1184deprecated_value() {
        return this.value;
    }

    @Deprecated(level = DeprecationLevel.ERROR, message = "moved to val", replaceWith = @ReplaceWith(expression = "persistent", imports = {}))
    /* renamed from: -deprecated_persistent  reason: not valid java name */
    public final boolean m1182deprecated_persistent() {
        return this.persistent;
    }

    @Deprecated(level = DeprecationLevel.ERROR, message = "moved to val", replaceWith = @ReplaceWith(expression = "expiresAt", imports = {}))
    /* renamed from: -deprecated_expiresAt  reason: not valid java name */
    public final long m1177deprecated_expiresAt() {
        return this.expiresAt;
    }

    @Deprecated(level = DeprecationLevel.ERROR, message = "moved to val", replaceWith = @ReplaceWith(expression = "hostOnly", imports = {}))
    /* renamed from: -deprecated_hostOnly  reason: not valid java name */
    public final boolean m1178deprecated_hostOnly() {
        return this.hostOnly;
    }
    ...
    public final String m1176deprecated_domain() {
        return this.domain;
    }

    @Deprecated(level = DeprecationLevel.ERROR, message = "moved to val", replaceWith = @ReplaceWith(expression = "path", imports = {}))
    /* renamed from: -deprecated_path  reason: not valid java name */
    public final String m1181deprecated_path() {
        return this.path;
    }

    @Deprecated(level = DeprecationLevel.ERROR, message = "moved to val", replaceWith = @ReplaceWith(expression = "httpOnly", imports = {}))
    /* renamed from: -deprecated_httpOnly  reason: not valid java name */
    public final boolean m1179deprecated_httpOnly() {
        return this.httpOnly;
    }

    @Deprecated(level = DeprecationLevel.ERROR, message = "moved to val", replaceWith = @ReplaceWith(expression = "secure", imports = {}))
    /* renamed from: -deprecated_secure  reason: not valid java name */
    public final boolean m1183deprecated_secure() {
        return this.secure;
    }
    ...
    public static final class Builder {
        ...
        public final Builder path(String str) {
            Intrinsics.checkParameterIsNotNull(str, ArtworkProvider.PATH);
            Builder builder = this;
    ...
    public static final class Companion {
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:57:0x010d, code lost:
            if (r1 > okhttp3.internal.http.DatesKt.MAX_DATE) goto L_0x0115;
         */
        ...
        /* JADX WARNING: Removed duplicated region for block: B:72:0x0145 A[RETURN] */
        ...
        public final okhttp3.Cookie parse$okhttp(long r26, okhttp3.HttpUrl r28, java.lang.String r29) {
            ...
            L_0x0084:
                ...
                r9 = r0
                okhttp3.Cookie$Companion r9 = (okhttp3.Cookie.Companion) r9     // Catch:{ IllegalArgumentException -> 0x00dc }
                int r9 = r13.length()     // Catch:{ IllegalArgumentException -> 0x00dc }
                long r23 = r0.parseExpires(r13, r3, r9)     // Catch:{ IllegalArgumentException -> 0x00dc }
                goto L_0x00a7
            L_0x0098:
            ...
            L_0x00aa:
                ...
                r9 = r0
                okhttp3.Cookie$Companion r9 = (okhttp3.Cookie.Companion) r9     // Catch:{ IllegalArgumentException -> 0x00dc }
                java.lang.String r10 = r0.parseDomain(r13)     // Catch:{ IllegalArgumentException -> 0x00dc }
                r20 = 0
                goto L_0x00dc
            L_0x00bc:
        ...
        private final long parseExpires(String str, int i, int i2) {
            ...
            if (i4 >= 0 && 69 >= i4) {
                i4 += OnRepeatListener.DEFAULT_SPEEDUP_DELAY;
            }
            if (i4 >= 1601) {
                if (i7 != -1) {
                    if (1 <= i6 && 31 >= i6) {
