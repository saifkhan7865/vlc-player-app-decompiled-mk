...
public final class HttpHeaders {
    ...
    public static final boolean promisesBody(Response response) {
        ...
        if (((code >= 100 && code < 200) || code == 204 || code == 304) && Util.headersContentLength(response) == -1 && !StringsKt.equals(HttpHeaders.Values.CHUNKED, Response.header$default(response, "Transfer-Encoding", (String) null, 2, (Object) null), true)) {
            return false;
        }
        return true;
    }
