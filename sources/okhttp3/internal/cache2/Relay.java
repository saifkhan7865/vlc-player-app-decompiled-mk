...
public final class Relay {
    ...
    @Metadata(bv = {1, 0, 3}, d1 = {"\u0000.\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\t\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\b\u0004\u0018\u00002\u00020\u0001B\u0005¢\u0006\u0002\u0010\u0002J\b\u0010\t\u001a\u00020\nH\u0016J\u0018\u0010\u000b\u001a\u00020\u00062\u0006\u0010\f\u001a\u00020\r2\u0006\u0010\u000e\u001a\u00020\u0006H\u0016J\b\u0010\u0007\u001a\u00020\bH\u0016R\u0010\u0010\u0003\u001a\u0004\u0018\u00010\u0004X\u000e¢\u0006\u0002\n\u0000R\u000e\u0010\u0005\u001a\u00020\u0006X\u000e¢\u0006\u0002\n\u0000R\u000e\u0010\u0007\u001a\u00020\bX\u0004¢\u0006\u0002\n\u0000¨\u0006\u000f"}, d2 = {"Lokhttp3/internal/cache2/Relay$RelaySource;", "Lokio/Source;", "(Lokhttp3/internal/cache2/Relay;)V", "fileOperator", "Lokhttp3/internal/cache2/FileOperator;", "sourcePos", "", "timeout", "Lokio/Timeout;", "close", "", "read", "sink", "Lokio/Buffer;", "byteCount", "okhttp"}, k = 1, mv = {1, 1, 15})
    /* compiled from: Relay.kt */
    public final class RelaySource implements Source {
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:64:0x0157, code lost:
            if (r1.this$0.getBuffer().size() <= r1.this$0.getBufferMaxSize()) goto L_0x0173;
         */
        ...
        public long read(okio.Buffer r20, long r21) throws java.io.IOException {
            ...
            L_0x0013:
                ...
                monitor-enter(r8)
            L_0x0018:
                okhttp3.internal.cache2.Relay r0 = okhttp3.internal.cache2.Relay.this     // Catch:{ all -> 0x01ca }
                long r6 = r0.getUpstreamPos()     // Catch:{ all -> 0x01ca }
                long r9 = r1.sourcePos     // Catch:{ all -> 0x01ca }
                r0 = 2
                r11 = -1
                int r13 = (r9 > r6 ? 1 : (r9 == r6 ? 0 : -1))
                if (r13 == 0) goto L_0x0065
                okhttp3.internal.cache2.Relay r4 = okhttp3.internal.cache2.Relay.this     // Catch:{ all -> 0x01ca }
                long r6 = r4.getUpstreamPos()     // Catch:{ all -> 0x01ca }
                okhttp3.internal.cache2.Relay r4 = okhttp3.internal.cache2.Relay.this     // Catch:{ all -> 0x01ca }
                okio.Buffer r4 = r4.getBuffer()     // Catch:{ all -> 0x01ca }
                long r9 = r4.size()     // Catch:{ all -> 0x01ca }
                long r6 = r6 - r9
                long r9 = r1.sourcePos     // Catch:{ all -> 0x01ca }
            ...
            L_0x0040:
                okhttp3.internal.cache2.Relay r0 = okhttp3.internal.cache2.Relay.this     // Catch:{ all -> 0x01ca }
                long r9 = r0.getUpstreamPos()     // Catch:{ all -> 0x01ca }
                long r11 = r1.sourcePos     // Catch:{ all -> 0x01ca }
                long r9 = r9 - r11
                long r9 = java.lang.Math.min(r2, r9)     // Catch:{ all -> 0x01ca }
                okhttp3.internal.cache2.Relay r0 = okhttp3.internal.cache2.Relay.this     // Catch:{ all -> 0x01ca }
                okio.Buffer r2 = r0.getBuffer()     // Catch:{ all -> 0x01ca }
                long r3 = r1.sourcePos     // Catch:{ all -> 0x01ca }
                long r6 = r3 - r6
                r3 = r20
                r4 = r6
                r6 = r9
                r2.copyTo((okio.Buffer) r3, (long) r4, (long) r6)     // Catch:{ all -> 0x01ca }
                long r2 = r1.sourcePos     // Catch:{ all -> 0x01ca }
                long r2 = r2 + r9
                r1.sourcePos = r2     // Catch:{ all -> 0x01ca }
                monitor-exit(r8)
                return r9
            L_0x0065:
                okhttp3.internal.cache2.Relay r6 = okhttp3.internal.cache2.Relay.this     // Catch:{ all -> 0x01ca }
                boolean r6 = r6.getComplete()     // Catch:{ all -> 0x01ca }
                if (r6 == 0) goto L_0x006f
                monitor-exit(r8)
                return r11
            L_0x006f:
                okhttp3.internal.cache2.Relay r6 = okhttp3.internal.cache2.Relay.this     // Catch:{ all -> 0x01ca }
                java.lang.Thread r6 = r6.getUpstreamReader()     // Catch:{ all -> 0x01ca }
                if (r6 == 0) goto L_0x007f
                okio.Timeout r0 = r1.timeout     // Catch:{ all -> 0x01ca }
                okhttp3.internal.cache2.Relay r6 = okhttp3.internal.cache2.Relay.this     // Catch:{ all -> 0x01ca }
                r0.waitUntilNotified(r6)     // Catch:{ all -> 0x01ca }
                goto L_0x0018
            L_0x007f:
                okhttp3.internal.cache2.Relay r6 = okhttp3.internal.cache2.Relay.this     // Catch:{ all -> 0x01ca }
                java.lang.Thread r7 = java.lang.Thread.currentThread()     // Catch:{ all -> 0x01ca }
                r6.setUpstreamReader(r7)     // Catch:{ all -> 0x01ca }
            L_0x0088:
                monitor-exit(r8)
                r8 = 32
            ...
            L_0x00bc:
                ...
                monitor-enter(r2)
                okhttp3.internal.cache2.Relay r0 = okhttp3.internal.cache2.Relay.this     // Catch:{ all -> 0x00f9 }
                r3 = r10
                java.lang.Thread r3 = (java.lang.Thread) r3     // Catch:{ all -> 0x00f9 }
                r0.setUpstreamReader(r10)     // Catch:{ all -> 0x00f9 }
                okhttp3.internal.cache2.Relay r0 = okhttp3.internal.cache2.Relay.this     // Catch:{ all -> 0x00f9 }
                if (r0 == 0) goto L_0x00f1
                java.lang.Object r0 = (java.lang.Object) r0     // Catch:{ all -> 0x00f9 }
                r0.notifyAll()     // Catch:{ all -> 0x00f9 }
            ...
            L_0x011b:
                ...
                r0.write((okio.Buffer) r3, (long) r4)     // Catch:{ all -> 0x01a3 }
                okhttp3.internal.cache2.Relay r0 = okhttp3.internal.cache2.Relay.this     // Catch:{ all -> 0x01a3 }
                okio.Buffer r0 = r0.getBuffer()     // Catch:{ all -> 0x01a3 }
            ...
            L_0x0173:
                ...
                r3 = r10
                java.lang.Thread r3 = (java.lang.Thread) r3     // Catch:{ all -> 0x01a0 }
            ...
            L_0x01a6:
                ...
                okhttp3.internal.cache2.Relay r2 = okhttp3.internal.cache2.Relay.this
                monitor-enter(r2)
                okhttp3.internal.cache2.Relay r3 = okhttp3.internal.cache2.Relay.this     // Catch:{ all -> 0x01c7 }
                r4 = r10
                java.lang.Thread r4 = (java.lang.Thread) r4     // Catch:{ all -> 0x01c7 }
                r3.setUpstreamReader(r10)     // Catch:{ all -> 0x01c7 }
                okhttp3.internal.cache2.Relay r3 = okhttp3.internal.cache2.Relay.this     // Catch:{ all -> 0x01c7 }
                if (r3 != 0) goto L_0x01be
                kotlin.TypeCastException r0 = new kotlin.TypeCastException     // Catch:{ all -> 0x01c7 }
                java.lang.String r3 = "null cannot be cast to non-null type java.lang.Object"
                r0.<init>(r3)     // Catch:{ all -> 0x01c7 }
                throw r0     // Catch:{ all -> 0x01c7 }
            L_0x01be:
                java.lang.Object r3 = (java.lang.Object) r3     // Catch:{ all -> 0x01c7 }
                r3.notifyAll()     // Catch:{ all -> 0x01c7 }
                kotlin.Unit r3 = kotlin.Unit.INSTANCE     // Catch:{ all -> 0x01c7 }
                monitor-exit(r2)
                throw r0
            L_0x01c7:
                r0 = move-exception
    ...
    @Metadata(bv = {1, 0, 3}, d1 = {"\u00006\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\t\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\b\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0004\b\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J&\u0010\u000b\u001a\u00020\f2\u0006\u0010\r\u001a\u00020\u000e2\u0006\u0010\u000f\u001a\u00020\u00102\u0006\u0010\u0011\u001a\u00020\u00062\u0006\u0010\u0012\u001a\u00020\u0004J\u000e\u0010\u0013\u001a\u00020\f2\u0006\u0010\r\u001a\u00020\u000eR\u000e\u0010\u0003\u001a\u00020\u0004XT¢\u0006\u0002\n\u0000R\u0010\u0010\u0005\u001a\u00020\u00068\u0006X\u0004¢\u0006\u0002\n\u0000R\u0010\u0010\u0007\u001a\u00020\u00068\u0006X\u0004¢\u0006\u0002\n\u0000R\u000e\u0010\b\u001a\u00020\tXT¢\u0006\u0002\n\u0000R\u000e\u0010\n\u001a\u00020\tXT¢\u0006\u0002\n\u0000¨\u0006\u0014"}, d2 = {"Lokhttp3/internal/cache2/Relay$Companion;", "", "()V", "FILE_HEADER_SIZE", "", "PREFIX_CLEAN", "Lokio/ByteString;", "PREFIX_DIRTY", "SOURCE_FILE", "", "SOURCE_UPSTREAM", "edit", "Lokhttp3/internal/cache2/Relay;", "file", "Ljava/io/File;", "upstream", "Lokio/Source;", "metadata", "bufferMaxSize", "read", "okhttp"}, k = 1, mv = {1, 1, 15})
    /* compiled from: Relay.kt */
