...
public final class PublicSuffixDatabase {
    ...
    private final void readTheList() throws java.io.IOException {
        /*
            ...
            r2 = r1
            okio.BufferedSource r2 = (okio.BufferedSource) r2     // Catch:{ all -> 0x0057 }
            int r3 = r2.readInt()     // Catch:{ all -> 0x0057 }
            long r3 = (long) r3     // Catch:{ all -> 0x0057 }
            byte[] r3 = r2.readByteArray(r3)     // Catch:{ all -> 0x0057 }
            int r4 = r2.readInt()     // Catch:{ all -> 0x0057 }
            long r4 = (long) r4     // Catch:{ all -> 0x0057 }
            byte[] r2 = r2.readByteArray(r4)     // Catch:{ all -> 0x0057 }
        ...
        L_0x0042:
            r6.publicSuffixListBytes = r3     // Catch:{ all -> 0x0054 }
            if (r2 != 0) goto L_0x0049
            kotlin.jvm.internal.Intrinsics.throwNpe()     // Catch:{ all -> 0x0054 }
        L_0x0049:
            r6.publicSuffixExceptionListBytes = r2     // Catch:{ all -> 0x0054 }
            kotlin.Unit r0 = kotlin.Unit.INSTANCE     // Catch:{ all -> 0x0054 }
            monitor-exit(r6)
