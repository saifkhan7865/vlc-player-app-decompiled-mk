...
public final class Http2Stream {
    ...
    public final synchronized okhttp3.Headers takeHeaders() throws java.io.IOException {
        ...
        L_0x0016:
            ...
            kotlin.jvm.internal.Intrinsics.checkExpressionValueIsNotNull(r0, r1)     // Catch:{ all -> 0x0050 }
        ...
        L_0x0036:
            ...
            kotlin.jvm.internal.Intrinsics.throwNpe()     // Catch:{ all -> 0x0050 }
        L_0x0043:
    ...
    public final void enqueueTrailers(Headers headers) {
        Intrinsics.checkParameterIsNotNull(headers, HttpHeaders.Values.TRAILERS);
        synchronized (this) {
            boolean z = true;
    ...
    public final void receiveHeaders(okhttp3.Headers r3, boolean r4) {
        /*
            ...
            monitor-enter(r2)
            boolean r0 = r2.hasResponseHeaders     // Catch:{ all -> 0x003e }
            r1 = 1
            if (r0 == 0) goto L_0x0017
            if (r4 != 0) goto L_0x0011
            goto L_0x0017
        L_0x0011:
            okhttp3.internal.http2.Http2Stream$FramingSource r0 = r2.source     // Catch:{ all -> 0x003e }
            r0.setTrailers(r3)     // Catch:{ all -> 0x003e }
            goto L_0x0020
        L_0x0017:
            r2.hasResponseHeaders = r1     // Catch:{ all -> 0x003e }
            java.util.ArrayDeque<okhttp3.Headers> r0 = r2.headersQueue     // Catch:{ all -> 0x003e }
            java.util.Collection r0 = (java.util.Collection) r0     // Catch:{ all -> 0x003e }
            r0.add(r3)     // Catch:{ all -> 0x003e }
        L_0x0020:
            if (r4 == 0) goto L_0x0027
            okhttp3.internal.http2.Http2Stream$FramingSource r3 = r2.source     // Catch:{ all -> 0x003e }
            r3.setFinished$okhttp(r1)     // Catch:{ all -> 0x003e }
        L_0x0027:
            boolean r3 = r2.isOpen()     // Catch:{ all -> 0x003e }
            r4 = r2
            java.lang.Object r4 = (java.lang.Object) r4     // Catch:{ all -> 0x003e }
            r4.notifyAll()     // Catch:{ all -> 0x003e }
            kotlin.Unit r4 = kotlin.Unit.INSTANCE     // Catch:{ all -> 0x003e }
            monitor-exit(r2)
    ...
    public final class FramingSink implements Sink {
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:11:0x001a, code lost:
            if (r8.this$0.getSink$okhttp().finished != false) goto L_0x007c;
         */
        /* JADX WARNING: Code restructure failed: missing block: B:13:0x0027, code lost:
            if (r8.sendBuffer.size() <= 0) goto L_0x002b;
         */
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:17:0x002e, code lost:
            if (r8.trailers == null) goto L_0x0059;
         */
        /* JADX WARNING: Code restructure failed: missing block: B:19:0x0038, code lost:
            if (r8.sendBuffer.size() <= 0) goto L_0x003e;
         */
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:24:0x0051, code lost:
            r0.writeHeaders$okhttp(r2, true, okhttp3.internal.Util.toHeaderList(r3));
         */
        /* JADX WARNING: Code restructure failed: missing block: B:25:0x0059, code lost:
            if (r2 == false) goto L_0x0069;
         */
        /* JADX WARNING: Code restructure failed: missing block: B:27:0x0063, code lost:
            if (r8.sendBuffer.size() <= 0) goto L_0x007c;
         */
        /* JADX WARNING: Code restructure failed: missing block: B:28:0x0065, code lost:
            emitFrame(true);
         */
        /* JADX WARNING: Code restructure failed: missing block: B:29:0x0069, code lost:
            r8.this$0.getConnection().writeData(r8.this$0.getId(), true, (okio.Buffer) null, 0);
         */
        ...
        public void close() throws java.io.IOException {
            /*
                ...
                java.lang.Thread.holdsLock(r0)
                okhttp3.internal.http2.Http2Stream r0 = okhttp3.internal.http2.Http2Stream.this
                monitor-enter(r0)
                boolean r1 = r8.closed     // Catch:{ all -> 0x0096 }
            ...
            L_0x003e:
                ...
                kotlin.jvm.internal.Intrinsics.throwNpe()
            L_0x0051:
                java.util.List r3 = okhttp3.internal.Util.toHeaderList(r3)
                r0.writeHeaders$okhttp(r2, r1, r3)
                goto L_0x007c
            L_0x0059:
            ...
            L_0x007c:
                okhttp3.internal.http2.Http2Stream r0 = okhttp3.internal.http2.Http2Stream.this
                monitor-enter(r0)
                r8.closed = r1     // Catch:{ all -> 0x0093 }
                kotlin.Unit r1 = kotlin.Unit.INSTANCE     // Catch:{ all -> 0x0093 }
                monitor-exit(r0)
                okhttp3.internal.http2.Http2Stream r0 = okhttp3.internal.http2.Http2Stream.this
                okhttp3.internal.http2.Http2Connection r0 = r0.getConnection()
                r0.flush()
    ...
    @Metadata(bv = {1, 0, 3}, d1 = {"\u0000\u0012\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\t\n\u0000\b\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002R\u000e\u0010\u0003\u001a\u00020\u0004XT¢\u0006\u0002\n\u0000¨\u0006\u0005"}, d2 = {"Lokhttp3/internal/http2/Http2Stream$Companion;", "", "()V", "EMIT_BUFFER_SIZE", "", "okhttp"}, k = 1, mv = {1, 1, 15})
    /* compiled from: Http2Stream.kt */
