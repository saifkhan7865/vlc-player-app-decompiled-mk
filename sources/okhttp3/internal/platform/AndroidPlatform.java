...
public final class AndroidPlatform extends Platform {
    ...
    public boolean isCleartextTrafficPermitted(String str) {
        ...
        try {
            ...
            throw UInt$$ExternalSyntheticBackport0.m("unable to determine cleartext support", (Throwable) e);
        } catch (IllegalArgumentException e2) {
            throw UInt$$ExternalSyntheticBackport0.m("unable to determine cleartext support", (Throwable) e2);
        } catch (InvocationTargetException e3) {
            throw UInt$$ExternalSyntheticBackport0.m("unable to determine cleartext support", (Throwable) e3);
        }
    }
    ...
    private final boolean api23IsCleartextTrafficPermitted(String str, Class<?> cls, Object obj) throws InvocationTargetException, IllegalAccessException {
        try {
            Object invoke = cls.getMethod("isCleartextTrafficPermitted", (Class[]) null).invoke(obj, (Object[]) null);
            if (invoke != null) {
                return ((Boolean) invoke).booleanValue();
            }
            throw new TypeCastException("null cannot be cast to non-null type kotlin.Boolean");
    ...
    public CertificateChainCleaner buildCertificateChainCleaner(X509TrustManager x509TrustManager) {
        ...
        try {
            ...
            Method method = cls.getMethod("checkServerTrusted", new Class[]{X509Certificate[].class, cls2, cls2});
    ...
    public static final class CustomTrustRootIndex implements TrustRootIndex {
        ...
        public X509Certificate findByIssuerAndSignature(X509Certificate x509Certificate) {
            ...
            try {
                ...
                throw UInt$$ExternalSyntheticBackport0.m("unable to get issues and signature", (Throwable) e);
