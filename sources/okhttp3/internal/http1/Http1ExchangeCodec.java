...
public final class Http1ExchangeCodec implements ExchangeCodec {
    ...
    private final boolean isChunked(Response response) {
        return StringsKt.equals(HttpHeaders.Values.CHUNKED, Response.header$default(response, "Transfer-Encoding", (String) null, 2, (Object) null), true);
    }

    private final boolean isChunked(Request request) {
        return StringsKt.equals(HttpHeaders.Values.CHUNKED, request.header("Transfer-Encoding"), true);
    }
