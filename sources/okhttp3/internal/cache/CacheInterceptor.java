    ...
    public static final class Companion {
        ...
        public final Headers combine(Headers headers, Headers headers2) {
            ...
            for (int i = 0; i < size; i++) {
                ...
                if (!StringsKt.equals("Warning", name, true) || !StringsKt.startsWith$default(value, DiskLruCache.VERSION_1, false, 2, (Object) null)) {
        ...
        private final boolean isEndToEnd(String str) {
            if (StringsKt.equals("Connection", str, true) || StringsKt.equals(com.google.common.net.HttpHeaders.KEEP_ALIVE, str, true) || StringsKt.equals("Proxy-Authenticate", str, true) || StringsKt.equals("Proxy-Authorization", str, true) || StringsKt.equals("TE", str, true) || StringsKt.equals("Trailers", str, true) || StringsKt.equals("Transfer-Encoding", str, true) || StringsKt.equals("Upgrade", str, true)) {
                return false;
            }
            return true;
        }
