...
public final class DiskLruCache implements Closeable, Flushable {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:17:?, code lost:
        r11.redundantOpCount = r0 - r11.lruEntries.size();
     */
    /* JADX WARNING: Code restructure failed: missing block: B:18:0x007e, code lost:
        if (r4.exhausted() == false) goto L_0x0080;
     */
    ...
    /* JADX WARNING: Unknown top exception splitter block from list: {B:24:0x0090=Splitter:B:24:0x0090, B:16:0x0071=Splitter:B:16:0x0071} */
    ...
    private final void readJournal() throws java.io.IOException {
        /*
            ...
            r4 = r2
            okio.BufferedSource r4 = (okio.BufferedSource) r4     // Catch:{ all -> 0x00bb }
            java.lang.String r5 = r4.readUtf8LineStrict()     // Catch:{ all -> 0x00bb }
            java.lang.String r6 = r4.readUtf8LineStrict()     // Catch:{ all -> 0x00bb }
            java.lang.String r7 = r4.readUtf8LineStrict()     // Catch:{ all -> 0x00bb }
            java.lang.String r8 = r4.readUtf8LineStrict()     // Catch:{ all -> 0x00bb }
            java.lang.String r9 = r4.readUtf8LineStrict()     // Catch:{ all -> 0x00bb }
            java.lang.String r10 = MAGIC     // Catch:{ all -> 0x00bb }
            boolean r10 = kotlin.jvm.internal.Intrinsics.areEqual((java.lang.Object) r10, (java.lang.Object) r5)     // Catch:{ all -> 0x00bb }
            r10 = r10 ^ 1
            if (r10 != 0) goto L_0x0090
            java.lang.String r10 = VERSION_1     // Catch:{ all -> 0x00bb }
            boolean r10 = kotlin.jvm.internal.Intrinsics.areEqual((java.lang.Object) r10, (java.lang.Object) r6)     // Catch:{ all -> 0x00bb }
            r10 = r10 ^ 1
            if (r10 != 0) goto L_0x0090
            int r10 = r11.appVersion     // Catch:{ all -> 0x00bb }
            java.lang.String r10 = java.lang.String.valueOf(r10)     // Catch:{ all -> 0x00bb }
            boolean r7 = kotlin.jvm.internal.Intrinsics.areEqual((java.lang.Object) r10, (java.lang.Object) r7)     // Catch:{ all -> 0x00bb }
            r7 = r7 ^ 1
            if (r7 != 0) goto L_0x0090
            int r7 = r11.valueCount     // Catch:{ all -> 0x00bb }
            java.lang.String r7 = java.lang.String.valueOf(r7)     // Catch:{ all -> 0x00bb }
            boolean r7 = kotlin.jvm.internal.Intrinsics.areEqual((java.lang.Object) r7, (java.lang.Object) r8)     // Catch:{ all -> 0x00bb }
            r7 = r7 ^ 1
            if (r7 != 0) goto L_0x0090
            r7 = r9
            java.lang.CharSequence r7 = (java.lang.CharSequence) r7     // Catch:{ all -> 0x00bb }
            int r7 = r7.length()     // Catch:{ all -> 0x00bb }
            if (r7 > 0) goto L_0x0090
            r0 = 0
        L_0x0067:
            java.lang.String r1 = r4.readUtf8LineStrict()     // Catch:{ EOFException -> 0x0071 }
            r11.readJournalLine(r1)     // Catch:{ EOFException -> 0x0071 }
            int r0 = r0 + 1
            goto L_0x0067
        L_0x0071:
            java.util.LinkedHashMap<java.lang.String, okhttp3.internal.cache.DiskLruCache$Entry> r1 = r11.lruEntries     // Catch:{ all -> 0x00bb }
            int r1 = r1.size()     // Catch:{ all -> 0x00bb }
            int r0 = r0 - r1
            r11.redundantOpCount = r0     // Catch:{ all -> 0x00bb }
            boolean r0 = r4.exhausted()     // Catch:{ all -> 0x00bb }
            if (r0 != 0) goto L_0x0084
            r11.rebuildJournal$okhttp()     // Catch:{ all -> 0x00bb }
            goto L_0x008a
        L_0x0084:
            okio.BufferedSink r0 = r11.newJournalWriter()     // Catch:{ all -> 0x00bb }
            r11.journalWriter = r0     // Catch:{ all -> 0x00bb }
        L_0x008a:
        ...
        L_0x0090:
            ...
            r4.<init>(r1)     // Catch:{ all -> 0x00bb }
            r4.append(r5)     // Catch:{ all -> 0x00bb }
            r4.append(r0)     // Catch:{ all -> 0x00bb }
            r4.append(r6)     // Catch:{ all -> 0x00bb }
            r4.append(r0)     // Catch:{ all -> 0x00bb }
            r4.append(r8)     // Catch:{ all -> 0x00bb }
            r4.append(r0)     // Catch:{ all -> 0x00bb }
            r4.append(r9)     // Catch:{ all -> 0x00bb }
            r0 = 93
            r4.append(r0)     // Catch:{ all -> 0x00bb }
            java.lang.String r0 = r4.toString()     // Catch:{ all -> 0x00bb }
            r3.<init>(r0)     // Catch:{ all -> 0x00bb }
            java.lang.Throwable r3 = (java.lang.Throwable) r3     // Catch:{ all -> 0x00bb }
    ...
    public final synchronized void rebuildJournal$okhttp() throws java.io.IOException {
        ...
        L_0x0091:
            ...
            kotlin.io.CloseableKt.closeFinally(r0, r1)     // Catch:{ all -> 0x00cd }
            okhttp3.internal.io.FileSystem r0 = r8.fileSystem     // Catch:{ all -> 0x00cd }
    ...
    public final synchronized okhttp3.internal.cache.DiskLruCache.Snapshot get(java.lang.String r4) throws java.io.IOException {
        /*
            ...
            kotlin.jvm.internal.Intrinsics.checkParameterIsNotNull(r4, r0)     // Catch:{ all -> 0x0062 }
            ...
            kotlin.jvm.internal.Intrinsics.checkExpressionValueIsNotNull(r0, r2)     // Catch:{ all -> 0x0062 }
        ...
        L_0x0027:
            ...
            okio.BufferedSink r1 = r3.journalWriter     // Catch:{ all -> 0x0062 }
            if (r1 != 0) goto L_0x003a
            kotlin.jvm.internal.Intrinsics.throwNpe()     // Catch:{ all -> 0x0062 }
        L_0x003a:
            java.lang.String r2 = READ     // Catch:{ all -> 0x0062 }
            okio.BufferedSink r1 = r1.writeUtf8(r2)     // Catch:{ all -> 0x0062 }
            r2 = 32
            okio.BufferedSink r1 = r1.writeByte(r2)     // Catch:{ all -> 0x0062 }
            okio.BufferedSink r4 = r1.writeUtf8(r4)     // Catch:{ all -> 0x0062 }
            r1 = 10
            r4.writeByte(r1)     // Catch:{ all -> 0x0062 }
    ...
    public final synchronized okhttp3.internal.cache.DiskLruCache.Editor edit(java.lang.String r6, long r7) throws java.io.IOException {
        /*
            ...
            monitor-enter(r5)
            java.lang.String r0 = "key"
            kotlin.jvm.internal.Intrinsics.checkParameterIsNotNull(r6, r0)     // Catch:{ all -> 0x0085 }
            ...
            long r1 = r0.getSequenceNumber$okhttp()     // Catch:{ all -> 0x0085 }
        ...
        L_0x0036:
            ...
            goto L_0x007c
        L_0x003f:
            okio.BufferedSink r7 = r5.journalWriter     // Catch:{ all -> 0x0085 }
            if (r7 != 0) goto L_0x0046
            kotlin.jvm.internal.Intrinsics.throwNpe()     // Catch:{ all -> 0x0085 }
        L_0x0046:
            java.lang.String r8 = DIRTY     // Catch:{ all -> 0x0085 }
            okio.BufferedSink r8 = r7.writeUtf8(r8)     // Catch:{ all -> 0x0085 }
            r1 = 32
            okio.BufferedSink r8 = r8.writeByte(r1)     // Catch:{ all -> 0x0085 }
            okio.BufferedSink r8 = r8.writeUtf8(r6)     // Catch:{ all -> 0x0085 }
            r1 = 10
            r8.writeByte(r1)     // Catch:{ all -> 0x0085 }
    ...
    public final synchronized void completeEdit$okhttp(okhttp3.internal.cache.DiskLruCache.Editor r9, boolean r10) throws java.io.IOException {
        /*
            ...
            kotlin.jvm.internal.Intrinsics.checkParameterIsNotNull(r9, r0)     // Catch:{ all -> 0x0138 }
            okhttp3.internal.cache.DiskLruCache$Entry r0 = r9.getEntry$okhttp()     // Catch:{ all -> 0x0138 }
            okhttp3.internal.cache.DiskLruCache$Editor r1 = r0.getCurrentEditor$okhttp()     // Catch:{ all -> 0x0138 }
            boolean r1 = kotlin.jvm.internal.Intrinsics.areEqual((java.lang.Object) r1, (java.lang.Object) r9)     // Catch:{ all -> 0x0138 }
            if (r1 == 0) goto L_0x012a
            r1 = 0
            if (r10 == 0) goto L_0x0065
            boolean r2 = r0.getReadable$okhttp()     // Catch:{ all -> 0x0138 }
            if (r2 != 0) goto L_0x0065
            int r2 = r8.valueCount     // Catch:{ all -> 0x0138 }
            r3 = 0
        L_0x0020:
            if (r3 >= r2) goto L_0x0065
            boolean[] r4 = r9.getWritten$okhttp()     // Catch:{ all -> 0x0138 }
            if (r4 != 0) goto L_0x002b
            kotlin.jvm.internal.Intrinsics.throwNpe()     // Catch:{ all -> 0x0138 }
        L_0x002b:
            boolean r4 = r4[r3]     // Catch:{ all -> 0x0138 }
            if (r4 == 0) goto L_0x0049
            okhttp3.internal.io.FileSystem r4 = r8.fileSystem     // Catch:{ all -> 0x0138 }
            java.util.List r5 = r0.getDirtyFiles$okhttp()     // Catch:{ all -> 0x0138 }
            java.lang.Object r5 = r5.get(r3)     // Catch:{ all -> 0x0138 }
            java.io.File r5 = (java.io.File) r5     // Catch:{ all -> 0x0138 }
            boolean r4 = r4.exists(r5)     // Catch:{ all -> 0x0138 }
            if (r4 != 0) goto L_0x0046
            r9.abort()     // Catch:{ all -> 0x0138 }
            monitor-exit(r8)
            return
        L_0x0046:
            int r3 = r3 + 1
        ...
        L_0x0049:
            r9.abort()     // Catch:{ all -> 0x0138 }
            java.lang.IllegalStateException r9 = new java.lang.IllegalStateException     // Catch:{ all -> 0x0138 }
            java.lang.StringBuilder r10 = new java.lang.StringBuilder     // Catch:{ all -> 0x0138 }
            r10.<init>()     // Catch:{ all -> 0x0138 }
            java.lang.String r0 = "Newly created entry didn't create value for index "
            r10.append(r0)     // Catch:{ all -> 0x0138 }
            r10.append(r3)     // Catch:{ all -> 0x0138 }
            java.lang.String r10 = r10.toString()     // Catch:{ all -> 0x0138 }
            r9.<init>(r10)     // Catch:{ all -> 0x0138 }
            java.lang.Throwable r9 = (java.lang.Throwable) r9     // Catch:{ all -> 0x0138 }
            throw r9     // Catch:{ all -> 0x0138 }
        L_0x0065:
            int r9 = r8.valueCount     // Catch:{ all -> 0x0138 }
        L_0x0067:
            if (r1 >= r9) goto L_0x00ad
            java.util.List r2 = r0.getDirtyFiles$okhttp()     // Catch:{ all -> 0x0138 }
            java.lang.Object r2 = r2.get(r1)     // Catch:{ all -> 0x0138 }
            java.io.File r2 = (java.io.File) r2     // Catch:{ all -> 0x0138 }
            if (r10 == 0) goto L_0x00a5
            okhttp3.internal.io.FileSystem r3 = r8.fileSystem     // Catch:{ all -> 0x0138 }
            boolean r3 = r3.exists(r2)     // Catch:{ all -> 0x0138 }
            if (r3 == 0) goto L_0x00aa
            java.util.List r3 = r0.getCleanFiles$okhttp()     // Catch:{ all -> 0x0138 }
            java.lang.Object r3 = r3.get(r1)     // Catch:{ all -> 0x0138 }
            java.io.File r3 = (java.io.File) r3     // Catch:{ all -> 0x0138 }
            okhttp3.internal.io.FileSystem r4 = r8.fileSystem     // Catch:{ all -> 0x0138 }
            r4.rename(r2, r3)     // Catch:{ all -> 0x0138 }
            long[] r2 = r0.getLengths$okhttp()     // Catch:{ all -> 0x0138 }
            r4 = r2[r1]     // Catch:{ all -> 0x0138 }
            okhttp3.internal.io.FileSystem r2 = r8.fileSystem     // Catch:{ all -> 0x0138 }
            long r2 = r2.size(r3)     // Catch:{ all -> 0x0138 }
            long[] r6 = r0.getLengths$okhttp()     // Catch:{ all -> 0x0138 }
            r6[r1] = r2     // Catch:{ all -> 0x0138 }
            long r6 = r8.size     // Catch:{ all -> 0x0138 }
            long r6 = r6 - r4
            long r6 = r6 + r2
            r8.size = r6     // Catch:{ all -> 0x0138 }
            goto L_0x00aa
        L_0x00a5:
            okhttp3.internal.io.FileSystem r3 = r8.fileSystem     // Catch:{ all -> 0x0138 }
            r3.delete(r2)     // Catch:{ all -> 0x0138 }
        L_0x00aa:
            int r1 = r1 + 1
            goto L_0x0067
        L_0x00ad:
            int r9 = r8.redundantOpCount     // Catch:{ all -> 0x0138 }
            r1 = 1
            int r9 = r9 + r1
            r8.redundantOpCount = r9     // Catch:{ all -> 0x0138 }
            r9 = 0
            r2 = r9
            okhttp3.internal.cache.DiskLruCache$Editor r2 = (okhttp3.internal.cache.DiskLruCache.Editor) r2     // Catch:{ all -> 0x0138 }
            r0.setCurrentEditor$okhttp(r9)     // Catch:{ all -> 0x0138 }
            okio.BufferedSink r9 = r8.journalWriter     // Catch:{ all -> 0x0138 }
        ...
        L_0x00c1:
            ...
            goto L_0x00eb
        L_0x00ce:
            java.util.LinkedHashMap<java.lang.String, okhttp3.internal.cache.DiskLruCache$Entry> r10 = r8.lruEntries     // Catch:{ all -> 0x0138 }
            java.lang.String r1 = r0.getKey$okhttp()     // Catch:{ all -> 0x0138 }
            r10.remove(r1)     // Catch:{ all -> 0x0138 }
            java.lang.String r10 = REMOVE     // Catch:{ all -> 0x0138 }
            okio.BufferedSink r10 = r9.writeUtf8(r10)     // Catch:{ all -> 0x0138 }
            r10.writeByte(r4)     // Catch:{ all -> 0x0138 }
            java.lang.String r10 = r0.getKey$okhttp()     // Catch:{ all -> 0x0138 }
            r9.writeUtf8(r10)     // Catch:{ all -> 0x0138 }
            r9.writeByte(r3)     // Catch:{ all -> 0x0138 }
            goto L_0x0110
        L_0x00eb:
            r0.setReadable$okhttp(r1)     // Catch:{ all -> 0x0138 }
            java.lang.String r1 = CLEAN     // Catch:{ all -> 0x0138 }
            okio.BufferedSink r1 = r9.writeUtf8(r1)     // Catch:{ all -> 0x0138 }
            r1.writeByte(r4)     // Catch:{ all -> 0x0138 }
            java.lang.String r1 = r0.getKey$okhttp()     // Catch:{ all -> 0x0138 }
            r9.writeUtf8(r1)     // Catch:{ all -> 0x0138 }
            r0.writeLengths$okhttp(r9)     // Catch:{ all -> 0x0138 }
            r9.writeByte(r3)     // Catch:{ all -> 0x0138 }
            if (r10 == 0) goto L_0x0110
            long r1 = r8.nextSequenceNumber     // Catch:{ all -> 0x0138 }
            r3 = 1
            long r3 = r3 + r1
            r8.nextSequenceNumber = r3     // Catch:{ all -> 0x0138 }
            r0.setSequenceNumber$okhttp(r1)     // Catch:{ all -> 0x0138 }
        L_0x0110:
            r9.flush()     // Catch:{ all -> 0x0138 }
            long r9 = r8.size     // Catch:{ all -> 0x0138 }
            long r0 = r8.maxSize     // Catch:{ all -> 0x0138 }
            int r2 = (r9 > r0 ? 1 : (r9 == r0 ? 0 : -1))
            if (r2 > 0) goto L_0x0121
            boolean r9 = r8.journalRebuildRequired()     // Catch:{ all -> 0x0138 }
            if (r9 == 0) goto L_0x0128
        L_0x0121:
            java.util.concurrent.Executor r9 = r8.executor     // Catch:{ all -> 0x0138 }
            java.lang.Runnable r10 = r8.cleanupRunnable     // Catch:{ all -> 0x0138 }
            r9.execute(r10)     // Catch:{ all -> 0x0138 }
        L_0x0128:
            monitor-exit(r8)
            return
        L_0x012a:
            java.lang.String r9 = "Check failed."
            java.lang.IllegalStateException r10 = new java.lang.IllegalStateException     // Catch:{ all -> 0x0138 }
            java.lang.String r9 = r9.toString()     // Catch:{ all -> 0x0138 }
            r10.<init>(r9)     // Catch:{ all -> 0x0138 }
            java.lang.Throwable r10 = (java.lang.Throwable) r10     // Catch:{ all -> 0x0138 }
    ...
    public final class Snapshot implements Closeable {
        ...
        public Snapshot(DiskLruCache diskLruCache, String str, long j, List<? extends Source> list, long[] jArr) {
            Intrinsics.checkParameterIsNotNull(str, LeanbackPreferenceDialogFragment.ARG_KEY);
    ...
    public final class Editor {
        ...
        public final okio.Source newSource(int r5) {
            /*
                ...
                boolean r1 = kotlin.jvm.internal.Intrinsics.areEqual((java.lang.Object) r1, (java.lang.Object) r4)     // Catch:{ all -> 0x004c }
                r1 = r1 ^ 1
        ...
        public final okio.Sink newSink(int r5) {
            /*
                ...
                boolean r1 = kotlin.jvm.internal.Intrinsics.areEqual((java.lang.Object) r1, (java.lang.Object) r4)     // Catch:{ all -> 0x006a }
                r1 = r1 ^ r2
