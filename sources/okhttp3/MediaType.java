...
public final class MediaType {
    ...
    public final String m1221deprecated_type() {
        return this.type;
    }
    ...
    public final String m1220deprecated_subtype() {
        return this.subtype;
    }
    ...
    public static final class Companion {
        ...
        public final MediaType m1222deprecated_get(String str) {
        ...
        public final MediaType m1223deprecated_parse(String str) {
            Intrinsics.checkParameterIsNotNull(str, "mediaType");
            Companion companion = this;
            return parse(str);
        }
