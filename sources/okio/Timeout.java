...
public class Timeout {
    ...
    public final void waitUntilNotified(Object obj) throws InterruptedIOException {
        ...
        try {
            ...
            if (hasDeadline2 || timeoutNanos2 != 0) {
                ...
                if (timeoutNanos2 > 0) {
                    long j2 = timeoutNanos2 / PickTimeFragment.SECONDS_IN_MICROS;
                    Long.signum(j2);
                    obj.wait(j2, (int) (timeoutNanos2 - (PickTimeFragment.SECONDS_IN_MICROS * j2)));
    ...
    public final void intersectWith(Timeout timeout, Function0<Unit> function0) {
        Intrinsics.checkParameterIsNotNull(timeout, "other");
