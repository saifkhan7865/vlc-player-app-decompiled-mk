...
public final class Pipe$sink$1 implements Sink {
    ...
    public void close() {
        /*
            ...
            boolean r2 = r2.getSinkClosed$jvm()     // Catch:{ all -> 0x00f8 }
            if (r2 == 0) goto L_0x0015
            monitor-exit(r1)
            return
        L_0x0015:
            okio.Pipe r2 = r11.this$0     // Catch:{ all -> 0x00f8 }
            okio.Sink r2 = r2.getFoldedSink$jvm()     // Catch:{ all -> 0x00f8 }
            if (r2 == 0) goto L_0x001f
            r0 = r2
            goto L_0x0055
        L_0x001f:
            okio.Pipe r2 = r11.this$0     // Catch:{ all -> 0x00f8 }
            boolean r2 = r2.getSourceClosed$jvm()     // Catch:{ all -> 0x00f8 }
            if (r2 == 0) goto L_0x0042
            okio.Pipe r2 = r11.this$0     // Catch:{ all -> 0x00f8 }
            okio.Buffer r2 = r2.getBuffer$jvm()     // Catch:{ all -> 0x00f8 }
        ...
        L_0x0042:
            okio.Pipe r2 = r11.this$0     // Catch:{ all -> 0x00f8 }
            r3 = 1
            r2.setSinkClosed$jvm(r3)     // Catch:{ all -> 0x00f8 }
            okio.Pipe r2 = r11.this$0     // Catch:{ all -> 0x00f8 }
            okio.Buffer r2 = r2.getBuffer$jvm()     // Catch:{ all -> 0x00f8 }
        ...
        L_0x00ef:
            return
        L_0x00f0:
            kotlin.TypeCastException r0 = new kotlin.TypeCastException     // Catch:{ all -> 0x00f8 }
