...
public final class JsonElementKt {
    ...
    public static final JsonPrimitive m2427JsonPrimitive7apg3OU(byte b) {
        return m2428JsonPrimitiveVKZWuLQ(ULong.m1948constructorimpl(((long) b) & 255));
    }

    @ExperimentalSerializationApi
    /* renamed from: JsonPrimitive-xj2QHRw  reason: not valid java name */
    public static final JsonPrimitive m2430JsonPrimitivexj2QHRw(short s) {
        return m2428JsonPrimitiveVKZWuLQ(ULong.m1948constructorimpl(((long) s) & WebSocketProtocol.PAYLOAD_SHORT_MAX));
    }

    @ExperimentalSerializationApi
    /* renamed from: JsonPrimitive-WZ4Q5Ns  reason: not valid java name */
    public static final JsonPrimitive m2429JsonPrimitiveWZ4Q5Ns(int i) {
        return m2428JsonPrimitiveVKZWuLQ(ULong.m1948constructorimpl(((long) i) & 4294967295L));
    }

    @ExperimentalSerializationApi
    /* renamed from: JsonPrimitive-VKZWuLQ  reason: not valid java name */
    public static final JsonPrimitive m2428JsonPrimitiveVKZWuLQ(long j) {
        return JsonUnquotedLiteral(UInt$$ExternalSyntheticBackport0.m(j));
    }
