...
public interface ParametrizedSerializerCache<T> {
    ...
    Object m2393getgIAlus(KClass<Object> kClass, List<? extends KType> list);

    @Metadata(k = 3, mv = {1, 8, 0}, xi = 48)
    /* compiled from: Platform.common.kt */
    public static final class DefaultImpls {
        /* renamed from: get-gIAlu-s$default  reason: not valid java name */
        public static /* synthetic */ Object m2394getgIAlus$default(ParametrizedSerializerCache parametrizedSerializerCache, KClass kClass, List list, int i, Object obj) {
            if (obj == null) {
                if ((i & 2) != 0) {
                    list = CollectionsKt.emptyList();
                }
                return parametrizedSerializerCache.m2393getgIAlus(kClass, list);
            }
