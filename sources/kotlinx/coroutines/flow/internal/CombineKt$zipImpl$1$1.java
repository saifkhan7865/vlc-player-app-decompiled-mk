...
final class CombineKt$zipImpl$1$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final java.lang.Object invokeSuspend(java.lang.Object r23) {
        ...
        L_0x0026:
            ...
            r7.invokeOnClose(r8)
            kotlin.coroutines.CoroutineContext r13 = r2.getCoroutineContext()     // Catch:{ AbortFlowException -> 0x00a3, all -> 0x00a0 }
            java.lang.Object r14 = kotlinx.coroutines.internal.ThreadContextKt.threadContextElements(r13)     // Catch:{ AbortFlowException -> 0x00a3, all -> 0x00a0 }
            kotlin.coroutines.CoroutineContext r2 = r2.getCoroutineContext()     // Catch:{ AbortFlowException -> 0x00a3, all -> 0x00a0 }
            kotlin.coroutines.CoroutineContext r6 = (kotlin.coroutines.CoroutineContext) r6     // Catch:{ AbortFlowException -> 0x00a3, all -> 0x00a0 }
            kotlin.coroutines.CoroutineContext r2 = r2.plus(r6)     // Catch:{ AbortFlowException -> 0x00a3, all -> 0x00a0 }
            kotlin.Unit r6 = kotlin.Unit.INSTANCE     // Catch:{ AbortFlowException -> 0x00a3, all -> 0x00a0 }
            kotlinx.coroutines.flow.internal.CombineKt$zipImpl$1$1$2 r7 = new kotlinx.coroutines.flow.internal.CombineKt$zipImpl$1$1$2     // Catch:{ AbortFlowException -> 0x00a3, all -> 0x00a0 }
            kotlinx.coroutines.flow.Flow<T1> r12 = r1.$flow     // Catch:{ AbortFlowException -> 0x00a3, all -> 0x00a0 }
            kotlinx.coroutines.flow.FlowCollector<R> r8 = r1.$this_unsafeFlow     // Catch:{ AbortFlowException -> 0x00a3, all -> 0x00a0 }
            kotlin.jvm.functions.Function3<T1, T2, kotlin.coroutines.Continuation<? super R>, java.lang.Object> r9 = r1.$transform     // Catch:{ AbortFlowException -> 0x00a3, all -> 0x00a0 }
            r18 = 0
            r11 = r7
            r15 = r5
            r16 = r8
            r17 = r9
            r11.<init>(r12, r13, r14, r15, r16, r17, r18)     // Catch:{ AbortFlowException -> 0x00a3, all -> 0x00a0 }
            r18 = r7
            kotlin.jvm.functions.Function2 r18 = (kotlin.jvm.functions.Function2) r18     // Catch:{ AbortFlowException -> 0x00a3, all -> 0x00a0 }
            r19 = r1
            kotlin.coroutines.Continuation r19 = (kotlin.coroutines.Continuation) r19     // Catch:{ AbortFlowException -> 0x00a3, all -> 0x00a0 }
            r1.L$0 = r5     // Catch:{ AbortFlowException -> 0x00a3, all -> 0x00a0 }
            r1.label = r3     // Catch:{ AbortFlowException -> 0x00a3, all -> 0x00a0 }
            r17 = 0
            r20 = 4
            r21 = 0
            r15 = r2
            r16 = r6
            java.lang.Object r2 = kotlinx.coroutines.flow.internal.ChannelFlowKt.withContextUndispatched$default(r15, r16, r17, r18, r19, r20, r21)     // Catch:{ AbortFlowException -> 0x00a3, all -> 0x00a0 }
