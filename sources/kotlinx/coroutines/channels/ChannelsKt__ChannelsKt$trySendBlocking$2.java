    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            try {
                ...
                obj2 = Result.m1774constructorimpl(ResultKt.createFailure(th));
            }
        } else {
            throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
        }
        obj2 = Result.m1774constructorimpl(Unit.INSTANCE);
        if (Result.m1781isSuccessimpl(obj2)) {
            obj3 = ChannelResult.Companion.m2351successJP2dKIU(Unit.INSTANCE);
        } else {
            obj3 = ChannelResult.Companion.m2349closedJP2dKIU(Result.m1777exceptionOrNullimpl(obj2));
        }
