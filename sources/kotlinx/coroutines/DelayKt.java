...
public final class DelayKt {
    ...
    public static final Object m2330delayVtjQ1oo(long j, Continuation<? super Unit> continuation) {
        Object delay = delay(m2331toDelayMillisLRDsOJo(j), continuation);
    ...
    public static final long m2331toDelayMillisLRDsOJo(long j) {
        if (Duration.m991compareToLRDsOJo(j, Duration.Companion.m1095getZEROUwyO8pc()) > 0) {
            return RangesKt.coerceAtLeast(Duration.m1010getInWholeMillisecondsimpl(j), 1);
        }
        return 0;
    }
}
