...
final class OnTimeout {
    ...
    public final void register(SelectInstance<?> selectInstance, Object obj) {
        ...
        selectInstance.disposeOnCompletion(DelayKt.getDelay(context).invokeOnTimeout(this.timeMillis, new OnTimeout$register$$inlined$Runnable$1(selectInstance, this), context));
    }
}
