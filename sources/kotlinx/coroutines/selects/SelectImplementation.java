...
public class SelectImplementation<R> extends CancelHandler implements SelectBuilder<R>, SelectInstanceInternal<R> {
    ...
    public static final AtomicReferenceFieldUpdater state$FU = AtomicReferenceFieldUpdater.newUpdater(SelectImplementation.class, Object.class, OAuth2RequestParameters.State);
    ...
    public final class ClauseData {
        ...
        public final boolean tryRegisterAsWaiter(SelectImplementation<R> selectImplementation) {
            if (DebugKt.getASSERTIONS_ENABLED() && !selectImplementation.getInRegistrationPhase() && !selectImplementation.isCancelled()) {
                throw new AssertionError();
            } else if (!DebugKt.getASSERTIONS_ENABLED() || selectImplementation.internalResult == SelectKt.NO_RESULT) {
